<?php
  ...
  define(sanction_uri,     "POST /servlet/AllatPayUtf8/pay/sanction.jsp HTTP/1.0\r\n");
  define(cancel_uri,       "POST /servlet/AllatPayUtf8/pay/cancel.jsp HTTP/1.0\r\n");
  define(cashreg_uri,      "POST /servlet/AllatPayUtf8/pay/cash_registry.jsp HTTP/1.0\r\n");
  define(cashapp_uri,      "POST /servlet/AllatPayUtf8/pay/cash_approval.jsp HTTP/1.0\r\n");
  define(cashcan_uri,      "POST /servlet/AllatPayUtf8/pay/cash_cancel.jsp HTTP/1.0\r\n");
  define(escrowchk_uri,    "POST /servlet/AllatPayUtf8/pay/escrow_check.jsp HTTP/1.0\r\n");
  define(escrowret_uri,    "POST /servlet/AllatPayUtf8/pay/escrow_return.jsp HTTP/1.0\r\n");
  define(escrowconfirm_uri,"POST /servlet/AllatPayUtf8/pay/escrow_confirm.jsp HTTP/1.0\r\n");
  define(certreg_uri,      "POST /servlet/AllatPayUtf8/pay/fix.jsp HTTP/1.0\r\n"); 
  define(certcancel_uri,   "POST /servlet/AllatPayUtf8/pay/fix_cancel.jsp HTTP/1.0\r\n");

  define(c2c_approval_uri,     "POST /servlet/AllatPayUtf8/pay/c2c_approval.jsp HTTP/1.0\r\n");
  define(c2c_cancel_uri,       "POST /servlet/AllatPayUtf8/pay/c2c_cancel.jsp HTTP/1.0\r\n");
  define(c2c_sellerreg_uri,    "POST /servlet/AllatPayUtf8/pay/seller_registry.jsp HTTP/1.0\r\n");
  define(c2c_productreg_uri,   "POST /servlet/AllatPayUtf8/pay/product_registry.jsp HTTP/1.0\r\n");
  define(c2c_buyerchg_uri,     "POST /servlet/AllatPayUtf8/pay/buyer_change.jsp HTTP/1.0\r\n");
  define(c2c_escrowchk_uri,    "POST /servlet/AllatPayUtf8/pay/c2c_escrow_check.jsp HTTP/1.0\r\n");
  define(c2c_escrowconfirm_uri,"POST /servlet/AllatPayUtf8/pay/c2c_escrow_confirm.jsp HTTP/1.0\r\n");
  define(c2c_esrejectcheck_uri,"POST /servlet/AllatPayUtf8/pay/c2c_reject_check.jsp HTTP/1.0\r\n");
  define(c2c_expressreg_uri,   "POST /servlet/AllatPayUtf8/pay/c2c_express_reg.jsp HTTP/1.0\r\n");
