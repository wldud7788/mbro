  ...
  function StartLog() 
	{
		...
		if( $this->type == "chkfake" )
			...
			$type = $this->type;
		if( $this->mergelog == "1")
			$this->logfile = $this->homedir. "/log/".PROGRAM."_".$type."_mergelog_".date("ymd").".log";
		else
			$this->logfile = $this->homedir. "/log/".PROGRAM."_".$type."_".$this->mid."_".date("ymd").".log";
  ...
  function MakeBody()
	...
	if(strcmp(substr($ResultCode,2, 4),"0000") == 0) 
		...
		{	
			...
			$this->m_RESULT[NM_RESULTERRORCODE] 	= $ResultCode;
