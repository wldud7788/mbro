   ...
   /* 주문번호 생성 예제 */
    ...
    function call_pay_form()
    {
       var v_frm = document.sm_form;
        ...
        layer_scbl_obj = document.getElementById("layer_scbl");

        layer_cont_obj.style.display = "none";
        layer_scbl_obj.style.display = "block";

        v_frm.target = "frm_scbl";
        v_frm.action = PayUrl;
...
<table border="0" width="100%">
	<tr>
		<td align="center">
			...
			<b style="color:blue">* 스마트폰 도서상품권 결제 *</b>
...
<!-- 인증시 필요한 파라미터(변경불가)-->
<input type="hidden" name='ActionResult' value="scbl">
<!-- 인증시 필요한 파라미터(변경불가)-->
<input type="hidden" name='van_code'     value="SCBL">
<!-- 화면 크기조정 부분 - Start - -->
...
<div id="layer_scbl" style="position:absolute; left:1px; top:1px; width:310;height:400; z-index:1; display:none;">
	<table width="310" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>
				<iframe name="frm_scbl" frameborder="0" border="0" width="310" height="400" scrolling="auto"></iframe>
			</td>
		</tr>
	</table>
</div>
