...
<?
    ...
    {
?>
                        <tr><td class="sub_title1">결과 상세 메세지</td><td class="sub_content1 bold"><?=$res_msg_bsucc?></td></tr>
					</table>
<?
    }
?>
...
?>                
                <table width="85%" cellpadding="0" cellspacing="1" class="margin_top_20">
                    ...
                    <!-- 주문자명 -->
                    <tr><td class="sub_title1">수취인명</td><td class="sub_content1"><?=$rcvr_name?></td></tr>
                    <!-- 주문자 전화번호 -->
                    <tr><td class="sub_title1">수취인 전화번호</td><td class="sub_content1"><?=$rcvr_tel1?></td></tr>
                    <!-- 주문자 휴대폰번호 -->
                    <tr><td class="sub_title1">수취인 휴대폰번호</td><td class="sub_content1"><?=$rcvr_tel2?></td></tr>
                    <!-- 주문자 E-mail -->
                    <tr><td class="sub_title1">수취인 E-mail</td><td class="sub_content1"><?=$rcvr_mail?></td></tr>
					<!-- 수취인 우편번호 -->
					<tr><td class="sub_title1">수취인 우편번호</td><td class="sub_content1"><?=$rcvr_zipx?></td></tr>
					<!-- 수취인 주소 -->
					<tr><td class="sub_title1">수취인 주소</td><td class="sub_content1"><?=$rcvr_add1?></td></tr>
					<!-- 수취인 상세주소 -->
					<tr><td class="sub_title1">수취인 상세주소</td><td class="sub_content1"><?=$rcvr_add2?></td></tr>
					<!-- 배송 소요일 -->
					<tr><td class="sub_title1">배송 소요일</td><td class="sub_content1"><?=$deli_term?></td></tr>
                </table>
<?
				}
				/* ============================================================================== */
