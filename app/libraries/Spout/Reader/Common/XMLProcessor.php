...
class XMLProcessor
{
     ...
     */
    protected function getCallbackKey($nodeName, $nodeType)
    {
     ...
     */
    protected function getInvokableCallbackData($callback)
    {
     ...
     */
    protected function getRegisteredCallbackData($nodeNamePossiblyWithPrefix, $nodeNameWithoutPrefix, $nodeType)
    {
     ...
     */
    protected function invokeCallback($callbackData, $args)
    {
