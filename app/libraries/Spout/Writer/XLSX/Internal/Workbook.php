...
class Workbook extends AbstractWorkbook
{
     ...
     */
	public function __construct($tempFolder, $shouldUseInlineStrings, $shouldCreateNewSheetsAutomatically, $defaultRowStyle, $colWidth=null, $mergeCells=null)
    {
    ...
    public function addNewSheet()
    {
        ...
        $worksheet = new Worksheet($sheet, $worksheetFilesFolder, $this->sharedStringsHelper, $this->styleHelper, $this->shouldUseInlineStrings, $this->colWidth, $this->mergeCells);
