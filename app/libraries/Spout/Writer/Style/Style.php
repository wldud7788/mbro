...
class Style
{
     ...
     * @return void
     */
    protected function mergeFontStyles($styleToUpdate, $baseStyle)
    {
     ...
     * @return void
     */
    protected function mergeOtherFontProperties($styleToUpdate, $baseStyle)
    {
     ...
     * @return void
     */
    protected function mergeCellProperties($styleToUpdate, $baseStyle)
    {
