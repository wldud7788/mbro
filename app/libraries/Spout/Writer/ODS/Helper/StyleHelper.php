...
EOD;
     ...
     * @return string
     */
    protected function getTextPropertiesSectionContent($style)
    {
        $content = '';
     ...
     * @return string
     */
    protected function getFontSectionContent($style)
    {
        $defaultStyle = $this->getDefaultStyle();
     ...
     * @return string
     */
    protected function getTableCellPropertiesSectionContent($style)
    {
        $content = '';
     ...
     * @return string
     */
    protected function getWrapTextXMLContent()
    {
     ...
     * @return string
     */
    protected function getBorderXMLContent($style)
    {
     ...
     * @return string
     */
    protected function getBackgroundColorXMLContent($style)
    {
        return sprintf(
