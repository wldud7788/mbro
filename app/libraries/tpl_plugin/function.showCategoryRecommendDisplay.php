...
{
	$CI =& get_instance();
	if (empty($CI->designDisplayTabAjaxIdx)){
	...
	$cache_item_id = sprintf('category_recommend_%s_tabs_%s_html',  $category_code, $CI->designDisplayTabAjaxIdx);
