<?
function getGabiaSkinPannel($type = null)
{
	$CI =& get_instance();
	...
	$cach_file_path	= $_SERVER['DOCUMENT_ROOT'] . '/data/cach/admin_skin_banner_pannel.html';
	...
	if($read){
		$res	= readurl(get_connet_protocol()."interface.firstmall.kr/firstmall_plus/request.php?cmd=getGabiaSkinPannel", $data);
