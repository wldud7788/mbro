...
class PHPExcel_Reader_Excel5 implements PHPExcel_Reader_IReader
{
	 ...
	 * @var string
	 */
	protected $_documentSummaryInformation;
	 ...
	 * @var string
	 */
	protected $_userDefinedProperties;
	 ...
	 * @var array
	 */
	protected $_mapCellStyleXfIndex;
...
//					echo '<br />';
	 ...
	 * @param string $pFilename
	 */
	protected function _loadOLE($pFilename)
	{
		// OLE reader
		$ole = new PHPExcel_Shared_OLERead();
...
//		$this->_userDefinedProperties = $ole->getUserDefinedProperties();
	 ...
	 */
	protected function _readSummaryInformation()
	{
	 ...
	 */
	protected function _readDocumentSummaryInformation()
	{
...
//													->setAuthor( $author )
	 ...
	 */
	protected function _readTextObject()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
...
//		echo '<br />';
	 ...
	 * 		Excel File Format"
	 */
	protected function _readFilepass()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
//		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readCodepage()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readDateMode()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readFormat()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read PALETTE record
	 */
	protected function _readPalette()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readExternalBook()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readExternName()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readExternSheet()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readDefinedName()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readMsoDrawingGroup()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
	 ...
	 */
	protected function _readPrintGridlines()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readDefaultRowHeight()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read SHEETPR record
	 */
	protected function _readSheetPr()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readHorizontalPageBreaks()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readVerticalPageBreaks()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read FOOTER record
	 */
	protected function _readFooter()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read HCENTER record
	 */
	protected function _readHcenter()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read VCENTER record
	 */
	protected function _readVcenter()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readLeftMargin()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readRightMargin()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readTopMargin()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readBottomMargin()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readPageSetup()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readProtect()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * SCENPROTECT
	 */
	protected function _readScenProtect()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * OBJECTPROTECT
	 */
	protected function _readObjectProtect()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readPassword()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readDefColWidth()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read COLINFO record
	 */
	protected function _readColInfo()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readLabelSst()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readSharedFmla()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readBoolErr()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * 		Excel File Format"
	 */
	protected function _readMulBlank()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readMsoDrawing()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
...
//		echo '<br />';
	 ...
	 * Read WINDOW2 record
	 */
	protected function _readWindow2()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readSelection()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	...
	protected function _includeCellRangeFiltered($cellRangeAddress)
	{
	 ...
	 * 		Excel File Format"
	 */
	protected function _readMergedCells()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readHyperLink()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readDataValidations()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readDataValidation()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readSheetLayout()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readSheetProtection()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 */
	protected function _readRangeProtection()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * Read IMDATA record
	 */
	protected function _readImData()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
...
//			var_dump($bcBitCount);
	 ...
	 */
	protected function _readContinue()
	{
		$length = self::_GetInt2d($this->_data, $this->_pos + 2);
		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * @return array
	 */
	protected function _getSplicedRecordData()
	{
		$data = '';
		$spliceOffsets = array();
	 ...
	 */
	protected function _getFormulaFromStructure($formulaStructure, $baseCell = 'A1')
	{
	 ...
	 * @return string Human readable formula
	 */
	protected function _getFormulaFromData($formulaData,  $additionalData = '', $baseCell = 'A1')
	{
	 ...
	 * @return string Human readable formula
	 */
	protected function _createFormulaFromTokens($tokens, $additionalData)
	{
		// empty formula?
		if (empty($tokens)) {
			return '';
	 ...
	 * @throws Exception
	 */
	protected function _getNextToken($formulaData, $baseCell = 'A1')
	{
	 ...
	 * @return string
	 */
	protected function _readBIFF8CellAddress($cellAddressStructure)
	{
	 ...
	 * @return string
	 */
	protected function _readBIFF8CellAddressB($cellAddressStructure, $baseCell = 'A1')
	{
	 ...
	 * @throws Exception
	 */
	protected function _readBIFF5CellRangeAddressFixed($subData)
	{
	 ...
	 * @throws Exception
	 */
	protected function _readBIFF8CellRangeAddressFixed($subData)
	{
		// offset: 0; size: 2; index to first row
		$fr = self::_GetInt2d($subData, 0) + 1;
	 ...
	 * @return string
	 */
	protected function _readBIFF8CellRangeAddress($subData)
	{
	 ...
	 */
	protected function _readBIFF8CellRangeAddressB($subData, $baseCell = 'A1')
	{
		list($baseCol, $baseRow) = PHPExcel_Cell::coordinateFromString($baseCell);
		$baseCol = PHPExcel_Cell::columnIndexFromString($baseCol) - 1;
	 ...
	 * @return array
	 */
	protected function _readBIFF8CellRangeAddressList($subData)
	{
	 ...
	 * @return array
	 */
	protected function _readBIFF5CellRangeAddressList($subData)
	{
		$cellRangeAddresses = array();
	 ...
	 * @throws Exception
	 */
	protected function _readSheetRangeByRefIndex($index)
	{
	 ...
	 * @return array
	 */
	protected function _readByteStringShort($subData)
	{
	 ...
	 * @return array
	 */
	protected function _readByteStringLong($subData)
	{
	 ...
	 * @return string
	 */
	protected function _decodeCodepage($string)
	{
