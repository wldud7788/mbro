...
class PHPExcel_Reader_Excel5_Escher
{
	 ...
	 */
	protected function _readDggContainer()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readBstoreContainer()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readBlipJPEG()
	{
		// offset: 0; size: 2; recVer and recInstance
	 ...
	 */
	protected function _readBlipPNG()
	{
		// offset: 0; size: 2; recVer and recInstance
	 ...
	 */
	protected function _readTertiaryOPT()
	{
		// offset: 0; size: 2; recVer and recInstance
	 ...
	 */
	protected function _readSplitMenuColors()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readDgContainer()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readSpgrContainer()
	{
	 ...
	 */
	protected function _readSpContainer()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readClientTextbox()
	{
		// offset: 0; size: 2; recVer and recInstance
	 ...
	 */
	protected function _readClientAnchor()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readClientData()
	{
		$length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data, $this->_pos + 4);
		$recordData = substr($this->_data, $this->_pos + 8, $length);
	 ...
	 */
	protected function _readOfficeArtRGFOPTE($data, $n) {
