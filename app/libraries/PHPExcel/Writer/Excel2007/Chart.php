...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeTitle(PHPExcel_Chart_Title $title = null, $objWriter)
	{
		if (is_null($title)) {
			return;
		}
	 ...
	 * @throws 	Exception
	 */
	protected function _writeLegend(PHPExcel_Chart_Legend $legend = null, $objWriter)
	{
		if (is_null($legend)) {
			return;
		}
	 ...
	 * @throws 	Exception
	 */
	protected function _writePlotArea(PHPExcel_Chart_PlotArea $plotArea,
...
//					} while ($id1 == $id2);
	 ...
	 * @throws 	Exception
	 */
	protected function _writeDataLbls($objWriter)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeCatAx($objWriter, PHPExcel_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeValAx($objWriter, PHPExcel_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writePlotSeriesLabel($plotSeriesLabel, $objWriter)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType='str')
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeBubbles($plotSeriesValues, $objWriter)
	{
		if (is_null($plotSeriesValues)) {
			return;
		}
	 ...
	 * @throws 	Exception
	 */
	protected function _writeLayout(PHPExcel_Chart_Layout $layout = NULL, $objWriter)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeAlternateContent($objWriter)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writePrintSettings($objWriter)
	{
