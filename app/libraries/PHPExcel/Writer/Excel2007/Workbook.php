...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeFileVersion(PHPExcel_Shared_XMLWriter $objWriter = null)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeWorkbookPr(PHPExcel_Shared_XMLWriter $objWriter = null)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeBookViews(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// bookViews
	 ...
	 * @throws 	Exception
	 */
	protected function _writeWorkbookProtection(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeCalcPr(PHPExcel_Shared_XMLWriter $objWriter = null, $recalcRequired = TRUE)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeSheets(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// Write sheets
	 ...
	 * @throws 	Exception
	 */
	protected function _writeSheet(PHPExcel_Shared_XMLWriter $objWriter = null, $pSheetname = '', $pSheetId = 1, $pRelId = 1, $sheetState = 'visible')
	{
		if ($pSheetname != '') {
			// Write sheet
	 ...
	 * @throws 	Exception
	 */
	protected function _writeDefinedNames(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// Write defined names
	 ...
	 * @throws 	Exception
	 */
	protected function _writeNamedRanges(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel)
	{
		// Loop named ranges
	 ...
	 * @throws 	Exception
	 */
	protected function _writeDefinedNameForNamedRange(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_NamedRange $pNamedRange)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeDefinedNameForAutofilter(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pSheetId = 0)
	{
		// definedName for autoFilter
	 ...
	 * @throws 	Exception
	 */
	protected function _writeDefinedNameForPrintTitles(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pSheetId = 0)
	{
	 ...
	 * @throws 	Exception
	 */
	protected function _writeDefinedNameForPrintArea(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pSheetId = 0)
	{
