...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
	 ...
	 * @var int
	 */
	protected $_firstRowIndex;

	/**
	 * Index of last used row. (no used rows means -1)
	 * @var int
	 */
	protected $_lastRowIndex;

	/**
	 * Index of first used column (at least 0)
	 * @var int
	 */
	protected $_firstColumnIndex;

	/**
	 * Index of last used column (no used columns means -1)
	 * @var int
	 */
	protected $_lastColumnIndex;
...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	 ...
	 */
	protected function _writeBIFF8CellRangeAddressFixed($range = 'A1')
	{
	 ...
	 * @return integer
	 */
	protected function _writeNumber($row, $col, $num, $xfIndex)
	{
	 ...
	 */
	protected function _writeString($row, $col, $str, $xfIndex)
	{
	 ...
	 */
	protected function _writeRichTextString($row, $col, $str, $xfIndex, $arrcRun){
	 ...
	 * @return integer
	 */
	protected function _writeLabel($row, $col, $str, $xfIndex)
	{
		$strlen	= strlen($str);
	 ...
	 * @return integer
	 */
	protected function _writeLabelSst($row, $col, $str, $xfIndex)
	{
		$record	= 0x00FD;				   // Record identifier
		$length	= 0x000A;				   // Bytes to follow
	 ...
	 */
	protected function _writeNote($row, $col, $note)
	{
	 ...
	 * @param int $xfIndex
	 */
	protected function _writeBoolErr($row, $col, $value, $isError, $xfIndex)
	{
		$record = 0x0205;
		$length = 8;
	 ...
	 * @return integer
	 */
	protected function _writeFormula($row, $col, $formula, $xfIndex, $calculatedValue)
	{
	 ...
	 */
	protected function _writeStringRecord($stringValue)
	{
	 ...
	 * @return integer
	 */
	protected function _writeUrl($row, $col, $url)
	{
	 ...
	 */
	protected function _writeRow($row, $height, $xfIndex, $hidden = false, $level = 0)
	{
	 ...
	 */
	protected function _writeDimensions()
	{
	 ...
	 */
	protected function _writeWindow2()
	{
	 ...
	 */
	protected function _writeDefaultRowHeight()
	{
	 ...
	 */
	protected function _writeDefcol()
	{
		$defaultColWidth = 8;
	 ...
	 */
	protected function _writeColinfo($col_array)
	{
	 ...
	 */
	protected function _writeSelection()
	{
	 ...
	 */
	protected function _writeMergedCells()
	{
	 ...
	 */
	protected function _writeSheetLayout()
	{
	 ...
	 */
	protected function _writeSheetProtection()
	{
		// record identifier
		$record = 0x0867;
	 ...
	 */
	protected function _writeRangeProtection()
	{
	 ...
	 */
	protected function _writeExterncount($count)
	{
	 ...
	 */
	protected function _writeExternsheet($sheetname)
	{
	 ...
	 */
	protected function _writePanes()
	{
		$panes = array();
	 ...
	 */
	protected function _writeSetup()
	{
	 ...
	 * @access private
	 */
	protected function _writeHcenter()
	{
	 ...
	 */
	protected function _writeVcenter()
	{
	 ...
	 */
	protected function _writeMarginLeft()
	{
	 ...
	 */
	protected function _writeMarginRight()
	{
	 ...
	 */
	protected function _writeMarginTop()
	{
	 ...
	 */
	protected function _writeMarginBottom()
	{
	 ...
	 */
	protected function _writePrintHeaders()
	{
	 ...
	 * GRIDSET record.
	 */
	protected function _writePrintGridlines()
	{
	 ...
	 */
	protected function _writeGridset()
	{
	 ...
	 */
	protected function _writeWsbool()
	{
	 ...
	 */
	protected function _writeBreaks()
	{
		// initialize
		$vbreaks = array();
		$hbreaks = array();
	 ...
	 */
	protected function _writeProtect()
	{
	 ...
	 * Write SCENPROTECT
	 */
	protected function _writeScenProtect()
	{
	 ...
	 * Write OBJECTPROTECT
	 */
	protected function _writeObjectProtect()
	{
		// Exit if sheet protection is not active
		if (!$this->_phpSheet->getProtection()->getSheet()) {
			return;
	 ...
	 */
	protected function _writePassword()
	{
	 ...
	 */
	protected function _writeObjPicture($colL,$dxL,$rwT,$dyT,$colR,$dxR,$rwB,$dyB)
	{
	 ...
	 */
	protected function _writeMsoDrawing()
	{
	 ...
	 */
	protected function _writeDataValidity()
	{
