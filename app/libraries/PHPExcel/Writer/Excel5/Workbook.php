...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
	 ...
	 * @var array
	 */
	protected $_addedNumberFormats = array();
	 ...
	 * @var array
	 */
	protected $_worksheetSizes = array();
	 ...
	 * @var array
	 */
	protected $_worksheetOffsets = array();
	 ...
	 */
	protected function _addColor($rgb) {
	 ...
	 */
	protected function _writeAllFonts()
	{
	 ...
	 */
	protected function _writeAllNumFormats()
	{
	 ...
	 */
	protected function _writeAllXfs()
	{
	 ...
	 */
	protected function _writeAllStyles()
	{
		$this->_writeStyle();
	}
	 ...
	 * the NAME records.
	 */
	protected function _writeExterns()
	{
	 ...
	 */
	protected function _writeNames()
	{
	 ...
	 */
	protected function _writeAllDefinedNamesBiff8()
	{
		$chunk = '';
	 ...
	 */
	protected function _writeDefinedNameBiff8($name, $formulaData, $sheetIndex = 0, $isBuiltIn = false)
	{
		$record = 0x0018;
	 ...
	 */
	protected function _writeCodepage()
	{
	 ...
	 */
	protected function _writeWindow1()
	{
	 ...
	 */
	protected function _writeBoundsheet($sheet, $offset)
	{
	 ...
	 */
	protected function _writeSupbookInternal()
	{
	 ...
	 *
	 */
	protected function _writeExternsheetBiff8()
	{
	 ...
	 */
	protected function _writeStyle()
	{
	 ...
	 */
	protected function _writeNumFormat($format, $ifmt)
	{
	 ...
	 */
	protected function _writeDatemode()
	{
	 ...
	 */
	protected function _writeExterncount($cxals)
	{
	 ...
	 */
	protected function _writeNameShort($index, $type, $rowmin, $rowmax, $colmin, $colmax)
	{
	 ...
	 * @param integer $colmax End column
	 */
	protected function _writeNameLong($index, $type, $rowmin, $rowmax, $colmin, $colmax)
	{
		$record          = 0x0018;       // Record identifier
	 ...
	 * @return string
	 */
	protected function _writeCountry()
	{
	 ...
	 * @return string
	 */
	protected function _writeRecalcId()
	{
	 ...
	 */
	protected function _writePalette()
	{
		$aref            = $this->_palette;
	 ...
	 */
	protected function _writeSharedStringsTable()
	{
	 ...
	 */
	protected function _writeMsoDrawingGroup()
	{
