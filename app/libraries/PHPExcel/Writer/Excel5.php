...
class PHPExcel_Writer_Excel5 implements PHPExcel_Writer_IWriter
{
	 ...
	 *
	 */
	protected function _buildWorksheetEschers()
	{
	 ...
	 */
	protected function _buildWorkbookEscher()
	{
		$escher = null;
	 ...
	 * @return string
	 */
	protected function _writeDocumentSummaryInformation(){
	 ...
	 * @return string
	 */
	protected function _writeSummaryInformation(){
		// offset: 0; size: 2; must be 0xFE 0xFF (UTF-16 LE byte order mark)
		$data = pack('v', 0xFFFE);
		// offset: 2; size: 2;
		$data .= pack('v', 0x0000);
