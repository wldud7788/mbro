...
class PHPExcel_Cell_DataValidation
{
     ...
     * @var string
     */
    protected $_type = PHPExcel_Cell_DataValidation::TYPE_NONE;
     ...
     * @var string
     */
    protected $_errorStyle = PHPExcel_Cell_DataValidation::STYLE_STOP;
