...
class PHPExcel_ReferenceHelper
{
	 ...
	 * @throws	Exception
	 */
	protected function _updateCellRange($pCellRange = 'A1:A1', $pBefore = 'A1', $pNumCols = 0, $pNumRows = 0) {
	 ...
	 * @throws	Exception
	 */
	protected function _updateSingleCellReference($pCellReference = 'A1', $pBefore = 'A1', $pNumCols = 0, $pNumRows = 0) {
