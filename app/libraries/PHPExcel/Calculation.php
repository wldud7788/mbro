...
class PHPExcel_Calculation {
	...
	protected $_cyclicFormulaCount = 0;
	protected $_cyclicFormulaCell = '';
	public $cyclicFormulaCount = 0;


	protected $_savedPrecision	= 12;
...
//						echo 'Cache has expired<br />';
	 ...
	 * @return	mixed
	 */
	protected function _showValue($value) {
	 ...
	 * @return	mixed
	 */
	protected function _showTypeDetails($value) {
		if ($this->writeDebugLog) {
			$testArray = PHPExcel_Calculation_Functions::flattenArray($value);
			if (count($testArray) == 1) {
				$value = array_pop($testArray);
	...
	protected function _parseFormula($formula, PHPExcel_Cell $pCell = null) {
...
//					echo 'Element is an Intersect Operator<br />';
	...
	protected function _processTokenStack($tokens, $cellID = null, PHPExcel_Cell $pCell = null) {
...
//		}
	...
	protected function _validateBinaryOperand($cellID,&$operand,&$stack) {
	...
	protected function _executeBinaryComparisonOperation($cellID,$operand1,$operand2,$operation,&$stack,$recursingArrays=false) {
	...
	protected function _executeNumericBinaryOperation($cellID,$operand1,$operand2,$operation,$matrixFunction,&$stack) {
	...
	protected function _writeDebug($message) {
