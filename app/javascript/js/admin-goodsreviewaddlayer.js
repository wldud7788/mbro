...
$(function() {
	...
	// 평가 정보 추가
	$("#labelWriteBtn").on("click", function() {
	...
	$(".sampleCloseBtn").on("click", function(){
		$(".sample").hide();
	});
});
...
{
	openDialog("평가 정보 추가","joinDiv",{"width":450,"height":500});
}
	...
	switch(type)
	{
		...
		case "radio" :
			...
			if (right) {
				html += '<tr class="labelAdd"><th align="left" style="width:65px;"></th>';
				html += '<td>';
				html += '<input type="hidden" name="labelIcon[]" value="'+labelIcon[i]+'" /><img src="'+goodsreviewicon+'/emotion_happy.png" border="0" class="goodsReviewIcon hand" align="absmiddle" iconindex="'+label_item_radio+'" > ';
				html += '<input type="button" class="goodsReviewIcon resp_btn v3 size_S" value="선택" iconindex="'+label_item_radio+'" /> ';
				...
				html += '<input type="hidden" name="labelIcon[]" value="" /><img src="'+goodsreviewicon+'/emotion_happy.png" border="0" class="goodsReviewIcon hand" align="absmiddle"  iconindex="'+label_item_radio+'" > ';
				html += '<input type="button" class="goodsReviewIcon resp_btn v3 size_S" value="선택" iconindex="'+label_item_radio+'" /> ';
...
function labelAddItem(labelType, labelValue, labelsubValue, labelIcon)
{
	...
	switch(labelType)
	{
		case "text" :
			...
			html = '<input type="text" name="windowLabelValue[]" size="30" readonly style="background:#eee;"> <button type="button" class="btn_plus" onclick="labelAdd(\'text\')" ></button>';
		...
		case "radio" :
			if (labelValue)
			{
				...
				html = '<input type="hidden" name="labelIcon[]" value="'+labelIcon[0]+'" />';
				html +='<img src="'+goodsreviewicon+labelIcon[0]+'" border="0" class="goodsReviewIcon hand" align="absmiddle" iconindex="0" > ';
				html +='<input type="button" value="선택" class="goodsReviewIcon resp_btn v3 size_S" iconindex="0" /> ';
				html += '<label class="resp_radio"><input type="radio" name="labelKey[]" class="null" disabled></label> <input type="text" name="windowLabelValue[]" value="'+ labelValue[0] +'" size="30"><br/><input type="hidden" name="labelIcon[]" value="'+labelIcon[1]+'" />';
				html += '<img src="'+goodsreviewicon+labelIcon[1]+'" border="0" class="goodsReviewIcon hand" align="absmiddle" iconindex="1" > ';
				html += '<input type="button" value="선택" class="goodsReviewIcon resp_btn v3 size_S" iconindex="1" /> ';
				html += '<label class="resp_radio"><input type="radio" name="labelKey[]" class="null" disabled></label> <input type="text" name="windowLabelValue[]" value="'+ labelValue[1] +'" size="30"> <button type="button" class="btn_plus" onclick="labelAdd(\'radio\')"></button>';
				label_item_radio=2;
				...
				if (count > 2)
				{
					for (i=2; i<count; i++)
					{
						...
						labelTableHtml += '<tr class="labelAdd"><td>&nbsp;</td>';
						labelTableHtml += '<td>';
						labelTableHtml += '	<input type="hidden" name="labelIcon[]" value="'+labelIcon[i]+'" />';
						labelTableHtml += '<img src="'+goodsreviewicon+''+labelIcon[i]+'" border="0" class="goodsReviewIcon hand" align="absmiddle" iconindex="'+i+'" > ';
						labelTableHtml += '<input type="button" value="선택" class="goodsReviewIcon resp_btn v3 size_S"  iconindex="'+i+'" /> <label class="resp_radio"><input type="radio" name="labelKey[]" class="null" disabled></label> <input type="text" name="windowLabelValue[]" value="'+ labelValue[i] +'" size="30"> <button type="button" class="btn_minus" onclick="deleteRow(this)"></button>';
						labelTableHtml += '</td>';
						labelTableHtml += '</tr>';
					}
				}
				...
				html = '<input type="hidden" name="labelIcon[]" value="" /><img src="'+goodsreviewicon+'/emotion_happy.png" border="0" class="goodsReviewIcon hand" align="absmiddle" iconindex="0" > ';
				html += '<input type="button" value="선택" class="goodsReviewIcon resp_btn v3 size_S" iconindex="0" /> <label class="resp_radio"><input type="radio" name="labelKey[]" class="null" disabled></label> <input type="text" name="windowLabelValue[]" value="" size="30"><br/><input type="hidden" name="labelIcon[]" value="" />';
				html += '<img src="'+goodsreviewicon+'/emotion_happy.png" border="0" class="goodsReviewIcon hand" align="absmiddle" iconindex="1" > ';
				html += '<input type="button" value="선택" class="goodsReviewIcon resp_btn v3 size_S" iconindex="1" /> ';
				html += '<label class="resp_radio"><input type="radio" name="labelKey[]" class="null" disabled></label> <input type="text" name="windowLabelValue[]" value="" size="30"> <button type="button" class="btn_plus" onclick="labelAdd(\'radio\')"></button>';
				label_item_radio=2;
			}
		...
		case "textarea" :
			...
			html += '<tr>';
			html += '<td>';
			html += '<textarea id="labelTextArea" name="labelTextArea" style="width:98%; height:50px; padding:0;background:#eee;" readonly></textarea></td></tr>';
			html += '<tr>';
			html += '<td>항목값 박스크기 : <span class="resp_radio"><input type="radio" name="windowLabelValue" value="large" class="textAreaHeight null" '+ ckValueL +'> large ';
