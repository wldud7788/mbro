...
$(document).ready(function() {
	...
	$("#sampleViewBtn").on("click", function(){
		...
		{
			case "textSample":
				openDialog("텍스트박스 샘플", labelType, {"width":"500","height":"350","show" : "fade","hide" : "fade"});
			break;

			case "radioSample":
				openDialog("여러개 중 택1 샘플", labelType, {"width":"400","height":"240","show" : "fade","hide" : "fade"});
			break;

			case "textareaSample":
				openDialog("에디트 박스 샘플", labelType, {"width":"400","height":"270","show" : "fade","hide" : "fade"});
			break;

			case "checkboxSample":
				openDialog("체크박스 샘플", labelType, {"width":"400","height":"280","show" : "fade","hide" : "fade"});
			break;

			case "selectSample":
				openDialog("셀렉트박스 샘플", labelType, {"width":"400","height":"210","show" : "fade","hide" : "fade"});
			break;
		}		
	...
	$("#labelWriteBtn").click(function(){
		...
		html += '<td><input type="checkbox" name="labelItem[user]['+ user_layer_seq  +'][use]" class="user_chUse" user_ch="'+user_layer_seq+'" value="Y" /></td>';
		html += '<td><input type="checkbox" name="labelItem[user]['+ user_layer_seq  +'][required]" class="user_chRequired" value="Y" /></td>';	
		...
		html += '<td><button type="button" class="listJoinBtn btn_resp b_gray2" id="listJoinBtn" value="'+ user_layer_seq  +'" join_type="user" >수정</button></td>'		
		...
		html += '<th>'+ windowLabelName +'</th>';
		html += '<td><input type="checkbox" name="labelItem[order]['+ order_layer_seq +'][use]" class="order_chUse" order_ch="'+order_layer_seq+'" value="Y" /></td>';
		html += '<td><input type="checkbox" name="labelItem[order]['+ order_layer_seq +'][required]" class="order_chRequired" value="Y" /></td>';	
		html += '<td><img src="../skin/default/images/common/icon_move.png" style="cursor:pointer"></td>'
		html += '<td class="left">['+labelTypeText+'] '+ windowLabelExp+'</td>';	
		html += '<td><button type="button" class="listJoinBtn btn_resp b_gray2" id="listJoinBtn" value="'+ order_layer_seq  +'" join_type="order" >수정</button></td>'
		html += '<td>'+hiddenHtml+'<button type="button" class="btn_minus" onclick="deleteRow(this)"></button></td>';
		html += '</tr>';
...
{
	openDialog("가입항목 추가","joinDiv",{"width":"430","height":"450"});
	...
	switch(type)
	{
		case "text" :
			...
			if (right) {
				...
				html += '<td>';
				html += '<input type="text" name="windowLabelRight[]" value="" size="30" style="height:18px;" class="line"> <button type="button"  class="pointer btn_minus" onclick="deleteRow(this)"></button>';
				html += '</td>';
				html += '</tr>';
			}
			else {
				html += '<input type="text" name="windowLabelValue[]" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
			}
			html += '</td>';
			html += '</tr>';
		break;
		...
		case "radio" :
			...
			if (right) {
				...
				html += '<input type="radio" name="labelKey[]" class="null" disabled> <input type="text" name="windowLabelValue[]" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
			}
			html += '</td>';
			html += '</tr>';
		break;
		...
		case "checkbox" :
			...
			if (right) {
				html += '<tr class="labelAdd"><th align="left" style="width:65px;"></th>';
				html += '<td>';
				html += '<input type="text" name="windowLabelRight[]" value=""  size="30" style="height:18px;" class="line"> <input type="button" class="pointer btn_plus" onclick="deleteRow(this)"></button>';
				html += '</td>';
				html += '</tr>';
			}
			else {
				html += '<input type="checkbox" name="labelKey[]" class="null"> <input type="text" name="windowLabelValue[]" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
			}
			html += '</td>';
			html += '</tr>';
		break;
		...
		case "select" :
			...
			if (right) {
				...
				html += '<tr class="labelAdd"><th align="left" style="width:65px;"></th>';
				html += '<td>';
				html += '<input type="text" name="windowLabelRight['+label_item_seq+']" id="selectRight" class="line" size="30" style="height:18px;"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button><button type="button" class="pointer btn_plus" onclick="labelSubAdd('+label_item_seq+')"></button>';
				html += '</td>';
				html += '</tr>';
			}
			else {
				html += '<input type="text" name="windowLabelValue['+label_item_seq+']" class="windowLabelValue line" label_item_seq="'+label_item_seq+'" size="30" style="height:18px;" > <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button> <button type="button" class="pointer btn_plus gray" onclick="labelSubAdd('+label_item_seq+')"></button>';
			}
			html += '</td>';
			html += '</tr>';
...
function labelSubAdd(parent_label_item_seq){
	...
	html += '→ <input type="text" name="windowSubLabelValue['+parent_label_item_seq+'][]" size="27" style="height:18px; margin-left:3px;" class="line"> <button type="button" class="pointer btn_minus gray" onclick="deleteRow(this)"></button>';
	html += '</td></tr>';
...
function labelAddItem(labelType, labelValue, labelsubValue)
{
	...
	switch(labelType)
	{
		case "text" :
			...
			html = '<input type="text" name="windowLabelValue[]" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_plus" onclick="labelAdd(\'text\')" ></button>';
			if (labelValue && labelValue > 1)
			{
				for (i=1; i<labelValue; i++)
				{
					...
					labelTableHtml += '<td>';
					labelTableHtml += '<input type="text" name="windowLabelValue[]" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
					labelTableHtml += '</td>';
					labelTableHtml += '</tr>';
				}
			}
			...
			if (labelValue)
			{
				...
				if (count > 2)
				{
					for (i=2; i<count; i++)
					{
						labelTableHtml += '<tr class="labelAdd"><td></td>';
						labelTableHtml += '<td>';
						labelTableHtml += '<input type="radio" name="labelKey[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="'+ labelValue[i] +'" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
						labelTableHtml += '</td>';
						labelTableHtml += '</tr>';
					}
				}
				...
				html = '<input type="radio" name="labelKey[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="" size="30" style="height:18px;" class="line"><br/><input type="radio" name="labelKey[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_plus" onclick="labelAdd(\'radio\')"></button>';
			}
		...
		case "checkbox" :
			if (labelValue)
			{
				html = '<label class="resp_checkbox"><input type="checkbox" name="labelContent[]" class="null" disabled></label> <input type="text" name="windowLabelValue[]" value="'+ labelValue[0] +'" size="30" style="height:18px;" class="line"> <br/> <input type="checkbox" name="labelContent[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="'+ labelValue[1] +'" size="30" style="height:18px;" class="line"> <button type="button" class="pointer" onclick="labelAdd(\'checkbox\')"><img src="/admin/skin/default/images/design/icon_design_plus.gif" height="18px" align="middle"></button>';
				...
				if (count > 2)
				{
					for (i=2; i<count; i++)
					{
						labelTableHtml += '<tr class="labelAdd"><td></td>';
						labelTableHtml += '<td>';
						labelTableHtml += '<input type="checkbox" name="labelKey[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="'+ labelValue[i] +'" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
						labelTableHtml += '</td>';
						labelTableHtml += '</tr>';
					}
				}
				...
				html = '<input type="checkbox" name="labelContent[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="" size="30" style="height:18px;" class="line"> <button type="button" class="pointer btn_plus" onclick="labelAdd(\'checkbox\')"></button>';
		...
		case "select" :
			...
			{							
				...
				html = '<input type="text" name="windowLabelvalue['+label_item_seq+']" label_item_seq="'+label_item_seq+'" value="'+ labelsubValue[0][0] +'" size="30" style="height:18px;" class="windowLabelValue line"> <button type="button" class="pointer btn_plus" onclick="labelAdd(\'select\')"></button> <button type="button" class="pointer btn_plus" onclick="labelSubAdd('+label_item_seq+')"></button>';
				...
				if (subcount > 1)
				{
					...
					{	
						...
						labelTableHtml += '→ <input type="text" name="windowSubLabelValue['+label_item_seq+'][]" value="'+ labelsubValue[0][j] +'" size="27" style="height:18px; margin-left:3px;" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
				...
				if (count > 1)
				{
					for (i=1; i<count; i++)
					{
						...
						if (subcount > 1)
						{
							...
							{	
								labelTableHtml += '<tr class="labelAdd"><td></td><td>';
								labelTableHtml += '→ <input type="text" name="windowSubLabelValue['+label_item_seq+'][]" value="'+ labelsubValue[i][j] +'" size="27" style="height:18px; margin-left:3px" class="line"> <button type="button" class="pointer btn_minus" onclick="deleteRow(this)"></button>';
								labelTableHtml += '</td></tr>';
							}
						}						
				...
				html = '<input type="text" name="windowLabelValue['+label_item_seq+']" class="windowLabelValue line" label_item_seq="'+label_item_seq+'"  size="30" style="height:18px;"> <button type="button"  class="pointer btn_plus" onclick="labelAdd(\'select\')"></button> <button type="button" class="pointer btn_plus gray" onclick="labelSubAdd('+label_item_seq+')"></button>';
				label_item_seq++;
			}
			$("#labelTable").append(labelTableHtml);
		break;
