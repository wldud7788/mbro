$(document).ready(function() {
	...
	$("div.coupon_status_btn").bind("click",function(){
		...
		openDialog("티켓 상품의 상태 안내", "coupon_status_dialog", {width:270,height:600});
	});
	...
	$(".order_reverse").bind("click",function(){
		...
		if(order_npay && order_pg == "npay"){
			...
			openDialogAlert("교환 주문 건은 관리자가 결제 취소를 할 수 없습니다.<br />교환 주문 건 취소는 관리자가 교환 주문 건에 대해 출고 및 반품 처리 후 환불 처리해 주시기 바랍니다.",400,175);
			return;
		}else{
			var sale_stat	= true;
			var width		= 400;
