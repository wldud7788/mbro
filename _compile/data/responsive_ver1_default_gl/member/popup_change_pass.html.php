<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/member/popup_change_pass.html 000005100 */ ?>
<style>
...
.keyboard_guide_img .keyboard_hangul {margin:20px auto 0 auto; width:290px; height:80px; background:url('/data/skin/responsive_ver1_default_gl/images/common/keyboard.gif') no-repeat; background-size:100% auto}
.keyboard_guide_img .keyboard_specialchars {margin:20px auto 0 auto; width:290px; height:60px; background:url('/data/skin/responsive_ver1_default_gl/images/common/keyboard.gif') no-repeat 0 -85px; background-size:100% auto; display:none;}
