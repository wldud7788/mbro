<?php /* Template_ 2.2.6 2022/02/04 15:53:40 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/layout_header/standard.html 000027081 */  $this->include_("showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");
...
<?php }?>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/' target='_self'><img src="/data/skin/responsive_ver1_default_gl/images/design/resp_logo_sample.png" title="(주)음악형제들" alt="(주)음악형제들"></a>
			</h1>
