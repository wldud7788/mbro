<?php /* Template_ 2.2.6 2021/12/15 17:48:36 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/delivery_address.html 000033226 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL2RlbGl2ZXJ5X2FkZHJlc3MuaHRtbA==" >주소록</span></h2>
		</div>
					...
					<div class="tab_basic size1">
						<ul>
							<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?> class="on"<?php }?>>
								<a href="javascript:;" onclick="submitAddressBookFrm('tab','1')"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL2RlbGl2ZXJ5X2FkZHJlc3MuaHRtbA==" >자주쓰는 배송지</span></a>
							</li>
							<li <?php if($_GET["tab"]=='2'){?> class="on"<?php }?>>
								<a href="javascript:;" onclick="submitAddressBookFrm('tab','2')"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL2RlbGl2ZXJ5X2FkZHJlc3MuaHRtbA==" >최근 배송지</span></a>
							</li>
						</ul>
					</div>
...
<?php if($TPL_V1["default"]=='Y'){?><img src="/data/skin/responsive_ver1_default_gl/images/common/icon_default.gif" title="기본" /><?php }?>
...
<?php if($_GET["popup"]){?>
	...
	.address_reg .pop_close {padding-right:13px; background:url('/data/skin/responsive_ver1_default_gl/images/common/btn_close.gif') no-repeat right;}
