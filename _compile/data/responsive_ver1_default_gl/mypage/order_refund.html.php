<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/order_refund.html 000014686 */ 
...
<div class="subpage_wrap" data-ezmark="undo">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3JlZnVuZC5odG1s" >결제취소 / 환불신청</span></h2>
		</div>
...
<?php }?>
					...
					<li class="subject">
						<ul class="board_goods_list">
							<li class="pic">
								<img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_list.gif'" alt="<?php echo $TPL_V1["goods_name"]?>" />
							</li>
							<li class="info">
								<div class="title">
