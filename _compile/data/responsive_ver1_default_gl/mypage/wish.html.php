<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/wish.html 000006711 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL3dpc2guaHRtbA==" >위시리스트</span></h2>
		</div>
...
<?php if($TPL_record_1){foreach($TPL_VAR["record"] as $TPL_V1){?>
					<li>
						<div class="img_area"><a href="../goods/view?no=<?php echo $TPL_V1["goods_seq"]?>"><?php echo $TPL_V1["image_html"]?></a></div>
						<ul class="sub">
							<li class="wish_name">
