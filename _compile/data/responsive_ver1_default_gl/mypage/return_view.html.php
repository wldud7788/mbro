<?php /* Template_ 2.2.6 2022/01/28 16:55:03 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/return_view.html 000015720 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL3JldHVybl92aWV3Lmh0bWw=" >반품/교환 상세</span></h2>
		</div>
...
<?php if($TPL_V1["goods_type"]=='gift'){?><img src="/data/skin/responsive_ver1_default_gl/images/common/icon_gift.gif" alt="사은품" vspace=3 /><?php }?>
...
<?php }else{?>
								<?php echo implode("-",$TPL_VAR["data_return"]["sender_zipcode"])?><?php if($TPL_VAR["data_return"]["sender_address"]){?><input type="button" name="change_address_btn" class="btn_move small" style="margin-left: 10px;" onclick="address_change_view();" value="<?php if($TPL_VAR["address_type"]=="street"){?>지번 주소보기<?php }else{?>도로명 주소보기<?php }?>"><?php }?>
