<?php /* Template_ 2.2.6 2022/01/27 14:10:57 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/myqna_write.html 000013208 */  $this->include_("sslAction");
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL215cW5hX3dyaXRlLmh0bWw=" >나의 1:1 문의</span></h2>
		</div>
			...
			<script type="text/javascript">
				$(function(){
					$('#addcategory').change(function(){
					  	if($(this).val() == '뮤직브로 아이디 찾기'){ 
					   		$("#contents").text("아래의 양식에 맞게 글을 작성해 주세요. \n\n 닉네임:  ex)꿀바른가래떡 \n 휴대폰번호:  010-1234-1234 \n\n 작성해주시면 관리자가 확인하여 답변해 드리겠습니다. \n 감사합니다.");
					  	}
					  	else{
					  		$("#contents").text("");
					  	}
