<?php /* Template_ 2.2.6 2022/02/15 15:09:01 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/order_return.html 000024646 */ 
...
<div class="subpage_wrap" data-ezmark="undo">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><?php if($TPL_VAR["mode"]=='exchange'){?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3JldHVybi5odG1s" >교환</span><?php }else{?><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3JldHVybi5odG1s" >반품</span><?php }?> <span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3JldHVybi5odG1s" >신청</span></h2>
		</div>
...
<?php if($TPL_V2["opt_type"]=='opt'){?>
									<ul class="board_goods_list">
										<li class="pic">
											<img src="<?php echo $TPL_V2["image"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_list.gif'" alt="<?php echo $TPL_V2["goods_name"]?>" /></span>
										</li>
										<li class="info">
											<div class="title">
