<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/order_view.html 000129564 */ 
...
<?php }?>
				<li class="subject">
					<ul class="board_goods_list">
						<li class="pic">
<?php if($TPL_V2["goods_type"]=='gift'){?>
							<img src="<?php echo $TPL_V2["image"]?>" alt="" />
<?php }else{?>
							<a href='/goods/view?no=<?php echo $TPL_V2["goods_seq"]?>' target='_blank' title="새창"><img src="<?php echo $TPL_V2["image"]?>" alt="<?php echo $TPL_V1["goods_name"]?>" /></a>
<?php }?>
						</li>
						<li class="info">
							<div class="title">
...
<?php }else{?>
								<a href='/goods/view?no=<?php echo $TPL_V2["goods_seq"]?>' target='_blank' title="새창"><?php echo $TPL_V2["goods_name"]?></a>
<?php }?>
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_ver1_default_gl/images/common/auth_img.png" height="17" alt="성인" />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_ver1_default_gl/images/common/plane.png" height="14" alt="해외배송상품" />
<?php }?>
							</div>
...
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?><?php if($TPL_V4["type"]=='file'){?><a href="../mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" class="gray_05" title="다운로드"><?php echo $TPL_V4["value"]?></a><?php }else{?><?php echo $TPL_V4["value"]?><?php }?>
								</span>
<?php }?>
<?php }}?>
							</div>
...
<?php if($TPL_V3["opt_type"]=='opt'){?>
								<ul class="board_goods_list">
									<li class="pic">
										<img src="<?php echo $TPL_V3["image"]?>" alt="" />
									</li>
									<li class="info">
										<div class="title">
...
<?php if($TPL_data_return_1){foreach($TPL_VAR["data_return"] as $TPL_V1){?>
			<ul class="tbody">
				...
				<li class="subject half x1"><a href="../mypage/return_view?return_code=<?php echo $TPL_V1["return_code"]?>" target="_blank"><?php echo $TPL_V1["regist_date"]?></a></li>
				<li><span class="mtitle">수량:</span> <?php echo $TPL_V1["ea"]?></li>
				<li><span class="mtitle">금액:</span> <?php echo get_currency_price($TPL_V1["opt_price"]+$TPL_V1["sub_price"], 2)?></li>
				<li class="mo_end"><a href="../mypage/return_view?return_code=<?php echo $TPL_V1["return_code"]?>" target="_blank"><?php echo $TPL_V1["mstatus"]?></a>&nbsp;</li>
			</ul>
<?php }}?>
<?php if($TPL_data_refund_1){foreach($TPL_VAR["data_refund"] as $TPL_V1){?>
			<ul class="tbody">
				...
				<li class="subject half x1"><a href="../mypage/refund_view?refund_code=<?php echo $TPL_V1["refund_code"]?>" target="_blank"><?php echo $TPL_V1["regist_date"]?></a></li>
				<li><span class="mtitle">수량:</span> <?php echo $TPL_V1["ea"]?></li>
				<li><span class="mtitle">금액:</span> <?php echo get_currency_price($TPL_V1["refund_price"], 2)?></li>
				<li class="mo_end"><a href="../mypage/refund_view?refund_code=<?php echo $TPL_V1["refund_code"]?>" target="_blank"><?php echo $TPL_V1["mstatus"]?></a>&nbsp;</li>
			</ul>
<?php }}?>
		</div>
<?php }?>
...
<?php if($TPL_VAR["orders"]["typereceipt"]== 2){?> 현금영수증
						<img src="/data/skin/responsive_ver1_default_gl/images/design/btn_print_receipt.gif" id="pgcashbtn<?php echo $TPL_VAR["creceipt"]["tstep"]?>" class="hand" sales_seq="<?php echo $TPL_VAR["creceipt"]["seq"]?>"  order_seq ="<?php echo $TPL_VAR["orders"]["order_seq"]?>" cash_no="<?php echo $TPL_VAR["creceipt"]["cash_receipts_no"]?>" settleprice="<?php echo $TPL_VAR["orders"]["settleprice"]?>" />
...
<div id="coupon_use_guide" class="hide">
	<table class="coupon_use_guide_tb" cellpadding="0" cellspacing="0" border="0">
		...
		<tr><td class="guide_img"><img src="/data/skin/responsive_ver1_default_gl/images/design/guide_img_cpn.jpg" /></td></tr>
