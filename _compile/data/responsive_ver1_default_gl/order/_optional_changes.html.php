<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/order/_optional_changes.html 000003310 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 옵션/수량 변경 @@
...
<ul class="resp_content2">
	<li><a href="/goods/view?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>" target="_blank" title="새창"><img src="<?php echo $TPL_VAR["goods"]["image"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="" style="max-width:80px; border:1px #eee solid;" /></a></li>
