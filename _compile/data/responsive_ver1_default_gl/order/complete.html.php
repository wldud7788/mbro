<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/order/complete.html 000033725 */ 
...
<div class="subpage_wrap">
	<div class="subpage_container v3 Pb10">
		...
		<div class="title_container">
			<a class="btn_history back" href="javascript:history.back();"><img src="/data/skin/responsive_ver1_default_gl/images/design/arw_prev.gif" alt="히스토리 뒤로" /></a>
<?php if($TPL_VAR["orders"]["step"]== 99||$TPL_VAR["orders"]["step"]== 0){?>
			<h2 class="pointcolor imp"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >결제실패</span></h2>
<?php }else{?>
			<h2><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >주문완료</span></h2>
<?php }?>
			<a class="btn_history forward" href="javascript:history.forward();"><img src="/data/skin/responsive_ver1_default_gl/images/design/arw_next.gif" alt="히스토리 앞으로" /></a>
		</div>
...
<div class="subpage_wrap order_payment" data-ezmark="undo">
	<div class="subpage_container v2 Pt0 Pb40 order_payment_left2">
		<h2 class="title_od1 Pt15"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >주문상품</span></h2>
...
<?php }?>
		...
		<div class="order_subsection v2">
			<h3 class="title3"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >주문자</span></h3>
			<ul class="list_01 v2">
				<li>
...
<?php }?>
			...
			<h3 class="title3"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >배송지</span></h3>
			<ul class="list_01 v2">
				<li>
...
<?php if($TPL_VAR["orders"]["clearance_unique_personal_code"]){?>
			<h3 class="title3"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >해외구매대행상품</span></h3>
...
<?php }?>
	...
	<div class="subpage_container v2 Pt0 Pb40 order_payment_right2">
		<div class="order_subsection v2 ">
			<h3 class="title3 Pt15"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >결제 금액</span></h3>
			<div class="order_price_total">
				<ul>
					<li class="th"><strong><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >상품금액</span></strong></li>
					<li class="td"><?php echo get_currency_price($TPL_VAR["orders"]["tot_price"], 2)?></li>
				</ul>
				<ul>
					<li class="th">
						<span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >배송비</span>&nbsp;
...
<?php if($TPL_VAR["orders"]["total_sale_price"]> 0){?>
				<ul>
					<li class="th">
						<span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >할인금액</span>&nbsp;
...
<?php }?>
				<ul class="total">
					<li class="th"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >총 결제금액</span></li>
					<li class="td">
...
<?php }?>
			...
			<h3 class="title3"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >주문결제정보</span>&nbsp; <?php if($TPL_VAR["btn_tradeinfo"]){?><span class="btn_resp gray_06"><?php echo $TPL_VAR["btn_tradeinfo"]?></span><?php }?></h3>
...
<div class="Pb60 C">
	<a href="/mypage/order_view?no=<?php echo $TPL_VAR["orders"]["order_seq"]?>" class="btn_resp size_c color2"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >MY페이지 주문내역</span></a>
	<a href="/" class="btn_resp size_c color5"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvY29tcGxldGUuaHRtbA==" >쇼핑 계속하기</span></a>
</div>
