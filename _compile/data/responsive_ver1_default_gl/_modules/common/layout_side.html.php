<?php /* Template_ 2.2.6 2022/02/07 17:14:55 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/_modules/common/layout_side.html 000026587 */  $this->include_("dataWishCount");
...
<img src="/data/skin/responsive_ver1_default_gl/images/design/resp_logo_sample.png" title="(주)음악형제들" alt="(주)음악형제들" style="width: 141px; height: auto; display: block; margin: 0 auto; padding-top: 10px;">
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?><a href="/mypage/wish"><?php }else{?><a href="/member/login?return_url=/mypage/wish"><?php }?><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >위시리스트</span> <?php if(dataWishCount()){?><span class="push_count"><?php echo number_format(dataWishCount())?></span><?php }?></a>
		...
		<li class="am_emony"><a href="/mypage/emoney" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >캐시</a></li>
		<li class="bmp_icon"><a href="https://musicbroshop.com/coin" designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >BMP코인<br> 전환하기</a></li>
		<li class="mubro_intro"><a href="https://mubrothers.com/" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw="  target="_blank">소개페이지<br> 바로가기</a></li>
		<li class="mubro_music"><a href="https://music-brother.com/main/detail" designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw="  target="_blank">뮤직브로<br> 바로가기</a></li>
		<li class="mubro_audition"><a href="https://audition.music-brother.com/" designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw="  target="_blank">오디션<br> 바로가기</a></li>
		<li class="shop_event"><a href="https://musicbroshop.com/promotion/event" designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >EVENT</a></li>
	</ul>
</div>

<div class="aside_navigation_wrap">
	<ul class="tab">
		<li data-menuname="categorySideMenu" class="current"><span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >카테고리</span></li>
		<li data-menuname="brandSideMenu"><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >브랜드</span></li>
		<li data-menuname="locationSideMenu"><span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >지역</span></li>
		<li data-menuname="boardSideMenu"><span designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >커뮤니티</span></li>
	</ul>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
			<li class="mitem mitemicon1 favorite">
				<a class="mitem_title v3" designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >FAVORITE CATEGORY</a>
			</li>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
		<li class="mitem mitemicon1 favorite">
			<a class="mitem_title v3" designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >FAVORITE BRAND</a>
		</li>
		<li class="mitem_subcontents">
			<ul class="submenu">
...
<?php if($TPL_VAR["best_brand"]){?>
		<li class="mitem mitemicon1 favorite">
			<a class="mitem_title v2" designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >BEST BRAND</a>
		</li>
		<li class="mitem_subcontents">
...
<?php }?>
		...
		<li class="aside_brand_sorting">
			<ul class="brandsort">
				<li class="current"><span designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >전체</span></li>
				<li><span designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >가나다</span></li>
				<li><span designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >ABC</span></li>
				<li><span designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >기타</span></li>
			</ul>
...
<?php if($TPL_brand_1){foreach($TPL_VAR["brand"] as $TPL_V1){?>
		<li class="mitem category mitem_brand <?php if($TPL_V1["childs"]){?>mitemicon1<?php }else{?>mitemicon3<?php }?>" title_eng="<?php echo $TPL_V1["title_eng"]?>" title="<?php echo $TPL_V1["ori_title"]?>">
			<a class="mitem_title">
				<!-- //브랜드 로고 보이게 하는 부분 -->
				<img src="<?php echo $TPL_V1["brand_image"]?>" alt="" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif';" style="width: 80%;">
				<!-- 브랜드 로고 보이게 하는 부분// -->
			</a>
...
<?php }}?>
	...
	<ul id="boardSideMenu" class="menu board" style="display:none;">
		<li><a href="/board/?id=notice" designElement="text" textIndex="29"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >공지사항</a></li>
		<li><a href="/board/?id=faq" designElement="text" textIndex="30"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >자주묻는질문</a></li>
		<li><a href="/board/?id=goods_qna" designElement="text" textIndex="31"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >상품문의</a></li>
		<li><a href="/board/?id=goods_review" designElement="text" textIndex="32"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >상품후기</a></li>
<?php if($TPL_VAR["isplusfreenot"]){?><li><a href="/board/?id=bulkorder" designElement="text" textIndex="33"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >대량구매</a></li><?php }?>
	</ul>
	<!-- ++++++++ //커뮤니티 ++++++++ -->
...
<div class="wrap_aside">
	<h3 class="title_sub3 v2"><span designElement="text" textIndex="34"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >최근 본 상품</span> <?php if($TPL_VAR["push_count_today"]){?><a href="/goods/recently" class="push_count">(<?php echo $TPL_VAR["push_count_today"]?>)</a><?php }?></h3>
</div>
...
<!-- CS CENTER 정보(SIDE) -->
<div class="wrap_aside">
	<h3 class="title_sub3 v2"><a href="/service/cs" designElement="text" textIndex="35"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >CS CENTER</a></h3>
	...
	<p class="aside_cs_addinfo" designElement="text" textIndex="36"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvX21vZHVsZXMvY29tbW9uL2xheW91dF9zaWRlLmh0bWw=" >MON ~ FRI<br />AM 09:00 ~ PM 06:00<br />LUNCH AM 12:00 ~ PM 01:00<br />SAT, SUN, HOLIDAY OFF<br /></p>
</div>
