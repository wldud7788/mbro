<?php /* Template_ 2.2.6 2022/03/07 14:25:42 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/main/index.html 000014810 */  $this->include_("showDesignLightPopup","showDesignBanner","showDesignDisplay");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ index @@
...
<div class="pc_bmp_banner">
    <img src="/data/skin/responsive_ver1_default_gl/images/main_bmp_banner.jpg" alt="" title="">
...
<div class="mobile_bmp_banner">
    <img src="/data/skin/responsive_ver1_default_gl/images/mobile_main_bmp_banner2.jpg" alt="" title="">
...
<!--       <a href="#" target='_self'><img src="/data/skin/responsive_ver1_default_gl/images/design/resp_bnr_main_101.jpg" title="" alt="" /></a> -->
      <ul class="main_bnr_c1_2">
        <li class="left_area"><a href="#" target='_self'><img src="/data/skin/responsive_ver1_default_gl/images/design/bg_subimg02.jpg" title="" alt="" /></a></li>
        ...
        <li class="right_area"><a href="#ew?no=1541" target='_self'><img src="/data/skin/responsive_ver1_default_gl/images/design/bg_subimg01.jpg" title="" alt="" /></a></li>
      </ul>
    </li>
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_main"]=='Y'){?>
  ...
  <div class="btn_talk_area">
    <button type="button" class="btn_talk v2" onclick="location.href='https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?>#nafullscreen';"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWFpbi9pbmRleC5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_ver1_default_gl/images/icon/icon_talk.png" class="talk_img" alt="네이버톡톡" />&nbsp; <span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWFpbi9pbmRleC5odG1s" >톡톡하세요</span></button>
  </div>
<?php }?>
