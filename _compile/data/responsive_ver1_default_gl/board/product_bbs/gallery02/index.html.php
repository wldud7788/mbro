<?php /* Template_ 2.2.6 2021/12/30 17:04:08 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/board/product_bbs/gallery02/index.html 000013353 */  $this->include_("sslAction");
...
<?php if($TPL_V1["file_key_w"]&&$TPL_V1["uccdomain_thumbnail"]){?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["uccdomain_thumbnail"]?>" /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'http')){?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="http<?php echo str_replace('http','',$TPL_V1["filelist"]['realfile'])?>" /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'/data/editor/')){?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" /></span>
<?php }else{?>
