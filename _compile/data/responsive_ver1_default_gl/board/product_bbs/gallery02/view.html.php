<?php /* Template_ 2.2.6 2021/12/30 17:04:08 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/board/product_bbs/gallery02/view.html 000004575 */  $this->include_("sslAction");
...
<?php if($TPL_filelistimages_1){foreach($TPL_VAR["filelistimages"] as $TPL_V1){?>
		<li>
			<img class="gallery_detail_img" src="<?php echo $TPL_V1["realfileurl"]?>" >
		</li>
<?php }}?>
	</ul>
<?php }?>
