<?php /* Template_ 2.2.6 2022/02/25 17:09:45 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/board/video/gallery01/index.html 000013125 */  $this->include_("sslAction");
	...
	<li class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>"  viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>" style="cursor: pointer;">
		<ul class="custom_board_img_area">
			<li>
				<!-- 20220216 여기-->
				<span>
					<img id="video_img" class="image_thumb yutube_img" style="width: 500px; height: 300px; position: absolute;" src="https://img.youtube.com/vi/<?php echo $TPL_V1["video_url"]?>/maxresdefault.jpg"/>
