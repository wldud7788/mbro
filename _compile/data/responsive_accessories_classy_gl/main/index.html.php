<?php /* Template_ 2.2.6 2021/12/15 17:08:34 /www/music_brother_firstmall_kr/data/skin/responsive_accessories_classy_gl/main/index.html 000005424 */  $this->include_("showDesignLightPopup","showDesignBanner","showDesignDisplay");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ index @@
...
<div class="resp_wrap">
	<ul class="full_bnr3 clearbox">
		<li class="l_cont">
			...
			<p class="sbtn"><a href="#none" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbWFpbi9pbmRleC5odG1s" >ABOUT US</a></p>
		</li>
		<li class="r_cont"><a href="#none" class="btn_mov"><img src="/data/skin/responsive_accessories_classy_gl/images/design_resp/bnr_02.jpg" alt=""></a></li>
	</ul>
</div>
<!-- //full_bnr -->
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_main"]=='Y'){?>
	<div class="btn_talk_area">
		<button type="button" class="btn_talk v2" onclick="location.href='https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?>#nafullscreen';">쇼핑할땐 &nbsp;<img src="/data/skin/responsive_accessories_classy_gl/images/icon/icon_talk.png" class="talk_img" alt="네이버톡톡" /> 톡톡하세요</button>
	</div>
<?php }?>
</div>
<!-- //네이버 톡톡 -->