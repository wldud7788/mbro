<?php /* Template_ 2.2.6 2022/09/06 16:41:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/goods/view_common_contents.html 000003702 */  $this->include_("defaultScriptFunc");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 상품 상세 설명 - 공용정보 원본 보기 @@
...
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/common.css" />
...
#goods_view_contents_title h2 { font-size:14px; font-weight:500; line-height:40px; padding-left:36px; color:#fff; background:url(/data/skin/responsive_sports_sporti_gl_2/images/design/hand_zoom.png) 0 50% no-repeat; background-size:24px; }
#goods_view_contents_title .close { position: absolute; right: 0px; top: 0px; background: url(/data/skin/responsive_sports_sporti_gl_2/images/design/btn_close.png) no-repeat center center; background-size: 39px 39px; width: 39px; height: 39px; box-sizing: border-box; overflow:hidden; text-indent:-999px; }
...
<div id="goods_view_contents_top">
	<a href="#"><img src="/data/skin/responsive_sports_sporti_gl_2/images/design/btn_floating_top.png" /></a>
</div>
