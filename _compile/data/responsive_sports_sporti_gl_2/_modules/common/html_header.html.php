<?php /* Template_ 2.2.6 2022/09/06 16:41:42 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/_modules/common/html_header.html 000034668 */  $this->include_("metaHeaderWrite","naverWcsScript","defaultScriptFunc");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #HTML_HEADER @@
...
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/jqueryui/black-tie/jquery-ui-1.8.16.custom.css" />
<link rel="stylesheet" type="text/css" href="/app/javascript/plugin/slick/slick.css"><!-- 반응형 슬라이드 -->
<link rel="stylesheet" type="text/css" href="/data/design/goods_info_style.css"><!-- 상품디스플레이 CSS -->
<link rel="stylesheet" type="text/css" href="/data/design/goods_info_user.css"><!-- ++++++++++++ 상품디스플레이 사용자/제작자 CSS ++++++++++++ -->
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/lib.css" />
<link rel="stylesheet" type="text/css" href="/data/skin/<?php echo $TPL_VAR["skin"]?>/css/common.css?v=<?php echo date('Ymd')?>" />
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/board.css" />
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/buttons.css" />
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/mobile_pagination.css" />
<link rel="stylesheet" type="text/css" href="/link/css?k=quickdesign&v=<?php echo date('YmdHis')?>" /><!-- Quick Design CSS -->
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/broadcast.css" /> 
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl_2/css/user.css" /><!-- ++++++++++++ 스킨 사용자/제작자 CSS ++++++++++++ -->
...
<?php echo requirejs(array(array('/app/javascript/js/dev-tools.js', 30),array('/app/javascript/js/design.js', 31),array('/app/javascript/js/common.js', 32),array('/app/javascript/js/common-mobile.js', 33),array('/app/javascript/js/front-layout.js', 34),array('/app/javascript/js/base64.js', 35),array('/app/javascript/js/skin-responsive.js', 36),array(implode('',array('/data/js/language/L10n_',$TPL_VAR["config_system"]["language"],'.js')), 37),array('/data/skin/responsive_sports_sporti_gl_2/common/script.js', 40),array('/data/skin/responsive_sports_sporti_gl_2/common/jquery.touchSlider.js', 40),array('/data/skin/responsive_sports_sporti_gl_2/common/jquery.event.drag-1.5.min.js', 40),array('/data/skin/responsive_sports_sporti_gl_2/common/responsive.js', 40),array('/data/skin/responsive_sports_sporti_gl_2/common/search_ver2.js', 40),array('/data/skin/responsive_sports_sporti_gl_2/common/user.js', 40)))?>
