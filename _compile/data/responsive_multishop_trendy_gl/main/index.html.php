<?php /* Template_ 2.2.6 2021/12/15 16:44:42 /www/music_brother_firstmall_kr/data/skin/responsive_multishop_trendy_gl/main/index.html 000009073 */  $this->include_("showDesignLightPopup","showDesignBanner","getBoarddata","showDesignDisplay");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ index @@
...
<div class="resp_wrap">
	...
	<div class="title_group1">
		<h3 class="title1"><a href="/board/?id=custom_bbs2" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL21haW4vaW5kZXguaHRtbA==" >STORY</a></h3>
	</div>
...
<ul class="main_bnr_type2">
	<li style="background-color:#62ace5;">
		<a href="#"><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/bnr_main_c01.gif" alt="" /></a>
	</li>
	<li style="background-color:#e0e0e0;">
		<a href="#"><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/bnr_main_c02.gif" alt="" /></a>
	</li>
</ul>
...
<div class="resp_wrap">
	...
	<div class="style7_custom1 show_display show_display_col5">
		<?php echo showDesignDisplay( 10111)?>
...
<div class="resp_wrap">
	...
	<div class="style4_custom1 show_display show_display_col3" data-effect="scale">
		<?php echo showDesignDisplay( 10112)?>
...
<div class="resp_wrap">
	...
	<div class="style7_custom1 display_tab_custom show_display show_display_col4" data-effect="rotate_01">
		<?php echo showDesignDisplay( 10113)?>
...
<div class="main_space">
	<div class="resp_wrap">
		...
		<div class="respBnrGon respBnrGon_num5_typeX1">
			<ul>
				<li><a href="#"><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/bnr_306_01.jpg" alt="" /></a></li>
				<li><a href="#"><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/bnr_306_02.jpg" alt="" /></a></li>
				<li>
				...
				<li><a href="#"><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/bnr_306_03.jpg" alt="" /></a></li>
				<li><a href="#"><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/bnr_306_04.jpg" alt="" /></a></li>
			</ul>
		</div>
	</div>
</div>
