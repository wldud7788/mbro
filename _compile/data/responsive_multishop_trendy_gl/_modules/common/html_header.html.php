<?php /* Template_ 2.2.6 2021/12/15 16:44:42 /www/music_brother_firstmall_kr/data/skin/responsive_multishop_trendy_gl/_modules/common/html_header.html 000035175 */  $this->include_("metaHeaderWrite","naverWcsScript","defaultScriptFunc");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #HTML_HEADER @@
...
<?php echo requirejs(array(array('/app/javascript/js/dev-tools.js', 30),array('/app/javascript/js/design.js', 31),array('/app/javascript/js/common.js', 32),array('/app/javascript/js/common-mobile.js', 33),array('/app/javascript/js/front-layout.js', 34),array('/app/javascript/js/base64.js', 35),array('/app/javascript/js/skin-responsive.js', 36),array(implode('',array('/data/js/language/L10n_',$TPL_VAR["config_system"]["language"],'.js')), 37),array('/data/skin/responsive_multishop_trendy_gl/common/script.js', 40),array('/data/skin/responsive_multishop_trendy_gl/common/jquery.touchSlider.js', 40),array('/data/skin/responsive_multishop_trendy_gl/common/jquery.event.drag-1.5.min.js', 40),array('/data/skin/responsive_multishop_trendy_gl/common/responsive.js', 40),array('/data/skin/responsive_multishop_trendy_gl/common/search_ver2.js', 40),array('/data/skin/responsive_multishop_trendy_gl/common/user.js', 40)))?>
