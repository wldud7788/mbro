<?php /* Template_ 2.2.6 2021/12/15 16:44:42 /www/music_brother_firstmall_kr/data/skin/responsive_multishop_trendy_gl/layout_header/standard.html 000022525 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #LAYOUT_HEADER @@
...
<div id="layout_header" class="layout_header">
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/main/index' target='_self'><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>"></a>
			</h1>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
				<li class="user_info">
					<a href="/mypage"><?php if($TPL_VAR["userInfo"]["user_name"]){?><span class="u_name"><?php echo $TPL_VAR["userInfo"]["user_name"]?></span><?php }else{?><span class="u_id"><?php echo $TPL_VAR["userInfo"]["userid"]?></span><?php }?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >님.<br />진심 환영합니다!</span></a>
				</li>
...
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li class="user_logout"><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >LOGOUT</a></li>
<?php }else{?>
...
<?php }?>
				<li class="respCartArea"><a href="/order/cart"><?php echo $TPL_VAR["push_count_cart"]?></a></li>
			</ul>
