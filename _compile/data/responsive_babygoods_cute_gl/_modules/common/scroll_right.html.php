<?php /* Template_ 2.2.6 2021/12/15 17:12:32 /www/music_brother_firstmall_kr/data/skin/responsive_babygoods_cute_gl/_modules/common/scroll_right.html 000009241 */  $this->include_("dataGoodsToday");
...
<?php if($TPL_VAR["isplusfreenot"]){?><li><a href="/board/?id=bulkorder" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9iYWJ5Z29vZHNfY3V0ZV9nbC9fbW9kdWxlcy9jb21tb24vc2Nyb2xsX3JpZ2h0Lmh0bWw=" >BULKORDER</a></li><?php }?>
		</ul>
        <!-- //게시판-->
        ...
        <div id="rightQuickMenu" class="rightQuickMenu hide">
			<div class="right_item_recent">
				<div class="right_itemList">
					<h3><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9iYWJ5Z29vZHNfY3V0ZV9nbC9fbW9kdWxlcy9jb21tb24vc2Nyb2xsX3JpZ2h0Lmh0bWw=" >TODAY VIEW</span> <span id="right_recent_total"><?php echo number_format(count(dataGoodsToday()))?></span></h3>
					<ul></ul>
...
<?php if($TPL_bank_loop_1){foreach($TPL_VAR["bank_loop"] as $TPL_V1){?>
			<li>
				...
				<span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9iYWJ5Z29vZHNfY3V0ZV9nbC9fbW9kdWxlcy9jb21tb24vc2Nyb2xsX3JpZ2h0Lmh0bWw=" >HOLDER</span>  : <?php echo $TPL_V1["bankUser"]?><br />
			</li>
<?php }}?>
		</ul>
		<!-- //무통장 입금계좌 -->
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_web_quick"]=='Y'){?>
		<a href="javascript:;" class="btn_navertalk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?>', 'talktalk', 'width=471, height=640');return false;"><img src="/data/skin/responsive_babygoods_cute_gl/images/icon/icon_talk.png" alt="네이버 톡톡" />&nbsp; 톡톡</a>
		<!-- //네이버 톡톡 연동 -->
<?php }?>
	</div>
</div>
