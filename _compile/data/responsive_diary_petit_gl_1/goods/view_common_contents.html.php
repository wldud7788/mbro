<?php /* Template_ 2.2.6 2021/01/08 12:01:42 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/goods/view_common_contents.html 000003690 */  $this->include_("defaultScriptFunc");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 상품 상세 설명 - 공용정보 원본 보기 @@
...
#goods_view_contents_title h2 { font-size:14px; font-weight:500; line-height:40px; padding-left:36px; color:#fff; background:url(/data/skin/responsive_diary_petit_gl_1/images/design/hand_zoom.png) 0 50% no-repeat; background-size:24px; }
#goods_view_contents_title .close { position: absolute; right: 0px; top: 0px; background: url(/data/skin/responsive_diary_petit_gl_1/images/design/btn_close.png) no-repeat center center; background-size: 39px 39px; width: 39px; height: 39px; box-sizing: border-box; overflow:hidden; text-indent:-999px; }
...
<div id="goods_view_contents_top">
	<a href="#"><img src="/data/skin/responsive_diary_petit_gl_1/images/design/btn_floating_top.png" /></a>
</div>
