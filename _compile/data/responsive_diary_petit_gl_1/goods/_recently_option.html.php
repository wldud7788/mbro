<?php /* Template_ 2.2.6 2020/12/23 15:33:30 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/goods/_recently_option.html 000002713 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
...
<div class="cart_dialog_img">
	<a href="/goods/view?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>" target="_blank">
		<img src="<?php echo $TPL_VAR["goods"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl_1/images/common/noimage.gif'" alt="" /></a>
...
<?php }?>
	...
	<li class="btn_area">
		<button type="button" id="addCart" class="btn_resp color2"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2dvb2RzL19yZWNlbnRseV9vcHRpb24uaHRtbA==" >장바구니담기</span></button>
	</li>
</ul>
</form>
