<?php /* Template_ 2.2.6 2020/12/23 15:33:54 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/_modules/display/goods_display_person.html 000001507 */ 
...
<div class="personal_item" onclick="document.location.href='/order/settle?person_seq=<?php echo $TPL_V1["person_seq"]?>&member_seq=<?php echo $TPL_V1["member_seq"]?>'">
	<div class="pi_icon"><img src="/data/skin/responsive_diary_petit_gl_1/images/common/prv_pay.png" width="39" height="39" /></div>
	<div class="pi_arrow"><img src="/data/skin/responsive_diary_petit_gl_1/images/common/arrow.png" width="12" height="21" /></div>
