<?php /* Template_ 2.2.6 2021/01/08 12:02:07 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/layout_header/standard.html 000028974 */  $this->include_("showDesignLightPopup","showCategoryLightNavigation","showSearchRecent","dataGoodsTodayLight","showTopPromotion");
...
<!--   <div class="wrap_aside">
  ...
  <div class="app_down_box">
    <div class="margin_bottom_0">
      <a href="https://play.google.com/store/apps/details?id=com.musicbrother.app" target="blank">
        <img src="/data/skin/responsive_diary_petit_gl_1/images/bmp_icon2.png" alt="" >
        <p>BMP코인 환전</p>
      </a>
    </div>
...
<?php }}?>
        ...
        <li>
          <a designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/goods/best"><em>Best</em></a>
        </li>
        <li>
          <a designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/goods/new_arrivals"><em>New</em></a>
        </li>
        <li style="display:none;">
          <a designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/goods/brand_main"><em>Brands</em></a>
        </li>
        <li>
          <a designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/promotion/event"><em>Event</em></a>
        </li>
        <li style="display:none;">
          <a designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/board/?id=custom_bbs2"><em>Story</em></a>
        </li>
      </ul>

      <ul class="util_wrap_menu2">
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
        <li><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Logout</a><?php }else{?><a href="/login_process/logout" target="actionFrame" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Logout</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
        <li><a href="/login_process/logout" target="actionFrame" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Logout</a></li>
<?php }else{?>
        <li><a href="/member/login" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Login</a></li>
        <li>
          <a href="/member/agreement" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Join</a>
...
<?php }?>
        <li><a href="/mypage" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >MyPage</a></li>
        <li><a href="/mypage/order_catalog" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Order</a></li>
        <li class="respCartArea">
          <a href="/order/cart"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >Cart</span><span>(<?php echo $TPL_VAR["push_count_cart"]?>)</span></a>
        </li>
        <li><a href="/service/cs" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >CS Center</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="logo_wrap">
    <div class="resp_wrap">
      <!-- logo -->
      <h1 class="logo_area">
        <a href="/main/index" target="_self"><img src="/data/skin/responsive_diary_petit_gl_1/images/design_resp/top_logo.jpg" title="" alt="" /></a>
      </h1>
