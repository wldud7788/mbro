<?php /* Template_ 2.2.6 2020/12/23 15:33:56 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/mypage/emoney.html 000003057 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9lbW9uZXkuaHRtbA==" >캐시 내역</span></h2>
		</div>

<?php if($TPL_VAR["loop"]){?>
		<div class="mypage_greeting btm_padding">
			<span class="username"><?php echo $TPL_VAR["user_name"]?>(<span class="usergroup"><?php echo $TPL_VAR["userid"]?></span>)</span>님이 보유한 캐시는 <span class="pointnum"><?php echo number_format($TPL_VAR["emoney"])?></span>M 입니다.
		</div>
		<div class="res_table">
			<ul class="thead">
