<?php /* Template_ 2.2.6 2022/09/06 16:34:10 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/main/index.html 000020390 */  $this->include_("getBoarddata","showDesignLightPopup","showDesignBanner","showDesignDisplay");
...
<div class='designDisplay designLastestNew6316f7f1e1277' designElement='displaylastest'  id="designLastestNew6316f7f1e1277" templatePath='bWFpbi9pbmRleC5odG1s' >
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td valign="bottom" align="right"><b><a href="/board/?id=store_review"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design/cscenter_btn_more.gif" /></a></b></td>
		</tr>
	</table>
	</div>
...
<?php if($TPL_I1&&$TPL_I1% 2== 0){?></tr><tr ><td height="10"></td></tr><tr  class="normal_bbslist"><?php }?>
			<td width="50%"  class="sbj">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
<td  width="80"  height="80"><?php if($TPL_V1["filelist"]){?><span class="BoardgoodsDisplayImageWrap"  decoration="e30=" ><a href="<?php echo $TPL_V1["wigetboardurl_view"]?>" ><img src="<?php echo $TPL_V1["filelist"]?>" width="80" height="80" onerror="this.src='/data/skin/<?php echo $TPL_VAR["skin"]?>/images/common/noimage.gif'" /></a></span><?php }?></td>					<td width="10"></td>
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td align="left">
<?php if($TPL_V1["goodsInfo"]){?><a href="<?php echo $TPL_V1["wigetboardurl_view"]?>" target=""><?php echo $TPL_V1["goodsInfo"]["goods_name"]?> </a><br/><?php }?>
...
<div class='designDisplay designLastestNew6316cd30dc51f' designElement='displaylastest'  id="designLastestNew6316cd30dc51f" templatePath='bWFpbi9pbmRleC5odG1s' >
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td valign="bottom" align="left" height="25"><span class="tit"><p><br></p></span></td>
			<td valign="bottom" align="right"><b><a href="/board/?id=goods_review"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design/cscenter_btn_more.gif" /></a></b></td>
		</tr>
	</table>
	</div>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10172)?>
  ...
  <div class="main_bnr_type2" style="margin-top:0px;">
      <ul data-effect="scale">
          <li style="text-align: center">
              <a href="#none" target='_self'><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/bravekongz_img01.jpg" title="" alt="" /></a>
          </li>
    ...
    <ul>
      <li>
        <a href="#none" class="roll">
          ...
          <img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/john-vicente-NmaFcajjlMw-unsplash.jpg" alt="배너 01" />
        </a>
      </li>
  <!--    <li>
        <a href="#none" class="roll">
          <p style="text-align: left; margin-bottom: 5px;">뮤직브로 기획전 상품 20% 할인</p>
          <h2 style="text-align:left; font-weight: bold; margin-bottom: 15px; font-size: 40px;">Best Collection</h2>
          <img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/khalid-boutchich-zMTDK9p2QyQ-unsplash.jpg" alt="배너 02" />
        </a>
      </li> -->
      <li>
        <a href="#none" class="roll">
          <a href='#none' target='_self'><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/sama-hosseini-WUru1jV4ix8-unsplash.jpg" title="배너 02" alt="배너 02" /></a>
...
<div class="main_bnr_type2">
    <ul data-effect="scale">
        <li>
            <a href="#none"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/middle_music_banner01.png" alt="" /></a>
        </li>
        <li>
            <a href="#none"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/middle_luxury_banner01.png" alt="" /></a>
        </li>
    </ul>
</div>
<!-- //2단 이미지 배너 -->
...
<div class="resp_wrap main_bnr3">
  ...
  <div class="respBnrGon respBnrGon_num3_typeB">
    <ul data-effect="scale">
      <li><a href="#"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/main_middle_img03.png" alt="" /></a></li>
      <li><a href="#"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/main_middle_img01.png" alt="" /></a></li>
      <li><a href="#"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/main_middle_img02.png" alt="" /></a></li>
    </ul>
  </div>
</div>
<!-- //이미지 배너 (EVENT) -->
...
<div class="main_bnr_type3 respBnrGon respBnrGon_num3_typeE">
  <ul data-effect="rotate_01">
    <li><a href="#none"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/main_bottom_banner01.png" alt="" /></a></li>
    <li><a href="#none"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/main_bottom_banner02.png" alt="" /></a></li>
    <li><a href="#none"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/main_bottom_banner03.png" alt="" /></a></li>
  </ul>
</div>
<!-- //3단 이미지 배너 -->
<div class="resp_wrap"> 
  ...
  <div class="show_display_col4">
    <?php echo showDesignDisplay( 10171)?>
...
<div class="full_bnr" style="background-image:url('/data/skin/responsive_sports_sporti_gl_1/images/design_resp/bottom_img01.jpg');">
    <ul class="text_wrap">          
        ...
        <li class="sbtn"><a href="#none" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWFpbi9pbmRleC5odG1s" >read more</a></li>        
    </ul>
</div>
<!-- //패럴렉스 배너 -->
...
<div class="resp_wrap"> 
  <div class="title_group1">
    <h3 class="title1"><a href="/board/?id=custom_bbs2" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWFpbi9pbmRleC5odG1s" >NEW BRAND INTRODUCTION</a></h3>
  </div>
...
<div class="resp_wrap">
    <div class="title_group1">
        <h3 class="title1"><a href="" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWFpbi9pbmRleC5odG1s" >RANK</a></h3>
    </div>
<!--      <div class="item_img_area">
        올해 방문자 TOP
        <table>
