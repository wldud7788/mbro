<?php /* Template_ 2.2.6 2022/03/18 15:13:18 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/board/notice/default01/view.html 000008833 */  $this->include_("sslAction","snslinkurl");
...
<?php if($TPL_V1["is_image"]){?>
								<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');"><img src="/data/skin/responsive_sports_sporti_gl_1/images/icon/icon_zoom.gif" hspace="1" title="미리보기"/></span>
<?php }?>
						</li>
<?php }}?>
					</ul>
