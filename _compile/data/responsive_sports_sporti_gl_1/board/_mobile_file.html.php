<?php /* Template_ 2.2.6 2022/03/18 15:13:17 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/board/_mobile_file.html 000003268 */ 
...
<tr>
	<th class="width_a"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX21vYmlsZV9maWxlLmh0bWw=" >첨부파일을</span></th>
	<td>
...
<?php if($TPL_VAR["manager"]["file_use"]=='Y'){?>
				<tr>
					<td>
						...
						<div class="pdt5">
							<button type="button" class="btnUploader btn_resp size_b"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX21vYmlsZV9maWxlLmh0bWw=" >+ 파일 추가</span></button>
						</div>
					</td>
				</tr>
<?php }?>
