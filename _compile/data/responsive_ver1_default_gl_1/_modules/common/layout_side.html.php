<?php /* Template_ 2.2.6 2022/02/07 16:56:15 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl_1/_modules/common/layout_side.html 000026619 */  $this->include_("dataWishCount");
...
<?php }?>
		...
		<li class="left_area">
			<strong class="user_name"><?php if($TPL_VAR["userInfo"]["user_name"]){?><?php echo $TPL_VAR["userInfo"]["user_name"]?><?php }else{?><?php echo $TPL_VAR["userInfo"]["userid"]?><?php }?></strong><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >님 안녕하세요.</span>
		</li>
		<li class="right_area">
...
<?php }else{?>
	<ul>
		<li class="left_area">
			<span class="gray_06" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >로그인하세요.</span>
		</li>
		<li class="right_area">
			<a href="../member/login" class="btn_resp color4" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >로그인</a>
			<a href="../member/agreement" class="btn_resp" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >회원가입</a>
		</li>
	</ul>
<?php }?>
</div>
...
<div class="asie_main_menu">
	<ul>
		<li class="am_home"><a href="/" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >홈</a></li>
		<li class="am_order"><a href="/mypage/order_catalog"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >주문조회</span> <?php if($TPL_VAR["push_count_order"]){?><span class="push_count" title="무료/취소/완료 제외한 수"><?php echo $TPL_VAR["push_count_order"]?></span><?php }?></a></li>
		<li class="am_my">
<?php if($TPL_VAR["userInfo"]["member_seq"]){?><a href="/mypage/index"><?php }else{?><a href="/member/login?return_url=/mypage/index"><?php }?><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >MY쇼핑</span></a>
		</li>
		<li class="am_cs"><a href="/mypage/myqna_catalog" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >1:1문의</a></li>
		<li class="am_cart"><a href="/order/cart"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >장바구니</span> <?php if($TPL_VAR["push_count_cart"]){?><span class="push_count"><?php echo $TPL_VAR["push_count_cart"]?></span><?php }?></a></li>
		<li class="am_wish">
<?php if($TPL_VAR["userInfo"]["member_seq"]){?><a href="/mypage/wish"><?php }else{?><a href="/member/login?return_url=/mypage/wish"><?php }?><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >위시리스트</span> <?php if(dataWishCount()){?><span class="push_count"><?php echo number_format(dataWishCount())?></span><?php }?></a>
		</li>
		<li class="am_coupon"><a href="/mypage/coupon" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >쿠폰</a></li>
		<li class="am_emony"><a href="/mypage/emoney" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >캐시</a></li>
		<li class="bmp_icon"><a href="https://musicbroshop.com/coin" designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >BMP코인<br> 전환하기</a></li>
		<li class="mubro_intro"><a href="https://mubrothers.com/" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA=="  target="_blank">소개페이지<br> 바로가기</a></li>
		<li class="mubro_music"><a href="https://music-brother.com/main/detail" designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA=="  target="_blank">뮤직브로<br> 바로가기</a></li>
		<li class="mubro_audition"><a href="https://audition.music-brother.com/" designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA=="  target="_blank">오디션<br> 바로가기</a></li>
		<li class="shop_event"><a href="https://musicbroshop.com/promotion/event" designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >EVENT</a></li>
	</ul>
</div>

<div class="aside_navigation_wrap">
	<ul class="tab">
		<li data-menuname="categorySideMenu" class="current"><span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >카테고리</span></li>
		<li data-menuname="brandSideMenu"><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >브랜드</span></li>
		<li data-menuname="locationSideMenu"><span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >지역</span></li>
		<li data-menuname="boardSideMenu"><span designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >커뮤니티</span></li>
	</ul>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
			<li class="mitem mitemicon1 favorite">
				<a class="mitem_title v3" designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >FAVORITE CATEGORY</a>
			</li>
...
<?php }else{?>
						<li class="submitem no_favorite">
							자주 이용할 카테고리의 <img src="/data/skin/responsive_ver1_default_gl_1/images/design/ico_fvr_off.png" width="20" alt="카테고리 즐겨찾기" />을 눌러주세요.
						</li>
<?php }?>
				</ul>
			</li>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
		<li class="mitem mitemicon1 favorite">
			<a class="mitem_title v3" designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >FAVORITE BRAND</a>
		</li>
		<li class="mitem_subcontents">
			<ul class="submenu">
...
<?php }else{?>
					<li class="submitem no_favorite">
						자주 이용할 브랜드의 <img src="/data/skin/responsive_ver1_default_gl_1/images/design/ico_fvr_off.png" width="20" alt="브랜드 즐겨찾기" />을 눌러주세요.
					</li>
<?php }?>
			</ul>
		</li>
...
<?php if($TPL_VAR["best_brand"]){?>
		<li class="mitem mitemicon1 favorite">
			<a class="mitem_title v2" designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >BEST BRAND</a>
		</li>
		<li class="mitem_subcontents">
...
<?php }?>
		...
		<li class="aside_brand_sorting">
			<ul class="brandsort">
				<li class="current"><span designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >전체</span></li>
				<li><span designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >가나다</span></li>
				<li><span designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >ABC</span></li>
				<li><span designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >기타</span></li>
			</ul>
...
<?php if($TPL_brand_1){foreach($TPL_VAR["brand"] as $TPL_V1){?>
		<li class="mitem category mitem_brand <?php if($TPL_V1["childs"]){?>mitemicon1<?php }else{?>mitemicon3<?php }?>" title_eng="<?php echo $TPL_V1["title_eng"]?>" title="<?php echo $TPL_V1["ori_title"]?>">
			<a class="mitem_title">
				<!-- //브랜드 로고 보이게 하는 부분 -->
				<img src="<?php echo $TPL_V1["brand_image"]?>" alt="" onerror="this.src='/data/skin/responsive_ver1_default_gl_1/images/common/noimage.gif';" style="width: 80%;">
				<!-- 브랜드 로고 보이게 하는 부분// -->
			</a>
...
<?php }}?>
	...
	<ul id="boardSideMenu" class="menu board" style="display:none;">
		<li><a href="/board/?id=notice" designElement="text" textIndex="29"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >공지사항</a></li>
		<li><a href="/board/?id=faq" designElement="text" textIndex="30"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >자주묻는질문</a></li>
		<li><a href="/board/?id=goods_qna" designElement="text" textIndex="31"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >상품문의</a></li>
		<li><a href="/board/?id=goods_review" designElement="text" textIndex="32"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >상품후기</a></li>
<?php if($TPL_VAR["isplusfreenot"]){?><li><a href="/board/?id=bulkorder" designElement="text" textIndex="33"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >대량구매</a></li><?php }?>
	</ul>
	<!-- ++++++++ //커뮤니티 ++++++++ -->
...
<div class="wrap_aside">
	<h3 class="title_sub3 v2"><span designElement="text" textIndex="34"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >최근 본 상품</span> <?php if($TPL_VAR["push_count_today"]){?><a href="/goods/recently" class="push_count">(<?php echo $TPL_VAR["push_count_today"]?>)</a><?php }?></h3>
</div>
...
<?php if(($TPL_I1< 30)){?>
		<li class="sslide" data-removeitem='<?php echo $TPL_V1["goods_seq"]?>'>
			<a href="../goods/view?no=<?php echo $TPL_V1["goods_seq"]?>"><img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl_1/images/common/noimage_list.gif'" alt="" /></a>
...
<!-- CS CENTER 정보(SIDE) -->
<div class="wrap_aside">
	<h3 class="title_sub3 v2"><a href="/service/cs" designElement="text" textIndex="35"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >CS CENTER</a></h3>
	...
	<p class="aside_cs_addinfo" designElement="text" textIndex="36"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9fbW9kdWxlcy9jb21tb24vbGF5b3V0X3NpZGUuaHRtbA==" >MON ~ FRI<br />AM 09:00 ~ PM 06:00<br />LUNCH AM 12:00 ~ PM 01:00<br />SAT, SUN, HOLIDAY OFF<br /></p>
</div>
...
<script type="text/javascript" src="/data/skin/responsive_ver1_default_gl_1/common/side.js"></script>
<script>
$(function() {
