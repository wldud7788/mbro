<?php /* Template_ 2.2.6 2022/02/04 15:52:00 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl_1/layout_header/standard.html 000027153 */  $this->include_("showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");
    ...
    <div class="designPopupBody" style="margin-bottom: 20px;">
        ...
        <div class="pc_top_banner">
          <a href="https://music-brother.com/main/detail" target="_blank" class="top_link_banner">
              <img src="/data/skin/responsive_ver1_default_gl/images/top_music_link02.jpeg">
          </a>
          <a href="https://audition.music-brother.com" target="_blank" class="top_link_banner">
              <img src="/data/skin/responsive_ver1_default_gl/images/top_audition_link02.jpeg">
          </a>
        </div>

        <div class="mobile_top_banner">
          <a href="https://music-brother.com/main/detail" target="_blank" class="top_link_banner">
            <img src="/data/skin/responsive_ver1_default_gl/images/m_top_music_link02.jpeg">
          </a>
          <a href="https://audition.music-brother.com" target="_blank" class="top_link_banner">
              <img src="/data/skin/responsive_ver1_default_gl/images/m_top_audition_link02.jpeg">
          </a>
        </div>
...
<?php }}?>
			...
			<!-- bookmark -->
			<a class="bookmark" href="<?php echo $TPL_VAR["bookmark"]?>" title="북마크"><img src="/data/skin/responsive_ver1_default_gl_1/images/common/icon_bookmark.png" alt="bookmark" /> <span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9sYXlvdXRfaGVhZGVyL3N0YW5kYXJkLmh0bWw=" >BOOKMARK</span></a>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
				...
				<li><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9sYXlvdXRfaGVhZGVyL3N0YW5kYXJkLmh0bWw=" >LOGOUT</a><?php }else{?><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9sYXlvdXRfaGVhZGVyL3N0YW5kYXJkLmh0bWw=" >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9sYXlvdXRfaGVhZGVyL3N0YW5kYXJkLmh0bWw=" >LOGOUT</a></li>
<?php }else{?>
...
<?php }?>
				...
				<li class="respCartArea"><a href="/order/cart"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2xfMS9sYXlvdXRfaGVhZGVyL3N0YW5kYXJkLmh0bWw=" >CART</span><span class="cart_cnt1"><?php echo $TPL_VAR["push_count_cart"]?></span></a></li>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/' target='_self'><img src="/data/skin/responsive_ver1_default_gl_1/images/design/resp_logo_sample.png" title="(주)음악형제들" alt="(주)음악형제들"></a>
			</h1>
