<?php /* Template_ 2.2.6 2021/06/09 10:51:38 /www/music_brother_firstmall_kr/order/_lg.html 000008219 */  $this->include_("defaultScriptFunc");?>
<html>
<head>
...
<?php }else{?>
		alert("LG U+ 전자결제를 위한 XPayPlugin 모듈이 설치되지 않았습니다11111."); 
		xpay_showInstall();
<?php }?>
        /** 인증실패 화면 처리 **/
       parent.reverse_pay_button();
