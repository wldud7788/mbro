<?php /* Template_ 2.2.6 2021/12/15 17:04:32 /www/music_brother_firstmall_kr/data/skin/responsive_wristwatch_classic_gl/main/index.html 000006341 */  $this->include_("showDesignLightPopup","showDesignBanner","showDesignDisplay");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ index @@
...
<div class="full_bnr">
	<div class="respBnrGon respBnrGon_num2_typeA">
		<ul class="resp_wrap">
			<li><a href="#none" class="roll"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr_01_over.png" alt="배너 01" /></a></li>
			<li><a href="#none" class="roll"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr_02_over.png" alt="배너 02" /></a></li>
		</ul>
	</div>
</div>
<!-- //full_bnr (이미지 배너) -->
...
<div class="full_bnr2">
   <a href="#none"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr2_01.jpg" alt="배너 01" /></a>
</div>
<!-- //full_bnr2 (이미지 배너) -->
...
<div class="full_bnr3">
	<div class="respBnrGon respBnrGon_num3_typeE">
		...
		<ul class="resp_wrap" data-effect="opacity">
			<li><a href="#none"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr3_01.jpg" alt="배너 01" /></a></li>
			<li><a href="#none"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr3_02.jpg" alt="배너 02" /></a></li>
			<li><a href="#none"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr3_03.jpg" alt="배너 03" /></a></li>
		</ul>
	</div>
</div>
<!-- //full_bnr3 (이미지 배너) -->
...
<div class="full_bnr4">
	<div class="respBnrGon respBnrGon_num2_typeA">
		<ul class="resp_wrap">
			<li><a href="#none" class="btn_mov"><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr4_01.jpg" alt="영상"></a></li>
			<li><a href="/service/company" target='_self'><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/bnr4_02.png" title="텍스트" alt="텍스트"></a></li>
		</ul>
	</div>
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_main"]=='Y'){?>
	<div class="btn_talk_area">
		<button type="button" class="btn_talk v2" onclick="location.href='https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?>#nafullscreen';">쇼핑할땐 &nbsp;<img src="/data/skin/responsive_wristwatch_classic_gl/images/icon/icon_talk.png" class="talk_img" alt="네이버톡톡" /> 톡톡하세요</button>
	</div>
<?php }?>
</div>
<!-- //네이버 톡톡 -->