<?php /* Template_ 2.2.6 2021/12/15 17:04:30 /www/music_brother_firstmall_kr/data/skin/responsive_wristwatch_classic_gl/layout_header/standard.html 000029472 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showDesignBanner","showTopPromotion","showCategoryLightNavigation");
...
<?php }}?>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/main/index'><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>"></a>
			</h1>
...
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >LOGOUT</a></li>
<?php }else{?>
...
<?php }?>
                ...
                <li class="respCartArea"><a href="/order/cart"><em designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >CART</em><?php if($TPL_VAR["push_count_cart"]){?><span class="cart_cnt2"><?php echo $TPL_VAR["push_count_cart"]?></span><?php }?></a></li>
