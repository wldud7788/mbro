<?php /* Template_ 2.2.6 2021/06/16 17:02:25 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/layout_footer/standard.html 000017796 */  $this->include_("confirmLicenseLink","escrow_mark");
    ...
    <div class="footer_b">
        ...
        <div class="resp_wrap">
          ...
          <ul class="menu1">
              ...
              <li>
                  <span class="info_title" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw=" >대표번호/고객센터</span> <a href="tel:<?php echo $TPL_VAR["config_basic"]["companyPhone"]?>" class="pcolor"><?php echo $TPL_VAR["config_basic"]["companyPhone"]?></a>
...
<?php }?>
              ...
              <li>
                  <span class="info_title" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw=" >대표이사</span> <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["member_info_manager"]?> (<a href="mailto:<?php echo $TPL_VAR["config_basic"]["companyEmail"]?>"><?php echo $TPL_VAR["config_basic"]["companyEmail"]?></a>)</span>
          ...
          <ul class="footer_info">
              <li><a href="https://mubrothers.com" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw="  target="_blank">공식홈페이지</a></li>
              <li><a href="/service/agreement" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw="  target="_self">이용약관</a></li>
              <li><a href="/service/privacy" designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw="  target="_self"><strong>개인정보처리방침</strong></a></li>
              <li><a href="/service/guide" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw="  target="_self">이용안내</a></li>
              <li><a href="https://musicbroshop.com/page/index?tpl=etc%2Fparter_page.html" designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9sYXlvdXRfZm9vdGVyL3N0YW5kYXJkLmh0bWw="  target="_self">입점문의</a></li>
          </ul>
        </div>

        <div class="ini_box">
            <div>
                <img class="ini_img" src='/data/skin/responsive_diary_petit_gl/images/escrow_74x74_color.png' border="0" alt="클릭하시면 이니시스 결제시스템의 유효성을 확인하실 수 있습니다." >
...
<?php }?>
                            <li>
                                <a href="../goods/view?no=<?php echo $TPL_V1["goods_seq"]?>" class="right_quick_goods"><img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_list.gif'" alt="<?php echo $TPL_V1["goods_name"]?>" /></a
