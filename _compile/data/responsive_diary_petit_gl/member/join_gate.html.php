<?php /* Template_ 2.2.6 2021/03/08 13:58:05 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/member/join_gate.html 000007626 */ 
...
<!-- <img src="/data/skin/responsive_diary_petit_gl/images/login_event.jpeg" alt="" title="" style="left: 50%;
    position: relative;
    transform: translate(-50%); max-width: 800px; margin-top: 30px;"> -->
...
<?php if($TPL_VAR["joinform"]["join_type"]!='business_only'){?>
			<li class="on"><a href="javascript:void(0)"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvam9pbl9nYXRlLmh0bWw=" >개인회원</span></a></li>
<?php }?>
<?php if($TPL_VAR["joinform"]["join_type"]!='member_only'){?>
			<li><a href="javascript:void(0)"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvam9pbl9nYXRlLmh0bWw=" >사업자회원</span></a></li>
<?php }?>
		</ul>
	</div>
...
<?php if($TPL_K1){?>
			<li><div class="img" style="margin: 0 auto;"><img src="/data/skin/responsive_diary_petit_gl/images/design/sns_icon_<?php echo $TPL_K1?>.png" onclick="document.location.href='agreement?join_type=<?php echo $TPL_V1['cd']?>member'" alt=" <?php echo $TPL_K1?> 회원가입" title="<?php echo $TPL_V1['nm']?> 회원가입"></div></li>
<?php }?>
<?php }}?>
		</ul>
<?php }?>
...
<?php if(is_array($TPL_R1=$TPL_VAR["joinform"]["use_sns"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_K1=>$TPL_V1){?>
<?php if($TPL_K1){?>
			<li><div class="img"><img src="/data/skin/responsive_diary_petit_gl/images/design/sns_icon_<?php echo $TPL_K1?>.png" onclick="document.location.href='agreement?join_type=<?php echo $TPL_V1['cd']?>business'" alt=" <?php echo $TPL_K1?> 회원가입" title="<?php echo $TPL_V1['nm']?> 회원가입"></div></li>
<?php }?>
<?php }}?>
		</ul>
<?php }?>
