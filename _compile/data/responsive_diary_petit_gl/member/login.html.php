<?php /* Template_ 2.2.6 2021/07/09 18:32:33 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/member/login.html 000009642 */  $this->include_("sslAction");?>
<a href="http://musicbroshop.com/page/index?tpl=etc%2Fsignup_event.html" target="_self"><img src="/data/skin/responsive_diary_petit_gl/images/KakaoTalk_20210308_133858062.jpg" alt="" title=""></a>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 로그인 @@
...
<div class="resp_login_wrap">
	<div id="loginTab" class="tab_basic fullsize Pt20">
		...
		<ul>
			<li class="on"><a href="javascript:void(0)" data-tab="member"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvbG9naW4uaHRtbA==" >회원</span></a></li>
			<li <?php if($TPL_VAR["mode"]=='settle'){?>style="display:none"<?php }?>><a href="javascript:void(0)" data-tab="nonmember"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvbG9naW4uaHRtbA==" >비회원</span></a></li>
		</ul>
	</div>
</div>
		...
		<fieldset>
			<ul class="login_real_area">
				...
				<li>
					...
					<a href="https://musicbroshop.com/board/view?id=notice&seq=39" style="color: red; font-weight: 500;">로그인이 안되신다면?</a>
				</li>
				<li>
				...
				<li class="find_join">
					<a href="../member/find?mode=findid" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvbG9naW4uaHRtbA==" >아이디 찾기</a> &nbsp;|&nbsp;
					<a href="../member/find?mode=findpw" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvbG9naW4uaHRtbA==" >비밀번호 찾기</a> &nbsp;|&nbsp;
					<a href="../member/agreement" class="Fw500 gray_01" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvbG9naW4uaHRtbA==" >회원가입</a>
				</li>
			</ul>
...
<?php if($TPL_K1){?><li class="sns-login-button" snstype="<?php echo $TPL_K1?>"><div class="img"><img src="/data/skin/responsive_diary_petit_gl/images/design/sns_icon_<?php echo $TPL_K1?>.png" alt="<?php echo $TPL_K1?> 로그인" title="<?php echo $TPL_V1['nm']?> 로그인"/></div></li><?php }?>
<?php }}?>
			</ul>
<?php }?>
