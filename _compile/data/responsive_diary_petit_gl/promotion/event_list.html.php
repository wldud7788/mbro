<?php /* Template_ 2.2.6 2021/04/27 10:15:03 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/promotion/event_list.html 000009204 */  $this->include_("showDesignBanner");
...
<?php if($TPL_VAR["record"]){?>
  ...
  <!--   <li class="bravegirls_cd_event">
      <a href="https://musicbroshop.com/board/view?id=notice&seq=66">
        <div class="event-image-box">
            <p class="image_event "><img class="event_list_banner designElement" src="/data/event/bravegirls_cd.jpg" alt=""></p>
        </div>
        <div class="infobox">
...
<?php if($TPL_V1["joincheck_seq"]){?>
            <p class="no_image_event"><img src="/data/skin/responsive_diary_petit_gl/images/design/no_images_stamp.png" alt="출석체크 이벤트" /></p>
<?php }elseif($TPL_V1["gift_seq"]){?>
            <p class="no_image_event"><img src="/data/skin/responsive_diary_petit_gl/images/design/no_images_gift.png" alt="사은품 이벤트" /></p>
<?php }elseif($TPL_V1["event_seq"]){?>
            <p class="no_image_event"><img src="/data/skin/responsive_diary_petit_gl/images/design/no_images_promotion.png" alt="할인/기획전 이벤트" /></p>
<?php }else{?>
            <img class="none" src="/data/skin/responsive_diary_petit_gl/images/design/noimg_thumb.gif" alt="이미지 준비중입니다" />
<?php }?>
<?php }?>
