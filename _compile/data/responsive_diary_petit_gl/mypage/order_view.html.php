<?php /* Template_ 2.2.6 2020/12/31 10:49:16 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/order_view.html 000126717 */ 
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/common/auth_img.png" height="17" alt="성인" />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/common/plane.png" height="14" alt="해외배송상품" />
<?php }?>
							</div>
...
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?><?php if($TPL_V4["type"]=='file'){?><a href="../mypage_process/filedown?file=<?php echo $TPL_V3["value"]?>" target="actionFrame" class="gray_05" title="다운로드"><?php echo $TPL_V4["value"]?></a><?php }else{?><?php echo $TPL_V4["value"]?><?php }?>
								</span>
<?php }?>
<?php }}?>
							</div>
...
<div id="coupon_use_guide" class="hide">
	<table class="coupon_use_guide_tb" cellpadding="0" cellspacing="0" border="0">
		...
		<tr><td class="guide_img"><img src="/data/skin/responsive_diary_petit_gl/images/design/guide_img_cpn.jpg" /></td></tr>
