<?php /* Template_ 2.2.6 2020/12/08 11:56:43 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/myinfo.html 000019087 */  $this->include_("sslAction");
...
<?php if($TPL_snslist_1){foreach($TPL_VAR["snslist"] as $TPL_V1){?>
				<img src="/data/skin/responsive_diary_petit_gl/images/design/mypage_sns_<?php echo substr($TPL_V1["rute"], 0, 1)?>.png"  class="hand" snstype="<?php echo $TPL_V1["rute"]?>"  alt="<?php echo $TPL_VAR["joinform"]["use_sns"][$TPL_V1["rute"]]['nm']?>"  title="<?php echo $TPL_VAR["joinform"]["use_sns"][$TPL_V1["rute"]]['nm']?>" height="42" />
...
<?php if($TPL_V1["key"]){?>
				<li>
					<img src="/data/skin/responsive_diary_petit_gl/images/design/mypage_sns_<?php echo substr($TPL_K1, 0, 1)?>.png" class="icon" snstype="sns_<?php echo substr($TPL_K1, 0, 1)?>"  snsrute="<?php echo $TPL_K1?>" alt="<?php echo $TPL_V1["nm"]?>"  title="<?php echo $TPL_V1["nm"]?>"  />
