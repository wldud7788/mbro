<?php /* Template_ 2.2.6 2020/10/15 17:39:16 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/coupon.html 000020288 */  $this->include_("o2oFrontMypageCouponBarcode");
		...
		<div class="tab_basic size2">
			<ul>
				<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=1"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvY291cG9uLmh0bWw=" >보유한 쿠폰</span>(<strong class="pointcolor2"><?php echo number_format($TPL_VAR["unusedcount"])?></strong>/<?php echo number_format($TPL_VAR["totalcount"])?>)</a>
				</li>
				<li <?php if($_GET["tab"]=='2'){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=2"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvY291cG9uLmh0bWw=" >다운로드 가능 쿠폰</span>(<?php echo number_format($TPL_VAR["svcount"])?>)</a>
				</li>
			</ul>
		</div>
