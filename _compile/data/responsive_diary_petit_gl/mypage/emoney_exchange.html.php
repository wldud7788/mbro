<?php /* Template_ 2.2.6 2020/12/29 11:40:27 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/emoney_exchange.html 000006542 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvZW1vbmV5X2V4Y2hhbmdlLmh0bWw=" >캐시로 사은품 교환</span></h2>
		</div>
...
<?php if(is_array($TPL_R2=$TPL_V1["goods"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
				<li>
					<ul class="item_detail">
						<li class="img_area"><img class="item_img" src="<?php echo get_gift_image($TPL_V2,'list1')?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif';" alt="<?php echo get_gift_name($TPL_V2)?>" /></li>
