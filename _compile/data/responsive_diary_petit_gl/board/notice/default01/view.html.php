<?php /* Template_ 2.2.6 2021/12/03 16:33:31 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/notice/default01/view.html 000009225 */  $this->include_("sslAction","snslinkurl");
...
<?php if($TPL_V1["is_image"]){?>
								<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');"><img src="/data/skin/responsive_diary_petit_gl/images/icon/icon_zoom.gif" hspace="1" title="미리보기"/></span>
<?php }?>
						</li>
<?php }}?>
					</ul>
