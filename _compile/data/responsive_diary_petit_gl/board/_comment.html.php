<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/_comment.html 000025743 */  $this->include_("sslAction");
...
<?php if($TPL_V1["iconnew"]){?>
						<img src="/data/skin/responsive_diary_petit_gl/board/<?php echo $TPL_VAR["templateskin"]?>/images/icon/icon_new.png" title="new" align="absmiddle" >
<?php }?>
				</td>
			</tr>
			<tr>
...
<?php if(is_array($TPL_R2=$TPL_V1["cmtreplyloop"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
					<tr>
						...
						<img src="/data/skin/responsive_diary_petit_gl/board/<?php echo $TPL_VAR["templateskin"]?>/images/board/icon/icon_comment_reply.gif"  title="답변" alt="답변">
