<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/mbqna/_mbqna/index.html 000010491 */  $this->include_("sslAction");
...
<div class="sub_title_bar">
	...
	<a href="javascript:history.back();" class="stb_back_btn"><img src="/data/skin/responsive_diary_petit_gl/images/design/btn_back.png" /></a>
</div>
...
<div class="pdb5">
	<div class="bbssearchbox" <?php if(!$_GET["search_text"]){?>style="display:none"<?php }?>>
		...
		<input type="text" name="search_text" id="search_text" value="<?php echo $_GET["search_text"]?>" title="이 게시판 검색" /><input type="image" src="/data/skin/responsive_diary_petit_gl/images/design/btn_search_s.png" />
		</form>
	</div>
</div>
<?php }?>
...
<?php }?>
			<span class="hand boad_view_btn_m<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>"  viewtype="<?php echo $TPL_VAR["manager"]["viewtype"]?>"  pagetype="<?php echo $TPL_VAR["pagetype"]?>"  board_seq="<?php echo $TPL_V1["seq"]?>" board_id="<?php echo $_GET["id"]?>">
				<div class="bus_subject">
					<img src="/data/skin/responsive_diary_petit_gl/images/board/icon/icon_notice.gif" />
...
<?php if($TPL_V1["iconnew"]){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/icon/icon_new.png" title="new" align="absmiddle" >
<?php }?>
