<?php /* Template_ 2.2.6 2020/10/15 17:39:16 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/order/_optional_changes.html 000003308 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 옵션/수량 변경 @@
...
<ul class="resp_content2">
	<li><a href="/goods/view?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>" target="_blank" title="새창"><img src="<?php echo $TPL_VAR["goods"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif'" alt="" style="max-width:80px; border:1px #eee solid;" /></a></li>
