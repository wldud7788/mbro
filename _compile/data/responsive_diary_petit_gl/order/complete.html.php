<?php /* Template_ 2.2.6 2020/12/30 18:42:54 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/order/complete.html 000032913 */ 
...
<div class="subpage_wrap">
	<div class="subpage_container v3 Pb10">
		...
		<div class="title_container">
			<a class="btn_history back" href="javascript:history.back();"><img src="/data/skin/responsive_diary_petit_gl/images/design/arw_prev.gif" alt="히스토리 뒤로" /></a>
...
<?php }?>
			<a class="btn_history forward" href="javascript:history.forward();"><img src="/data/skin/responsive_diary_petit_gl/images/design/arw_next.gif" alt="히스토리 앞으로" /></a>
		</div>
						...
						<div class="cart_goods_detail">
							<div class="cgd_contents">
								<div class="block block1">
									<ul>
										<li class="img_area">
											<a href="../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>"><img src="<?php echo $TPL_V2["image"]?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_list.gif'" /></a>
										</li>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
												<img src="/data/skin/responsive_diary_petit_gl/images/common/auth_img.png" alt="성인" class="icon1" />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
												<img src="/data/skin/responsive_diary_petit_gl/images/common/plane.png" alt="해외배송상품" class="icon2" />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
												<img src="/data/skin/responsive_diary_petit_gl/images/common/nocancellation.gif" alt="청약철회" class="icon3" />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
												<img src="/data/skin/responsive_diary_petit_gl/images/common/taxfree.gif" alt="비과세" class="icon4" />
<?php }?>
											</div>
<?php }?>
...
<div class="Pb60 C">
	<a href="/mypage/order_view?no=<?php echo $TPL_VAR["orders"]["order_seq"]?>" class="btn_resp size_c color2"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9vcmRlci9jb21wbGV0ZS5odG1s" >MY페이지 주문내역</span></a>
	<a href="/" class="btn_resp size_c color5"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9vcmRlci9jb21wbGV0ZS5odG1s" >쇼핑 계속하기</span></a>
</div>
