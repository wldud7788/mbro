<?php /* Template_ 2.2.6 2020/12/14 13:02:49 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/brand_main.html 000006235 */  $this->include_("assignBrandMenuData","showDesignBanner");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 브랜드 메인 @@
...
<?php if(in_array('kor',$TPL_VAR["page_config"]["search_filter"])||in_array('eng',$TPL_VAR["page_config"]["search_filter"])){?>
		<div class="resp_brand_search_btns">
			<ul>
				<li><a href="javascript:void(0)" class="alphabet_btn all on" data-target="all"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9icmFuZF9tYWluLmh0bWw=" >ALL</span></a></li>
		...
		<ul class="brandwrap brand<?php echo $TPL_V2["category_code"]?> wrap<?php echo str_replace("/","",strtr(base64_encode(str_replace("/","",$TPL_K1)),"+=","-_"))?>">
			<li>
				<a class="brand_list_block" <?php if($TPL_V2["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V2["category_code"]?>">
					<div>
						<img src="<?php echo $TPL_V2["brand_image"]?>" alt="<?php echo $TPL_V2["prn_title"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif';" />
					</div>
					<span class="name">
