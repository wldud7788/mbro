<?php /* Template_ 2.2.6 2022/01/06 11:41:01 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/view.html 000103740 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php }?>
<?php }else{?>
							<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_wide.gif'" title="뮤직브로샵,[TEST] BT21 스마트램프 + BT21 미니스피커" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="뮤직브로샵,[TEST] BT21 스마트램프 + BT21 미니스피커"<?php }?>/>
<?php }?>
					</div>
<?php }?>
<?php }}?>
...
<?php if($TPL_V1["thumbView"]["image"]){?>
							<li><a href="javascript:void(0)"><img src="<?php echo $TPL_V1["thumbView"]["image"]?>" width="<?php echo $TPL_VAR["goodsImageSize"]["thumbView"]["width"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_list.gif'" <?php if($TPL_V1["thumbView"]["match_color"]){?> color="<?php echo $TPL_V1["thumbView"]["match_color"]?>"<?php }?> /></a></li>
<?php }?>
<?php }}?>
						</ul>
					</div>
...
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_diary_petit_gl/images/common/icon_inter_ship.png" class="icon_global" alt="" />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
...
<?php if($TPL_VAR["ship_summary"]["gl_shipping_yn"]=='Y'){?>
				<li class="goods_spec_international_shipping">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="72"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >해외배송</span> <img src="/data/skin/responsive_diary_petit_gl/images/common/plane.png" height="15" alt="해외배송" /></li>
						<li>
		...
		<div id="goods_tabs" class="goods_tabs">
			<div class="resp_area">
				<div class="goods_information_tabs">
					...
					<a href="#goods_contents_quick" id="goodsQnaLoad" onclick="open_information_tab(this,'goods_qna');"><span><span designElement="text" textIndex="120"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상품문의</span> <?php if($TPL_VAR["goods"]["qna_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["qna_count"])?></span><?php }?></span></a>
...
<?php if($TPL_info_1){foreach($TPL_VAR["info"] as $TPL_V1){?>
					<img src="<?php echo $TPL_V1["url"]?>"><br>	
<?php }}?>
			</center>
<?php if($TPL_VAR["goods"]["mobile_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1">원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1">원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
