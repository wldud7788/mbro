<?php /* Template_ 2.2.6 2021/12/07 14:14:27 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/catalog.html 000013299 */  $this->include_("showDesignBanner","showGoodsSearchFormLight","showDesignDisplay");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ "카테고리" 리스트 페이지 @@
...
<?php }?>
    ...
    <div class="mdpick_box">
        ...
        <div class="music_mdpick">
            <?php echo showDesignDisplay( 10319)?>

        </div>
        <div class="goods_mdpick">
            <?php echo showDesignDisplay( 10320)?>

        </div>
        <div class="fashion_mdpick">
            <?php echo showDesignDisplay( 10321)?>

        </div>
        <div class="beauty_mdpick">
            <?php echo showDesignDisplay( 10322)?>

        </div>
        <div class="food_mdpick">
            <?php echo showDesignDisplay( 10323)?>

        </div>
        <div class="sports_mdpick">
            <?php echo showDesignDisplay( 10324)?>

        </div>
        <div class="style_mdpick">
            <?php echo showDesignDisplay( 10325)?>

        </div>
        <div class="toy_mdpick">
            <?php echo showDesignDisplay( 10341)?>

        </div>
        <div class="digital_mdpick">
            <?php echo showDesignDisplay( 10342)?>

        </div>
        <div class="life_mdpick">
            <?php echo showDesignDisplay( 10343)?>

        </div>
        <div class="bravegirls_notice" style="text-align: center;">
            <?php echo showDesignDisplay( 10344)?>
