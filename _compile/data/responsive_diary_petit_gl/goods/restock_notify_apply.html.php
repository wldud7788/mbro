<?php /* Template_ 2.2.6 2020/12/09 11:18:03 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/restock_notify_apply.html 000005526 */  $this->include_("sslAction");
...
<?php }?>
	...
	<p class="Pt20 Pb5">개인정보 수집</p>
	<textarea style="width: 100%; height: 60px; overflow-y: auto; margin-bottom: 10px; color:#999;">
[개인정보의 수집·이용 목적]
상품 재입고 안내
...
개인정보 수집 목적 달성 완료시. 단, 내부방침 및 관계법령의 규정에 의하여 보존할 필요가 있는 경우 일정기간 동안 보관
	...
	<div class="btn_area_a">
		<label class="label1"><input type="radio" name="agree" value="1" /> 개인정보 수집 이용에 대해 동의합니다.</label>
		<label class="label1"><input type="radio" name="agree" value="0" checked="checked"/> 동의하지 않습니다.</label>
	</div>
