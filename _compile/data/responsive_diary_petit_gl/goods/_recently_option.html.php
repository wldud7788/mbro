<?php /* Template_ 2.2.6 2020/12/10 10:19:48 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/_recently_option.html 000002705 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
...
<div class="cart_dialog_img">
	<a href="/goods/view?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>" target="_blank">
		<img src="<?php echo $TPL_VAR["goods"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif'" alt="" /></a>
...
<?php }?>
	...
	<li class="btn_area">
		<button type="button" id="addCart" class="btn_resp color2"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fcmVjZW50bHlfb3B0aW9uLmh0bWw=" >장바구니담기</span></button>
	</li>
</ul>
</form>
