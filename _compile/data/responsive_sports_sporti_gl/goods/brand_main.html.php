<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/goods/brand_main.html 000007253 */  $this->include_("assignBrandMenuData","showDesignBanner");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 브랜드 메인 @@
...
<?php if(in_array('kor',$TPL_VAR["page_config"]["search_filter"])||in_array('eng',$TPL_VAR["page_config"]["search_filter"])){?>
		<div class="resp_brand_search_btns">
			<ul>
				<li><a href="javascript:void(0)" class="alphabet_btn all on" data-target="all"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==" >ALL</span></a></li>
		...
		<ul class="brandwrap all brand<?php echo $TPL_V1["category_code"]?>" >
			<li>
				<a class="brand_list_block" <?php if($TPL_V1["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V1["category_code"]?>">
					<img src="<?php echo $TPL_V1["brand_image"]?>" alt="<?php echo $TPL_V1["prn_title"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif';" />
					<span class="name">
		...
		<ul class="brandwrap brand<?php echo $TPL_V2["category_code"]?> wrap<?php echo str_replace("/","",strtr(base64_encode(str_replace("/","",$TPL_K1)),"+=","-_"))?>" style="display: none">
			<li>
				<a class="brand_list_block" <?php if($TPL_V2["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V2["category_code"]?>">
					<img src="<?php echo $TPL_V2["brand_image"]?>" alt="<?php echo $TPL_V2["prn_title"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif';" />
					<span class="name">
