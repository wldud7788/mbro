<?php /* Template_ 2.2.6 2022/06/15 16:17:48 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/goods/view.html 000106878 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php }?>
<?php }else{?>
							<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_wide.gif'" title="<?php echo $TPL_V1["large"]["label"]?>" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="<?php echo $TPL_VAR["goods_view_image_alt"]?>"<?php }?>/>
<?php }?>
					</div>
<?php }?>
<?php }}?>
...
<?php if($TPL_V1["thumbView"]["image"]){?>
							<li><a href="javascript:void(0)"><img src="<?php echo $TPL_V1["thumbView"]["image"]?>" width="<?php echo $TPL_VAR["goodsImageSize"]["thumbView"]["width"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_list.gif'" <?php if($TPL_V1["thumbView"]["match_color"]){?> color="<?php echo $TPL_V1["thumbView"]["match_color"]?>"<?php }?> /></a></li>
<?php }?>
<?php }}?>
						</ul>
					</div>
...
<?php }?>
		...
		<input type="hidden" name="goodsViewVersion" value="2" />
			...
			<div class="sns_wish">
				<!-- SNS 공유 -->
				<a href="javascript:void(0)" id="btnSnsShare" class="btn_sns_share" title="SNS 공유" onclick="share_chg()" ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3ZpZXcuaHRtbA==" >공유</span></a>
...
<?php if($TPL_VAR["braodcastData"]["status"]=='live'){?>
						<img class="status" src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_live.png" alt="방송 중">
						<p class="notice_text"><?php echo $TPL_VAR["braodcastData"]["start_date"]?> 현재 방송 중</p>
						<a class="btn_resp no_border" href="/broadcast/player?no=<?php echo $TPL_VAR["braodcastData"]["bs_seq"]?>" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/btn_live_go.png" alt="시청하기"></a>
<?php }else{?>
						<img class="status" src="/data/skin/responsive_sports_sporti_gl/images/broadcast/reserve_live.png" alt="방송 예정 LIVE">
...
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_sports_sporti_gl/images/common/icon_inter_ship.png" class="icon_global" alt="" />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
...
<?php if($TPL_VAR["ship_summary"]["gl_shipping_yn"]=='Y'){?>
				<li class="goods_spec_international_shipping">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="72"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3ZpZXcuaHRtbA==" >해외배송</span> <img src="/data/skin/responsive_sports_sporti_gl/images/common/plane.png" height="15" alt="해외배송" /></li>
						<li>
...
<?php }?>
			...
			<div id="goodsBuyOpenSection" class="goods_buy_open_sections">
				<a href="javascript:void(0);" id="btnSectionOpen" class="btn_section_open off" onclick="btn_close()">열기</a>
...
<?php }?>
			...
			<div id="goodsOptionBuySection" class="goods_buy_sections">
				<a href="javascript:void(0);" id="btnSectionClose" class="btn_section_close btn_close" onclick="btn_open()">닫기</a>
	...
	<div id="goods_contents_quick" class="set_preload">
		...
		<div id="goods_tabs" class="goods_tabs">
			<div class="resp_area">
				<div class="goods_information_tabs">
					...
					<a href="#goods_contents_quick" id="goodsQnaLoad" onclick="open_information_tab(this,'goods_qna');"><span><span designElement="text" textIndex="120"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3ZpZXcuaHRtbA==" >상품문의</span> <?php if($TPL_VAR["goods"]["qna_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["qna_count"])?></span><?php }?></span></a>
		...
		<div class="goods_information_contents goods_description">
			...
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3ZpZXcuaHRtbA==" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1">원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3ZpZXcuaHRtbA==" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1">원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
