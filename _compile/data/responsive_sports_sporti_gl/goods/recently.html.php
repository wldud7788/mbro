<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/goods/recently.html 000007040 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3JlY2VudGx5Lmh0bWw=" >최근본 상품</span></h2>
		</div>
...
<?php if($TPL_record_1){foreach($TPL_VAR["record"] as $TPL_V1){?>
					<li>
						<div class="img_area"><a href="../goods/view?no=<?php echo $TPL_V1["goods_seq"]?>"><img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_list.gif'" /></a></div>
						<ul class="sub">
