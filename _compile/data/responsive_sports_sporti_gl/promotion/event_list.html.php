<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/promotion/event_list.html 000008249 */  $this->include_("showDesignBanner");
...
<?php if($TPL_V1["joincheck_seq"]){?>
						<p class="no_image_event"><img src="/data/skin/responsive_sports_sporti_gl/images/design/no_images_stamp.png" alt="출석체크 이벤트" /></p>
<?php }elseif($TPL_V1["gift_seq"]){?>
						<p class="no_image_event"><img src="/data/skin/responsive_sports_sporti_gl/images/design/no_images_gift.png" alt="사은품 이벤트" /></p>
<?php }elseif($TPL_V1["event_seq"]){?>
						<p class="no_image_event"><img src="/data/skin/responsive_sports_sporti_gl/images/design/no_images_promotion.png" alt="할인/기획전 이벤트" /></p>
<?php }else{?>
						<img class="none" src="/data/skin/responsive_sports_sporti_gl/images/design/noimg_thumb.gif" alt="이미지 준비중입니다" />
<?php }?>
<?php }?>
