<?php /* Template_ 2.2.6 2022/06/30 13:34:41 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/promotion/event_view.html 000005066 */  $this->include_("showGoodsSearchFormLight","showDesignDisplay");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ "할인 이벤트" 리스트 페이지 @@
...
<div id="event_view_page">
	<div class="search_nav">
		...
		<a class="navi_linemap" href="/promotion/event" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL3Byb21vdGlvbi9ldmVudF92aWV3Lmh0bWw=" >이벤트</a>
...
<div class="special_promotion" style="display:none;">
	...
	<div class="resp_wrap">
	  ...
	  <div class="show_display_col4" data-effect="scale">
	    <?php echo showDesignDisplay( 10375)?>
	...
	<div class="resp_wrap">
	  ...
	  <div class="show_display_col4" data-effect="scale">
	    <?php echo showDesignDisplay( 10376)?>
