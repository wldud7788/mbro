<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/popup/zipcode.html 000031281 */ 
...
<?php if($TPL_VAR["page"]["first"]){?><a href="javascript:getZipcodeResultgo('<?php echo $TPL_VAR["zipcode_type"]?>','<?php echo $TPL_VAR["page"]["first"]?>');" class="first"></a><?php }?>
<?php if($TPL_VAR["page"]["prev"]){?><a href="javascript:getZipcodeResultgo('<?php echo $TPL_VAR["zipcode_type"]?>','<?php echo $TPL_VAR["page"]["prev"]?>');" class="prev"></a><?php }?>
<?php if(is_array($TPL_R1=$TPL_VAR["page"]["page"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
<?php if($TPL_VAR["page"]["nowpage"]==$TPL_V1){?>
				<a href="javascript:getZipcodeResultgo('<?php echo $TPL_VAR["zipcode_type"]?>','<?php echo $TPL_V1?>');" class="on"><b><?php echo $TPL_V1?></b></a>
<?php }else{?>
				<a href="javascript:getZipcodeResultgo('<?php echo $TPL_VAR["zipcode_type"]?>','<?php echo $TPL_V1?>');"><?php echo $TPL_V1?></a>
<?php }?>
<?php }}?>
<?php if($TPL_VAR["page"]["next"]){?><a href="javascript:getZipcodeResultgo('<?php echo $TPL_VAR["zipcode_type"]?>','<?php echo $TPL_VAR["page"]["next"]?>');" class="next"></a><?php }?>
<?php if($TPL_VAR["page"]["last"]){?><a href="javascript:getZipcodeResultgo('<?php echo $TPL_VAR["zipcode_type"]?>','<?php echo $TPL_VAR["page"]["last"]?>');" class="last"></a><?php }?>
	</div>
<?php }?>
</div>