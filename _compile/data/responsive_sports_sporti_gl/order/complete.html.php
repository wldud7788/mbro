<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/order/complete.html 000033733 */ 
...
<div class="subpage_wrap">
	<div class="subpage_container v3 Pb10">
		...
		<div class="title_container">
			<a class="btn_history back" href="javascript:history.back();"><img src="/data/skin/responsive_sports_sporti_gl/images/design/arw_prev.gif" alt="히스토리 뒤로" /></a>
...
<?php }?>
			<a class="btn_history forward" href="javascript:history.forward();"><img src="/data/skin/responsive_sports_sporti_gl/images/design/arw_next.gif" alt="히스토리 앞으로" /></a>
		</div>
...
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?>
														<a href="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" title="다운로드"><img src="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" class="inputed_img" alt="" /></a>
<?php }else{?>
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?>
...
<div class="Pb60 C">
	<a href="/mypage/order_view?no=<?php echo $TPL_VAR["orders"]["order_seq"]?>" class="btn_resp size_c color2"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >MY페이지 주문내역</span></a>
	<a href="/" class="btn_resp size_c color5"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >쇼핑 계속하기</span></a>
</div>
