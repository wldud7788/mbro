<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/order/settle.html 000086036 */  $this->include_("showNaverMileageButton","sslAction");
						...
						<div class="cart_goods_detail">
							...
							<div class="cgd_contents">
								<div class="block block1">
									<ul>
										<li class="img_area">
											<a href="../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>"><img src="<?php echo $TPL_V2["image"]?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_list.gif'" /></a>
										</li>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
												<img src="/data/skin/responsive_sports_sporti_gl/images/common/auth_img.png" alt="성인" class="icon1" />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
												<img src="/data/skin/responsive_sports_sporti_gl/images/common/plane.png" alt="해외배송상품" class="icon2" />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
												<img src="/data/skin/responsive_sports_sporti_gl/images/common/nocancellation.gif" alt="청약철회" class="icon3" />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
												<img src="/data/skin/responsive_sports_sporti_gl/images/common/taxfree.gif" alt="비과세" class="icon4" />
<?php }?>
											</div>
<?php }?>
