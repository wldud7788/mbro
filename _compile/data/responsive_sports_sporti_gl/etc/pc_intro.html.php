<?php /* Template_ 2.2.6 2022/05/11 13:26:36 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/etc/pc_intro.html 000018434 */  $this->include_("defaultScriptFunc");?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="top_wrap">
    <div class="store_box">
        <div class="title_box">
            <h2>글로벌 K-POP 놀이터</h2>
            <img src="/data/skin/responsive_sports_sporti_gl/images/logo2.png" alt="">
        ...
        <div class="store_btn_box">
            <a href="https://play.google.com/store/apps/details?id=com.musicbrother.app" target="_">
                <img src="/data/skin/responsive_sports_sporti_gl/images/google_store.png" alt="">
            </a>
            <a href="https://apps.apple.com/us/app/%EB%AE%A4%EC%A7%81%EB%B8%8C%EB%A1%9C-musicbro/id1537070798" target="_">
                <img src="/data/skin/responsive_sports_sporti_gl/images/apple_store.png" alt="">
            </a>
        </div>
    </div>
</div>
...
<div class="ticket_wrap">
    ...
    <div class="pc_ticket_box">
        <p>PC + MOBILE</p>
        <img src="/data/skin/responsive_sports_sporti_gl/images/pc_ticket_img.png" alt="">
    ...
    <div class="mobile_ticket_box">
        <p>MOBILE</p>
        <img src="/data/skin/responsive_sports_sporti_gl/images/mobile_ticket_img.png" alt="">
        <div class="ticket_price_box">
            <!-- <div class="ticket_price_div">
                <p>기간(30일) 이용권</p>
                <p>7400원</p>
...
<div class="music_wrap">
    ...
    <div class="img_box">
        <img src="/data/skin/responsive_sports_sporti_gl/images/music_img.png" alt="">
    </div>
    <!-- <div class="long_banner_box">
        <img src="/data/skin/responsive_sports_sporti_gl/images/long_banner.png" alt="">
    </div> -->
    <div class="banner_list_box">
        ...
        <div class="banner">
            <ul>
                <li><img src="/data/skin/responsive_sports_sporti_gl/images/top_banner_list01.png" width="270" height="185px"></li>
                <li><img src="/data/skin/responsive_sports_sporti_gl/images/top_banner_list02.png" width="270" height="185px"></li>
                <li><img src="/data/skin/responsive_sports_sporti_gl/images/top_banner_list03.png" width="270" height="185px"></li>
                <li><img src="/data/skin/responsive_sports_sporti_gl/images/top_banner_list04.png" width="270" height="185px"></li>
                <li><img src="/data/skin/responsive_sports_sporti_gl/images/top_banner_list05.png" width="270" height="185px"></li>
            </ul>
        </div>
    </div>
...
<div class="audition_wrap">
    ...
    <div class="img_box">
        ...
        <img src="/data/skin/responsive_sports_sporti_gl/images/audition_img.png" alt=""><br>
...
<div class="shopping_wrap">
    ...
    <div class="img_box">
        <img src="/data/skin/responsive_sports_sporti_gl/images/shopping_img.png" alt=""><br>
...
<div class="bmp_wrap">
    ...
    <div class="img_box">
        <img src="/data/skin/responsive_sports_sporti_gl/images/bmp_img.png" alt="" class="bmp_img"><br>
...
<div class="cha_wrap">
    ...
    <div class="container">
        <div class="carousel">
            <div class="item a">
                <img src="/data/skin/responsive_sports_sporti_gl/images/pc_int_cha01.png" alt="">
            </div>
            <div class="item b">
                <img src="/data/skin/responsive_sports_sporti_gl/images/pc_int_cha02.png" alt="">
            </div>
            <div class="item c">
                <img src="/data/skin/responsive_sports_sporti_gl/images/pc_int_cha03.png" alt="">
            </div>
            <div class="item d">
                <img src="/data/skin/responsive_sports_sporti_gl/images/pc_int_cha04.png" alt="">
            </div>
            <div class="item e">
                <img src="/data/skin/responsive_sports_sporti_gl/images/pc_int_cha05.png" alt="">
            </div>
            <div class="item f">
                <img src="/data/skin/responsive_sports_sporti_gl/images/pc_int_cha06.png" alt="">
            </div>
        </div>
    </div>
