<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/_modules/display/goods_display_person.html 000001775 */ 
...
<div class="personal_item" onclick="document.location.href='/order/settle?person_seq=<?php echo $TPL_V1["person_seq"]?>&member_seq=<?php echo $TPL_V1["member_seq"]?>'">
	<div class="pi_icon"><img src="/data/skin/responsive_sports_sporti_gl/images/common/prv_pay.png" width="39" height="39" /></div>
	<div class="pi_arrow"><img src="/data/skin/responsive_sports_sporti_gl/images/common/arrow.png" width="12" height="21" /></div>
