<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/_modules/lastest/display_lattice_a.html 000004107 */ ?>
...
<div class='designDisplay <?php echo $TPL_VAR["lastest_key"]?>' designElement='displaylastest'  id="<?php echo $TPL_VAR["lastest_key"]?>" templatePath='<?php echo $TPL_VAR["template_path"]?>' >
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td valign="bottom" align="right"><b><a href="/board/?id=<?php echo $TPL_VAR["recent"]["boardId"]?>"><img src="/data/skin/responsive_sports_sporti_gl/images/design/cscenter_btn_more.gif" /></a></b></td>
		</tr>
	</table>
	</div>
