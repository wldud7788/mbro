<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/_modules/common/scroll_right.html 000007801 */  $this->include_("dataGoodsToday");
...
<?php if($TPL_VAR["isplusfreenot"]){?><li><a href="/board/?id=bulkorder" designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL19tb2R1bGVzL2NvbW1vbi9zY3JvbGxfcmlnaHQuaHRtbA==" >BULKORDER</a></li><?php }?>
        </ul>
        <!-- //회사 링크 -->
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_web_quick"]=='Y'){?>
		<a href="javascript:;" class="btn_navertalk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?>', 'talktalk', 'width=471, height=640');return false;"><img src="/data/skin/responsive_sports_sporti_gl/images/icon/icon_talk.png" alt="네이버 톡톡" />&nbsp; 톡톡</a>
		<!-- //네이버 톡톡 연동 -->
<?php }?>
	</div>
</div>
