<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/goods_review/_goods_review/write.html 000031528 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["reserves"]["autoemoney"]== 1&&$TPL_VAR["reserves"]["autoemoneytype"]!= 3&&$TPL_VAR["reserves"]["autoemoneytitle"]){?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >구매자(회원)가 작성한</span><br /><?php }?>
<?php if($TPL_VAR["reserves"]["autoemoney_video"]> 0||$TPL_VAR["reserves"]["autopoint_video"]> 0){?><span class="gray_04" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >동영상 상품후기는</span>
...
<?php if($TPL_VAR["reserves"]["autoemoney_photo"]> 0||$TPL_VAR["reserves"]["autopoint_photo"]> 0){?><span class="gray_04" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >포토 상품후기는</span>
<?php if($TPL_VAR["reserves"]["autoemoneytype"]!= 1&&($TPL_VAR["reserves"]["autoemoneystrcut1"]> 0||$TPL_VAR["reserves"]["autoemoneystrcut2"]> 0)){?>
			<span class="gray_05">(
<?php if($TPL_VAR["reserves"]["autoemoneytype"]== 2&&$TPL_VAR["reserves"]["autoemoneystrcut1"]> 0){?>
				<?php echo number_format($TPL_VAR["reserves"]["autoemoneystrcut1"])?>
...
<?php if($TPL_VAR["reserves"]["autoemoney_review"]> 0||$TPL_VAR["reserves"]["autopoint_review"]> 0){?><span class="gray_04" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >일반 상품후기는</span>
<?php if($TPL_VAR["reserves"]["autoemoneytype"]!= 1&&($TPL_VAR["reserves"]["autoemoneystrcut1"]> 0||$TPL_VAR["reserves"]["autoemoneystrcut2"]> 0)){?>
			<span class="gray_05">(
<?php if($TPL_VAR["reserves"]["autoemoneytype"]== 2&&$TPL_VAR["reserves"]["autoemoneystrcut1"]> 0){?>
				<?php echo number_format($TPL_VAR["reserves"]["autoemoneystrcut1"])?>
...
<?php if($TPL_VAR["categorylist"]){?>
		<tr>
			<th><p designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >분류</p></th>
			<td>
...
<?php }?>
		<tr>
			<th><p designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >작성자</p></th>
			<td>
...
<?php }?>
				<span class="<?php echo $TPL_VAR["hiddenlay"]?>"><input type="checkbox" name="hidden" id="hidden"  value="1" <?php echo $TPL_VAR["hiddenckeck"]?> /><label for="hidden" > <span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >비밀글</span></label></span>
...
<?php if(!$TPL_VAR["pw"]){?>
		<tr>
			<th><p designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >비밀번호</p></th>
			<td>
...
<?php }?>
		<tr>
			<th><p designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >답변받기</p></th>
			<td>
...
<?php if($TPL_VAR["manager"]["sms_reply_user_yn"]=='Y'){?>
					<li>
						...
						<label class="Dib"><input type="checkbox" name="board_sms" id="board_sms" value="1" <?php if(($TPL_VAR["seq"]&&$TPL_VAR["rsms"]=='Y')||(!$TPL_VAR["seq"]&&($TPL_VAR["tel1"]||$TPL_VAR["tel2"]))){?> checked="checked" <?php }?> /> <span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >SMS받기</span></label>
					</li>
<?php }?>
					<li>
						<input type="text" name="email" id="email" value="<?php echo $TPL_VAR["email"]?>" class="size_mail" title="이메일주소를 입력" />
						<label class="Dib"><input type="checkbox" name="board_email" id="board_email" value="1"  <?php if(($TPL_VAR["seq"]&&$TPL_VAR["remail"]=='Y')||(!$TPL_VAR["seq"]&&$TPL_VAR["email"])){?> checked="checked" <?php }?>/> <span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >메일받기</span></label>
					</li>
				</ul>
			</td>
		</tr>
		...
		<tr>
			<th><p designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >후기상품</p></th>
			<td class="Pt0">
				<!-- 상품선택 & 선택된 상품 -->
...
<?php if(!$TPL_VAR["displayGoods"]){?>
						<button type="button" id="issueGoodsButton" class="btn_resp size_b color2"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >상품 선택</span></button>&nbsp;
<?php }?>
<?php if(defined('__ISUSER__')){?>
						<select id="ordergoodslist"  name="ordergoodslist" class="Ls-1 hide">
							<option value="">선택하세요!</option>
						</select>&nbsp;
						<span id="orderbtnlay" class="res_st_desc"><?php if(!$_GET["goods_seq"]&&!$TPL_VAR["seq"]){?><span class="pointcolor" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >상품을 먼저 선택하세요.</span><?php }?></span>
<?php }else{?>
						<span id="orderbtnlay"><button type="button" id="OrderauthButton" class="btn_resp size_b"><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >주문조회하기</span></button></span>
						<div class="hide" id="nonemblay" >
							<select id="ordergoodslist"  name="ordergoodslist" class="Ls-1 hide">
								<option value="">선택하세요!</option>
							</select>&nbsp;
							<span id="ordertxtlay" class="res_st_desc"><?php if(!$_GET["goods_seq"]&&!$TPL_VAR["seq"]){?><span class="pointcolor" designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >상품을 먼저 선택하세요.</span><?php }?></span>
						</div>
<?php }?>
					</div>
<?php }?>
...
<?php if(!$TPL_VAR["isplusfreenot"]){?>
		<tr>
			<th><p designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >평점</p></th>
			<td>
...
<?php }?>
		<tr>
			<th><p designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >제목</p></th>
			<td>
...
<?php }?>
		...
		<button type="button" class="data_save_btn btn_resp size_c color2"><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >저장</span></button>
		<button type="button" class="btn_resp size_c" onclick="<?php if($_GET["popup"]&&!$_GET["iframe"]){?>self.close();<?php }else{?>document.location.href='<?php echo $TPL_VAR["boardurl"]->lists?>';<?php }?>"><span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L3dyaXRlLmh0bWw=" >취소</span></button>
	</div>
