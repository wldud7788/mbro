<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/bulkorder/_bulkorder/write.html 000020783 */  $this->include_("sslAction");
...
<?php }?>
	...
	<div class="resp_bulk_table">
		<ul>
			<li class="th"><p designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >문의등록자</p></li>
			<li class="td">
...
<?php if(!$TPL_VAR["pw"]){?>
		<ul>
			<li class="th"><p designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >비밀번호</p></li>
			<li class="td">
...
<?php if($TPL_VAR["categorylist"]){?>
		<ul class="required">
			<li class="th"><p designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >분류</p></li>
			<li class="td">
...
<?php if(strstr($TPL_VAR["manager"]["bulk_show"],'[goods]')){?>
		<ul>
			<li class="th"><p designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >(희망)구매요청상품</p></li>
			<li class="td">
<?php if(!$_GET["goods_seq"]){?><button type="button" id="issueGoodsButton" class="btn_resp size_b color2"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >상품 선택</span></button>&nbsp;<?php }?>
				<span class="Dib desc pd_2" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >* 상품을 선택하신 후 옵션명과 수량을 아래 입력칸에 입력하세요</span>
...
<?php if(strstr($TPL_VAR["manager"]["bulk_show"],'[goods]')&&$TPL_VAR["manager"]["bulk_totprice"]){?>
		<ul>
			<li class="th"><p designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >요청금액</p></li>
			<li class="td">
				<input type="text" name="total_price" id="total_price" value="<?php if($TPL_VAR["total_price"]> 0){?><?php echo $TPL_VAR["total_price"]?><?php }?>" title="희망 구매가격 입력" /> <span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >원</span>
			</li>
		</ul>
<?php }?>
<?php if(strstr($TPL_VAR["manager"]["bulk_show"],'[payment]')){?>
		<ul>
			<li class="th"><p designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >(희망)결제수단</p></li>
			<li class="td label_group2">
				<label><input type="radio" name="payment" value="bank" checked="checked" /> <span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >무통장</span></label>
<?php if($TPL_VAR["manager"]["bulk_payment_type"]=='all'){?>
<?php if($TPL_VAR["payment"]["card"]){?>
					<label><input type="radio" name="payment" value="card" <?php if($TPL_VAR["payment"]=='card'){?>checked="checked"<?php }?> /> <span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >카드결제</span></label>
<?php }?>
<?php if($TPL_VAR["payment"]["account"]){?>
					<label><input type="radio" name="payment" value="account" <?php if($TPL_VAR["payment"]=='account'){?>checked="checked"<?php }?> /> <span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >실시간계좌이체</span></label>
<?php }?>
<?php if($TPL_VAR["payment"]["cellphone"]){?>
					<label><input type="radio" name="payment" value="cellphone" <?php if($TPL_VAR["payment"]=='cellphone'){?>checked="checked"<?php }?> /> <span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >핸드폰결제</span></label>
<?php }?>
<?php if($TPL_VAR["payment"]["virtual"]){?>
					<label><input type="radio" name="payment" value="virtual" <?php if($TPL_VAR["payment"]=='virtual'){?>checked="checked"<?php }?> /> <span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >가상계좌</span></label>
<?php }?>
<?php }?>
			</li>
		</ul>
...
<?php if(strstr($TPL_VAR["manager"]["bulk_show"],'[typereceipt]')){?>
		<ul>
			<li class="th"><p designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >(희망)매출증빙자료</p></li>
			<li class="td label_group2">
				<label><input type="radio" name="typereceipt" id="typereceipt0" value="0" checked="checked"> <span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >발급안함</span></label>
<?php if($TPL_VAR["cfg"]["order"]["cashreceiptuse"]> 0){?>
				<label><input type="radio" name="typereceipt" id="typereceipt2" value="2" <?php if($TPL_VAR["typereceipt"]== 2){?>checked="checked"<?php }?>> <span designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >현금영수증</span></label>
<?php }?>
<?php if($TPL_VAR["cfg"]["order"]["taxuse"]> 0){?>
				<label><input type="radio" name="typereceipt" id="typereceipt1" value="1" <?php if($TPL_VAR["typereceipt"]== 1){?>checked="checked"<?php }?>> <span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >세금계산서</span></label>
<?php }?>
			</li>
		</ul>
<?php }?>
		<ul>
			<li class="th"><p designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >답변받기</p></li>
			<li class="td">
...
<?php if($TPL_VAR["manager"]["sms_reply_user_yn"]=='Y'){?>
					<li>
						...
						<label class="Dib"><input type="checkbox" name="board_sms" id="board_sms" value="1" <?php if(($TPL_VAR["seq"]&&$TPL_VAR["rsms"]=='Y')||(!$TPL_VAR["seq"]&&($TPL_VAR["tel1"]||$TPL_VAR["tel2"]))){?> checked="checked" <?php }?> /> <span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >SMS받기</span></label>
					</li>
<?php }?>
					<li>
						<input type="text" name="email" id="email" value="<?php echo $TPL_VAR["email"]?>" class="size_mail" title="이메일주소 입력" />
						<label class="Dib"><input type="checkbox" name="board_email" id="board_email" value="1"  <?php if(($TPL_VAR["seq"]&&$TPL_VAR["remail"]=='Y')||(!$TPL_VAR["seq"]&&$TPL_VAR["email"])){?> checked="checked" <?php }?>/> <span designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >메일받기</span></label>
					</li>
				</ul>
			</li>
		</ul>
		<ul class="required">
			<li class="th"><p designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >제목</p></li>
			<li class="td">
...
<?php if(!defined('__ISUSER__')){?>
	<div class="label_group Pt20">
		<label><input type="radio" name="agree" value="Y" /> <span designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >개인정보 수집ㆍ이용에 동의합니다.</span></label>&nbsp;&nbsp;&nbsp;
		<label><input type="radio" name="agree" value="N" checked /> <span designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >개인정보 수집ㆍ이용에 동의하지 않습니다.</span></label>
		<textarea class="size1 Mt5" readonly><?php echo $TPL_VAR["policy"]?></textarea>
	</div>
<?php }?>

	<div class="board_detail_btns2">
		<button type="button" name="data_save_btn" id="data_save_btn" class="data_save_btn btn_resp size_c color2"><span designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >확인</span></button>
		<button type="button" class="btn_resp size_c" onclick="<?php if($_GET["popup"]){?>self.close();<?php }else{?>document.location.href='<?php echo $TPL_VAR["boardurl"]->lists?>';<?php }?>"><span designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2J1bGtvcmRlci9fYnVsa29yZGVyL3dyaXRlLmh0bWw=" >취소</span></button>
	</div>
