<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/_mobile_file.html 000003258 */ 
...
<tr>
	<th class="width_a"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL19tb2JpbGVfZmlsZS5odG1s" >첨부파일을</span></th>
	<td>
...
<?php if($TPL_VAR["manager"]["file_use"]=='Y'){?>
				<tr>
					<td>
						...
						<div class="pdt5">
							<button type="button" class="btnUploader btn_resp size_b"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL19tb2JpbGVfZmlsZS5odG1s" >+ 파일 추가</span></button>
						</div>
					</td>
				</tr>
<?php }?>
