<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/broadcast/schedule.html 000010725 */ 
...
<?php }elseif($TPL_V1["status"]=='live'){?>
							<img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_live.png" class="live_mode">
...
<?php if($TPL_V1["status"]=='live'){?>
							<span class="view_count"><img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_view.png"/><?php echo $TPL_V1["sumvisitors"]?></span>
							<span class="like_count"><img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_heart.png"/><?php echo $TPL_V1["likes"]?></span>
<?php }?>
...
<?php }else{?>				
				<div class="nodata_wrap">		
					<img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_nodata.png">
...
<?php if($TPL_V2["status"]=='end'){?>
							<span class="view_count"><img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_view.png"/><?php echo $TPL_V2["sumvisitors"]?></span>
							<span class="like_count"><img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_heart.png"/><?php echo $TPL_V2["likes"]?></span>
<?php }elseif($TPL_V2["status"]=='live'){?>
							<div class="like_count"><img src="/data/skin/responsive_sports_sporti_gl/images/broadcast/i_heart.png"/><?php echo $TPL_V2["likes"]?></div>
<?php }?>
<?php if(serviceLimit('H_AD')){?>
