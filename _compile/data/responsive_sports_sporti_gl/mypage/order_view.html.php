<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/order_view.html 000129570 */ 
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_sports_sporti_gl/images/common/auth_img.png" height="17" alt="성인" />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_sports_sporti_gl/images/common/plane.png" height="14" alt="해외배송상품" />
<?php }?>
							</div>
...
<div id="coupon_use_guide" class="hide">
	<table class="coupon_use_guide_tb" cellpadding="0" cellspacing="0" border="0">
		...
		<tr><td class="guide_img"><img src="/data/skin/responsive_sports_sporti_gl/images/design/guide_img_cpn.jpg" /></td></tr>
