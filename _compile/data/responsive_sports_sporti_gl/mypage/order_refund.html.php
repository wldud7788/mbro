<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/order_refund.html 000014693 */ 
...
<?php }?>
					...
					<li class="subject">
						<ul class="board_goods_list">
							<li class="pic">
								<img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_list.gif'" alt="<?php echo $TPL_V1["goods_name"]?>" />
							</li>
							<li class="info">
								<div class="title">
