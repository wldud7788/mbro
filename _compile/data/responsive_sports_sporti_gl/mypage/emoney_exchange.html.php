<?php /* Template_ 2.2.6 2022/03/15 17:26:03 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/emoney_exchange.html 000006552 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9lbW9uZXlfZXhjaGFuZ2UuaHRtbA==" >캐시로 사은품 교환</span></h2>
		</div>
...
<?php if($TPL_gift_loop_1){foreach($TPL_VAR["gift_loop"] as $TPL_V1){?>
			...
			<div class="gift_loop_title">
				<ul>
					<li class="title">
						<strong class="tt1">교환 캐시 <?php echo number_format($TPL_V1["sprice"])?></strong> 
...
<?php if(is_array($TPL_R2=$TPL_V1["goods"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
				<li>
					<ul class="item_detail">
						<li class="img_area"><img class="item_img" src="<?php echo get_gift_image($TPL_V2,'list1')?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif';" alt="<?php echo get_gift_name($TPL_V2)?>" /></li>
