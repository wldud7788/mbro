<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/order_catalog.html 000016663 */ 
...
<?php if($TPL_record_1){foreach($TPL_VAR["record"] as $TPL_V1){?>
			<ul class="tbody">
				...
				<li class="sjb_top order_seq"><span class="motle">주문번호 : </span><a href="order_view?no=<?php echo $TPL_V1["order_seq"]?>"><?php echo $TPL_V1["order_seq"]?></a></li>
				<li class="item_info">
