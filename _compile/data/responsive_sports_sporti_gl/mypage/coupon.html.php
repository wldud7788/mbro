<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/coupon.html 000020304 */  $this->include_("o2oFrontMypageCouponBarcode");
		...
		<div class="tab_basic size2">
			<ul>
				<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=1"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9jb3Vwb24uaHRtbA==" >보유한 쿠폰</span>(<strong class="pointcolor2"><?php echo number_format($TPL_VAR["unusedcount"])?></strong>/<?php echo number_format($TPL_VAR["totalcount"])?>)</a>
				</li>
				<li <?php if($_GET["tab"]=='2'){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=2"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9jb3Vwb24uaHRtbA==" >다운로드 가능 쿠폰</span>(<?php echo number_format($TPL_VAR["svcount"])?>)</a>
				</li>
			</ul>
		</div>
