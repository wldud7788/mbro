<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/refund_catalog.html 000004956 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9yZWZ1bmRfY2F0YWxvZy5odG1s" >취소/환불 내역</span></h2>
		</div>
...
<?php if($TPL_record_1){foreach($TPL_VAR["record"] as $TPL_V1){?>
			<ul class="tbody">
				...
				<li class="sjb_top mo_r grow" style="order:-8">
					...
					<a class="link1" href="refund_view?refund_code=<?php echo $TPL_V1["refund_code"]?>" title="상세"><?php echo $TPL_V1["refund_code"]?></a>
				</li>
...
<?php if($TPL_V1["mrefund_date"]){?><span class="motle">환불완료일:</span><?php }?>
				...
				<li style="order:1;">
					...
					<a href="/mypage/myqna_write?category=<?php echo urlencode('환불문의')?>" class="btn_resp mo_adj">문의</a>
				</li>
			</ul>
<?php }}?>
		</div>
