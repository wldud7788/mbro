<?php /* Template_ 2.2.6 2022/02/25 14:46:31 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/coin/loading.html 000003686 */  $this->include_("sslAction");?>
<style>
  .container {
...
<div class="bmp_loading_box">
    ...
    <div style="text-align: center; top: 40%; position: relative;">
      ...
      <a href="/mypage/myinfo">문자로 캐시 지급 현황을 확인 하고 싶으시면 여기를 클릭해 주세</a>
    </div>
  <div class="wait_btn_box" style="">
    <a href="<?php echo sslAction('../mypage/emoney')?>">BMP 전환 확인하기</a>
    <a href="../coin/coin_notice">이전 화면</a>
  </div>
</div>