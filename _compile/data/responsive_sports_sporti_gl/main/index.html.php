<?php /* Template_ 2.2.6 2022/09/26 16:37:35 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/main/index.html 000022104 */  $this->include_("showDesignLightPopup","showDesignBanner","showDesignDisplay","getBoarddata");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ index @@
  ...
  <div class="main_bnr_type2" style="margin-top:0px;">
      <ul data-effect="scale">
          <li style="text-align: center">
              <a href="https://musicbroshop.com/board/?id=goods_review" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/event_banner_02.png" title="" alt="" /></a>
          </li>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10388)?>
...
<div class="resp_wrap">
  ...
  <div class="main_bnr_type2" style="margin-top:0px;">
      <ul data-effect="scale">
          <li style="text-align: center">
              <a href="https://musicbroshop.com/board/?id=goods_review" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/event_banner_03.png" title="" alt="" /></a>
          </li>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10379)?>
...
<div class="resp_wrap">
  ...
  <div class="main_bnr_type2" style="margin-top:0px;">
      <ul data-effect="scale">
          <li style="text-align: center">
              <a href="https://musicbroshop.com/board/?id=goods_review" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/event_banner_04.png" title="" alt="" /></a>
          </li>
      </ul>
  </div>
</div>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10378)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10377)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10389)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10390)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10391)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10392)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10393)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10394)?>
...
<div class="resp_wrap">
  ...
  <div class="show_display_col4" data-effect="scale">
    <?php echo showDesignDisplay( 10395)?>
...
<div class="resp_wrap">
  ...
  <div class="main_bnr_type2" style="margin-top:0px;">
      <ul data-effect="scale">
          <li style="text-align: center">
              <a href="https://musicbroshop.com/board/?id=goods_review" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/event_banner_05.png" title="" alt="" /></a>
          </li>
      </ul>
  </div>
</div>
...
<div class="resp_wrap">
  ...
  <div class="main_bnr_type2" style="margin-top:0px;">
      <ul data-effect="scale">
          <li style="text-align: center">
              <a href="https://musicbroshop.com/coin/coin_notice" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/coin_sbaner.png" title="" alt="" /></a>
          </li>
...
<div class="resp_wrap main_bnr3">
  ...
  <div class="respBnrGon respBnrGon_num3_typeB">
    <ul data-effect="scale">
      <li><a href="https://www.musicbroshop.com/promotion/event_view?event=35&page=1&searchMode=event_view&per=40&sorting=ranking&filter_display=lattice" target='_self'><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/main_middle_img_20220617_01.png" title="" alt="" /></a></li>
      <li><a href="https://www.musicbroshop.com/promotion/event_view?event=36&page=1&searchMode=event_view&per=40&sorting=ranking&filter_display=lattice" target='_self'><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/main_middle_img_20220617_02.png" title="" alt="" /></a></li>
      <li><a href="https://www.musicbroshop.com/promotion/event_view?event=37&page=1&searchMode=event_view&per=40&sorting=ranking&filter_display=lattice" target='_self'><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/main_middle_img_20220617_03.png" title="" alt="" /></a></li>
      <li><a href="https://www.musicbroshop.com/promotion/event_view?event=38&page=1&searchMode=event_view&per=40&sorting=ranking&filter_display=lattice" target='_self'><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/main_middle_img_20220617_04.png" title="" alt="" /></a></li>
    </ul>
  </div>
</div>
 -->
...
<div class="main_bnr_type2">
    <ul data-effect="scale">
        <li>
            <a href="https://www.musicbroshop.com/goods/catalog?page=1&searchMode=catalog&category=c00330001&per=40&sorting=ranking&filter_display=lattice" target='_self'><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/middle_music_banner01.png" title="" alt="" /></a>
        </li>
        <li>
            <a href="https://www.musicbroshop.com/promotion/event_view?event=21&page=1&searchMode=event_view&per=40&sorting=ranking&filter_display=lattice" target='_self'><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/middle_luxury_banner01.png" title="" alt="" /></a>
        </li>
    </ul>
</div>
<!-- //2단 이미지 배너 -->
...
<div class="full_bnr" style="background-image:url('/data/skin/responsive_sports_sporti_gl/images/design_resp/bottom_img01.jpg'); display: none;">
    <ul class="text_wrap">          
        ...
        <li class="sbtn"><a href="#none" designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21haW4vaW5kZXguaHRtbA==" >read more</a></li>        
    </ul>
</div>
<!-- //패럴렉스 배너 -->
...
<div class="resp_wrap" style="display:none;"> 
  <div class="title_group1">
    <h3 class="title1"><a href="/board/?id=custom_bbs2" designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21haW4vaW5kZXguaHRtbA==" >NEW BRAND INTRODUCTION</a></h3>
  </div>
...
<div class="main_bnr_type3 respBnrGon respBnrGon_num3_typeE">
  <ul data-effect="rotate_01">
    <li><a href="https://music-brother.com" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/main_bottom_banner01.png" alt="" /></a></li>
    <li><a href="https://bravekongz.com/" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/new_bravekongz.png" alt="" /></a></li>
      <li><a href="https://bmpbrave.com/" target="_blank"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/main_bottom_banner03.png" alt="" /></a></li>
  </ul>
</div>
<!-- //3단 이미지 배너 -->
