<?php /* Template_ 2.2.6 2022/09/13 17:02:34 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/layout_header/standard.html 000028907 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #LAYOUT_HEADER @@
  ...
  <div class="resp_wrap">
    <div class="logo_wrap">
      ...
      <h1 class="logo_area">
        ...
        <a href='https://musicbroshop.com/' target='_self' style="max-width: 160px;"><img src="/data/skin/responsive_sports_sporti_gl/images/design_resp/white_logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>"></a>
      </h1>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
        <li class="user_info">
          <a href="/mypage"><?php if($TPL_VAR["userInfo"]["user_name"]){?><span class="u_name"><?php echo $TPL_VAR["userInfo"]["user_name"]?></span><?php }else{?><span class="u_id"><?php echo $TPL_VAR["userInfo"]["userid"]?></span><?php }?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >님 환영합니다!</span></a>
        </li>
        <li class="user_logout"><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >LOGOUT</a><?php }else{?><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
        <li class="user_logout"><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >LOGOUT</a></li>
<?php }else{?>
...
<?php }?>
        <li><a href="/mypage" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >MYPAGE</a></li>
        <li class="respCartArea"><a href="/order/cart"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >CART</span><span class="cart_cnt1"><?php echo $TPL_VAR["push_count_cart"]?></span></a></li>
        <li><a href="/service/cs" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >CS CENTER</a></li>
...
<!--             <li class="custom_nav_link">
  ...
  <!--                       <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" href="#"><em>SALE</em></a>
                        ...
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="https://www.musicbroshop.com/promotion/event"><em>기획전</em></a>
            </li>
            <!--<li class="custom_nav_link">
