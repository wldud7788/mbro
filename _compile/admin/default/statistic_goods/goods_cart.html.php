<?php /* Template_ 2.2.6 2022/05/17 12:37:07 /www/music_brother_firstmall_kr/admin/skin/default/statistic_goods/goods_cart.html 000018281 */ 
...
<?php $this->print_("goods_menu",$TPL_SCP,1);?>
	...
	<div class='slc-body-wrap'>
		<div class="slc-body">
			<div class="clearbox">
				<div class="item-title fl">상품통계 - 장바구니</div>
			...
			<div style="width:100%; margin:auto;">
				...
				<div id="goods_cart_list">
					<table width="100%" class="simpledata-table-style" style="margin:auto;">
						...
						<thead>
							<tr>
								<th class="top_title" colspan="4">검색 기간 내</th>
								<th class="top_title" colspan="6">해당 상품의 현재 정보</th>
							</tr>
							<tr>
								<th>순위</th>
								<th>상품</th>
...
<?php if($TPL_statlist_1){$TPL_I1=-1;foreach($TPL_VAR["statlist"] as $TPL_V1){$TPL_I1++;?>
							<tr>
								...
								<td class="rtd"><?php echo number_format($TPL_V1["goods_cnt"])?>회</td>
								<td class="rtd"><?php echo number_format($TPL_V1["goods_user_cnt"])?>명</td>
								<td class="rtd">
...
<?php if($TPL_V2["option5"]!=null){?><?php echo $TPL_V2["option5"]?> <?php }?>
								...
								<td class="rtd"><?php echo number_format($TPL_V2["option_cnt"])?>회</td>
								<td class="rtd"><?php echo number_format($TPL_V2["option_user_cnt"])?>명</td>
								<td class="rtd">
