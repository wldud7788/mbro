<?php /* Template_ 2.2.6 2022/05/17 12:37:08 /www/music_brother_firstmall_kr/admin/skin/default/statistic_goods/goods_wish.html 000016457 */ 
...
<?php $this->print_("goods_menu",$TPL_SCP,1);?>
	...
	<div class='slc-body-wrap'>
		<div class="slc-body">
			<div class="clearbox">
				<div class="item-title fl">상품통계 - 위시리스트</div>
					...
					<table width="100%" class="simpledata-table-style" style="margin:auto;">
						...
						<thead>
							<tr>
								...
								<th class="top_title" colspan="6" bgcolor="#eeeeee">해당 상품의 현재 정보</th>
							</tr>
							<tr>
								<th>순위</th>
								<th>상품</th>
						...
						<!-- <?php if($TPL_VAR["statlist"]){?> -->
							...
							<tr>
								...
								<td class="rtd"><?php echo number_format($TPL_V1["user_cnt"])?>명</td>
								<td class="rtd">
