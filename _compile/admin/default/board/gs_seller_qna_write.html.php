<?php /* Template_ 2.2.6 2020/12/01 09:20:51 /www/music_brother_firstmall_kr/admin/skin/default/board/gs_seller_qna_write.html 000017349 */ 
...
<table class="table_basic thl">
	<tbody>
		<tr>
			<th>제목</th>
			<td >
				<input type="text" name="re_subject" id="re_subject" value="<?php echo $TPL_VAR["re_subject"]?>" class="required line" size="70">
			</td>
		</tr>
		<tr>
			<th>내용</th>
