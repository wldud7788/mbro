<?php /* Template_ 2.2.6 2022/05/17 12:30:57 /www/music_brother_firstmall_kr/admin/skin/default/board/_survey.htm 000007965 */ ?>
<style>
.pointer {cursor:pointer;}
.sample  input[type="text"]{width:100%; height:39px; box-sizing: border-box}
.sample textarea, .sample select {width:100%;}
dl > dt {padding-bottom:5px; display:block;}
dl > dd > ul > li {padding-bottom:5px;}
</style>
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="legacySurveyForm">
<tr>
...
<!--텍스트 샘플 -->
<div id="textSample" class="sample hide">
	<dl>
...
<!--/텍스트 샘플 -->
<!--여러개 중 택일 샘플 -->
<div id="radioSample" class="sample hide">
	<dl>
		<dt>2000CC급 자동차 선호 색상은?</dt>
		<dd>
			<ul>
				<li><label><input type="radio" class="null"> 화이트</label></li>
				<li><label><input type="radio" class="null"> 블랙</label></li>
				<li><label><input type="radio" class="null"> 그레이</label></li>
			</ul>
		</dd>
	</dl>
</div>
<!--/여러개 중 택일 샘플 -->
<!--텍스트 박스 샘플 -->
<div id="textareaSample" class="sample hide">
	<dl>
		<dt>올 여름  강력 추천 여행지를 소개해 주세요~!!</dt>
		<dd><textarea rows="6"></textarea></dd>
	</dl>
</div>
<!--/텍스트 박스 샘플 -->
<!--체크박스 샘플 -->
<div id="checkboxSample" class="sample hide">
	<dl>
		<dt>꼭 가고 싶은 여행지? (여러 개 선택 가능)</dt>
		<dd>
			<ul>
				<li><label><input type="checkbox" name="checkbox" id="checkbox" class="null"> 세부</label></li>
				<li><label><input type="checkbox" name="checkbox" id="checkbox" class="null"> 아프리카</label></li>
				<li><label><input type="checkbox" name="checkbox" id="checkbox" class="null"> 유럽</label></li>
				<li><label><input type="checkbox" name="checkbox" id="checkbox" class="null"> 하와이</label></li>
			</ul>
		</dd>
	</dl>
</div>
<!--/체크박스 샘플 -->
<!--드롭다운 샘플 -->
<div id="selectSample" class="sample hide">
	<dl>
...
<!--/드롭다운 샘플 -->
<!--이메일 샘플 -->
<div style="width:260px; height:120px; border:1px solid #5298c6; padding:15px; position:absolute; top:298px; left:450px; background:#FFFFFF" id="emailSample" class="sample hide">
<!--타이틀 -->
...
<!--/이메일 샘플 -->
<!--댓글달기 샘플 -->
<div style="width:260px; height:120px; border:1px solid #5298c6; padding:15px; position:absolute; top:348px; left:368px; background:#FFFFFF" id="commentSample" class="sample hide">
<!--타이틀 -->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
...
<!--/댓글달기 샘플 -->
<!--생일 샘플 -->
<div style="width:260px; height:120px; border:1px solid #5298c6; padding:15px; position:absolute; top:348px; left:450px; background:#FFFFFF" id="birthSample" class="sample hide">
<!--타이틀 -->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
