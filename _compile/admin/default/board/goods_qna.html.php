<?php /* Template_ 2.2.6 2022/05/17 12:30:53 /www/music_brother_firstmall_kr/admin/skin/default/board/goods_qna.html 000008774 */ 
...
<?php if($TPL_VAR["categorylist"]){?><td class="category" nowrap><?php echo $TPL_V1["category"]?></td><?php }?>
						<td class="left" nowrap>
<?php if($TPL_V1["goods_seq"]){?><a href="/admin/goods/regist?no=<?php echo $TPL_V1["goods_seq"]?>" target="_blank">
								<span class="hand black underline"><?php if($TPL_V1["goodsInfo"]["provider_seq"]&&$TPL_V1["goodsInfo"]["provider_seq"]!='1'){?>[<?php echo $TPL_V1["goodsInfo"]["provider_name"]?>] <?php }?><?php echo getstrcut($TPL_V1["goodsInfo"]["goods_name"], 8)?></span>
							</a><?php }?>
						</td>
						<td class="left">
							<?php echo $TPL_V1["iconmobile"]?>
						...
						<td><?php echo $TPL_V1["replaybtn"]?></td>
						<td nowrap><?php echo $TPL_V1["emoneylay"]?></td>
						<td class="name"><?php echo $TPL_V1["name"]?></td>
						<td class="date"><?php echo $TPL_V1["date"]?></td>
						<td class="hit"><?php echo $TPL_V1["hit"]?></td>
						<td nowrap><?php echo $TPL_V1["modifybtn"]?></td>
