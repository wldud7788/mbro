<?php /* Template_ 2.2.6 2020/12/01 09:20:51 /www/music_brother_firstmall_kr/admin/skin/default/board/faq_write.html 000010039 */
...
<form name="writeform" id="writeform" method="post" action="../board_process" enctype="multipart/form-data" target="actionFrame">
    ...
    <?php }?>
    <input type="hidden" name="returnurl" id="returnurl" value="<?php echo $TPL_VAR["boardurl"]->lists?><?php echo $TPL_VAR["boardurl"]->querystr?>">

    <div class="content">
        <div class="item-title">게시글123</div>
        <table class="table_basic thl">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php }?>
                    <input type="text" name="subject" id="subject" value="<?php echo $TPL_VAR["subject"]?>" class="required line" size="110">
                    <label class="resp_checkbox">
                        <input type="checkbox" name="hidden" id="hidden" value="1" <?php echo $TPL_VAR["hiddenckeck"]?>>
                        <span>노출</span>
                    </label>
                </td>
            </tr>
