<?php /* Template_ 2.2.6 2022/05/17 12:30:56 /www/music_brother_firstmall_kr/admin/skin/default/board/view.html 000012374 */ 
...
<?php }?>
				...
				<!--2022.02.15 유튜브 영상 업로드 작업 by 김혜진 -->
<?php if($_GET["id"]=='video'){?>
				<tr>
					<th>유튜브 영상코드</th>
					<td>
						<?php echo $TPL_VAR["youtube"]?>
				...
				<tr>
					<th>유튜브 영상</th>
					<td colspan="3">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $TPL_VAR["youtube"]?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</td>
				</tr>
<?php }?>
