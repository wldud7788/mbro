<?php /* Template_ 2.2.6 2020/12/01 09:20:51 /www/music_brother_firstmall_kr/admin/skin/default/popup/zipcode_zone.html 000030317 */ ?>
		...
		<table class="table_basic thl mt10">		
			<tr>
				...
				<td>
					...
					<span class="btn large cyanblue"><button type="button" onclick="submit_zone();">&nbsp;&nbsp;&nbsp;적용&nbsp;&nbsp;&nbsp;</button></span></span>
				</td>
			</tr>	
			<tr>				
				<td colspan="2">
