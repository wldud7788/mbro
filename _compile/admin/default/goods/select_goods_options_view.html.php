<?php /* Template_ 2.2.6 2021/08/25 16:14:45 /www/music_brother_firstmall_kr/admin/skin/default/goods/select_goods_options_view.html 000002079 */ 
...
<?php }?>
			...
			<td class="its-td-align hand right pdr5" onclick="package_toggle_option(this);">
				<?php echo get_currency_price($TPL_V1["consumer_price"])?> → <?php echo get_currency_price($TPL_V1["price"])?>
