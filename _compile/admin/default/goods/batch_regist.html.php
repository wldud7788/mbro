<?php /* Template_ 2.2.6 2022/05/17 12:31:48 /www/music_brother_firstmall_kr/admin/skin/default/goods/batch_regist.html 000039527 */ 
...
<?php }?>
			...
			<th class="its-th-align center">
				재고에 따른 판매
				<span class="btn small whiteblue"><button type="button" onclick="<?php if(serviceLimit('H_FR')){?><?php echo serviceLimit('A1')?><?php }else{?>open_runout_setting_popup();<?php }?>">설정</button></span>
			</th>
			<td class="its-td-align left pdl5">
