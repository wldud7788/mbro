<?php /* Template_ 2.2.6 2021/08/25 16:14:44 /www/music_brother_firstmall_kr/admin/skin/default/goods/select_auto_condition.html 000027627 */ 
...
<?php }?>
	...
	<div class="item-title">타이틀</div>

	<textarea name="display_title" contentHeight="170px" class="daumeditor"></textarea>

	<div class="item-title">통계 설정</div>

	<table class="table_basic thl hide">		
		<tr>
			<th>통계 대상 기간</th>
			<td>
				<select name="month">
					<option value="1">최근 1개월</span>
					<option value="2">최근 2개월</span>
					<option value="3">최근 3개월</span>
					<option value="4">최근 4개월</span>
					<option value="5">최근 5개월</span>
					<option value="6">최근 6개월</span>
				</select>				
			</td>
		</tr>
	...
	<table class="info-table-style table_basic thl" width="100%" border="0" cellpadding="0" cellspacing="0">
		<col width="125"/>
		<col width="170"/>
