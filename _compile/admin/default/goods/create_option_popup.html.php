<?php /* Template_ 2.2.6 2021/08/25 16:14:41 /www/music_brother_firstmall_kr/admin/skin/default/goods/create_option_popup.html 000005618 */ 
...
<tr>
	...
	<th class="its-th-align center">
		옵션명
<?php if($TPL_VAR["service_code"]!='P_ADVL'){?>[특수옵션선택]<?php }?>
	</th>
	<th class="its-th-align center">
		옵션값 → ','(콤마)로 구분
	</th>
