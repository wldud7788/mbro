<?php /* Template_ 2.2.6 2022/05/17 12:31:54 /www/music_brother_firstmall_kr/admin/skin/default/goods/shipping_group_view.html 000003756 */ 
...
<?php if($TPL_V1["shipping_provider_seq"]=='1'&&$TPL_VAR["provider_seq"]> 1){?>
		위탁<br/>
<?php }?>
...
<?php if($TPL_I2== 0&&$TPL_I3== 0){?>
	<td class="its-td-align center" rowspan="<?php echo (count($TPL_V1["setting"]['korea'])+count($TPL_V1["setting"]['global']))?>">
		...
		<div style="height:5px;"></div>
		<span class="btn small valign-middle"><input name="modify_btn" onclick="window.open('../setting/shipping_group_regist?shipping_group_seq=<?php echo $TPL_V1["shipping_group_seq"]?>&provider_seq=<?php echo $TPL_V1["shipping_provider_seq"]?>');" type="button" value="상세" style="width:85px;"></span>
	</td>
<?php }?>
</tr>
<?php }}?>
