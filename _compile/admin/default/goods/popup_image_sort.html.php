<?php /* Template_ 2.2.6 2022/05/17 12:31:51 /www/music_brother_firstmall_kr/admin/skin/default/goods/popup_image_sort.html 000010244 */  $this->include_("defaultScriptFunc");
...
$(function(){
	...
	$("#saveGoodsImg").bind('click',function(){
		...
		if(goodsSeq){
			...
			$.ajax({
				type: "post",
				url: "/admin/goods_process/goods_img_sort",
				dataType : 'json',
				data: serialize,
