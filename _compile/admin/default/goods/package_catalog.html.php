<?php /* Template_ 2.2.6 2022/05/17 12:31:51 /www/music_brother_firstmall_kr/admin/skin/default/goods/package_catalog.html 000029585 */ 
...
<?php if(serviceLimit('H_FR')){?>
				<span class="btn large <?php echo serviceLimit('C1')?>"><button type="button" onclick="<?php echo serviceLimit('A1')?>">워터마크 설정</button></span>
<?php }else{?>
...
<?php if($TPL_VAR["managerInfo"]){?>
			<li><span class="icon-goods-kind-<?php echo $TPL_VAR["goods"]["goods_kind"]?>"></span><span class="btn large deepblue"><button onclick="location.href='regist?provider=base&package_yn=y';">본사매입 상품등록<span class="arrowright"></span></button></span></li>
			<li><span class="icon-goods-kind-<?php echo $TPL_VAR["goods"]["goods_kind"]?>"></span><span class="btn large red"><button onclick="location.href='regist?package_yn=y';">입점사 상품등록<span class="arrowright"></span></button></span></li>
<?php }elseif($TPL_VAR["providerInfo"]){?>
			<li><span class="icon-goods-kind-<?php echo $TPL_VAR["goods"]["goods_kind"]?>"></span><span class="btn large red"><button onclick="location.href='regist';">상품등록<span class="arrowright"></span></button></span></li>
<?php }?>
<?php }else{?>
			<li><span class="icon-goods-kind-<?php echo $TPL_VAR["goods"]["goods_kind"]?>"></span><span class="btn large red"><button onclick="location.href='regist?provider=base&package_yn=y';">상품등록<span class="arrowright"></span></button></span></li>
<?php }?>
		</ul>
	</div>
</div>
...
<?php }else{?>
	<tr class="list-row">
		<td align="center" <?php if(serviceLimit('H_AD')){?>colspan="17"<?php }else{?>colspan="16"<?php }?>>
