<?php /* Template_ 2.2.6 2022/05/17 12:31:48 /www/music_brother_firstmall_kr/admin/skin/default/goods/create_goods_options.html 000062525 */ 
...
<?php if(is_array($TPL_R2=$TPL_V1["goodsoptionloop"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
					<span class="goodsoption_<?php echo $TPL_V2["codeform_seq"]?> goodsoptionsublay <?php if((($TPL_V1["code_seq"]!=$TPL_V2["codeform_seq"]&&strstr($TPL_V1["type"],'goodsoption_'))||(!strstr($TPL_V1["type"],'goodsoption_')))){?>hide<?php }?> "><span class="btn small black"><button type="button" class="<?php echo $TPL_V2["label_type"]?>btn" onclick="goodsOptionBtn(this);" layerid="<?php echo $TPL_V2["label_type"]?><?php echo $TPL_V2["codeform_seq"]?>_lay" label_type="<?php echo $TPL_V2["label_type"]?>"  codeform_seq="<?php echo $TPL_V2["codeform_seq"]?>" label_title="<?php echo $TPL_V2["label_title"]?>"  label_newtype="<?php echo $TPL_V2["label_newtype"]?>"  label_color="<?php echo $TPL_V2["label_color"]?>" label_zipcode="<?php echo $TPL_V2["label_zipcode"]?>"  label_address_type="<?php echo $TPL_V2["label_address_type"]?>"  label_address="<?php echo $TPL_V2["label_address"]?>"  label_address_street="<?php echo $TPL_V2["label_address_street"]?>"  label_addressdetail="<?php echo $TPL_V2["label_addressdetail"]?>" label_biztel="<?php echo $TPL_V2["label_biztel"]?>" label_address_commission="<?php echo $TPL_V2["label_address_commission"]?>"  label_codedate="<?php echo $TPL_V2["label_codedate"]?>"  label_sdayinput="<?php echo $TPL_V2["label_sdayinput"]?>" label_fdayinput="<?php echo $TPL_V2["label_fdayinput"]?>" label_dayauto_type="<?php echo $TPL_V2["label_dayauto_type"]?>" label_sdayauto="<?php echo $TPL_V2["label_sdayauto"]?>" label_fdayauto="<?php echo $TPL_V2["label_fdayauto"]?>" label_dayauto_day="<?php echo $TPL_V2["label_dayauto_day"]?>" >선택</button></span></span>
<?php }}?>
				</span>
			...
			<td class="its-td-align center">
				<input type="text" name="optionMakePrice[]" class="line" size="25" value="<?php echo $TPL_V1["price"]?>"  title="예) 0,0,0" />
			</td>
		</tr>
<?php }}?>
<?php }else{?>
...
<?php }}?>
			...
			<td class="its-td-align center">
				<input type="text" name="optionMakePrice[]" class="line" size="25" value="" title="예) 0,0,0" />
			</td>
		</tr>
<?php }?>
	</tbody>
