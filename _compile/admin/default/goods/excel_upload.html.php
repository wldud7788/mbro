...
<div class="upload-form">
	...
	<div class="notice">[주의] 최초 상품 등록<?php if(serviceLimit('H_AD')){?>(모든 입점사 포함)<?php }?> 이후부터는 기준 통화를 변경할 수 없습니다.</div>
...
<div class="upload-notice">
	<div class="item-title red">
		...
		<span class="btn small cyanblue"><button type="button" onclick="download_sample();">설명용 샘플파일 다운로드(실물-Admin)</button></span>
	</div>
	...
	<tr>
		<td>
			...
			<div>4. 업로드 파일로 추가옵션 정보를 수정하고자 할 때 조건 (추가옵션 정보를 수정할 필요가 없으면 <?php echo count($TPL_VAR["suboptions"])?>개의 열을 모두 없애십시오)</div>
			...
			<div>- 조건2)</div>
			<div style="margin-left:13px;">추가옵션명의 행 수 = 추가옵션값의 행 수 = 추가옵션수수료의 행 수 = 추가옵션매입가의 행 수 = 추가옵션정가의 행 수 = 추가옵션할인가(판매가)의 행 수 = 추가옵션 캐시의 행 수</div>
			<br style="line-height:20px;" />
			...
			<div>6. 본사 상품인 경우 매입가만 입력되며 입점사 상품의 경우 정산 기준에 따라 수수료 기준은 수수료가 공급가기준은 공급가가 입력됩니다. 입점사 상품의 경우 수수료와 공급가를 입력하지 않으면 해당 입점사의 기본 설정값이 입력됩니다.</div>
			<br style="line-height:20px;" />

			<div>7. 입점사 상품은 상품 승인 상태 변경시 입점사 판매상품은 정산금액(수수료,공급가)을, 본사 상품은 매입금액과 판매금액 확인해 주셔서 역마진이 없도록 주의해 주십시오.</div>
			<br style="line-height:20px;" />
		</td>
	</tr>
	</tbody>
