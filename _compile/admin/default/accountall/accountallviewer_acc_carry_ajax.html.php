<?php /* Template_ 2.2.6 2022/05/17 12:30:47 /www/music_brother_firstmall_kr/admin/skin/default/accountall/accountallviewer_acc_carry_ajax.html 000014019 */ 
...
<?php if($TPL_V1["out_ac_acc_status"]=='no_acc'){?>
						<td class=" <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_no_acc_bg cal_left">
						<!-- 정산수량 --></td>
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_no_acc_bg">
						<!-- 정산대상금액 --></td>
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_no_acc_bg">
						<!-- 정산대상-결제금액 --></td>
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_no_acc_bg">
						...
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_no_acc_bg cal_right">
						<!-- 정산금액(B) -->
						</td>
<?php }elseif($TPL_V1["out_ac_acc_status"]=='ing_acc'){?>
						<td class=" <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg cal_left">-
						<!-- 정산수량 --></td>
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg">-
						<!-- 정산대상(수수료방식) --></td>
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg">-
						<!-- 정산대상(수수료방식)-결제금액 --></td>
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg">-
						...
						<td class="right <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg cal_right">-
						<!-- 정산금액(B) -->
						</td>
<?php }else{?>
						<td class="center <?php if($TPL_V1["ac_type"]=='cal_sales'){?> its_tr_carryover_not <?php }?>  <?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg cal_left"><?php echo $TPL_V1["out_exp_ea"]?>

						<!-- 정산수량 --></td>
						<td class="<?php if($TPL_V1["ac_type"]=='cal_sales'){?> its_tr_carryover_not <?php }?>  right fwbd <?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg"><?php if(($TPL_V1["minus_sale"]=='1')&&$TPL_V1["out_total_ac_price"]> 0){?>-<?php }?><?php echo number_format($TPL_V1["out_total_ac_price"])?>

						<!-- 정산대상(수수료방식) --></td>
						<td class="<?php if($TPL_V1["ac_type"]=='cal_sales'){?> its_tr_carryover_not <?php }?>  right  <?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg"><?php if(($TPL_V1["minus_sale"]=='1')&&$TPL_V1["out_pg_default_price"]> 0){?>-<?php }?><?php echo number_format($TPL_V1["out_pg_default_price"])?>

						<!-- 정산대상(수수료방식)-결제금액 --></td>
						<td class="<?php if($TPL_V1["ac_type"]=='cal_sales'){?> its_tr_carryover_not <?php }?>  right  <?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg">
...
<?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> 
							cal_bg
							"
						>
							<span 
...
<?php }?>
						...
						<td class="<?php if($TPL_V1["ac_type"]=='cal_sales'){?> its_tr_carryover_not <?php }?>  right  <?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg" title="(<?php echo $TPL_V1["sales_unit_feeprice"]?>*<?php echo $TPL_V1["out_ea"]?>)+<?php echo $TPL_V1["sales_unit_minfee"]?>+<?php echo $TPL_V1["sales_feeprice_rest"]?>"><?php if(($TPL_V1["minus_sale"]=='1')&&($TPL_V1["out_sales_unit_feeprice"])> 0){?>-<?php }?><?php echo number_format($TPL_V1["out_sales_unit_feeprice"])?>

						<!-- 수수료 -->
						</td>
						<td class="<?php if($TPL_V1["ac_type"]=='cal_sales'){?> its_tr_carryover_not <?php }?>  right fwbd <?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> <?php if($TPL_VAR["carry_page"]== 1&&$TPL_I1== 0){?>cal_top<?php }?> cal_bg cal_right"><?php if($TPL_V1["account_type"]=='refund'){?>-<?php }?><?php echo number_format($TPL_V1["out_commission_price"])?>
