<?php /* Template_ 2.2.6 2022/05/17 12:37:19 /www/music_brother_firstmall_kr/admin/skin/default/statistic_visitor/visitor_platform.html 000005462 */ 
...
<?php $this->print_("visitor_menu",$TPL_SCP,1);?>
	...
	<div class='slc-body-wrap'>
		<div class="slc-body">		
			<div class="item-title">방문 통계 - 환경</div>
...
<?php }}?>
			...
			<div style="width:100%; margin:auto;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td align="right" valign="bottom" class="pdb10"><span class="btn small"><input type="button" value="엑셀출력" onclick="divExcelDownload('환경별_방문통계','#platform_monthly_table')" /></span></td>
					</tr>
				</table>					
