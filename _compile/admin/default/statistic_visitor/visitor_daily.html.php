<?php /* Template_ 2.2.6 2022/05/30 15:56:29 /www/music_brother_firstmall_kr/admin/skin/default/statistic_visitor/visitor_daily.html 000007812 */ ?>
...
<?php }}?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 1200px; margin:auto;">
					<tr>
						<td align="right" valign="bottom" class="pdb10"><span class="btn small"><input type="button" value="엑셀출력" onclick="divExcelDownload('일별_방문자_달력','#visitor_daily_calendar')" /></span></td>
					</tr>
				</table>				
				<div id="visitor_daily_calendar" style="max-width: 1200px; margin:auto;">
<?php $this->print_("visitor_daily_calendar",$TPL_SCP,1);?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td align="right" valign="bottom" class="pdb10"><span class="btn small"><input type="button" value="엑셀출력" onclick="divExcelDownload('일별_방문자수','#visitor_daily_table')" /></span></td>
					</tr>
				</table>				
				<div id="visitor_daily_table" style="max-width: 1200px; margin:auto;">
<?php $this->print_("visitor_daily_table",$TPL_SCP,1);?>
