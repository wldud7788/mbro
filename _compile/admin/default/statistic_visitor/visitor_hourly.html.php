<?php /* Template_ 2.2.6 2022/05/30 15:56:03 /www/music_brother_firstmall_kr/admin/skin/default/statistic_visitor/visitor_hourly.html 000008945 */ ?>
...
<?php }}?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td align="right" valign="bottom" class="pdb10"><span class="btn small"><input type="button" value="엑셀출력" onclick="divExcelDownload('시간대별_방문자수','#visitor_hourly_table')" /></span></td>
					</tr>
				</table>				
				<div id="visitor_hourly_table" style="max-width: 1200px; margin:auto;">
<?php $this->print_("visitor_hourly_table",$TPL_SCP,1);?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 1200px; margin:auto;">
					<tr>
						...
						<td align="right" valign="bottom" class="pdb10"><span class="btn small"><input type="button" value="엑셀출력" onclick="DirectExcelDownload('유입경로','visitor_referer_table', '<?php echo $_SERVER["QUERY_STRING"]?>')" /></span></td>
					</tr>
				</table>
				<div id="visitor_referer_table" style="max-width: 1200px; margin:auto;">
<?php $this->print_("visitor_referer_table",$TPL_SCP,1);?>
