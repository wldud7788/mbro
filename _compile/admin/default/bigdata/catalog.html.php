<?php /* Template_ 2.2.6 2022/05/10 14:50:42 /www/music_brother_firstmall_kr/admin/skin/default/bigdata/catalog.html 000006692 */ ?>
		...
		<div class="slc-body">
			<form name="bigdataFrm" id="bigdataFrm" method="post" action="../bigdata_process/save_config" target="actionFrame" onsubmit="return loadingStart();">
				<div id="bigdataGoodsAutoContainer" class="bigdataGoodsContainer">					
					...
					<input type='hidden' class="displayCriteriaBigdata" id="bigdataCriteria" name='bigdataCriteria' value="<?php echo $TPL_VAR["cfg_bigdata"]?>" />
					<div class="displayCriteriaBigdataDesc">
<?php if(!$TPL_VAR["cfg_bigdata"]){?>
