<?php /* Template_ 2.2.6 2020/12/01 09:20:51 /www/music_brother_firstmall_kr/admin/skin/default/member/download_write.html 000007455 */ 
...
<div class="pdl20 pdr20">
	<ul class="ul_list_01 pd0">
		<li class="wp45">
			...
			<select multiple="multiple" name="downloads_item_nouse[]" id="downloads_item_nouse" style="width: 100%; height: 300px;">
...
<?php }}?>
		...
		<li class="wp45">
			...
			<select multiple="multiple" name="downloads_item_use[]" id="downloads_item_use" style="width: 100%; height: 300px;">
