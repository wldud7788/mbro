...
<?php }else{?>
					<div class="resp_radio">
						<label><input type="radio" name="gift_gb" value="order" checked /> 사은품 증정</label>
						<label><input type="radio" name="gift_gb" value="buy" /> 사은품 교환</label>						
					</div>						
<?php }?>				
			</td>
		</tr>
...
<?php }}?>
		...
		<tr class="goods_rule_goods hide">
			...
			<td class="t_select_goods">
				<input type="button" value="상품 선택" class="resp_btn active btn_select_goods" />
...
<?php }}?>
					...
					<tr class="pricetr">
						<th>
							...
							<span class="gift_gb_buy hide">교환 캐시</span> 
...
<?php }?>
	...
	<div class="resp_message">- 사은품 교환 시 배송비 무료 (배송비 본사부담)</div>
