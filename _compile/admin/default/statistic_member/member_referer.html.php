<?php /* Template_ 2.2.6 2022/05/30 16:02:24 /www/music_brother_firstmall_kr/admin/skin/default/statistic_member/member_referer.html 000009755 */ 
	...
	<div class='slc-body-wrap'>
		<div class="slc-body">
			...
			<div style="width:100%; margin:auto;">				
				<div class="item-title">가입 통계 - 유입경로</div>				
...
<?php }}?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 1800px; margin:auto;">
					<tr>
						<td align="right" valign="bottom" class="pdb10">
							<span class="btn small orange"><input type="button" value="안내) 네이버광고 유입경로"  class="guide_naver_referer" /></span><span class="btn small"><input type="button" value="엑셀출력" onclick="divExcelDownload('유입경로_가입통계','#member_referer')" /></span>
						</td>
					</tr>
				</table>				
				<div id="member_referer" style="max-width: 1800px; margin:auto;">
