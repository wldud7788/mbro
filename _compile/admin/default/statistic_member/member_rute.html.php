<?php /* Template_ 2.2.6 2022/05/30 16:04:08 /www/music_brother_firstmall_kr/admin/skin/default/statistic_member/member_rute.html 000005304 */ 
...
<?php $this->print_("member_menu",$TPL_SCP,1);?>
	...
	<div class='slc-body-wrap'>
		<div class="slc-body">		
			<div class="item-title">가입 통계 - 가입수단</div>
...
<?php }}?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 1200px; margin:auto;">
					<tr>
						<td align="right" valign="bottom" class="pdb10"><span class="btn small"><input type="button" value="엑셀출력" onclick="divExcelDownload('가입수단별_가입통계','#rute_table')" /></span></td>
					</tr>
				</table>				
				<div id="rute_table" style="max-width: 1200px; margin:auto;">
