<?php /* Template_ 2.2.6 2022/05/17 12:37:00 /www/music_brother_firstmall_kr/admin/skin/default/setting/order.html 000025137 */ 
		...
		<table class="table_basic thl">			
			...
			<tr>
				...
				<td>						
					...
					<table id="reasonTable" class="table_basic tdc tablednd wx900">
		...
		<table class="table_basic thl">
			...
			<tr>
				...
				<td>
					...
					<table id="reasonTablecoupon" class="table_basic tdc tablednd wx900">
...
<?php }}?>
	...
	<div class="contents_dvs">
		...
		<table class="table_basic thl">
			<tr>
				...
				<td>	
					<div class="resp_radio">
						<label><input type="radio" value="y" name="autocancel"> 사용함</label>
	...
	<div class="contents_dvs">
		<div class="item-title">
			청약철회 관련방침
			<span class="tooltip_btn" onClick="showTooltip(this, '/admin/tooltip/order', '#tip9', 'sizeM')"></span>
		</div>
	</div>
	<!-- 서브메뉴 바디 : 끝 -->
</div>
