<?php /* Template_ 2.2.6 2022/01/05 11:58:50 /www/music_brother_firstmall_kr/admin/skin/default/setting/add_national_pop.html 000047651 */ 
				...
				<div class="basic_shipping_area">
					...
					<tr>
						<th class="its-th center" colspan="2">
							<select class="shipping_opt_type std_area" name="shipping_opt_type[std]" onchange="shipping_opt_type(this, []);" style="width:108px;">
...
<?php }?>
					...
					<tr>
						...
						<td class="its-td section_area_td" style="min-width:110px;">
							<div class="section_area_input hide">
								...
								<input type="text" name="section_st[std][]" value="0" class="section_st_input std_area" readonly /> <span class="section_st_unit std_area"></span>
								~
								<input type="text" name="section_ed[std][]" value="0" class="section_ed_input line std_area onlyfloat" onclick="if($(this).val()==0) $(this).val('');" onblur="section_auto_chk(this);" /> <span class="section_ed_unit"></span>
							</div>
						</td>
					...
					<tr class="last-tr-base hide">
						...
						<td class="its-td" style="min-width:110px;">
							<div class="section_area_input hide">
								<input type="hidden" name="shipping_opt_seq[std][]" value=""> 
								<input type="text" name="section_st[std][]" value="0" class="section_st_input std_area" readonly/> <span class="section_st_unit"></span>
			...
			<td class="its-td left">
				...
				<tr>
					<th class="its-th center" width="50px">
						<div class="section_area_add_btn hide">
							<span class="btn small ctrl-add-btn add-row cyanblue add_btn_area"><button class="ctrl-btn" type="button" onclick="add_price_section(this,'section');">추가</button></span>
						</div>
					</th>
					<td class="its-td section_area_td" style="min-width:110px;">
						<div class="section_area_input hide">
							<input type="hidden" name="shipping_opt_seq[add][]" value=""> 
							<input type="text" name="section_st[add][]" value="0" class="section_st_input add_area" readonly /> <span class="section_st_unit"></span>
							~
							<input type="text" name="section_ed[add][]" value="0" class="section_ed_input line add_area onlyfloat" onclick="if($(this).val()==0) $(this).val('');" onblur="section_auto_chk(this);" /> <span class="section_ed_unit"></span>
						</div>
					</td>
					<td class="its-td" width="105px">
		...
		<tr class="hop_tr">
			...
			<td class="its-td left">
				...
				<div class="hopeday_setting_area">
					<table class="table_basic" cellspacing="0" cellpadding="0" width="100%">
					<colgroup>
						<col width="130px" />
						<col />
					</colgroup>
					...
					<tr>
						...
						<td class="its-td nonpd clear">
							<table class="table_basic v3 bdr0 hope_day_tb info-tb-inner">
							<col width="120px" /><col />
							<thead>
							<tr>
								<td>매년</td>
...
<?php }?>
				...
				<div class="hop_shipping_area pdt20">
					<table class="table_basic wauto price_set_area" id="price_hop" cellspacing="0" cellpadding="0" price_type="hop">
					...
					<tr>
						...
						<td class="its-td section_area_td" style="min-width:110px;">
							...
							<div class="section_area_input hide">
								<input type="text" name="section_st[hop][]" value="0" class="section_st_input hop_area" readonly /> <span class="section_st_unit"></span>
								~
								<input type="text" name="section_ed[hop][]" value="0" class="section_ed_input line hop_area onlyfloat" onclick="if($(this).val()==0) $(this).val('');" onblur="section_auto_chk(this);" /> <span class="section_ed_unit"></span>
							</div>
						</td>
						<td class="its-td right pdr10" width="235px">
							<input type="hidden" name="shipping_cost_seq[hop][]" value="0" /> 
							<input type="text" name="shipping_cost[hop][]" value="0" class="line right shipping-cost-input hop_area onlyfloat wx50" onclick="if($(this).val()==0) $(this).val('');" disabled /> <?php echo $TPL_VAR["basic_currency_info"]['currency_symbol']?>
					...
					<tr class="last-tr-base hide">
						...
						<td class="its-td right pdr10" width="235px">
							<input type="hidden" name="shipping_cost_seq[hop][]" value="0" /> 
							<input type="text" name="shipping_cost[hop][]" value="0" class="line right shipping-cost-input hop_area onlyfloat wx50" onclick="if($(this).val()==0) $(this).val('');" /> <?php echo $TPL_VAR["basic_currency_info"]['currency_symbol']?>
...
<?php }?>
				...
				<div class="direct_store_area pdt5">
					<!-- 매장 설정부 :: START -->
					<table class="table_basic store_tb" cellspacing="0" cellpadding="0" width="99%">
					<colgroup>
						<col width="80px" />
						<col width="100px" />
						<col width="60px" />
					...
					<tr>
						...
						<th class="its-th center">해외</th>
						<th class="its-th center">주소</th>
						<th class="its-th center">전화번호</th>
						<th class="its-th center">매장의 재고수량</th>
						<th class="its-th center">상태</th>
