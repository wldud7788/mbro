<?php /* Template_ 2.2.6 2022/05/17 12:37:00 /www/music_brother_firstmall_kr/admin/skin/default/setting/pg.html 000032582 */ ?>
...
<script type="text/javascript">
	...
	function setPaySetting(){
		...
		var htmlTitle = '';
		var addHtml = '<div id="settingArgeeDiv" style="padding-top:20px;text-align:center;">설정 저장 후 반드시 결제 테스트를 진행하여 결제 이상유무를 확인하시기 바랍니다.<br/><label class="resp_checkbox"><input type="checkbox" value="Y" name="settingArgee" id="settingArgee" /> 상기 내용에 동의 합니다.</label></div></div><div id="saveBtn" class="footer"><button type="button" id="btnPaySetting" onclick="setPaymentSeeting();" class="resp_btn active size_XL" >저장</button> <button type="button" onclick="closeDialogEvent(this);" class="resp_btn v3 size_XL" >취소</button></div>';
		...
		<tr>
			<td>
				...
				<div id="virtual_info_allat" class="virtual_info" class="hide">
					<ul class="varturnl_url_contens">
						<li>
							모빌리언스 고객센터(02-3783-9990 )에 가상계좌 입금확인 URL 추가를 요청하여 주세요.
						</li>
						<li>
							가상계좌 입금 시, 퍼스트몰 관리자화면의 주문상태(주문접수→결제확인)가 자동 변경 됩니다.
						</li>
