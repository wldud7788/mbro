<?php /* Template_ 2.2.6 2020/12/01 09:20:51 /www/music_brother_firstmall_kr/admin/skin/default/setting/inicis.html 000027927 */ 
...
<?php }else{?>
					<input type="radio" class="line" name="nonActiveXUse" id="nonActiveXNot" size="40" value="N" title="웹표준 결제 사용안함" <?php if($TPL_VAR["nonActiveXUse"]==""||$TPL_VAR["nonActiveXUse"]=="N"){?> checked = "cehcked" <?php }?>/> <label for="nonActiveXNot">INIpay50</label><br/>			
					<input type="radio" class="line" name="nonActiveXUse" id="nonActiveXUse" size="40" value="Y" title="웹표준 결제 사용" <?php if($TPL_VAR["nonActiveXUse"]=="Y"){?> checked = "cehcked" <?php }?> /> <label for="nonActiveXUse">[NON-ActiveX] INIpayWebStandard</label>
<?php }?>			
			</td>
		</tr>		
		<tr>
			...
			<td class="its-td">
				...
				<div><input type="text" name="signKey" class="line" value="<?php echo $TPL_VAR["signKey"]?>" title="사인키" /></div>
				<div class="desc">
...
<?php }?>
				...
				<div style="padding-top:15px;"   <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemojs1"]?>  <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]?>  <?php }?>>					
					<div>
						<input type="text" name="iniapiKey" class="line" value="<?php echo $TPL_VAR["iniapiKey"]?>" title="INIAPI key" />
						<input type="text" name="iniapiIv" class="line" value="<?php echo $TPL_VAR["iniapiIv"]?>" title="INIAPI iv" />
					</div>
...
<?php }}?>
		...
		<tr>
			...
			<td class="its-td">
				...
				<div><input type="text" name="escrowSignKey" class="line" value="<?php echo $TPL_VAR["escrowSignKey"]?>" title="사인키" /></div>
				<div class="desc">
				여기는 [NON-ActiveX] INIpayWebStandard 에서 사용되는 사인키를 입력하여 주십시요. 사인키는 상점관리자에서 확인 하실수 있습니다.
				</div>	
				<div style="padding-top:5px;"   <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemojs1"]?>  <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]?>  <?php }?>>
...
<?php }}?>
		...
		<tr>
			...
			<td class="its-td">
				...
				<div>구매자가 <input type="text" name="mobileEscrowAccountLimit" class="line onlynumber" size="6" disabled="disabled" value="<?php echo $TPL_VAR["mobileEscrowAccountLimit"]?>" />원 이상의 금액을 결제할 때 계좌이체 에스크로 결제수단을 선택할 수 있습니다.</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="its-td">
				...
				<div>구매자가 <input type="text" name="mobileEscrowVirtualLimit" class="line onlynumber" size="6" disabled="disabled" value="<?php echo $TPL_VAR["mobileEscrowVirtualLimit"]?>"  />원 이상의 금액을 결제할 때 계좌이체 에스크로 결제수단을 선택할 수 있습니다.</div>
			</td>
		</tr>
		<tr>
			<td class="its-td">
