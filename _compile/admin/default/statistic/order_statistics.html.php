<?php /* Template_ 2.2.6 2022/05/17 12:37:05 /www/music_brother_firstmall_kr/admin/skin/default/statistic/order_statistics.html 000005361 */ ?>
...
function getMemberStatistic(type){
	...
	$.ajax({
		type: "get",
		url: "../statistic/order_referer",
		data: "referer_name="+encodeURIComponent('<?php echo $_GET["referer_name"]?>'),
...
<div class="advanced-statistic">
	...
	<tr>
		...
		<td class="head-title">
			이 주문의 유입경로 : <?php echo $_GET["referer_name"]?>

<?php if($_GET["referer_domain"]){?>
				(<?php if($_GET["referer"]){?><a href="<?php echo $_GET["referer"]?>" target="_blank"><u style="color:#0263d9;"><?php }?><?php echo $_GET["referer_domain"]?><?php if($_GET["referer"]){?></u></a><?php }?>)
<?php }?>
			<a href="/admin/statistic_sales/sales_referer" target="_blank"><img src="/admin/skin/default/images/common/btn_plus_gray.png" align="absmiddle" /></a>
		</td>
