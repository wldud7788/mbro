<?php /* Template_ 2.2.6 2022/05/17 12:31:00 /www/music_brother_firstmall_kr/admin/skin/default/category/catalog.html 000022182 */ 
$TPL_groups_1=empty($TPL_VAR["groups"])||!is_array($TPL_VAR["groups"])?0:count($TPL_VAR["groups"]);?>
<?php $this->print_("layout_header",$TPL_SCP,1);?>

<!-- 해당 페이지는 1406 패치 하면 에러남!!! by 김혜진  -->
...
<div id="page-title-bar-area">
	<div id="page-title-bar">
		...
		<ul class="page-buttons-left">
			<li><span class="btn large default"><a href="../page_manager/page_layout?cmd=category" target="_blank">상품리스트 페이지 관리</a></span></li>
		</ul>
		...
		<table width="100%" class="info-table-style">
			...
			<tr>
				<th class="its-th" id="mmenu" style="padding:6px 10px;">
					...
					<span style="float:right; padding-top:5px;">카테고리영역 디자인  <span class="helpicon" title="<?php echo $TPL_VAR["category_design_ex"]?>"></span></span>
				</th>
			</tr>
			<tr>
