<?php /* Template_ 2.2.6 2022/01/05 11:36:22 /www/music_brother_firstmall_kr/admin/skin/default/design/image_upload.html 000004322 */  $this->include_("defaultScriptFunc");?>
...
<head>
	...
	<script type="text/javascript">
		...
		var krdomain = location.protocol+'<?php echo $TPL_VAR["config_system"]["subDomain"]?>';
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			var callback	= function(res){
				var that		= this;
				var result		= eval(res);
				var mockdata	= {'division':'<?php echo $_GET["division"]?>','selector':'<?php echo $_GET["selector"]?>','idx':'<?php echo $_GET["idx"]?>', 'tmpFile' : '', 'status' : '', 'width' : '', 'height' : ''};
