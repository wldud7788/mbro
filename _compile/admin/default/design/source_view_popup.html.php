<?php /* Template_ 2.2.6 2022/05/17 12:31:39 /www/music_brother_firstmall_kr/admin/skin/default/design/source_view_popup.html 000003907 */ ?>
...
<style type="text/css">
	...
	#originalSourceTextareaContainer {position:relative; width:100%; height:470px;}
...
<body>
	...
	<col width="140" />
<?php if($TPL_VAR["tpl_desc"]){?>
	<tr>
		<td class="its-th">파일설명</th>
		<td class="its-td"><?php echo $TPL_VAR["layout_config"]["tpl_desc"]?></td>
	</tr>
<?php }?>
	<tr>
