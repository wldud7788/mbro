<?php /* Template_ 2.2.6 2022/09/15 17:42:15 /www/music_brother_firstmall_kr/selleradmin/skin/default/setting/add_national_view.html 000026234 */ 
...
<div class="item_view">
	...
	<tr class="item_tr ready_item_tr">
		<td class="center nonpd under-line" width="150px">
			...
			<input type="hidden" name="shipping_set_name" value="<?php echo htmlspecialchars($TPL_VAR["ship_set"]["shipping_set_name"])?>" />			
