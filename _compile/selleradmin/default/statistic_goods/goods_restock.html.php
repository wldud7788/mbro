<?php /* Template_ 2.2.6 2022/05/11 10:50:20 /www/music_brother_firstmall_kr/selleradmin/skin/default/statistic_goods/goods_restock.html 000006900 */ 
...
$(document).ready(function() {
	gSearchForm.init({'pageid':'goods_restock', 'sc':<?php echo $TPL_VAR["scObj"]?>});
...
<div id="page-title-bar-area">
	<div id="page-title-bar">
		...
		<!-- 타이틀 -->
		<div class="page-title"><h2>재입고 알림 통계</h2></div>
		<!-- 우측 버튼 -->
...
<div class="contents_dvs v2">
	<div class="title_dvs">
		<div class="item-title">재입고알림</div>
	...
	<div id="goods_cart_list">
		...
		<tr>
			...
			<td class="right"><?php echo number_format($TPL_V1["restock_cnt"])?>회</td>
			<td class="right">
