...
<div id="page-title-bar-area">
	<div id="page-title-bar">
		...
		<!-- 타이틀 -->
		<div class="page-title"><h2>장바구니 통계</h2></div>
		<!-- 우측 버튼 -->
...
<?php if($TPL_statlist_1){$TPL_I1=-1;foreach($TPL_VAR["statlist"] as $TPL_V1){$TPL_I1++;?>
				<tr>
					...
					<td class="right"><?php echo number_format($TPL_V1["goods_user_cnt"])?>명</td>
					<td class="right">
...
<?php if($TPL_V2["option5"]!=null){?><?php echo $TPL_V2["option5"]?> <?php }?>
					...
					<td class="right"><?php echo number_format($TPL_V2["option_cnt"])?>회</td>
					<td class="right"><?php echo number_format($TPL_V2["option_user_cnt"])?>명</td>
					<td class="right">
