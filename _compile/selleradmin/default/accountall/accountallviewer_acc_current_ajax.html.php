<?php /* Template_ 2.2.6 2022/05/17 12:28:49 /www/music_brother_firstmall_kr/selleradmin/skin/default/accountall/accountallviewer_acc_current_ajax.html 000011898 */ 
...
<?php if(($TPL_V1["minus_sale"]=='1')&&$TPL_V1["out_ac_consumer_real_price"]> 0){?>-<?php }?>
						...
						<td class="
							right
<?php if(($TPL_V1["minus_sale"]=='1')){?>red<?php }?> 
<?php if($TPL_VAR["current_page"]== 1&&$TPL_I1== 0&&!$TPL_VAR["carryoverloop"]){?>cal_top<?php }?> cal_bg
							"
						>
							<span 
<?php if(in_array($TPL_V1["commission_type"],array('SUCO','SUPR'))&&$TPL_V1["out_ac_fee_rate"]!= 0){?>
								style="color:blue;"
<?php }?>
							>
...
<?php }?>
						...
						<td title="<?php echo $TPL_V1["out_payment"]?>"><?php echo getstrcut($TPL_V1["out_payment"], 7)?></td>
					</tr>
<?php }}?>
<?php }?>
