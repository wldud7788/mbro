<?php /* Template_ 2.2.6 2022/05/17 12:29:25 /www/music_brother_firstmall_kr/selleradmin/skin/default/order/_socialcp_status_guide.html 000000996 */ 
...
<?php if($TPL_socialcp_status_loop_1){foreach($TPL_VAR["socialcp_status_loop"] as $TPL_V1){?> 
	<tr class="socialcp_status_<?php echo $TPL_V1["key"]?> socialcp_status_tr"  height="50">
