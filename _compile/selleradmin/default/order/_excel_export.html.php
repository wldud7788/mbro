<?php /* Template_ 2.2.6 2022/09/15 17:42:15 /www/music_brother_firstmall_kr/selleradmin/skin/default/order/_excel_export.html 000009054 */ ?>
<style>
...
<table class="excel-export-form-table" width="100%">
	...
	<tr>
		...
		<td>
			<table class="export-form-table" width="100%">
				...
				<tr>
					<td><input type="text" name="export_date" class="datepicker line"  maxlength="10" size="10" readonly value="<?php echo date('Y-m-d')?>"></td>
					<td>
						<div>
							실물 :
							<span class="hide">
	...
	<tr>
		<th>
		<span class="step">STEP 6.</span> 확인
		</th>
		<td>
		처리결과를 엑셀로 다운로드 받을 수 있습니다. 처리결과를 확인하십시오
		</td>
	</tr>
	-->
</table>
