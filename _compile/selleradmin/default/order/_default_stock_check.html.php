<?php /* Template_ 2.2.6 2022/05/17 12:29:24 /www/music_brother_firstmall_kr/selleradmin/skin/default/order/_default_stock_check.html 000002162 */ ?>
...
<tr>
	<td>
		<div>
		실물 :
			<select name="default_export_stock_check" style="width:330px;">
				...
				<option value="unlimit" <?php if($TPL_VAR["data_present_provider"]["default_export_stock_check"]=='unlimit'){?>selected<?php }?>>출고되는 모든 실물의 재고가 부족해도</option>
		...
		<div class="pdt5">
			티켓 :
			<select name="default_export_ticket_stock_check" style="width:330px;">
