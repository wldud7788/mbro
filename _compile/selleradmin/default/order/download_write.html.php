<?php /* Template_ 2.2.6 2022/05/17 12:29:21 /www/music_brother_firstmall_kr/selleradmin/skin/default/order/download_write.html 000021454 */ 
...
<div id="page-title-bar-area">
	<div id="page-title-bar">
		...
		<ul class="page-buttons-left">
			<li><span class="btn large icon"><button type="button" onclick="location.href='../order/download_list';"><span class="arrowleft"></span>양식리스트</button></span></li>
		</ul>
