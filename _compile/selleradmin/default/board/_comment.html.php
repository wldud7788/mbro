<?php /* Template_ 2.2.6 2022/05/17 12:28:55 /www/music_brother_firstmall_kr/selleradmin/skin/default/board/_comment.html 000016597 */ 
...
<?php if($TPL_cmtloop_1){foreach($TPL_VAR["cmtloop"] as $TPL_V1){?>
		<tr>
			<td class="center">
				<label class="resp_checkbox">
					<input type="checkbox" name="cmtdel[]" value="<?php echo $TPL_V1["seq"]?>" class="cmtcheckeds hand" cmt="parent"<?php if(number_format($TPL_V1["mseq"])!=( 0-$TPL_VAR["providerInfo"]["provider_seq"])){?> disabled<?php }?>>
				</label>
			</td>
			<td>
				<p>
...
<?php if(number_format($TPL_V1["mseq"])==( 0-$TPL_VAR["providerInfo"]["provider_seq"])){?>
...
<?php if(is_array($TPL_R2=$TPL_V1["cmtreplyloop"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
		<tr>
			<td class="center">
				<label class="resp_checkbox">
					<input type="checkbox" name="cmtdel[]" value="<?php echo $TPL_V2["seq"]?>" class="cmtcheckeds hand" cmt="reply"<?php if(number_format($TPL_V1["mseq"])!=( 0-$TPL_VAR["providerInfo"]["provider_seq"])){?> disabled<?php }?>>
				</label>
			</td>
			<td>
				<p>
...
<?php }?>  
			...
			<td>
				<nobr>
<?php if(number_format($TPL_V1["mseq"])==( 0-$TPL_VAR["providerInfo"]["provider_seq"])){?>
					<button type="button" name="boad_cmt_modify_btn<?php echo $TPL_V1["isperm_moddel"]?>" board_cmt_seq="<?php echo $TPL_V1["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" board_cmt_reply_seq="<?php echo $TPL_V2["seq"]?>" board_cmt_idx="<?php echo $TPL_V1["idx"]?>" class="resp_btn v2 <?php echo $TPL_V1["isperm_hide"]?>">수정</button>
					<button type="button" name="boad_cmt_delete_btn<?php echo $TPL_V1["isperm_moddel"]?>" board_cmt_seq="<?php echo $TPL_V1["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" board_cmt_reply_seq="<?php echo $TPL_V2["seq"]?>" board_cmt_idx="<?php echo $TPL_V1["idx"]?>" class="resp_btn v3 <?php echo $TPL_V1["isperm_hide"]?>">삭제</button>
<?php }else{?>
					<button type="button" onclick="alert('본사의 댓글은 수정할 수 없습니다.');" class="resp_btn v2">수정</button>
					<button type="button" onclick="alert('본사의 댓글은 삭제할 수 없습니다.');" class="resp_btn v3">삭제</button>
<?php }?>
