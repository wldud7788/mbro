<?php /* Template_ 2.2.6 2022/05/11 10:47:06 /www/music_brother_firstmall_kr/selleradmin/skin/default/board/goods_review.html 000009063 */ 
...
<?php if($TPL_noticeloop_1){foreach($TPL_VAR["noticeloop"] as $TPL_V1){?>
					<tr class="list-row noticetr <?php echo $TPL_V1["onlynoticeclass"]?>">
						...
						<td nowrap>
<?php if($TPL_V1["goods_seq"]){?><a href="/selleradmin/goods/regist?no=<?php echo $TPL_V1["goods_seq"]?>" target="_blank"><?php if($TPL_V1["goodsInfo"]["provider_seq"]&&$TPL_V1["goodsInfo"]["provider_seq"]!='1'){?>[<?php echo $TPL_V1["goodsInfo"]["provider_name"]?>] <?php }?><?php echo getstrcut($TPL_V1["goodsInfo"]["goods_name"], 8)?></a><?php }?>
						</td>
						<td class="left">
...
$(document).ready(function() {
	...
	$(".orderview").click(function(){
		...
		var href = "/selleradmin/order/view?no="+order_seq;
