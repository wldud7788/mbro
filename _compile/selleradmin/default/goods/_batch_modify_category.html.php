<?php /* Template_ 2.2.6 2022/05/17 12:29:14 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/_batch_modify_category.html 000026355 */ 
...
<table class="list-table-style" cellspacing="0">
	...
	<tbody class="ltb if_brand">
		<tr class="list-row" style="height:70px;">
			...
			검색된 상품에서  →
			<select name="modify_list_brand" class="line">
				<option value="choice">선택 </option>
				<option value="all">전체 </option>
			</select>
			</td>
	...
	<tbody class="ltb if_location">
		<tr class="list-row" style="height:70px;">
			<td align="center" rowspan="5">
			검색된 상품에서  →
			<select name="modify_list_location" class="line">
				<option value="choice">선택 </option>
				<option value="all">전체 </option>
			</select>
			</td>
