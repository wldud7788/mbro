<?php /* Template_ 2.2.6 2022/05/17 12:29:15 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/_batch_modify_goodsetc.html 000013244 */ 
...
<?php if($TPL_VAR["scm_cfg"]['use']!='Y'){?>
				<td class="pdl10 left"><!--// 재고 //-->
					<input type="text" name="stock[<?php echo $TPL_V1["option_seq"]?>]" size="7" value="<?php echo $TPL_V1["default_stock"]?>" style="text-align:right;" class="onlyfloat stock stock_<?php echo $TPL_V1["goods_seq"]?>_value" apply_target="stock" />
...
<?php if($TPL_V1["options"][ 0]["option_title"]){?><span class="btn small gray" style="display:none;"><button type="button" class="applyOptionsBtn"  goods_seq='<?php echo $TPL_V1["goods_seq"]?>' apply_type='stock_<?php echo $TPL_V1["goods_seq"]?>'>▼</button></span><?php }?>
				...
				<td class="pdl10 left"><!--// 불량 //-->
					<input type="text" name="badstock[<?php echo $TPL_V1["option_seq"]?>]" size="7" value="<?php echo $TPL_V1["default_badstock"]?>" style="text-align:right;" class="onlyfloat badstock badstock_<?php echo $TPL_V1["goods_seq"]?>_value" apply_target="badstock" />
