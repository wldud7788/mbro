<?php /* Template_ 2.2.6 2022/05/17 12:29:11 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/select.html 000024030 */ 
...
<?php }?>
	...
	<tr>
		...
		<td class="its-td">
			<select name="selectBrand1" style="width:100px" <?php if($_GET["displayKind"]=='brand'){?>disabled<?php }?>>
			<option value="">1차 브랜드</option>
			</select>
			<select name="selectBrand2" style="width:100px" <?php if($_GET["displayKind"]=='brand'){?>disabled<?php }?>>
			<option value="">2차 브랜드</option>
			</select>
			<select name="selectBrand3" style="width:100px" <?php if($_GET["displayKind"]=='brand'){?>disabled<?php }?>>
			<option value="">3차 브랜드</option>
			</select>
			<select name="selectBrand4" style="width:100px" <?php if($_GET["displayKind"]=='brand'){?>disabled<?php }?>>
	...
	<tr>
		...
		<td class="its-td">
			<select name="selectLocation1" style="width:100px">
			<option value="">1차 지역</option>
			</select>
			<select name="selectLocation2" style="width:100px">
			<option value="">2차 지역</option>
			</select>
			<select name="selectLocation3" style="width:100px">
			<option value="">3차 지역</option>
			</select>
			<select name="selectLocation4" style="width:100px">
