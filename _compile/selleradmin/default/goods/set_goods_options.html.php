<?php /* Template_ 2.2.6 2022/05/17 12:29:13 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/set_goods_options.html 000006972 */  $this->include_("defaultScriptFunc");?>
...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/common.css" />
	<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/layout.css" />
	<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/buttons.css" />
	<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/boardnew.css" />
	<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/page.css" />
...
<?php }?>
	...
	<script type="text/javascript" src="/app/javascript/js/selleradmin-layout.js?dummy=<?php echo date('YmdHis')?>&krdomain=http://<?php echo $TPL_VAR["config_system"]["subDomain"]?>"></script>
...
<?php if($TPL_VAR["reload"]=='y'){?>
			location.replace('?tmp_seq=<?php echo $TPL_VAR["tmp_seq"]?>&tmp_policy=<?php echo $TPL_VAR["tmp_policy"]?>&socialcp_input_type=<?php echo $_GET["socialcp_input_type"]?><?php if($TPL_VAR["mode"]=='view'){?>&mode=view&goods_seq=<?php echo $TPL_VAR["goods_seq"]?><?php }?>&provider_seq=<?php echo $_GET["provider_seq"]?>&package_yn=<?php echo $_GET["package_yn"]?>');
