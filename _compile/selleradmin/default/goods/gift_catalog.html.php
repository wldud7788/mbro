<?php /* Template_ 2.2.6 2022/05/17 12:29:09 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/gift_catalog.html 000025885 */ 
...
<?php }else{?>
			<li><span class="icon-goods-kind-<?php echo $TPL_VAR["goods"]["goods_kind"]?>"></span><span class="btn large red"><button onclick="location.href='gift_regist';">사은품등록<span class="arrowright"></span></button></span></li>
<?php }?>
		</ul>
...
<?php }?>
			...
			<td align="center"><?php echo $TPL_V1["_no"]?></td>
<?php if(serviceLimit('H_AD')){?>
...
<?php }else{?>
				<td align="center" bgcolor="red" class="white bold"><?php echo $TPL_V1["provider_name"]?></td>
<?php }?>
<?php }?>
...
<a href="?page=<?php echo $TPL_VAR["page"]["first"]?>&amp;<?php echo $TPL_VAR["page"]["querystring"]?>">
<input type="button" class="first btn" /></a>&nbsp;
<?php }?>
<?php if($TPL_VAR["page"]["prev"]){?>
<a href="?page=<?php echo $TPL_VAR["page"]["prev"]?>&amp;<?php echo $TPL_VAR["page"]["querystring"]?>" class="prev">
...
<a href="?page=<?php echo $TPL_VAR["page"]["next"]?>&amp;<?php echo $TPL_VAR["page"]["querystring"]?>" class="next">
<input type="button" class="next btn " /></a>&nbsp;
<?php }?>
<?php if($TPL_VAR["page"]["last"]){?>
<a href="?page=<?php echo $TPL_VAR["page"]["last"]?>&amp;<?php echo $TPL_VAR["page"]["querystring"]?>"><input type="button" class="end btn" /></a>
<?php }?>
</div>
<!-- paging end -->
