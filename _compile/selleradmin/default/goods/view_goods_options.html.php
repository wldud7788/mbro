<?php /* Template_ 2.2.6 2022/05/17 12:29:14 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/view_goods_options.html 000023166 */ 
...
<?php }else{?>
			<th class="its-th-align center" colspan="4">
...
<?php }else{?>
			...
			<th class="its-th-align center">
				...
				<input type="hidden" class="safestock_text" title="입점사"/>
			</th>
<?php }?>
		</tr>
		</thead>
...
<?php if($TPL_VAR["package_yn"]!='y'&&$TPL_VAR["isplusfreenot"]){?><td class="its-td-align center"><span class="goodsCode"></span><?php echo $TPL_V1["optioncode"]?></td><?php }?>
...
<?php }?>
			<td class="its-td-align center"><?php echo get_currency_price($TPL_V1["commission_price"],'','KRW')?></td>
			<td class="its-td-align right pdr10">
...
<?php if($TPL_V1["reserve_unit"]=='percent'){?>
				<?php echo number_format($TPL_V1["reserve_rate"])?>% (<?php echo get_currency_price($TPL_V1["reserve"], 2,'basic')?>)
<?php }else{?>
