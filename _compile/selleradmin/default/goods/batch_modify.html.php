<?php /* Template_ 2.2.6 2022/05/17 12:29:07 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/batch_modify.html 000008014 */ 
...
table.list-table-style tr th { 
	background-color:#e3e3e3; text-align:center; height:34px !important;
}
...
.batchmodify_ui-combobox {width:650px;height:40px;margin: 0;padding: 0.3em;font-size:18px;}
</style>
<div class="center">
...
<?php if($TPL_batchmodify_selector_1){foreach($TPL_VAR["batchmodify_selector"] as $TPL_K1=>$TPL_V1){?>
			<option value="<?php echo $TPL_K1?>" <?php if($_GET["mode"]==$TPL_K1){?> selected <?php }?> ><?php echo $TPL_V1?></option>
<?php }}?>
			</select>
			<script>
