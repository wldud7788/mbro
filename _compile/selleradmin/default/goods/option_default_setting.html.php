<?php /* Template_ 2.2.6 2022/05/17 12:29:10 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/option_default_setting.html 000007793 */ ?>
...
$(function(){
	...
	$("button#relationCriteriaButton").live("click",function(){
		...
		if (criteria=="") {
			criteria = "admin∀type=select_auto,provider=all,month=3,age=all,sex=all,agent=all,act=view,min_ea=1";
		}
...
<tr>
	...
	<td class="its-td-align center">공용정보</td>
	<td class="its-td-align pdl10">
...
<?php }}?>
<?php }else{?>
				<option value="">공용정보가 없습니다.</option>
<?php }?>
		</select><br/>
		<span class="desc">※ 공용정보는 상품 등록 및 수정 화면에서 공용정보 입력 시 생성할 수 있습니다.</span>
	</td>
</tr>
<tr>
