<?php /* Template_ 2.2.6 2022/05/17 12:29:15 /www/music_brother_firstmall_kr/selleradmin/skin/default/goods/_batch_modify_ifstatus.html 000013495 */ 
	...
	<tbody class="ltb">
		<tr class="list-row" style="height:70px;">
			...
			<td>
				...
				<tr>
					<td><label><input type="checkbox" name="batch_goods_view_yn" value="1" /> 노출/미노출</label></td>
					<td>
						...
						<span class="desc">('수동' 상품만 적용)</span>
						변경합니다.
					</td>
				</tr>
				<tr>
					<td><label><input type="checkbox" name="batch_goods_status_yn" value="1" /> 상태</label></td>
					<td>
				...
				<tr>
					<td><label><input type="checkbox" name="batch_runout_type_yn" value="1" /> 재고에 따른 판매 여부를</label></td>
					<td>
						<!--재고연동판매-->
...
<?php }?>
				...
				<tr>
					<td>
						<label><input type="checkbox" name="batch_adult_goods_yn" value="1" /> 성인</label></td>
					<td>
				...
				<tr>
					<td><label><input type="checkbox" name="batch_option_international_shipping_status_yn" value="1" /> 해외구매대행</label></td>
					<td>
				...
				<tr>
					<td style="border-bottom:0px;"><label><input type="checkbox" name="batch_cancel_type_yn" value="1" /> 청약철회</label></td>
...
<?php if($TPL_V1["provider_status"]=='0'||$TPL_V1["provider_status"]==''){?>미승인<?php }else{?>승인<?php }?>
			...
			<td class="center">
				...
				<div class="mt3"><?php if($TPL_V1["goods_view"]=='look'){?>노출<?php }else{?>미노출<?php }?></div>
			</td>
			<!-- 상태 -->
			<td class="center">
...
<?php if($TPL_V1["option_international_shipping_status"]=="y"){?>구매대행<?php }else{?>일반<?php }?>
			...
			<!--청약철회-->
			<td class="center">
<?php if($TPL_V1["cancel_type"]=="0"){?>청약철회불가<?php }elseif($TPL_V1["cancel_type"]=="1"){?>청약철회가능<?php }?>
				</select>
			</td>
		</tr>
