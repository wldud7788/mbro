<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/mshop/index.html 000004951 */  $this->include_("showMyMinishopLight","snslinkurl","showGoodsSearchFormLight");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ "판매자 미니샵" 페이지 @@
...
<?php }else{?>
				<h3 class="title"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXNob3AvaW5kZXguaHRtbA==" >MINISHOP</span></h3>
<?php }?>
				<div class="info">
					<span class="point"><?php echo $TPL_VAR["aProvider"]["provider_name"]?></span> &nbsp; <span class="gray_07">|</span> &nbsp;
					<span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXNob3AvaW5kZXguaHRtbA==" >단골</span> <span class="point"><?php echo $TPL_VAR["aProvider"]["cnt"]?></span>
				</div>
...
<?php }?>
			...
			<li class="sns">
				<button class="reg_minishop <?php if($TPL_VAR["aProvider"]["thisshop"]=='y'){?>on<?php }?>" data-shop='<?php echo $TPL_VAR["aProvider"]["provider_seq"]?>' onclick="mshopadd(this, '<?php echo $TPL_VAR["member_seq"]?>');"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXNob3AvaW5kZXguaHRtbA==" >찜</span></button>
				<a href="javascript:void(0)" class="btn_sns_share" onclick="snsLink();" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXNob3AvaW5kZXguaHRtbA==" >공유</span></a>
