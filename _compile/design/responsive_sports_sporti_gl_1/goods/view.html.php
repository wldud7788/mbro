<?php /* Template_ 2.2.6 2022/06/15 11:11:45 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/goods/view.html 000114860 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php if($TPL_icons_1){foreach($TPL_VAR["icons"] as $TPL_V1){?>
			<img src="/data/icon/goods/<?php echo $TPL_V1["codecd"]?>.gif" alt="" designImgSrcOri='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designElement='image' >
<?php }}?>
		</span>
	</p>
...
<?php }?>
<?php }else{?>
							<img class="target" data-zoom="3" src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl_1/images/common/noimage_wide.gif'" title="<?php echo $TPL_V1["large"]["label"]?>" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="<?php echo $TPL_VAR["goods_view_image_alt"]?>"<?php }?> designImgSrcOri='ey52aWV3LmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='ey52aWV3LmltYWdlfQ==' designElement='image' />
<?php }?>
					</div>
<?php }?>
<?php }}?>
...
<?php if($TPL_V1["thumbView"]["image"]){?>
							<li><a href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><img src="<?php echo $TPL_V1["thumbView"]["image"]?>" width="<?php echo $TPL_VAR["goodsImageSize"]["thumbView"]["width"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl_1/images/common/noimage_list.gif'" <?php if($TPL_V1["thumbView"]["match_color"]){?> color="<?php echo $TPL_V1["thumbView"]["match_color"]?>"<?php }?> designImgSrcOri='ey50aHVtYlZpZXcuaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='ey50aHVtYlZpZXcuaW1hZ2V9' designElement='image' /></a></li>
<?php }?>
<?php }}?>
						</ul>
					</div>
...
<?php }?>
		...
		<input type="hidden" name="goodsViewVersion" value="2" />
			...
			<div class="sns_wish">
				<!-- SNS 공유 -->
				<a href="javascript:void(0)" id="btnSnsShare" class="btn_sns_share" title="SNS 공유" onclick="share_chg()" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >공유</span></a>
				<div id="snsListDetail" class="snsbox_area" style="display:none;">
					<?php echo snslinkurl('goods',$TPL_VAR["goods"]["goods_name"])?>

				</div>
				<!-- 찜 -->
				<a href="javascript:void(0)" id="wishimg" class="ico_wish" usewish="n" onclick="wish_chg();" title="찜하기(위시리스트에 추가)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >찜</span></a>
			</div>
...
<?php if($TPL_VAR["braodcastData"]["status"]=='live'){?>
						<img class="status" src="/data/skin/responsive_sports_sporti_gl_1/images/broadcast/i_live.png" alt="방송 중" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9pX2xpdmUucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvYnJvYWRjYXN0L2lfbGl2ZS5wbmc=' designElement='image' >
						<p class="notice_text"><?php echo $TPL_VAR["braodcastData"]["start_date"]?> 현재 방송 중</p>
						<a class="btn_resp no_border" href="/broadcast/player?no=<?php echo $TPL_VAR["braodcastData"]["bs_seq"]?>" target="_blank" hrefOri='L2Jyb2FkY2FzdC9wbGF5ZXI/bm89e2JyYW9kY2FzdERhdGEuYnNfc2VxfQ==' ><img src="/data/skin/responsive_sports_sporti_gl_1/images/broadcast/btn_live_go.png" alt="시청하기" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9idG5fbGl2ZV9nby5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvYnJvYWRjYXN0L2J0bl9saXZlX2dvLnBuZw==' designElement='image' ></a>
<?php }else{?>
						<img class="status" src="/data/skin/responsive_sports_sporti_gl_1/images/broadcast/reserve_live.png" alt="방송 예정 LIVE" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9yZXNlcnZlX2xpdmUucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvYnJvYWRjYXN0L3Jlc2VydmVfbGl2ZS5wbmc=' designElement='image' >
					...
					<div id="goodsInterest" class="Relative hide">
						<div class="layer_simple_basic px p_right">
							<table class="detail_option_table card" cellpadding="0" cellspacing="0">
								<tbody>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_bc.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfYmMuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19iYy5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_ct.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfY3QuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19jdC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_hd.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaGQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19oZC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_hn.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaG4uZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19obi5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_kb.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfa2IuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19rYi5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_lt.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfbHQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19sdC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_sh.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc2guZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19zaC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/interest/Interest_img_ss.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc3MuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19zcy5naWY=' designElement='image' ></th>
...
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_sports_sporti_gl_1/images/common/icon_inter_ship.png" class="icon_global" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2ludGVyX3NoaXAucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ljb25faW50ZXJfc2hpcC5wbmc=' designElement='image' />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
						...
						<ul>
							...
							<li>
								...
								<p class="e_content" designElement="text" textIndex="67"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >
									관세청에서는 개인정보 유출을 방지하기 위하여 개인물품 수입신고 시 주민등록번호를 대신 활용할 수 있는 개인통관고유부호 제도를 운영합니다. 개인통관고유부호는 <a href="https://p.customs.go.kr" class="Und" target="_blank" title="새창" designElement="text" textIndex="68"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" hrefOri='aHR0cHM6Ly9wLmN1c3RvbXMuZ28ua3I=' >관세청 사이트</a>에서 신청 즉시 부여되며, 계속 같은 번호로 사용이 가능합니다. 분실하면 관세청 사이트에서 조회 가능합니다. 부호 체계는 P로 시작하고 13자리입니다.
								</p>
							</li>
						</ul>
					</div>
...
<?php if($TPL_VAR["ship_summary"]["gl_shipping_yn"]=='Y'){?>
				<li class="goods_spec_international_shipping">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="72"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >해외배송</span> <img src="/data/skin/responsive_sports_sporti_gl_1/images/common/plane.png" height="15" alt="해외배송" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL3BsYW5lLnBuZw==' designElement='image' /></li>
						<li>
...
<?php if($TPL_ship_gl_list_1){foreach($TPL_VAR["ship_gl_list"] as $TPL_V1){?>
									<tr>
										<th scope="row" class="L">
											<img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_V1["gl_nation"]?>.png" height="20" alt="" designImgSrcOri='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designElement='image' >
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<li>
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="104"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_sports_sporti_gl_1/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvaWNvbi9pY29uX3RhbGsucG5n' designElement='image' />&nbsp; <span designElement="text" textIndex="105"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >톡톡하세요</span></button>
					</li>
<?php }?>
				</ul>
			</div>
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<div class="goods_naver_talk_pc">
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="114"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_sports_sporti_gl_1/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvaWNvbi9pY29uX3RhbGsucG5n' designElement='image' />&nbsp; <span designElement="text" textIndex="115"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >톡톡하세요</span></button>
					</div>
<?php }?>
				</div>
			</div>
		...
		<div id="goods_tabs" class="goods_tabs">
			<div class="resp_area">
				<div class="goods_information_tabs">
					<a href="#goods_contents_quick" class="current" onclick="open_information_tab(this,'goods_description');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="118"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >상세설명</span></a>
					...
					<a href="#goods_contents_quick" id="goodsQnaLoad" onclick="open_information_tab(this,'goods_qna');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span><span designElement="text" textIndex="120"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >상품문의</span> <?php if($TPL_VAR["goods"]["qna_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["qna_count"])?></span><?php }?></span></a>
					<a href="#goods_contents_quick" onclick="open_information_tab(this,'exchange_guide');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="121"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >교환/반품/<span class="Dib">배송</span></span></a>
				</div>
			</div>
		</div>
		<script>
...
<?php if($TPL_VAR["goods"]["mobile_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29udGVudHM/bm89e2dvb2RzLmdvb2RzX3NlcX0mem9vbT0x' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29tbW9uX2NvbnRlbnRzP25vPXtnb29kcy5nb29kc19zZXF9Jnpvb209MQ==' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
