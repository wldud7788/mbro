<?php /* Template_ 2.2.6 2022/06/10 11:07:07 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/_modules/category/category_gnb.html 000006111 */ 
...
<?php }?>
					...
					<!-- 2022.06.08 황혜찬 if문 추가 -->
<?php }}?>
<?php if($TPL_V1["name"]=='FASHION'){?>
					<li class="categorySubDepth brand_depth">
						<ul class="categoryDepth2 brand_show">
							<li class="brand_menu1"><span>브랜드 보기</span></li>
							<li class="brand_menu2" style="display: none;"><span>브랜드 접기</span></li>
						</ul>
					</li>
					<li class="brand_submenu" style="display: none;">
						...
						<span class="brand_content" onclick="window.location='https://musicbroshop.com/goods/brand?page=1&searchMode=brand&brand%5B0%5D=b0143&per=40&sorting=regist&filter_display=lattice'">매드마르스</span>
