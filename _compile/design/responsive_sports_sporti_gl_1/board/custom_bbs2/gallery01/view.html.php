...
<?php if($TPL_V1["is_image"]){?>
				<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');" ><img src="/data/skin/responsive_sports_sporti_gl_1/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vLi4vLi4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvY3VzdG9tX2JiczIvZ2FsbGVyeTAxL3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvaWNvbi9pY29uX3pvb20uZ2lm' designElement='image' /></span>
<?php }?>
		</li>
<?php }}?>
	</ul>
