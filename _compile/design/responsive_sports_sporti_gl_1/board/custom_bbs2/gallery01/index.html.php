<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/board/custom_bbs2/gallery01/index.html 000014196 */  $this->include_("sslAction");
...
<?php if($TPL_V1["file_key_w"]&&$TPL_V1["uccdomain_thumbnail"]){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["uccdomain_thumbnail"]?>" designImgSrcOri='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvY3VzdG9tX2JiczIvZ2FsbGVyeTAxL2luZGV4Lmh0bWw=' designImgSrc='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designElement='image' /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'http')){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="http<?php echo str_replace('http','',$TPL_V1["filelist"]['realfile'])?>" designImgSrcOri='aHR0cHs9c3RyX3JlcGxhY2Uo' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvY3VzdG9tX2JiczIvZ2FsbGVyeTAxL2luZGV4Lmh0bWw=' designImgSrc='aHR0cHs9c3RyX3JlcGxhY2Uo' designElement='image' /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'/data/editor/')){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl_1/images/common/noimage.gif'" designImgSrcOri='ey5maWxlbGlzdFs=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvY3VzdG9tX2JiczIvZ2FsbGVyeTAxL2luZGV4Lmh0bWw=' designImgSrc='ey5maWxlbGlzdFs=' designElement='image' /></span>
<?php }else{?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="/data/board/<?php echo $_GET["id"]?>/<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl_1/images/common/noimage.gif'" designImgSrcOri='L2RhdGEvYm9hcmQve19HRVQuaWR9L3suZmlsZWxpc3Rb' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvY3VzdG9tX2JiczIvZ2FsbGVyeTAxL2luZGV4Lmh0bWw=' designImgSrc='L2RhdGEvYm9hcmQve19HRVQuaWR9L3suZmlsZWxpc3Rb' designElement='image' /></span>
<?php }?>
			</li>
		</ul>
		<ul class="text_area">
