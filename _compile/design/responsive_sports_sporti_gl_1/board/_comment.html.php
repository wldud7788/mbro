<?php /* Template_ 2.2.6 2022/03/18 15:13:18 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/board/_comment.html 000029406 */  $this->include_("sslAction");
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	<div class="cmt_division v2">
		<div class="content title_area">
			<span class="title" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX2NvbW1lbnQuaHRtbA==" >댓글</span> <strong class="num pointcolor"><?php echo number_format($TPL_VAR["comment"])?></strong> &nbsp;
...
<?php if($TPL_V1["iconnew"]){?>
						<img src="/data/skin/responsive_sports_sporti_gl_1/board/<?php echo $TPL_VAR["templateskin"]?>/images/icon/icon_new.png" title="new" align="absmiddle" designImgSrcOri='e3RlbXBsYXRlc2tpbn0vaW1hZ2VzL2ljb24vaWNvbl9uZXcucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX2NvbW1lbnQuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9ib2FyZC97dGVtcGxhdGVza2lufS9pbWFnZXMvaWNvbi9pY29uX25ldy5wbmc=' designElement='image' >
<?php }?>
				</td>
			</tr>
			<tr>
...
<?php if($TPL_V1["isperm_hide"]!='hide'){?>
					<div class="pdt10">
						<span class="btn_resp size_a <?php echo $TPL_V1["isperm_hide"]?>" name="boad_cmt_reply_btn<?php echo $TPL_VAR["managerview"]["isperm_write_cmt"]?>" board_cmt_seq="<?php echo $TPL_V1["seq"]?>"  board_cmt_idx="<?php echo $TPL_V1["idx"]?>"  alt="답글쓰기" title="답글쓰기" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX2NvbW1lbnQuaHRtbA==" >답글</span>
						<span class="btn_resp size_a <?php echo $TPL_V1["isperm_hide"]?>" name="boad_cmt_modify_btn<?php echo $TPL_V1["isperm_moddel"]?>" board_cmt_seq="<?php echo $TPL_V1["seq"]?>" alt="답글수정" title="답글수정" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX2NvbW1lbnQuaHRtbA==" >수정</span>
						<span class="btn_resp size_a <?php echo $TPL_V1["isperm_hide"]?>" name="boad_cmt_delete_btn<?php echo $TPL_V1["isperm_moddel"]?>" board_cmt_seq="<?php echo $TPL_V1["seq"]?>" alt="답글삭제" title="답글삭제" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX2NvbW1lbnQuaHRtbA==" >삭제</span>
						<!-- 댓글평가 -->
...
<?php if(is_array($TPL_R2=$TPL_V1["cmtreplyloop"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
					<tr>
						...
						<img src="/data/skin/responsive_sports_sporti_gl_1/board/<?php echo $TPL_VAR["templateskin"]?>/images/board/icon/icon_comment_reply.gif"  title="답변" alt="답변" designImgSrcOri='e3RlbXBsYXRlc2tpbn0vaW1hZ2VzL2JvYXJkL2ljb24vaWNvbl9jb21tZW50X3JlcGx5LmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvYm9hcmQvX2NvbW1lbnQuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9ib2FyZC97dGVtcGxhdGVza2lufS9pbWFnZXMvYm9hcmQvaWNvbi9pY29uX2NvbW1lbnRfcmVwbHkuZ2lm' designElement='image' >
