<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/mypage/coupon.html 000020830 */  $this->include_("o2oFrontMypageCouponBarcode");
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2NvdXBvbi5odG1s" >쿠폰 내역</span></h2>
		</div>
		...
		<div class="tab_basic size2">
			<ul>
				<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=1" hrefOri='L215cGFnZS9jb3Vwb24/dGFiPTE=' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2NvdXBvbi5odG1s" >보유한 쿠폰</span>(<strong class="pointcolor2"><?php echo number_format($TPL_VAR["unusedcount"])?></strong>/<?php echo number_format($TPL_VAR["totalcount"])?>)</a>
				</li>
				<li <?php if($_GET["tab"]=='2'){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=2" hrefOri='L215cGFnZS9jb3Vwb24/dGFiPTI=' ><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2NvdXBvbi5odG1s" >다운로드 가능 쿠폰</span>(<?php echo number_format($TPL_VAR["svcount"])?>)</a>
				</li>
			</ul>
		</div>
		...
		<div class="Clearfix">
			<ul class="tab_right_menu">
				<li>
					<a class="btn_resp size_b" href="/mypage/offlinecoupon" hrefOri='L215cGFnZS9vZmZsaW5lY291cG9u' >+ 쿠폰 등록</a>
				</li>
			</ul>
...
<div id="couponuse_area" class="resp_layer_pop hide">
	...
	<a href="javascript:void(0)" class="btn_pop_close" onclick="$('#manager_code').val(''); hideCenterLayer()" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ></a>
</div>
				...
				$.ajax({
					...
					'success' : function(res){
						...
						if( res.result == 'goodsyes' ) {
							...
							$(".coupongoodsrevieweryes .issueGoods").find(".image").html("<img class=\"goodsThumbView\"  alt=\"\" src=\""+imgsrc+"\" width=\"50\" height=\"50\" designImgSrcOri='XA==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2NvdXBvbi5odG1s' designImgSrc='XA==' designElement='image' >");
