<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/mypage/order_catalog.html 000019014 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX2NhdGFsb2cuaHRtbA==" >주문/배송 내역</span></h2>
		</div>
...
<?php if(is_array($TPL_R3=$TPL_V2["options"])&&!empty($TPL_R3)){$TPL_I3=-1;foreach($TPL_R3 as $TPL_V3){$TPL_I3++;?>
					<ul class="oc_item_info_detail">
						<li class="img_link" <?php if($TPL_V2["goods_type"]!='gift'){?>style="cursor:pointer" title="상품 상세" onclick="location.href='../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>';"<?php }?>>
							<img src="<?php echo viewImg($TPL_V2["goods_seq"],'thumbCart')?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_sports_sporti_gl_1/images/common/noimage_list.gif'" alt="" designImgSrcOri='ez12aWV3SW1nKC4uZ29vZHNfc2VxLCA=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX2NhdGFsb2cuaHRtbA==' designImgSrc='ez12aWV3SW1nKC4uZ29vZHNfc2VxLCA=' designElement='image' />
						</li>
						<li class="detail_spec">
<?php if($TPL_V2["eventEnd"]){?>
							<div class="oc_event_area">
								<span class="soloEventTd<?php echo $TPL_V3["item_option_seq"]?>">
									<img src="/data/skin/responsive_sports_sporti_gl_1/images/common/icon_clock.gif" class="img_clock" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb2NrLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ljb25fY2xvY2suZ2lm' designElement='image' > 남은시간
...
<?php if($TPL_V2["goods_type"]=='gift'){?><img src="/data/skin/responsive_sports_sporti_gl_1/images/common/icon_gift.gif" alt="사은품" vspace=3 designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2dpZnQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2ljb25fZ2lmdC5naWY=' designElement='image' /><?php }?>
...
<?php if($TPL_V4["type"]=='file'){?>
										<a href="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" hrefOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' ><img src="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" class="input_img" title="크게 보기" designImgSrcOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX2NhdGFsb2cuaHRtbA==' designImgSrc='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designElement='image' /></a>
<?php }else{?>
