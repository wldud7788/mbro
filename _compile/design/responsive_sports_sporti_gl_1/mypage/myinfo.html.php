<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/mypage/myinfo.html 000020321 */  $this->include_("sslAction");
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s" >회원정보 수정</span></h2>
		</div>
...
<?php if($TPL_VAR["snslist"]){?>
			<h3 class="title_sub1"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s" >사용중인 SNS 계정</span></h3>
<?php if($TPL_snslist_1){foreach($TPL_VAR["snslist"] as $TPL_V1){?>
				<img src="/data/skin/responsive_sports_sporti_gl_1/images/design/mypage_sns_<?php echo substr($TPL_V1["rute"], 0, 1)?>.png"  class="hand" snstype="<?php echo $TPL_V1["rute"]?>"  alt="<?php echo $TPL_VAR["joinform"]["use_sns"][$TPL_V1["rute"]]['nm']?>"  title="<?php echo $TPL_VAR["joinform"]["use_sns"][$TPL_V1["rute"]]['nm']?>" height="42" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9teXBhZ2Vfc25zX3s9c3Vic3RyKC5ydXRlLDAsMSl9LnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL215cGFnZV9zbnNfez1zdWJzdHIoLnJ1dGUsMCwxKX0ucG5n' designElement='image' />
...
<?php }?>
			...
			<h3 class="title_sub1"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s" >SNS 계정 사용</span></h3>
			<p class="Pb8" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s" >사용하고 계신 SNS 또는 외부 계정으로 간편하게 로그인하여 쇼핑몰을 이용하실 수 있습니다. 여러 개를 함께 이용하실 수도 있습니다.</p>
...
<?php if(is_array($TPL_R1=$TPL_VAR["joinform"]["use_sns"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_K1=>$TPL_V1){?>
				<li>
					<img src="/data/skin/responsive_sports_sporti_gl_1/images/design/sns_icon_<?php echo $TPL_K1?><?php if(!in_array($TPL_K1,$TPL_VAR["sns_joined_list"])){?>_off<?php }?>.png" class="sns_icon <?php if(!in_array($TPL_K1,$TPL_VAR["sns_joined_list"])){?> <?php if($TPL_K1=='facebook'){?>fb-login-button-mbconnect-direct<?php }else{?>sns-login-button-mbconnect-direct<?php }?> hand <?php }?>" snstype="<?php echo $TPL_K1?>" alt="<?php echo $TPL_V1["nm"]?> 아이디 사용하기"  title="<?php echo $TPL_V1["nm"]?> 아이디 사용하기"  designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9zbnNfaWNvbl97PS5rZXlffXs/ICFpbl9hcnJheSgua2V5Xywgc25zX2pvaW5lZF9saXN0KX1fb2Zmey99LnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL3Nuc19pY29uX3s9LmtleV99ez8gIWluX2FycmF5KC5rZXlfLCBzbnNfam9pbmVkX2xpc3QpfV9vZmZ7L30ucG5n' designElement='image' />
...
<?php }?>
			...
			<h3 class="title_sub1"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s" >회원정보</span></h3>
...
<?php if(in_array($TPL_K1,$TPL_VAR["sns_joined_list"])){?>
				<li>
					<img src="/data/skin/responsive_sports_sporti_gl_1/images/design/mypage_sns_<?php echo substr($TPL_K1, 0, 1)?>.png" class="icon" snstype="sns_<?php echo substr($TPL_K1, 0, 1)?>"  snsrute="<?php echo $TPL_K1?>" alt="<?php echo $TPL_V1["nm"]?>"  title="<?php echo $TPL_V1["nm"]?>"  designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9teXBhZ2Vfc25zX3s9c3Vic3RyKC5rZXlfLDAsMSl9LnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL215aW5mby5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL215cGFnZV9zbnNfez1zdWJzdHIoLmtleV8sMCwxKX0ucG5n' designElement='image' />
