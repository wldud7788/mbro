<?php /* Template_ 2.2.6 2022/04/12 18:48:51 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/mypage/emoney.html 000005424 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text">나의 지갑 QR코드</span></h2>
		</div>
		<div class="mypage_greeting btm_padding">
			<span class="username">나만의 고유한 지갑주소입니다.</span>
		</div>


		<div class="res_table" style="text-align: center">
			<img src="<?php echo $TPL_VAR["walletAdd"]?>" designImgSrcOri='eyB3YWxsZXRBZGQgfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2Vtb25leS5odG1s' designImgSrc='eyB3YWxsZXRBZGQgfQ==' designElement='image' >
		</div>
		-->
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2Vtb25leS5odG1s" >캐시전환내역</span></h2>
		</div>
		<div class="mypage_greeting btm_padding">
...
<?php }?>
		...
		<!-- 타이틀 -->
		<div class="title_container">
			<h2><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL2Vtb25leS5odG1s" >캐시 내역</span></h2>
		</div>
