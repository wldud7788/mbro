<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/mypage/order_view.html 000132124 */ 
...
<?php if($TPL_VAR["pgCompany"]=="lg"){?><script type="text/javascript" src="//pgweb.uplus.co.kr/WEB_SERVER/js/receipt_link.js"></script><?php }?>
<?php if($TPL_VAR["pgCompany"]=="allat"){?> <?php }?>
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==" >주문/배송 상세</span></h2>
		</div>
...
<?php }?>
				<li class="subject">
					<ul class="board_goods_list">
						<li class="pic">
<?php if($TPL_V2["goods_type"]=='gift'){?>
							<img src="<?php echo $TPL_V2["image"]?>" alt="" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='ey4uaW1hZ2V9' designElement='image' />
<?php }else{?>
							<a href='/goods/view?no=<?php echo $TPL_V2["goods_seq"]?>' target='_blank' title="새창" hrefOri='L2dvb2RzL3ZpZXc/bm89ey4uZ29vZHNfc2VxfQ==' ><img src="<?php echo $TPL_V2["image"]?>" alt="<?php echo $TPL_V1["goods_name"]?>" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='ey4uaW1hZ2V9' designElement='image' /></a>
<?php }?>
						</li>
						<li class="info">
							<div class="title">
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_sports_sporti_gl_1/images/common/auth_img.png" height="17" alt="성인" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL2F1dGhfaW1nLnBuZw==' designElement='image' />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_sports_sporti_gl_1/images/common/plane.png" height="14" alt="해외배송상품" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvY29tbW9uL3BsYW5lLnBuZw==' designElement='image' />
<?php }?>
							</div>
...
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?><?php if($TPL_V4["type"]=='file'){?><a href="../mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" class="gray_05" title="다운로드" hrefOri='Li4vbXlwYWdlX3Byb2Nlc3MvZmlsZWRvd24/ZmlsZT17Li4uLnZhbHVlfQ==' ><?php echo $TPL_V4["value"]?></a><?php }else{?><?php echo $TPL_V4["value"]?><?php }?>
								</span>
<?php }?>
<?php }}?>
							</div>
...
<?php if($TPL_I2== 0&&$TPL_I3== 0){?>
				<li class="besong_group2 left <?php if($TPL_V1["totalitems"]> 1){?>rowspan<?php }?>">
<?php if($TPL_VAR["orders"]["payment"]!='pos_pay'){?>
						<div class="rcont">
...
<?php }?>
				...
				<tbody>
					...
					<tr>
						...
						<td>
<?php if($TPL_VAR["orders"]["payment"]!='pos_pay'){?>
							<?php echo $TPL_VAR["orders"]["step_info"]?> <?php if($TPL_VAR["orders"]["step"]== 99){?> [CODE: <?php echo $TPL_VAR["orders"]["pg_log"]["res_cd"]?>] <?php echo $TPL_VAR["orders"]["pg_log"]["res_msg"]?> <?php }?>
<?php }else{?>
								오프라인 매장 주문
<?php }?>
						</td>
...
<?php if($TPL_V3["opt_type"]=='opt'){?>
								<ul class="board_goods_list">
									<li class="pic">
										<img src="<?php echo $TPL_V3["image"]?>" alt="" designImgSrcOri='ey4uLmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='ey4uLmltYWdlfQ==' designElement='image' />
									</li>
									<li class="info">
										<div class="title">
...
<?php if($TPL_VAR["orders"]["typereceipt"]== 2){?> 현금영수증
						<img src="/data/skin/responsive_sports_sporti_gl_1/images/design/btn_print_receipt.gif" id="pgcashbtn<?php echo $TPL_VAR["creceipt"]["tstep"]?>" class="hand" sales_seq="<?php echo $TPL_VAR["creceipt"]["seq"]?>"  order_seq ="<?php echo $TPL_VAR["orders"]["order_seq"]?>" cash_no="<?php echo $TPL_VAR["creceipt"]["cash_receipts_no"]?>" settleprice="<?php echo $TPL_VAR["orders"]["settleprice"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9idG5fcHJpbnRfcmVjZWlwdC5naWY=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL2J0bl9wcmludF9yZWNlaXB0LmdpZg==' designElement='image' />
...
<?php }?>
	...
	$(function(){
<?php if($TPL_VAR["pgCompany"]=='allat'&&$TPL_VAR["orders"]["payment"]=='card'&&$TPL_VAR["naxCheck"]=='N'){?>
...
<?php }elseif($TPL_VAR["pgCompany"]=='inicis'){?>
				receiptWin = "https://iniweb.inicis.com/DefaultWebApp/mall/cr/cm/mCmReceipt_head.jsp?noTid="+ tno + "&noMethod=1";
				window.open(receiptWin , "" , "width=410,height=715, scrollbars=no,resizable=no");
<?php }elseif($TPL_VAR["pgCompany"]=='lg'){?>
				showReceiptByTID(shopid, tno, authdata);
<?php }elseif($TPL_VAR["pgCompany"]=='allat'){?>
				var allat_urls = "https://www.allatpay.com/servlet/AllatBizPop/member/pop_card_receipt.jsp?tx_seq_no="+tno+"&order_no="+ordno;
				window.open(allat_urls,"app","width=410,height=650,scrollbars=0");
<?php }elseif($TPL_VAR["pgCompany"]=='kspay'){?>
				var allat_urls = "https://nims.ksnet.co.kr/pg_infoc/src/bill/credit_view_print.jsp?tr_no="+tno;
				window.open(allat_urls,"app","width=456,height=700,scrollbars=1");
<?php }elseif($TPL_VAR["pgCompany"]=='kicc'){?>
				var status = "toolbar=0,scroll=1,menubar=0,status=0,resizable=0,width=380,height=700";
				$.get('/kicc/receipt?no='+ordno, function(data) {
					var url = data;
					if(url!='false'){
...
<div id="coupon_use_guide" class="hide">
	<table class="coupon_use_guide_tb" cellpadding="0" cellspacing="0" border="0">
		...
		<tr><td class="guide_img"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design/guide_img_cpn.jpg" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ndWlkZV9pbWdfY3BuLmpwZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL2d1aWRlX2ltZ19jcG4uanBn' designElement='image' /></td></tr>
