<?php /* Template_ 2.2.6 2022/04/04 18:31:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/service/company.html 000007434 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 회사소개 @@
...
<div class="visual_title" style="max-width:1260px; margin: 0px auto 40px auto; padding: 0 15px; box-sizing: border-box;">
	<div class="img_area">
		<img src="/data/skin/responsive_sports_sporti_gl_1/images/design/shop_company_img.jpg" alt="회사 이미지" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9zaG9wX2NvbXBhbnlfaW1nLmpwZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvc2VydmljZS9jb21wYW55Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL3Nob3BfY29tcGFueV9pbWcuanBn' designElement='image' />
	</div>
	<div class="visual_gon">
		<ul class="title_inner_a">
			<li>
				<p class="descr" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvc2VydmljZS9jb21wYW55Lmh0bWw="  style="color:white;">글로벌 K-POP 플랫폼</p> 
				<h2><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvc2VydmljZS9jb21wYW55Lmh0bWw="  style="color:white;">뮤직브로</span></h2>
			</li>
		</ul>
	</div>
</div>

<div class="visual_title" style="max-width:1260px; margin: 0 auto 50px auto; padding: 0 15px; box-sizing: border-box;">
	...
	<section id="timeline">
		...
		<div class="tl-item">
		    <div class="tl-bg" style="background-image: url(https://musicbroshop.com/data/skin/responsive_sports_sporti_gl_1/images/jacqueline-munguia-1pAwJiCD60c-unsplash.jpg)"></div>
		    <div class="tl-year">
		...
		<div class="tl-item">
		    <div class="tl-bg" style="background-image: url(https://musicbroshop.com/data/skin/responsive_sports_sporti_gl_1/images/laura-smetsers-St08jKkPVHw-unsplash.jpg)"></div>
		    <div class="tl-year">
