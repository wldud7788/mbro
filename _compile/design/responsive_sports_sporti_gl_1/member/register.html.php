<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/member/register.html 000006356 */  $this->include_("sslAction");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 회원가입 > 회원정보 입력 @@
...
<div class="title_container">
	<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL3JlZ2lzdGVyLmh0bWw=" >회원정보 입력</span></h2>
</div>
<div class="mypage_greeting Pb30">
	<span class="pilsu_icon"></span> <span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL3JlZ2lzdGVyLmh0bWw=" >항목은 <span class="pointcolor">필수 입력</span> 항목입니다.</span>
</div>
...
<?php $this->print_("form_member",$TPL_SCP,1);?>
	...
	<div id="btn_register" class="btn_area_c">
		<button type="submit" class="btn_resp size_c color2 Wmax"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL3JlZ2lzdGVyLmh0bWw=" >입력 완료</span></button>
	</div>
	</form>
</div>
