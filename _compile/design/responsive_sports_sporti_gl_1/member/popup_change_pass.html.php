<?php /* Template_ 2.2.6 2022/03/18 15:13:31 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/member/popup_change_pass.html 000005253 */ ?>
<style>
...
.keyboard_guide_img .keyboard_hangul {margin:20px auto 0 auto; width:290px; height:80px; background:url('/data/skin/responsive_sports_sporti_gl_1/images/common/keyboard.gif') no-repeat; background-size:100% auto}
.keyboard_guide_img .keyboard_specialchars {margin:20px auto 0 auto; width:290px; height:60px; background:url('/data/skin/responsive_sports_sporti_gl_1/images/common/keyboard.gif') no-repeat 0 -85px; background-size:100% auto; display:none;}
...
<div class="pw_ch_wrap">
	...
	<p class="Fs16 orange Pt5 Pb20">※ 비밀번호는 영문 대문자, 영문 소문자, 숫자, 특수문자 중 2가지 이상을 조합한 8~20자</p>
	...
	<input type='hidden' name='password_mode' value='update'>
		...
		<div class="keyboard_guide">
			<a href="#keyboard_specialchars" hrefOri='I2tleWJvYXJkX3NwZWNpYWxjaGFycw==' >특수 기호 보기</a>
			<a href="#keyboard_hangul" hrefOri='I2tleWJvYXJkX2hhbmd1bA==' >한글 보기</a>
			<a href="#keyboard_open" hrefOri='I2tleWJvYXJkX29wZW4=' >PC 키보드 보기 ▼</a>
			<a href="#keyboard_close" hrefOri='I2tleWJvYXJkX2Nsb3Nl' >PC 키보드 닫기 ▲</a>
