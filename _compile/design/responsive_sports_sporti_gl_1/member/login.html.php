<?php /* Template_ 2.2.6 2022/03/18 15:13:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/member/login.html 000008590 */  $this->include_("sslAction");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 로그인 @@
...
<div class="resp_login_wrap">
	<div id="loginTab" class="tab_basic fullsize Pt20">
		<ul>
			<li class="on"><a href="javascript:void(0)" data-tab="member" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL2xvZ2luLmh0bWw=" >회원</span></a></li>
			<li <?php if($TPL_VAR["mode"]=='settle'){?>style="display:none"<?php }?>><a href="javascript:void(0)" data-tab="nonmember" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL2xvZ2luLmh0bWw=" >비회원</span></a></li>
		</ul>
	</div>
</div>
	...
	<input type="hidden" name="order_auth" value="<?php echo $_GET["order_auth"]?>"/>
		<fieldset>
			<ul class="login_real_area">
				...
				<li class="find_join">
					<a href="../member/find?mode=findid" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL2xvZ2luLmh0bWw=" hrefOri='Li4vbWVtYmVyL2ZpbmQ/bW9kZT1maW5kaWQ=' >이메일아이디 찾기</a> &nbsp;|&nbsp;
					<a href="../member/find?mode=findpw" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL2xvZ2luLmh0bWw=" hrefOri='Li4vbWVtYmVyL2ZpbmQ/bW9kZT1maW5kcHc=' >비밀번호 찾기</a> &nbsp;|&nbsp;
					<a href="../member/agreement" class="Fw500 gray_01" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL2xvZ2luLmh0bWw=" hrefOri='Li4vbWVtYmVyL2FncmVlbWVudA==' >회원가입</a>
				</li>
			</ul>
...
<?php if($TPL_K1){?><li class="sns-login-button" snstype="<?php echo $TPL_K1?>"><div class="img"><img src="/data/skin/responsive_sports_sporti_gl_1/images/design/sns_icon_<?php echo $TPL_K1?>.png" alt="<?php echo $TPL_K1?> 로그인" title="<?php echo $TPL_V1['nm']?> 로그인" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9zbnNfaWNvbl97PS5rZXlffS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbWVtYmVyL2xvZ2luLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduL3Nuc19pY29uX3s9LmtleV99LnBuZw==' designElement='image' /></div></li><?php }?>
<?php }}?>
			</ul>
<?php }?>
