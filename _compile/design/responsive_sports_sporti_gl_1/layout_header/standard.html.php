<?php /* Template_ 2.2.6 2022/07/20 16:03:49 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_1/layout_header/standard.html 000032796 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #LAYOUT_HEADER @@
...
<style type="text/css">
  ...
  .other_subnav>li{position: relative;}
  ...
  .bmp_nav_text{
    ...
    background: linear-gradient(to right top, #FFA92F, #FCEAD6) !important;
    color: transparent !important;
    -webkit-background-clip: text !important;
    font-weight: bold !important;
  }
  .bmp_nav_text:hover{opacity: 0.8;}


  .rank_text{ 
    background: linear-gradient(to right top, #C34040, #FFBABA) !important;
    color: transparent !important;
    -webkit-background-clip: text !important;
    font-weight: bold !important;
    cursor: pointer;
  }
  .ranking_area{display: none; position: absolute;right: 0; z-index: 999999;}
  .ranking_nav:hover .ranking_area{display: block;}
...
<div id="layout_header" class="layout_header">  
  <div class="resp_wrap">
    <div class="logo_wrap">
      <!-- logo -->
      <h1 class="logo_area">
          <a href="https://musicbroshop.com/coin/coin_notice" class="bmp_nav_text" id="mb_bmpbi" style="font-size: 14px;" hrefOri='aHR0cHM6Ly9tdXNpY2Jyb3Nob3AuY29tL2NvaW4vY29pbl9ub3RpY2U=' >BMP CASH</a>
        <a href='/main/index' target='_self' style="max-width: 160px;" hrefOri='L21haW4vaW5kZXg=' ><img src="/data/skin/responsive_sports_sporti_gl_1/images/design_resp/white_logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbl9yZXNwL3doaXRlX2xvZ28ucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMS9pbWFnZXMvZGVzaWduX3Jlc3Avd2hpdGVfbG9nby5wbmc=' designElement='image' ></a>
      </h1>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
        <li class="user_info">
          <a href="/mypage" hrefOri='L215cGFnZQ==' ><?php if($TPL_VAR["userInfo"]["user_name"]){?><span class="u_name"><?php echo $TPL_VAR["userInfo"]["user_name"]?></span><?php }else{?><span class="u_id"><?php echo $TPL_VAR["userInfo"]["userid"]?></span><?php }?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >님 환영합니다!</span></a>
        </li>
        <li class="user_logout"><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >LOGOUT</a><?php }else{?><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
        <li class="user_logout"><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a></li>
<?php }else{?>
        <li class="user_login"><a href="/member/login" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9sb2dpbg==' >LOGIN</a></li>
        <li class="user_join">
          <a href="/member/agreement" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9hZ3JlZW1lbnQ=' >JOIN</a>
...
<?php }?>
        ...
        <li><a href="/mypage" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L215cGFnZQ==' >MYPAGE</a></li>
        
        <!-- <li><a href="/mypage/order_catalog" designElement="text" hrefOri='L215cGFnZS9vcmRlcl9jYXRhbG9n' >ORDER</a></li> -->
        <li class="respCartArea"><a href="/order/cart" hrefOri='L29yZGVyL2NhcnQ=' ><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >CART</span><span class="cart_cnt1"><?php echo $TPL_VAR["push_count_cart"]?></span></a></li>
        <li><a href="/service/cs" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L3NlcnZpY2UvY3M=' >CS CENTER</a></li>
        ...
        <li class="ranking_nav">
          <a class="rank_text">RANKING</a>
          <!-- 2022.07.20 iframe width, height 수정: 황혜찬 -->
          <iframe class="ranking_area" src="https://musicbroshop.com/page/index?tpl=etc%2Fguide2.html" style="border:0px #FFFFFF none;" name="test" scrolling="no" frameborder="0" marginheight="0px" marginwidth="0px" height="1150px" width="1400px"></iframe>
        </li>
...
<?php }?>
  ...
  <!--          <li class="custom_nav_link">
              ...
              <a class="categoryDepthLink" designElement="text" href="#" hrefOri='Iw==' ><em>LIVE</em></a>
                        ...
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#" hrefOri='Iw==' ><em>TV</em></a>
            </li>
                        <li class="menu_slash">/</li>
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#" hrefOri='Iw==' ><em>SALE</em></a>
            </li>
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzEvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#" hrefOri='Iw==' ><em>기획전</em></a>
            </li>
            <!--<li class="custom_nav_link">
