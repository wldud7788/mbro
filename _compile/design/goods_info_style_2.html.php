<?php /* Template_ 2.2.6 2022/09/14 10:54:26 /www/music_brother_firstmall_kr/data/design/goods_info_style_2.html 000008954 */ 
...
<?php }?>
			...
			<div class="infO_group">
				...
				<!-- 입점사명 작업 2022.09.13 황혜찬 -->
<?php if($TPL_V1["provider_name"]){?>
				<div class="goodS_info displaY_brand_name" style="display: none;">
					<a href="/mshop?m=<?php echo $TPL_V1["provider_seq"]?>" target="_blank" title="새창"><span class="areA"><?php echo $TPL_V1["provider_name"]?></span></a>
				</div>
<?php }?>
