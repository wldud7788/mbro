<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/promotion/event_list.html 000010878 */  $this->include_("setTemplatePath","showDesignBanner");
...
<?php if($TPL_V1["event_banner"]){?>
						<p class="image_event "><img class="event_list_banner" src="/data/event/<?php echo $TPL_V1["event_banner"]?>" alt="" designImgSrcOri='L2RhdGEvZXZlbnQvey5ldmVudF9iYW5uZXJ9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvZXZlbnQvey5ldmVudF9iYW5uZXJ9' designElement='image' /></p>
<?php }elseif($TPL_V1["joincheck_banner"]){?>
						<p class="image_event "><img class="event_list_banner" src="/data/joincheck/<?php echo $TPL_V1["joincheck_banner"]?>" alt="" designImgSrcOri='L2RhdGEvam9pbmNoZWNrL3suam9pbmNoZWNrX2Jhbm5lcn0=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvam9pbmNoZWNrL3suam9pbmNoZWNrX2Jhbm5lcn0=' designElement='image' /></p>
<?php }else{?>
<?php if($TPL_V1["joincheck_seq"]){?>
						<p class="no_image_event"><img src="/data/skin/responsive_ver1_default_gl/images/design/no_images_stamp.png" alt="출석체크 이벤트" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub19pbWFnZXNfc3RhbXAucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL25vX2ltYWdlc19zdGFtcC5wbmc=' designElement='image' /></p>
<?php }elseif($TPL_V1["gift_seq"]){?>
						<p class="no_image_event"><img src="/data/skin/responsive_ver1_default_gl/images/design/no_images_gift.png" alt="사은품 이벤트" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub19pbWFnZXNfZ2lmdC5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL25vX2ltYWdlc19naWZ0LnBuZw==' designElement='image' /></p>
<?php }elseif($TPL_V1["event_seq"]){?>
						<p class="no_image_event"><img src="/data/skin/responsive_ver1_default_gl/images/design/no_images_promotion.png" alt="할인/기획전 이벤트" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub19pbWFnZXNfcHJvbW90aW9uLnBuZw==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL25vX2ltYWdlc19wcm9tb3Rpb24ucG5n' designElement='image' /></p>
<?php }else{?>
						<img class="none" src="/data/skin/responsive_ver1_default_gl/images/design/noimg_thumb.gif" alt="이미지 준비중입니다" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub2ltZ190aHVtYi5naWY=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL25vaW1nX3RodW1iLmdpZg==' designElement='image' />
<?php }?>
<?php }?>
<?php if($TPL_V1["status"]=='close'){?><img class="close-icon" src="/data/icon/event/event_icon01.png" alt="마감임박" designImgSrcOri='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDEucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDEucG5n' designElement='image' /><?php }?>
<?php if($TPL_V1["status"]=='end'){?><img class="end-icon" src="/data/icon/event/event_icon02.png" alt="종료" designImgSrcOri='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDIucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDIucG5n' designElement='image' /><?php }?>
				</div>
				<div class="infobox">
...
<?php if($TPL_V1["status"]=='end'){?>
						<div class="until"><img src="/data/icon/event/event_end.gif" designImgSrcOri='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9lbmQuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvcHJvbW90aW9uL2V2ZW50X2xpc3QuaHRtbA==' designImgSrc='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9lbmQuZ2lm' designElement='image' /></div>
<?php }?>
				</div>
			</a>
		</li>
