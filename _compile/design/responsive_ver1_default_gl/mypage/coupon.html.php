<?php /* Template_ 2.2.6 2021/12/15 17:48:36 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/coupon.html 000020804 */  $this->include_("o2oFrontMypageCouponBarcode");
		...
		<div class="tab_basic size2">
			<ul>
				<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=1" hrefOri='L215cGFnZS9jb3Vwb24/dGFiPTE=' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL2NvdXBvbi5odG1s" >보유한 쿠폰</span>(<strong class="pointcolor2"><?php echo number_format($TPL_VAR["unusedcount"])?></strong>/<?php echo number_format($TPL_VAR["totalcount"])?>)</a>
				</li>
				<li <?php if($_GET["tab"]=='2'){?>class="on"<?php }?>>
					<a href="/mypage/coupon?tab=2" hrefOri='L215cGFnZS9jb3Vwb24/dGFiPTI=' ><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL2NvdXBvbi5odG1s" >다운로드 가능 쿠폰</span>(<?php echo number_format($TPL_VAR["svcount"])?>)</a>
				</li>
			</ul>
		</div>
				...
				$.ajax({
					...
					'success' : function(res){
						...
						if( res.result == 'goodsyes' ) {
							...
							$(".coupongoodsrevieweryes .issueGoods").find(".image").html("<img class=\"goodsThumbView\"  alt=\"\" src=\""+imgsrc+"\" width=\"50\" height=\"50\" designImgSrcOri='XA==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL2NvdXBvbi5odG1s' designImgSrc='XA==' designElement='image' >");
