<?php /* Template_ 2.2.6 2021/12/15 17:48:38 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/order_view.html 000132058 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==" >주문/배송 상세</span></h2>
		</div>
...
<?php }?>
				<li class="subject">
					<ul class="board_goods_list">
						<li class="pic">
<?php if($TPL_V2["goods_type"]=='gift'){?>
							<img src="<?php echo $TPL_V2["image"]?>" alt="" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='ey4uaW1hZ2V9' designElement='image' />
<?php }else{?>
							<a href='/goods/view?no=<?php echo $TPL_V2["goods_seq"]?>' target='_blank' title="새창" hrefOri='L2dvb2RzL3ZpZXc/bm89ey4uZ29vZHNfc2VxfQ==' ><img src="<?php echo $TPL_V2["image"]?>" alt="<?php echo $TPL_V1["goods_name"]?>" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='ey4uaW1hZ2V9' designElement='image' /></a>
<?php }?>
						</li>
						<li class="info">
							<div class="title">
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_ver1_default_gl/images/common/auth_img.png" height="17" alt="성인" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2F1dGhfaW1nLnBuZw==' designElement='image' />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_ver1_default_gl/images/common/plane.png" height="14" alt="해외배송상품" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL3BsYW5lLnBuZw==' designElement='image' />
<?php }?>
							</div>
...
<?php if($TPL_V3["opt_type"]=='opt'){?>
								<ul class="board_goods_list">
									<li class="pic">
										<img src="<?php echo $TPL_V3["image"]?>" alt="" designImgSrcOri='ey4uLmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='ey4uLmltYWdlfQ==' designElement='image' />
									</li>
									<li class="info">
										<div class="title">
...
<?php if($TPL_VAR["orders"]["typereceipt"]== 2){?> 현금영수증
						<img src="/data/skin/responsive_ver1_default_gl/images/design/btn_print_receipt.gif" id="pgcashbtn<?php echo $TPL_VAR["creceipt"]["tstep"]?>" class="hand" sales_seq="<?php echo $TPL_VAR["creceipt"]["seq"]?>"  order_seq ="<?php echo $TPL_VAR["orders"]["order_seq"]?>" cash_no="<?php echo $TPL_VAR["creceipt"]["cash_receipts_no"]?>" settleprice="<?php echo $TPL_VAR["orders"]["settleprice"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9idG5fcHJpbnRfcmVjZWlwdC5naWY=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL2J0bl9wcmludF9yZWNlaXB0LmdpZg==' designElement='image' />
...
<div id="coupon_use_guide" class="hide">
	<table class="coupon_use_guide_tb" cellpadding="0" cellspacing="0" border="0">
		...
		<tr><td class="guide_img"><img src="/data/skin/responsive_ver1_default_gl/images/design/guide_img_cpn.jpg" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ndWlkZV9pbWdfY3BuLmpwZw==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL29yZGVyX3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL2d1aWRlX2ltZ19jcG4uanBn' designElement='image' /></td></tr>
