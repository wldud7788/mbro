<?php /* Template_ 2.2.6 2022/02/25 18:59:42 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/board/video/gallery01/index.html 000013492 */  $this->include_("sslAction");
...
.boad_view_btn:hover{opacity: 0.7; transition: all 0.3s;}
...
<?php if($TPL_loop_1){foreach($TPL_VAR["loop"] as $TPL_V1){?>
	<li class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>"  viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>" style="cursor: pointer;">
		<ul class="custom_board_img_area">
			<li>
				<!-- 20220216 여기-->
				<span>
					<img id="video_img" class="image_thumb yutube_img" style="width: 500px; height: 300px; position: absolute;" src="https://img.youtube.com/vi/<?php echo $TPL_V1["video_url"]?>/maxresdefault.jpg" designImgSrcOri='aHR0cHM6Ly9pbWcueW91dHViZS5jb20vdmkvey52aWRlb191cmx9L21heHJlc2RlZmF1bHQuanBn' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvdmlkZW8vZ2FsbGVyeTAxL2luZGV4Lmh0bWw=' designImgSrc='aHR0cHM6Ly9pbWcueW91dHViZS5jb20vdmkvey52aWRlb191cmx9L21heHJlc2RlZmF1bHQuanBn' designElement='image' />
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li class="c_hit">조회 <?php echo $TPL_V1["hit"]?></li><?php }?>
			...
			<li class="c_short_code" onclick="location.href='<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>';">
				<div class="board_detail_contents"><?php echo $TPL_V1["contentcut"]?></div>
			</li>
