<?php /* Template_ 2.2.6 2022/02/15 15:42:35 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/board/video/gallery01/view.html 000010648 */  $this->include_("sslAction","snslinkurl");
...
<?php if($TPL_V1["is_image"]){?>
				<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');" ><img src="/data/skin/responsive_ver1_default_gl/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vLi4vLi4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvdmlkZW8vZ2FsbGVyeTAxL3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvaWNvbi9pY29uX3pvb20uZ2lm' designElement='image' /></span>
<?php }?>
		</li>
<?php }}?>
	</ul>
