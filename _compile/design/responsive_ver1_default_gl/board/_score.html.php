<?php /* Template_ 2.2.6 2021/12/15 17:48:34 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/board/_score.html 000009622 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 게시글/댓글 평가 @@
		...
		<table style="width:300px;margin:auto;border:0px dashed black;padding:5px;"> 
			...
			<tr  align="center">  
				<td>
					...
					<div><span class="icon_recommend1_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?>  icon_recommend1_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="recommend1"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_recommend1_src"]?>" class="icon_recommend1_img" designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kMV9zcmN9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvX3Njb3JlLmh0bWw=' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kMV9zcmN9' designElement='image' /></span></div>
				...
				<td>
					...
					<div><span class="icon_recommend4_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?>  icon_recommend4_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="recommend4"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_recommend4_src"]?>" class="icon_recommend4_img" designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kNF9zcmN9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvX3Njb3JlLmh0bWw=' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kNF9zcmN9' designElement='image' /></span></div>
				...
				<td>
					...
					<div><span class="icon_recommend5_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?>  icon_recommend5_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="recommend5"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_recommend5_src"]?>" class="icon_recommend5_img" designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kNV9zcmN9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvX3Njb3JlLmh0bWw=' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kNV9zcmN9' designElement='image' /></span></div>
...
<?php if($TPL_VAR["managerview"]["icon_recommend_src"]&&$TPL_VAR["managerview"]["icon_none_rec_src"]){?>
		<table style="width:100px;margin:auto;border:0px dashed black;padding:5px;"> 
			...
			<tr align="center"> 
				<td >
					<span class="icon_recommend_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?> icon_recommend_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="recommend"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_recommend_src"]?>" class="icon_recommend_img" designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kX3NyY30=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvX3Njb3JlLmh0bWw=' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kX3NyY30=' designElement='image' /></span>
				</td>
				<td><span class="idx-recommend-<?php echo $TPL_VAR["seq"]?>"><?php echo number_format($TPL_VAR["recommend"])?></span></td>  
				<td><span class="icon_none_rec_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?>  icon_none_rec_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="none_rec"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_none_rec_src"]?>"  class="icon_none_rec_img"  designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fbm9uZV9yZWNfc3JjfQ==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvX3Njb3JlLmh0bWw=' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fbm9uZV9yZWNfc3JjfQ==' designElement='image' /></span></td>
