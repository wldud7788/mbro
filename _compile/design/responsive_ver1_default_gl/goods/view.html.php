<?php /* Template_ 2.2.6 2022/01/18 15:21:47 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/view.html 000113533 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php if($TPL_VAR["navercheckout_tpl"]){?>
							<li class="npay_area"><button type="button" id="npay_btn" class="btn_resp size_c"></button></li>
<?php }?>
...
<?php if($TPL_info_1){foreach($TPL_VAR["info"] as $TPL_V1){?>
				<img src="<?php echo $TPL_V1["url"]?>" designImgSrcOri='ez1pbmZvLnVybH0=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='ez1pbmZvLnVybH0=' designElement='image' ><br>
<?php }}?>
			</center>
