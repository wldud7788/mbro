<?php /* Template_ 2.2.6 2021/12/15 17:48:34 /www/music_brother_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/brand_main.html 000008265 */  $this->include_("assignBrandMenuData","setTemplatePath","showDesignBanner");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 브랜드 메인 @@
...
<?php if(in_array('kor',$TPL_VAR["page_config"]["search_filter"])||in_array('eng',$TPL_VAR["page_config"]["search_filter"])){?>
		<div class="resp_brand_search_btns">
			<ul>
				<li><a href="javascript:void(0)" class="alphabet_btn all on" data-target="all" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvYnJhbmRfbWFpbi5odG1s" >ALL</span></a></li>
		...
		<ul class="brandwrap all brand<?php echo $TPL_V1["category_code"]?>" >
			<li>
				<a class="brand_list_block" <?php if($TPL_V1["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V1["category_code"]?>" hrefOri='L2dvb2RzL2JyYW5kP2NvZGU9ey5jYXRlZ29yeV9jb2RlfQ==' >
					<img src="<?php echo $TPL_V1["brand_image"]?>" alt="<?php echo $TPL_V1["prn_title"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif';" designImgSrcOri='ez0uYnJhbmRfaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvYnJhbmRfbWFpbi5odG1s' designImgSrc='ez0uYnJhbmRfaW1hZ2V9' designElement='image' />
					<span class="name">
						<?php echo $TPL_V1["prn_title"]?>

<?php if($TPL_V1["best"]=='Y'&&$TPL_VAR["brand_best_icon"]){?>
						<img class="icon" src="<?php echo $TPL_VAR["brand_best_icon"]?>" alt="best" onerror="this.src='/data/icon/goods/error/noimage_list.gif';" designImgSrcOri='e2JyYW5kX2Jlc3RfaWNvbn0=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvYnJhbmRfbWFpbi5odG1s' designImgSrc='e2JyYW5kX2Jlc3RfaWNvbn0=' designElement='image' />
<?php }?>
					</span>
				</a>
			</li>
		...
		<ul class="brandwrap brand<?php echo $TPL_V2["category_code"]?> wrap<?php echo str_replace("/","",strtr(base64_encode(str_replace("/","",$TPL_K1)),"+=","-_"))?>" style="display: none">
			<li>
				<a class="brand_list_block" <?php if($TPL_V2["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V2["category_code"]?>" hrefOri='L2dvb2RzL2JyYW5kP2NvZGU9ey4uY2F0ZWdvcnlfY29kZX0=' >
					<img src="<?php echo $TPL_V2["brand_image"]?>" alt="<?php echo $TPL_V2["prn_title"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif';" designImgSrcOri='ez0uLmJyYW5kX2ltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvYnJhbmRfbWFpbi5odG1s' designImgSrc='ez0uLmJyYW5kX2ltYWdlfQ==' designElement='image' />
					<span class="name">
