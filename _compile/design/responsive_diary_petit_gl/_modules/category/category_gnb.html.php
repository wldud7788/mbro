<?php /* Template_ 2.2.6 2021/03/31 17:54:26 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/_modules/category/category_gnb.html 000002224 */ 
...
<?php if($TPL_category_1){foreach($TPL_VAR["category"] as $TPL_V1){?>
	<li class="categoryDepth1">
		<a class="categoryDepthLink" href="/goods/catalog?code=<?php echo $TPL_V1["category_code"]?>" hrefOri='L2dvb2RzL2NhdGFsb2c/Y29kZT17LmNhdGVnb3J5X2NvZGV9' ><em><?php echo $TPL_V1["name"]?></em></a>
...
<!-- 	<li class="categoryDepth1 m_wine">
		<a class="categoryDepthLink" href="#" hrefOri='Iw==' ><em>Oil</em></a>
	</li> -->
<?php }}?>
