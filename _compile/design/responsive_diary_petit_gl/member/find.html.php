<?php /* Template_ 2.2.6 2021/02/22 16:08:37 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/member/find.html 000027882 */  $this->include_("sslAction");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 아이디/비밀번호 찾기 @@
...
<div class="resp_login_wrap Mt10">
	...
	<div class="tab_basic fullsize Mb0">
		<ul id="idPwTab">
			<li class="on"><a href="javascript:void(0)" data-tab="idFindArea" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >아이디 찾기</span></a></li>
			<li><a href="javascript:void(0)" data-tab="pwFindArea" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >비밀번호 찾기</span></a></li>
		</ul>
	</div>
...
<?php }?>
					...
					<ul id="phone_id_tab" class="find_confirm" <?php if($TPL_VAR["realnameinfo"]["useRealnamephone"]!='Y'){?>style="display:none;"<?php }?>>
						<li class="img"><img src="/data/skin/responsive_diary_petit_gl/images/common/join_img_phone.gif" alt="휴대폰 인증" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9qb2luX2ltZ19waG9uZS5naWY=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vam9pbl9pbWdfcGhvbmUuZ2lm' designElement='image' /></li>
						<li class="contents">
						...
						<li class="btns">
							<a href="javascript:phonePopup('id');" class="btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDpwaG9uZVBvcHVwKA==' ><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >휴대폰 인증</span></a>
						</li>
					</ul>
<?php if($TPL_VAR["realnameinfo"]["realnameId"]){?>
					<!-- 아이핀 -->
					<ul id="ipin_id_tab" class="find_confirm" <?php if($TPL_VAR["realnameinfo"]["useRealnamephone"]=='Y'){?>style="display:none;"<?php }?>>
						<li class="img"><img src="/data/skin/responsive_diary_petit_gl/images/common/join_img_ipin.gif" alt="아이핀 인증" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9qb2luX2ltZ19pcGluLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vam9pbl9pbWdfaXBpbi5naWY=' designElement='image' /></li>
						<li class="contents">
						...
						<li class="btns">
							<a href="javascript:ipinPopup('id');" class="btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDppcGluUG9wdXAo' ><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >아이핀 인증</span></a>
						</li>
					</ul>
					<!-- 안심체크 -->
					<ul id="auth_id_tab" class="find_confirm" style="display:none;">
						<li class="img"><img src="/data/skin/responsive_diary_petit_gl/images/common/join_img_name.gif" alt="안심체크 인증" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9qb2luX2ltZ19uYW1lLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vam9pbl9pbWdfbmFtZS5naWY=' designElement='image' /></li>
						<li class="contents">
						...
						<li class="btns">
							<a href="javascript:checkPopup('id');" class="btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDpjaGVja1BvcHVwKA==' ><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >안심체크 인증</span></a>
						</li>
					</ul>
<?php }?>
<?php }?>
			...
			<div id="findidresultlay" class="find_id_result" style="display:none;">
				<div class="auth_result">
					...
					<div class="findidresultok1 findidresultok2 findidresultok3 btn_area_c hide">
						<a href="javascript:;" class="btn_find_pw btn_resp size_c color2" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >비밀번호 찾기</span></a>
						<a href="/member/login?return_url=/main" class="btn_resp size_c color5" hrefOri='L21lbWJlci9sb2dpbj9yZXR1cm5fdXJsPS9tYWlu' ><span designElement="text" textIndex="29"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >로그인</span></a>
					</div>
					<div class="findidresultfalse btn_area_c hide">
						<a href="javascript:;" class="btn_find_id btn_resp size_c color2" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="30"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >아이디 찾기</span></a>
						<a href="/member/agreement" class="btn_resp size_c color5" hrefOri='L21lbWJlci9hZ3JlZW1lbnQ=' ><span designElement="text" textIndex="31"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >회원가입</span></a>
					</div>
				</div>
			</div>
		</form>
...
<?php if($TPL_VAR["realnameinfo"]["useRealnamephone"]=='Y'){?>
					<ul id="phone_pw_tab" class="find_confirm" <?php if($TPL_VAR["realnameinfo"]["useRealnamephone"]!='Y'){?> style="display:none;"<?php }?>>
						...
						<li class="btns">
							<a href="javascript:phonePopup('pw');" class="btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDpwaG9uZVBvcHVwKA==' ><span designElement="text" textIndex="39"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >휴대폰 인증</span></a>
						</li>
					</ul>
<?php }?>
<?php if($TPL_VAR["realnameinfo"]["realnameId"]){?>
					...
					<ul id="ipin_pw_tab" class="find_confirm" <?php if($TPL_VAR["realnameinfo"]["useRealnamephone"]=='Y'){?> style="display:none;"<?php }?>>
						...
						<li class="btns">
							<a href="javascript:ipinPopup('pw');" class="btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDppcGluUG9wdXAo' ><span designElement="text" textIndex="41"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >아이핀 인증</span></a>
						</li>
					</ul>
					<!-- 안심체크 -->
					<ul id="auth_pw_tab" class="find_confirm" style="display:none;">
						...
						<li class="btns">
							<a href="javascript:checkPopup('pw');" class="btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDpjaGVja1BvcHVwKA==' ><span designElement="text" textIndex="43"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >안심체크 인증</span></a>
						</li>
					</ul>
<?php }?>
<?php }?>
			...
			<div id="findpwresultlay" class="find_id_result" style="display:none;">
				<div class="auth_result">
					...
					<div class="findpwresultok1 findpwresultok2 findpwresultok3 btn_area_c hide">
						<a href="/member/login?return_url=/main" class="btn_resp size_c color2 Wmax" designElement="text" textIndex="59"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" hrefOri='L21lbWJlci9sb2dpbj9yZXR1cm5fdXJsPS9tYWlu' >로그인</a>
					</div>
					<div class="findpwresultfalse1 btn_area_c hide">
						<a href="javascript:;" class="btn_find_pw btn_resp size_c color2" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="60"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >비밀번호 찾기</span></a>&nbsp;
						<a href="/member/agreement" class="btn_resp size_c color5" designElement="text" textIndex="61"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" hrefOri='L21lbWJlci9hZ3JlZW1lbnQ=' >회원가입</a>
					</div>
					<div class="findpwresultfalse2 btn_area_c hide">
						<a href="javascript:;" class="btn_find_id btn_resp size_c color2 Wmax" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="62"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvZmluZC5odG1s" >아이디 찾기</span></a>
					</div>
				</div>
			</div>
			<!-- //비밀번호 찾기 결과 -->
