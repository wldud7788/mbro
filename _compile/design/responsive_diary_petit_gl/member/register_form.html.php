<?php /* Template_ 2.2.6 2021/03/12 17:21:55 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/member/register_form.html 000039625 */ 
...
<?php }else{?>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이디</p></li>
					<li class="td"><?php echo $TPL_VAR["userid"]?></li>
				</ul>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >기존 비밀번호</p></li>
					<li class="td">
						<input type="password" name="old_password" value="" class="eng_only" />
					</li>
				</ul>
				<ul>
					<li class="th"><p designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >신규 비밀번호</p></li>
					<li class="td">
...
<?php if($TPL_VAR["joinform"]["user_name_use"]=='Y'){?>
				<ul <?php if($TPL_VAR["joinform"]["user_name_required"]=='Y'){?>class="required"<?php }?>>
					<li class="th"><p designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >이름</p></li>
					<li class="td">
...
<?php if($TPL_VAR["joinform"]["email_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["email_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이디/이메일</p></li>
				<li class="td">
...
<?php }}?>
					...
					<div class="Pt10">
						<label><input type="checkbox" name="mailing" value="Y" /> <span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >정보메일을 수신하겠습니다.</span></label>
					</div>
					<p class="Pt10 desc" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >이메일 수신에 동의하시면 여러가지 할인혜택과 각종 이벤트 정보를 받아보실 수 있습니다.<br />회원가입관련, 주문배송관련 등의 메일은 수신동의와 상관없이 모든 회원에게 발송됩니다.<br /></p>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["member_seq"]){?>
				<ul class="required">
					<li class="th "><p designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >기존 비밀번호</p></li>
					<li class="td">
						<input type="password" name="old_password" value="" class="eng_only" />
					</li>
				</ul>
				<ul>
					<li class="th"><p designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >신규 비밀번호</p></li>
					<li class="td">
						<input type="password" name="new_password" value="" class="eng_only" placeholder="공백 없는 영문/숫자 포함 6~20자" />
					</li>
				</ul>
<?php }else{?>
				<ul class="required">
					<li class="th "><p designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >비밀번호</p></li>
					<li class="td">
						<input type="password" name="password" value="" class="eng_only" placeholder="공백 없는 영문/숫자 포함 6~20자" />
					</li>
				</ul>
				<ul class="required">
					<li class="th "><p designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >비밀번호 확인</p></li>
					<li class="td">
...
<?php if($TPL_VAR["joinform"]["user_name_use"]=='Y'){?>
				<ul <?php if($TPL_VAR["joinform"]["user_name_required"]=='Y'){?>class="required"<?php }?>>
					<li class="th "><p designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >이름</p></li>
					<li class="td">
						<input type="text" name="user_name" value="<?php echo $TPL_VAR["user_name"]?>" <?php if($TPL_VAR["user_name"]){?>readonly<?php }?> />
					</li>
				</ul>
...
<?php if($TPL_VAR["joinform"]["phone_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["phone_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >전화번호</p></li>
				<li class="td">
...
<?php if($TPL_VAR["joinform"]["cellphone_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["cellphone_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >휴대폰번호</p></li>
				<li class="td">
...
<?php if($TPL_VAR["confirmPhone"]=='Y'){?>
					...
					<button type="button" class="btn_resp size_b color2" onclick="authphone_popup('cellphone');"><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >휴대폰인증</span></button>
<?php }?>
					<div class="Pt10">
						<label><input type="checkbox" name="sms" value="Y" /> <span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >SMS를 수신하겠습니다.</span></label>
					</div>
					<p class="Pt10 desc" designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >SMS 수신에 동의하시면 여러가지 할인혜택과 각종 이벤트 정보를 받아보실 수 있습니다.<br />회원가입관련, 주문배송관련 등의 SMS는 수신동의와 상관없이 구매 회원에게 발송됩니다.<br /></p>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["joinform"]["address_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["address_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >주소</p></li>
				<li class="td">
					...
					<button type="button" class="btn_resp size_b color4" onclick="openDialogZipcode_resp('member');"><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >주소찾기</span></button>
...
<?php if($TPL_VAR["joinform"]["nickname_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["nickname_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >닉네임</p></li>
				<li class="td">
...
<?php if($TPL_VAR["joinform"]["birthday_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["birthday_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >생년월일</p></li>
				<li class="td">
					<label>
						<input type="text" name="birthday" value="<?php echo $TPL_VAR["birthday"]?>" class="datepicker" style="width:110px;" readonly />
						<span class="btn_resp size_b" designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >찾기</span>
					</label>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["joinform"]["anniversary_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["anniversary_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >기념일</p></li>
				<li class="td">
...
<?php }}?>
					</select> <span designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >월</span> &nbsp;
					<select name="anniversary[]">
						<option value="">선택</option>
...
<?php }}?>
					</select> <span designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >일</span>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["joinform"]["sex_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["sex_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >성별</p></li>
				<li class="td designed_radio_checkbox join_form">
					<label><input type="radio" name="sex" value="male" <?php if($TPL_VAR["sex"]=='male'){?>checked<?php }?> /> <span designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >남성</span></label>
					<label><input type="radio" name="sex" value="female"  <?php if($TPL_VAR["sex"]=='female'){?>checked<?php }?>  /> <span designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >여성</span></label>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["joinform"]["user_icon"]=='Y'){?>
			<ul>
				<li class="th"><p designElement="text" textIndex="29"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이콘</p></li>
				<li class="td">
...
<?php if($TPL_memberIcondata_1){$TPL_I1=-1;foreach($TPL_VAR["memberIcondata"] as $TPL_V1){$TPL_I1++;?>
							<li>
								<label class="lab1">
									...
									<img src="/data/icon/member/<?php echo $TPL_V1?>" class="icon_membericon" designImgSrcOri='L2RhdGEvaWNvbi9tZW1iZXIvey52YWx1ZV99' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s' designImgSrc='L2RhdGEvaWNvbi9tZW1iZXIvey52YWx1ZV99' designElement='image' />
								</label>
							</li>
<?php }}?>
<?php if($TPL_VAR["member_seq"]){?>
							<li>
								<label class="lab1 L">
									...
									<img src="/data/icon/member/<?php echo $TPL_VAR["user_icon_file"]?>" id="membericon_img" <?php if(!$TPL_VAR["user_icon_file"]){?> class="hide" <?php }?> designImgSrcOri='L2RhdGEvaWNvbi9tZW1iZXIve3VzZXJfaWNvbl9maWxlfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s' designImgSrc='L2RhdGEvaWNvbi9tZW1iZXIve3VzZXJfaWNvbl9maWxlfQ==' designElement='image' />
								</label>
							</li>
<?php }?>
					</ul>
...
<?php if($TPL_VAR["member_seq"]&&$TPL_VAR["recommend"]){?>
				<ul <?php if($TPL_VAR["joinform"]["recommend_required"]=='Y'){?>class="required"<?php }?>>
					<li class="th "><p designElement="text" textIndex="30"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >추천인ID</p></li>
					<li class="td"><?php echo $TPL_VAR["recommend"]?></li>
				</ul>
<?php }elseif(!$TPL_VAR["member_seq"]){?>
				<ul <?php if($TPL_VAR["joinform"]["recommend_required"]=='Y'){?>class="required"<?php }?>>
					<li class="th "><p designElement="text" textIndex="31"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >추천인ID</p></li>
					<li class="td">
...
<?php if($TPL_VAR["emoneyapp"]["emoneyJoiner"]> 0){?>
							<li><p designElement="text" textIndex="32"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >추천인ID 입력시 - 마일리지 <span class="pointcolor"><?php echo number_format($TPL_VAR["emoneyapp"]["emoneyJoiner"])?></span>원 추가지급</p></li>
<?php }?>
<?php if($TPL_VAR["emoneyapp"]["emoneyRecommend"]> 0){?>
							<li><p designElement="text" textIndex="33"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >추천받은 회원 - 마일리지 <span class="pointcolor2"><?php echo $TPL_VAR["emoneyapp"]["emoneyRecommend"]?></span>원 지급</p></li>
<?php }?>
						</ul>
					</li>
				</ul>
...
<?php if($TPL_VAR["fb_invite"]){?>
			<ul>
				<li class="th "><p designElement="text" textIndex="34"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >Facebook 초대한ID</p></li>
...
<?php if($TPL_VAR["sns_change"]== 0){?>
				<ul>
					<li class="th"><p designElement="text" textIndex="35"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이디 / 비밀번호</p></li>
					<li class="td"><span designElement="text" textIndex="36"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아직 등록하지 않았습니다.</span> <button type="button" class="btn_resp size_b color2" onclick="sns_change_id();"><span designElement="text" textIndex="37"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >등록</span></button></li>
				</ul>
<?php }else{?>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="38"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이디</p></li>
					<li class="td"><?php echo $TPL_VAR["userid"]?></li>
				</ul>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="39"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >기존 비밀번호</p></li>
					<li class="td"><input type="password" name="old_password" value="" class="eng_only" /></li>
				</ul>
				<ul>
					<li class="th"><p designElement="text" textIndex="40"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >신규 비밀번호</p></li>
					<li class="td">
						<input type="password" name="new_password" value="" class="eng_only" placeholder="공백 없는 영문/숫자 포함 6~20자" />
					</li>
				</ul>
...
<?php }else{?>
			<ul class="required">
				<li class="th"><p designElement="text" textIndex="41"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이디</p></li>
				<li class="td">
<?php if($TPL_VAR["member_seq"]){?>
					<?php echo $TPL_VAR["userid"]?>
...
<?php if($TPL_VAR["member_seq"]){?>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="42"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >기존 비밀번호</p></li>
					<li class="td"><input type="password" name="old_password" value="" class="eng_only" /></li>
				</ul>
				<ul>
					<li class="th"><p designElement="text" textIndex="43"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >신규 비밀번호</p></li>
					<li class="td">
						<input type="password" name="new_password" value="" class="eng_only" placeholder="공백 없는 영문/숫자 포함 6~20자" />
					</li>
				</ul>
<?php }else{?>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="44"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >비밀번호</p></li>
					<li class="td">
						<input type="password" name="password" value="" class="eng_only" placeholder="공백 없는 영문/숫자 포함 6~20자" />
					</li>
				</ul>
				<ul class="required">
					<li class="th"><p designElement="text" textIndex="45"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >비밀번호 확인</p></li>
					<li class="td">
						<input type="password" name="re_password" value="" class="eng_only" />
					</li>
				</ul>
...
<?php if($TPL_VAR["joinform"]["nickname_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["nickname_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th "><p designElement="text" textIndex="46"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >닉네임</p></li>
				<li class="td">
					<input type="text" name="nickname" value="<?php echo $TPL_VAR["nickname"]?>" maxlength="10" />
				</li>
			</ul>
...
<?php if($TPL_VAR["joinform"]["bname_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bname_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="47"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >업체명</p></li>
...
<?php if($TPL_VAR["joinform"]["bceo_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bceo_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="48"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >대표자명</p></li>
...
<?php if($TPL_VAR["joinform"]["bno_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bno_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="49"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >사업자 등록번호</p></li>
				<li class="td">
...
<?php if($TPL_VAR["joinform"]["bitem_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bitem_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="50"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >업태</p></li>
				<li class="td"><input type="text" name="bitem" value="<?php echo $TPL_VAR["bitem"]?>" /></li>
			</ul>
			<ul <?php if($TPL_VAR["joinform"]["bitem_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="51"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >종목</p></li>
...
<?php if($TPL_VAR["joinform"]["badress_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["badress_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="52"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >사업장 주소</p></li>
				<li class="td">
					...
					<button type="button" class="btn_resp size_b color4" onclick="openDialogZipcode_resp('business')"><span designElement="text" textIndex="53"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >주소찾기</span></button>
					<div class="address_area">
...
<?php if($TPL_VAR["joinform"]["bperson_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bperson_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="54"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >담당자 명</p></li>
...
<?php if($TPL_VAR["joinform"]["bpart_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bpart_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="55"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >담당자 부서명</p></li>
...
<?php if($TPL_VAR["joinform"]["bemail_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bemail_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="56"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >이메일</p></li>
				<li class="td">
					<input type="email" name="email[0]" value="<?php echo str_split_arr($TPL_VAR["email"],'@', 0)?>" class="size_mail1" /> @
					<input type="email" name="email[1]" value="<?php echo str_split_arr($TPL_VAR["email"],'@', 1)?>" class="size_mail2" />
					<select name="find_email" id="find_email">
...
<?php }}?>
					...
					<div class="Pt10">
						<label><input type="checkbox" name="mailing" value="Y" /> <span designElement="text" textIndex="57"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >정보메일을 수신하겠습니다.</span></label>
					</div>
					<p class="Pt10 desc" designElement="text" textIndex="58"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >이메일 수신에 동의하시면 여러가지 할인혜택과 각종 이벤트 정보를 받아보실 수 있습니다.<br />회원가입관련, 주문배송관련 등의 메일은 수신동의와 상관없이 모든 회원에게 발송됩니다.<br /></p>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["joinform"]["bphone_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bphone_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="59"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >전화번호</p></li>
				<li class="td">
...
<?php if($TPL_VAR["joinform"]["bcellphone_use"]=='Y'){?>
			<ul <?php if($TPL_VAR["joinform"]["bcellphone_required"]=='Y'){?>class="required"<?php }?>>
				<li class="th"><p designElement="text" textIndex="60"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >휴대폰번호</p></li>
				<li class="td">
...
<?php }?>
					<div class="Pt10">
						<label><input type="checkbox" name="sms" value="Y" /> <span designElement="text" textIndex="61"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >SMS를 수신하겠습니다.</span></label>
					</div>
					<p class="Pt10 desc" designElement="text" textIndex="62"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >SMS 수신에 동의하시면 여러가지 할인혜택과 각종 이벤트 정보를 받아보실 수 있습니다.<br />회원가입관련, 주문배송관련 등의 SMS는 수신동의와 상관없이 구매 회원에게 발송됩니다.<br /></p>
				</li>
			</ul>
<?php }?>
<?php if($TPL_VAR["joinform"]["user_icon"]=='Y'){?>
			<ul>
				<li class="th"><p designElement="text" textIndex="63"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >아이콘</p></li>
				<li class="td">
					<ul class="member_icon_list">
<?php if($TPL_memberIcondata_1){$TPL_I1=-1;foreach($TPL_VAR["memberIcondata"] as $TPL_V1){$TPL_I1++;?>
							<li>
...
<?php }?>
					-->
<?php if($TPL_VAR["emoneyapp"]["emoneyJoiner"]> 0){?>
						<li><p designElement="text" textIndex="64"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >추천인ID 입력시 - 마일리지 <span class="pointcolor"><?php echo number_format($TPL_VAR["emoneyapp"]["emoneyJoiner"])?></span>원 추가지급</p></li>
<?php }?>
<?php if($TPL_VAR["emoneyapp"]["emoneyRecommend"]> 0){?>
						<li><p designElement="text" textIndex="65"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9tZW1iZXIvcmVnaXN0ZXJfZm9ybS5odG1s" >추천받은 회원 - 마일리지 <span class="pointcolor2"><?php echo $TPL_VAR["emoneyapp"]["emoneyRecommend"]?></span>원 지급</p></li>
<?php }?>
					</ul>
				</li>
			</ul>
