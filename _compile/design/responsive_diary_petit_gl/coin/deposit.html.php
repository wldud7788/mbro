<?php /* Template_ 2.2.6 2020/12/15 18:55:17 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/coin/deposit.html 000000997 */  $this->include_("sslAction");?>
<!-- 탭 -->
	...
	<form name="loginmove" target="actionFrame" method="post" action="<?php echo sslAction('../coin/order')?>">
		<fieldset>
			<li class="input_area">
				...
				<input type="text" name="money" class="box_id" placeholder="코인금액" required="required" />
			</li>
			<br>
			<li>
