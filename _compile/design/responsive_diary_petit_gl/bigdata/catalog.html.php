<?php /* Template_ 2.2.6 2020/10/15 17:39:16 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/bigdata/catalog.html 000012655 */  $this->include_("snslinkurl");
...
<div class="visual_title">
	<div class="img_area">
		<img src="/data/bigdata/<?php echo $TPL_VAR["cfg_bigdata"]["banner"]?>" designImgSrcOri='L2RhdGEvYmlnZGF0YS97PSBjZmdfYmlnZGF0YS5iYW5uZXJ9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvYmlnZGF0YS97PSBjZmdfYmlnZGF0YS5iYW5uZXJ9' designElement='image' />
	</div>
...
<?php if($TPL_icons_1){foreach($TPL_VAR["icons"] as $TPL_V1){?>
					<img src="/data/icon/goods/<?php echo $TPL_V1["codecd"]?>.gif" alt="" designImgSrcOri='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designElement='image' />
<?php }}?>
			</span>
		</p>
	</div>
	...
	<div class="event_datetime" style="background:<?php echo $TPL_VAR["goodsinfo"]["event"]["bgcolor"]?>;">
		<ul class="event_wrap">
			...
			<li class="remain_time">
				<span class="title" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==" >남은시간</span>
...
<?php if($TPL_images_1){$TPL_I1=-1;foreach($TPL_VAR["images"] as $TPL_V1){$TPL_I1++;?>
						<div class="main_tabs_contents slide <?php if($TPL_I1== 0){?>active<?php }?>" id="slide<?php echo $TPL_I1?>" style="<?php if($TPL_I1!= 0){?>display:none;<?php }?>">
							<a href="javascript:;" hrefOri='amF2YXNjcmlwdDo7' >
...
<?php }else{?>
								<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_wide.gif'" title="<?php echo $TPL_V1[ 1]["large"]["label"]?>" designImgSrcOri='ey52aWV3LmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='ey52aWV3LmltYWdlfQ==' designElement='image' />
<?php }?>
							</a>
					</div>
<?php }}?>
...
<?php }else{?>
				<a href="javascript:;" hrefOri='amF2YXNjcmlwdDo7' ><img src="<?php echo $TPL_VAR["images"][ 1]["view"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif'" title="<?php echo $TPL_VAR["images"][ 1]["large"]["label"]?>" designImgSrcOri='e2ltYWdlc1sxXS52aWV3LmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='e2ltYWdlc1sxXS52aWV3LmltYWdlfQ==' designElement='image' /></a>
<?php }?>
				
				<div style="margin:10px auto; text-align:center; display:none;">
<?php if($TPL_images_1){$TPL_I1=-1;foreach($TPL_VAR["images"] as $TPL_V1){$TPL_I1++;?>
					<img src="/data/skin/responsive_diary_petit_gl/images/design/intro_dot<?php if($TPL_I1== 0){?>_on<?php }?>.png" class="dot_paging hand" id="dot_<?php echo $TPL_I1?>" idx="<?php echo $TPL_I1?>" <?php if($TPL_V1["view"]["match_color"]){?> color="<?php echo $TPL_V1["view"]["match_color"]?>" <?php }?> designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9pbnRyb19kb3R7PyAuaW5kZXhfID09IDB9X29uey99LnBuZw==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vaW50cm9fZG90ez8gLmluZGV4XyA9PSAwfV9vbnsvfS5wbmc=' designElement='image' />
<?php }}?>
				</div>
			</div>
			<!-- ++++++++++++++++++++++++ //상품 이미지 ++++++++++++++++++++++++ -->
			...
			<div id="goods_spec" style="border-top:none;">
				...
				<!-- 확대/sns -->
				<div class="dcont_b1">
					<div class="Fl"><a href="javascript:popup('../goods/zoom?no=<?php echo $TPL_VAR["goodsinfo"]["goods_seq"]?>&popup=1',<?php echo ($TPL_VAR["goodsImageSize"]["view"]["width"]+ 400)?>,<?php echo ($TPL_VAR["goodsImageSize"]["view"]["width"]+ 350)?>,'no')" hrefOri='amF2YXNjcmlwdDpwb3B1cCg=' ><img src="/data/skin/responsive_diary_petit_gl/images/design/icon_zoom.png" style="width:35px; opacity:0.4;" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9pY29uX3pvb20ucG5n' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vaWNvbl96b29tLnBuZw==' designElement='image' /></a></div>
...
<?php if($TPL_VAR["goodsinfo"]["sum_sale_price"]){?>
								<button type="button" class="btn_resp Mt-3" onclick="if( $('#priceDetail').is(':hidden') ) $('#priceDetail').show(); else $('#priceDetail').hide();"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==" >혜택보기</span></button>
<?php }?>
							</p>
						</li>
						<li>
...
<?php }?>
				...
				<ul class="cart_order_btn_area">
					<li><button type="button" class="btn-goods btn_resp size_c color2"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==" >상품상세정보</span></button></li>
					<li><button type="button" id="wishimg" usewish="n" class="btn_resp size_c" onclick="wish_chg();"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==" >위시리스트</span></button></li>
				</ul>
			</div>
			<!-- ++++++++++++++++++++++++ //상품 스펙 ++++++++++++++++++++++++ -->
		</div>
...
<?php if($TPL_kinds_1){foreach($TPL_VAR["kinds"] as $TPL_K1=>$TPL_V1){?>
		<h3 class="title_sub2"><b><img src="/data/skin/responsive_diary_petit_gl/images/design/ico_bd_<?php echo $TPL_K1?>.png" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9pY29fYmRfeyAua2V5XyB9LnBuZw==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9iaWdkYXRhL2NhdGFsb2cuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vaWNvX2JkX3sgLmtleV8gfS5wbmc=' designElement='image' /> <?php echo $TPL_V1["textStr"]?></b></h3>
...
function resimg_num(i){
	...
	$('.dot_paging').attr('src','/data/skin/responsive_diary_petit_gl/images/design/intro_dot.png');
	$('#dot_'+i).attr('src','/data/skin/responsive_diary_petit_gl/images/design/intro_dot_on.png');
