<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/_select_options.html 000037696 */ 
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==" >입력옵션</span></th>
		</tr>
<?php }?>
...
<?php if($TPL_V1["input_value"]){?>
					<td><img src="/data/order/<?php echo $TPL_V1["input_value"]?>" id="prevImg" style="height:20px;" designImgSrcOri='L2RhdGEvb3JkZXIvey5pbnB1dF92YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==' designImgSrc='L2RhdGEvb3JkZXIvey5pbnB1dF92YWx1ZX0=' designElement='image' /></td>
<?php }else{?>
					<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" designImgSrcOri='YWJvdXQ6Ymxhbms7' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==' designImgSrc='YWJvdXQ6Ymxhbms7' designElement='image' /></td>
<?php }?>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="3"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==" >추가구성</span></th>
		</tr>
<?php }?>
...
<?php if((count($TPL_VAR["options"])> 0&&$TPL_VAR["options"][ 0]["option_title"])&&(($TPL_VAR["suboptions"]&&$TPL_VAR["goods"]["suboption_layout_group"]!='first')||($TPL_VAR["inputs"]&&$TPL_VAR["goods"]["inputoption_layout_position"]!='down'))){?>
		...
		<tr>
			<td colspan="3" align="center" style="padding-top:10px; padding-bottom:10px;">
				<button type="button" class="viewOptionsApply btn_resp size_c color6" style="width:100%"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==" >위의 정보로 선택</span></button>
			</td>
		</tr>
<?php }?>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="3"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==" >추가구성</span></th>
		</tr>
<?php }?>
<?php if($TPL_suboptions_1){$TPL_I1=-1;foreach($TPL_VAR["suboptions"] as $TPL_V1){$TPL_I1++;?>
<?php if($TPL_V1[ 0]["sub_required"]=='y'){?>
...
<?php }?>
						...
						<ul class="num_price">
							...
							<li class="option_col_price">
								...
								<img src="/data/skin/responsive_diary_petit_gl/images/common/icon_close_gray.png" class="removeOption" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb3NlX2dyYXkucG5n' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaWNvbl9jbG9zZV9ncmF5LnBuZw==' designElement='image' />
							</li>
						</ul>
					</td>
				</tr>
...
<?php if($TPL_V2["input_value"]){?>
									<td><img src="/data/order/<?php echo $TPL_V2["input_value"]?>" class="prevImg" style="height:20px;" designImgSrcOri='L2RhdGEvb3JkZXIvey4uaW5wdXRfdmFsdWV9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==' designImgSrc='L2RhdGEvb3JkZXIvey4uaW5wdXRfdmFsdWV9' designElement='image' /></td>
<?php }else{?>
									<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" designImgSrcOri='YWJvdXQ6Ymxhbms7' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9fc2VsZWN0X29wdGlvbnMuaHRtbA==' designImgSrc='YWJvdXQ6Ymxhbms7' designElement='image' /></td>
<?php }?>
