<?php /* Template_ 2.2.6 2022/01/18 12:20:18 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/view.html 000109145 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php if($TPL_icons_1){foreach($TPL_VAR["icons"] as $TPL_V1){?>
			<img src="/data/icon/goods/<?php echo $TPL_V1["codecd"]?>.gif" alt="" designImgSrcOri='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designElement='image' >
<?php }}?>
		</span>
	</p>
...
<?php }?>
<?php }else{?>
							<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_wide.gif'" title="뮤직브로샵,[TEST] BT21 스마트램프 + BT21 미니스피커" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="뮤직브로샵,[TEST] BT21 스마트램프 + BT21 미니스피커"<?php }?> designImgSrcOri='ey52aWV3LmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='ey52aWV3LmltYWdlfQ==' designElement='image' />
<?php }?>
					</div>
<?php }?>
<?php }}?>
...
<?php }?>
		...
		<input type="hidden" name="goodsSeq" value="<?php echo $TPL_VAR["goods"]["goods_seq"]?>" />
			...
			<div class="sns_wish">
				<!-- SNS 공유 -->
				<a href="javascript:void(0)" id="btnSnsShare" class="btn_sns_share" title="SNS 공유" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >공유</span></a>
				<div id="snsListDetail" class="snsbox_area" style="display:none;">
					<?php echo snslinkurl('goods',$TPL_VAR["goods"]["goods_name"])?>

				</div>
				<!-- 찜 -->
				<a href="javascript:void(0)" id="wishimg" class="ico_wish" usewish="n" onclick="wish_chg();" title="찜하기(위시리스트에 추가)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >찜</span></a>
			</div>
...
<?php if($TPL_VAR["eventEnd"]){?>
				<li class="spec_solo_event">
					<ul class="list">
						<li class="buy_num"><strong class="num"><?php echo number_format($TPL_VAR["goods"]["event"]["event_order_ea"])?></strong><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >개 구매중</span></li>
						<li class="remain_time">
							<span class="title"></span>
							<div class="event_datetime_box">
								<span class="num2" id="soloday<?php echo $TPL_VAR["goods"]["goods_seq"]?>">00</span><span class="day" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >일</span>
...
<?php if((array_sum($TPL_VAR["sales"]["sale_list"])-$TPL_VAR["sales"]["sale_list"]["basic"])> 0){?>
					<button type="button" class="btn_open_small btn_resp B" onclick="detail_contents_toggle(this,'priceDetail')"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >혜택보기</span></button>
...
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
				<li class="goods_spec_unsold">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상태</span></li>
						<li class="td sell_stop"><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >판매중지</span></li>
					</ul>
				</li>
<?php }?>
				<!-- ~~~~~ //판매중지 ~~~~~ -->
...
<?php if($TPL_VAR["sales"]["mtext_list"]['multi']){?>
				<li class="goods_spec_large_purchase">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >대량구매</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['multi']?>

						</li>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'multi')"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
					</ul>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['member']){?>
				<li class="goods_spec_member_grade">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >회원등급</span></li>
						<li><?php echo $TPL_VAR["sales"]["mtext_list"]['member']?></li>
<?php if($TPL_VAR["goods"]["group_benifits"]){?>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'memberBenefitDetail')"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
<?php }?>
					</ul>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['coupon']){?>
				<li class="goods_spec_coupon">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >쿠폰</span></li>
						<li>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['code']){?>
				<li class="goods_spec_sales_code">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >할인코드</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['code']?>

						</li>
						<li class="btn_area1">
							<button type="button" id="codeSaleView" class="btn_resp no_border resStyle"><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
					</ul>
				</li>
<?php }?>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['like']&&$TPL_VAR["APP_USE"]=='f'&&$TPL_VAR["APP_LIKE_TYPE"]!='NO'){?>
				<li class="goods_spec_like">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >좋아요</span></li>
						<li>
...
<?php }?>
						...
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'fblikeDetail')"><span designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
					</ul>
...
<?php if(is_array($TPL_R1=$TPL_VAR["fblikesale"]["result"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
							<li>
								<p class="e_title" ><span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >좋아요 + </span><?php echo get_currency_price($TPL_V1["price1"], 2)?><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" > 이상 구매시</span></p>
								<div class="e_content">
...
<?php if($TPL_VAR["sales"]["mtext_list"]['mobile']){?>
				<li class="goods_spec_mobile">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >모바일</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['mobile']?>

						</li>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'mobileDetail')"><span designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
					</ul>
...
<?php if(is_array($TPL_R1=$TPL_VAR["mobilesale"]["result"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
							<li>
								<p class="e_title"><span designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >모바일 + </span><?php echo get_currency_price($TPL_V1["price1"], 2)?><span designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" > 이상 구매시</span></p>
								<div class="e_content">
<?php if(count($TPL_V1["result"])> 1){?>
										<ul class="basic_lr_style">
											<li>최대</li>
					...
					<div id="goodsInterest" class="Relative hide">
						<div class="layer_simple_basic px p_right">
							<table class="detail_option_table card" cellpadding="0" cellspacing="0">
								<tbody>
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_bc.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfYmMuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX2JjLmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_ct.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfY3QuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX2N0LmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_hd.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaGQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX2hkLmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_hn.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaG4uZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX2huLmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_kb.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfa2IuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX2tiLmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_lt.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfbHQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX2x0LmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_sh.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc2guZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX3NoLmdpZg==' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_diary_petit_gl/images/common/interest/Interest_img_ss.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc3MuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaW50ZXJlc3QvSW50ZXJlc3RfaW1nX3NzLmdpZg==' designElement='image' ></th>
...
<?php if($TPL_VAR["goods"]["referer_sale"]["referersale_seq"]){?>
				<li class="goods_spec_referersale_seq">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="43"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >유입경로</span></li>
						<li>
...
<?php if(($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_photo"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_photo"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_review"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_review"]> 0||($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]))&&$TPL_VAR["isplusfreenot"]){?>
							&nbsp;<span class="gray_07">|</span>&nbsp; <span designElement="text" textIndex="46"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >후기</span> <span class="Dib gray_06" designElement="text" textIndex="47"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >우측 '자세히' 참조</span>
<?php }?>
						</li>
<?php if(($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_photo"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_photo"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_review"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_review"]> 0||($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]))&&$TPL_VAR["isplusfreenot"]){?>
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'reviewDetail')"><span designElement="text" textIndex="48"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
<?php }?>
					</ul>
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_review"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_review"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="49"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >일반 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_photo"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_photo"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="50"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >포토 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="51"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >동영상 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]){?>
							<li>
								<p class="e_title" designElement="text" textIndex="52"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >기타 상품후기</p>
								<div class="e_content">
...
<?php if(in_array($TPL_VAR["naver_mileage_yn"],array('y','t'))){?>
				<li class="goods_spec_naver_mileage">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="53"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >네이버 마일리지</span></li>
						<li>
...
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_diary_petit_gl/images/common/icon_inter_ship.png" class="icon_global" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2ludGVyX3NoaXAucG5n' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaWNvbl9pbnRlcl9zaGlwLnBuZw==' designElement='image' />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<ul class="detail_spec_table sub">
								<li><span designElement="text" textIndex="55"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >해외구매대행 상품, 개인통관고유부호</span></li>
								<li class="btn_area1"><button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'customsDetail')"><span designElement="text" textIndex="56"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button></li>
							</ul>
<?php }?>
...
<?php if($TPL_V1["delivery_add_input"]){?>
										<div class="add">
											<span designElement="text" textIndex="59"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >추가배송비</span> <?php echo $TPL_V1["delivery_add_input"]?>

										</div>
<?php }?>
<?php if($TPL_V1["delivery_hop_input"]&&!$TPL_VAR["goods"]["reserve_ship_flag"]){?>
										<div class="hop">
											<span designElement="text" textIndex="60"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >희망배송일</span> <?php echo $TPL_V1["delivery_hop_input"]?>

											<button type="button" value="" class="btn_resp calendarBtn" grp_seq="<?php echo $TPL_V1["shipping_group_seq"]?>" set_seq="<?php echo $TPL_V1["shipping_set_seq"]?>" onclick="detail_contents_toggle(this,'deliverydateDetail');"><span designElement="text" textIndex="61"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >희망배송일</span></button>
...
<?php if($TPL_VAR["goods"]["reserve_ship_flag"]){?>
							<ul class="detail_spec_table sub">
								<li><span designElement="text" textIndex="62"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >예약판매 :</span> <?php echo $TPL_VAR["goods"]["reserve_ship_txt"]?></li>
							</ul>
<?php }?>
						</li>
					</ul>
						...
						<ul>
							...
							<li>
								...
								<p class="e_content" designElement="text" textIndex="67"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >
									관세청에서는 개인정보 유출을 방지하기 위하여 개인물품 수입신고 시 주민등록번호를 대신 활용할 수 있는 개인통관고유부호 제도를 운영합니다. 개인통관고유부호는 <a href="https://p.customs.go.kr" class="Und" target="_blank" title="새창" designElement="text" textIndex="68"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" hrefOri='aHR0cHM6Ly9wLmN1c3RvbXMuZ28ua3I=' >관세청 사이트</a>에서 신청 즉시 부여되며, 계속 같은 번호로 사용이 가능합니다. 분실하면 관세청 사이트에서 조회 가능합니다. 부호 체계는 P로 시작하고 13자리입니다.
								</p>
							</li>
						</ul>
					</div>
...
<?php if($TPL_VAR["ship_summary"]["gl_shipping_yn"]=='Y'){?>
				<li class="goods_spec_international_shipping">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="72"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >해외배송</span> <img src="/data/skin/responsive_diary_petit_gl/images/common/plane.png" height="15" alt="해외배송" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vcGxhbmUucG5n' designElement='image' /></li>
						<li>
							<span class="gray_06" designElement="text" textIndex="73"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >우측 '자세히' 참조</span>
							<div class="hide">
								이 상품은 해외에서 국내로 배송되는 상품이므로 배송,반품,교환이 일반 상품과 다를 수 있습니다.
							</div>
						</li>
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'countryDetail')"><span designElement="text" textIndex="74"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >자세히</span></button>
						</li>
					</ul>
...
<?php if($TPL_ship_gl_list_1){foreach($TPL_VAR["ship_gl_list"] as $TPL_V1){?>
									<tr>
										<th scope="row" class="L">
											<img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_V1["gl_nation"]?>.png" height="20" alt="" designImgSrcOri='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designElement='image' >
...
<?php if($TPL_VAR["goods"]["review_count"]){?>
				<li class="goods_spec_customer_ev">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="79"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상품후기</span></li>
						<li>
							<?php echo number_format($TPL_VAR["goods"]["review_count"])?><span designElement="text" textIndex="80"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >명</span>&nbsp;
...
<?php if($TPL_VAR["goods"]["cancel_type"]=='1'){?>
				<li class="goods_spec_cancel">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="82"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >청약철회</span></li>
						<li>
							<span designElement="text" textIndex="83"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >불가</span>
						</li>
					</ul>
				</li>
<?php }?>
...
<?php if($TPL_VAR["provider"]["info_name"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="93"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상호명</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_name"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_ceo"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="94"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >대표자</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_ceo"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_num"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="95"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >사업자등록번호</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_num"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_selling_license"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="96"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >통신판매신고번호</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_selling_license"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_phone"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="97"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >연락처</p></li>
...
<?php if($TPL_VAR["provider"]["info_address2"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="98"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >사업장 소재지</p></li>
											<li class="td">
...
<?php }?>
							<li><button type="button" id="buy_btn" class="btn_resp size_c color2"><span designElement="text" textIndex="99"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >구매하기</span></button></li>
						</ul>
					</li>
...
<?php }else{?>
<?php }?>
							<p class="text_soldout NpayNo" designElement="text" textIndex="100"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >품절</p>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='purchasing'){?>
						<li><button type="button" style="width:100%;" class="btn_resp size_c NpayNo"><span designElement="text" textIndex="101"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >재고확보 중</span></button></li>
<?php }?>
<?php if(($TPL_VAR["goods"]["goods_status"]=='purchasing'&&serviceLimit('H_NFR'))||($TPL_VAR["goods"]["goods_status"]=='runout'&&$TPL_VAR["goods"]["restock_notify_use"])){?>
						<li><button type="button" style="width:100%;" class="restockOpenBtn btn_resp size_c color4 NpayNo"><span designElement="text" textIndex="102"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >재입고알림 신청</span></button></li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
						<li><button type="button" style="width:100%;" class="btn_resp size_c color3 NpayNo"><span designElement="text" textIndex="103"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >판매중지</span></button></li>
<?php }?>
<?php }?>

<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<li>
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="104"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_diary_petit_gl/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9pY29uL2ljb25fdGFsay5wbmc=' designElement='image' />&nbsp; <span designElement="text" textIndex="105"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >톡톡하세요</span></button>
					</li>
<?php }?>
				</ul>
			</div>
...
<?php if($TPL_VAR["ship_summary"]["kr_direct_store_yn"]=='Y'||$TPL_VAR["ship_summary"]["gl_direct_store_yn"]=='Y'){?>
								<li>
									<button type="button" id="direct_store" class="btn_resp size_extra2 NpayNo"><span designElement="text" textIndex="108"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >매장픽업</span></button>
								</li>
<?php }?>
								<li><button type="button" id="buy" class="btn_resp size_extra2 color2 NpayNo"><span designElement="text" textIndex="109"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >구매하기</span></button></li>
							</ul>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='runout'){?>
...
<?php }else{?>
<?php }?>
							<p class="text_soldout NpayNo" designElement="text" textIndex="110"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >품절</p>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='purchasing'){?>
						<li>
							<button type="button" class="btn_resp size_c color3 Cd NpayNo"><span designElement="text" textIndex="111"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >재고확보 중</span></button>
						</li>
<?php }?>
<?php if(($TPL_VAR["goods"]["goods_status"]=='purchasing'&&serviceLimit('H_NFR'))||($TPL_VAR["goods"]["goods_status"]=='runout'&&$TPL_VAR["goods"]["restock_notify_use"])){?>
						<li>
							<button type="button" class="restockOpenBtn btn_resp size_c color4 NpayNo"><span designElement="text" textIndex="112"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >재입고알림 신청</span></button>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
						<li>
							<button type="button" class="btn_resp size_c color3 NpayNo"><span designElement="text" textIndex="113"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >판매중지</span></button>
						</li>
<?php }?>
					</ul>
<?php }?>
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<div class="goods_naver_talk_pc">
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="114"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_diary_petit_gl/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9pY29uL2ljb25fdGFsay5wbmc=' designElement='image' />&nbsp; <span designElement="text" textIndex="115"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >톡톡하세요</span></button>
					</div>
<?php }?>
				</div>
			</div>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['event']){?>
				<li class="goods_spec_event" style="display:none"><!-- 하단 관련 이벤트와 중복이라 hide 처리함( sjg ) -->
					<ul class="detail_event_area" onclick="detail_contents_toggle(this,'eventDetail'); if( $('#eventDetail').is(':hidden') ) $(this).removeClass('up'); else $(this).addClass('up');">
						<li class="th"><span designElement="text" textIndex="116"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >이벤트</span></li>
						<li>
...
<?php if($TPL_VAR["goods"]["gift"]&&$TPL_VAR["goods"]["gift"]["benifits"]){?>
				<li class="goods_spec_gift">
					<ul class="detail_event_area" onclick="detail_contents_toggle(this,'giftInterest'); if( $('#giftInterest').is(':hidden') ) $(this).removeClass('up'); else $(this).addClass('up');">
						<li class="th"><span designElement="text" textIndex="117"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >사은품</span></li>
						<li>
		...
		<div id="goods_tabs" class="goods_tabs">
			<div class="resp_area">
				<div class="goods_information_tabs">
					<a href="#goods_contents_quick" class="current" onclick="open_information_tab(this,'goods_description');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="118"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상세설명</span></a>
					<a href="#goods_contents_quick" id="goodsReviewLoad" onclick="open_information_tab(this,'goods_review');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span><span designElement="text" textIndex="119"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상품후기</span> <?php if($TPL_VAR["goods"]["review_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["review_count"])?></span><?php }?></span></a>
					<a href="#goods_contents_quick" id="goodsQnaLoad" onclick="open_information_tab(this,'goods_qna');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span><span designElement="text" textIndex="120"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상품문의</span> <?php if($TPL_VAR["goods"]["qna_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["qna_count"])?></span><?php }?></span></a>
					<a href="#goods_contents_quick" onclick="open_information_tab(this,'exchange_guide');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="121"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >교환/반품/<span class="Dib">배송</span></span></a>
				</div>
			</div>
		</div>
		<script>
...
<?php if($TPL_info_1){foreach($TPL_VAR["info"] as $TPL_V1){?>
					<img src="<?php echo $TPL_V1["url"]?>" designImgSrcOri='ez1pbmZvLnVybH0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=' designImgSrc='ez1pbmZvLnVybH0=' designElement='image' ><br>	
<?php }}?>
			</center>
<?php if($TPL_VAR["goods"]["mobile_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29udGVudHM/bm89e2dvb2RzLmdvb2RzX3NlcX0mem9vbT0x' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
					<button type="button" class="btn_resp size_b" onclick="document.location.href='/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1';"><span designElement="text" textIndex="123"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >원본 보기</span></button>
				</li>
			</ul>
<?php }?>
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29tbW9uX2NvbnRlbnRzP25vPXtnb29kcy5nb29kc19zZXF9Jnpvb209MQ==' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
					<button type="button" class="btn_resp size_b" onclick="document.location.href='/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1';"><span designElement="text" textIndex="125"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >원본 보기</span></button>
				</li>
			</ul>
<?php }?>
...
<?php if($TPL_VAR["event_banner"]){?>
		<h3 class="title_sub1"><span designElement="text" textIndex="126"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy92aWV3Lmh0bWw=" >관련 이벤트</span></h3>
