<?php /* Template_ 2.2.6 2020/12/10 10:20:15 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/goods/recently.html 000007492 */ 
					...
					<li>
						<div class="img_area">
							<a href="../goods/view?no=<?php echo $TPL_V1["goods_seq"]?>" hrefOri='Li4vZ29vZHMvdmlldz9ubz17Lmdvb2RzX3NlcX0=' >
								<img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_list.gif'" designImgSrcOri='ey5pbWFnZX0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9nb29kcy9yZWNlbnRseS5odG1s' designImgSrc='ey5pbWFnZX0=' designElement='image' />
							</a>
						</div>
						<ul class="sub">
