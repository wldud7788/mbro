<?php /* Template_ 2.2.6 2020/10/15 17:39:16 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/promotion/coupon_member.html 000006338 */  $this->include_("getCouponCode");?>
...
<div class="<?php if($_GET["popup"]){?>designPopup<?php }?>" popupStyle="layer" popupSeq="coupon_<?php echo $_GET["type"]?>"  >
	<div id="promo<?php if($_GET["popup"]){?>_popup<?php }?>"  class="designPopupBody" >
		<!-- 상단 이미지 -->
		<div style="text-align:center; margin-bottom:10px;"><img src="/data/skin/responsive_diary_petit_gl/images/promotion/main_img_newmem.jpg" alt="" designImgSrcOri='Li4vaW1hZ2VzL3Byb21vdGlvbi9tYWluX2ltZ19uZXdtZW0uanBn' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vY291cG9uX21lbWJlci5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9wcm9tb3Rpb24vbWFpbl9pbWdfbmV3bWVtLmpwZw==' designElement='image' /></div>
...
<?php }?>
		...
		<tr>
			<td><img src="/data/skin/responsive_diary_petit_gl/images/promotion/cpn_notice.gif" width="91" height="28" alt="쿠폰 사용 주의사항!" designImgSrcOri='Li4vaW1hZ2VzL3Byb21vdGlvbi9jcG5fbm90aWNlLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vY291cG9uX21lbWJlci5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9wcm9tb3Rpb24vY3BuX25vdGljZS5naWY=' designElement='image' /></td>
		</tr>
		<tr>
				<td height="5"></td>
		</tr>
