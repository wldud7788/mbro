<?php /* Template_ 2.2.6 2021/04/27 10:15:03 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/promotion/event_list.html 000012101 */  $this->include_("setTemplatePath","showDesignBanner");
...
<div class="search_nav">
  ...
  <span class="navi_linemap on" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s" >EVENT</span>
</div>
  ...
  <div class="tab_basic size1 Mt30 Mb0">
    <ul>
      <li <?php if($TPL_VAR["sc"]["sc_status"]=='ing'){?>class="on"<?php }?>>
        <label><input type="radio" name="sc_status" value="ing" <?php if($TPL_VAR["sc"]["sc_status"]=='ing'){?>checked<?php }?> /><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s" >진행중인 이벤트</span></label>
      </li>
...
<?php if(array_search('event',$TPL_VAR["page_config"]["search_filter"])){?>
      <li class="area_search">
        ...
        <button type="submit" class="btn_resp size_b"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s" >검색</span></button>
      </li>
<?php }?>
    </ul>
  </div>
...
<script type="text/javascript">
  $(function(){
    if (window.location=="http://music-brother.firstmall.kr/promotion/event?sc_status=expired&sc_filter=sales&event_name=" || window.location=="https://musicbroshop.com/promotion/event?sc_status=expired&sc_filter=sales&event_name=") {
        $(".bravegirls_cd_event").hide();
      }
...
<?php if($TPL_VAR["record"]){?>
  <ul class="event_bnr1">
  <!--   <li class="bravegirls_cd_event">
      <a href="https://musicbroshop.com/board/view?id=notice&seq=66" hrefOri='aHR0cHM6Ly9tdXNpY2Jyb3Nob3AuY29tL2JvYXJkL3ZpZXc/aWQ9bm90aWNlJnNlcT02Ng==' >
        <div class="event-image-box">
            <p class="image_event "><img class="event_list_banner designElement" src="/data/event/bravegirls_cd.jpg" alt="" designImgSrcOri='L2RhdGEvZXZlbnQvYnJhdmVnaXJsc19jZC5qcGc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvZXZlbnQvYnJhdmVnaXJsc19jZC5qcGc=' designElement='image' ></p>
        </div>
        <div class="infobox">
          <div class="intorduce" style="color:#333333">
            브레이브걸스-롤린 싸인 CD이벤트         </div>
          <div class="period">2021-03-22 ~ 2021-04-22</div>
        </div>
      </a>
    </li> -->
...
<?php if($TPL_V1["event_banner"]){?>
            <p class="image_event "><img class="event_list_banner" src="/data/event/<?php echo $TPL_V1["event_banner"]?>" alt="" designImgSrcOri='L2RhdGEvZXZlbnQvey5ldmVudF9iYW5uZXJ9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvZXZlbnQvey5ldmVudF9iYW5uZXJ9' designElement='image' /></p>
<?php }elseif($TPL_V1["joincheck_banner"]){?>
            <p class="image_event "><img class="event_list_banner" src="/data/joincheck/<?php echo $TPL_V1["joincheck_banner"]?>" alt="" designImgSrcOri='L2RhdGEvam9pbmNoZWNrL3suam9pbmNoZWNrX2Jhbm5lcn0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvam9pbmNoZWNrL3suam9pbmNoZWNrX2Jhbm5lcn0=' designElement='image' /></p>
<?php }else{?>
<?php if($TPL_V1["joincheck_seq"]){?>
            <p class="no_image_event"><img src="/data/skin/responsive_diary_petit_gl/images/design/no_images_stamp.png" alt="출석체크 이벤트" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub19pbWFnZXNfc3RhbXAucG5n' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vbm9faW1hZ2VzX3N0YW1wLnBuZw==' designElement='image' /></p>
<?php }elseif($TPL_V1["gift_seq"]){?>
            <p class="no_image_event"><img src="/data/skin/responsive_diary_petit_gl/images/design/no_images_gift.png" alt="사은품 이벤트" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub19pbWFnZXNfZ2lmdC5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vbm9faW1hZ2VzX2dpZnQucG5n' designElement='image' /></p>
<?php }elseif($TPL_V1["event_seq"]){?>
            <p class="no_image_event"><img src="/data/skin/responsive_diary_petit_gl/images/design/no_images_promotion.png" alt="할인/기획전 이벤트" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub19pbWFnZXNfcHJvbW90aW9uLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vbm9faW1hZ2VzX3Byb21vdGlvbi5wbmc=' designElement='image' /></p>
<?php }else{?>
            <img class="none" src="/data/skin/responsive_diary_petit_gl/images/design/noimg_thumb.gif" alt="이미지 준비중입니다" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9ub2ltZ190aHVtYi5naWY=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9kZXNpZ24vbm9pbWdfdGh1bWIuZ2lm' designElement='image' />
<?php }?>
<?php }?>
<?php if($TPL_V1["status"]=='close'){?><img class="close-icon" src="/data/icon/event/event_icon01.png" alt="마감임박" designImgSrcOri='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDEucG5n' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDEucG5n' designElement='image' /><?php }?>
<?php if($TPL_V1["status"]=='end'){?><img class="end-icon" src="/data/icon/event/event_icon02.png" alt="종료" designImgSrcOri='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDIucG5n' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9pY29uMDIucG5n' designElement='image' /><?php }?>
        </div>
        <div class="infobox">
...
<?php if($TPL_V1["status"]=='end'){?>
            <div class="until"><img src="/data/icon/event/event_end.gif" designImgSrcOri='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9lbmQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9wcm9tb3Rpb24vZXZlbnRfbGlzdC5odG1s' designImgSrc='L2RhdGEvaWNvbi9ldmVudC9ldmVudF9lbmQuZ2lm' designElement='image' /></div>
<?php }?>
        </div>
      </a>
    </li>
