<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/goods_qna/_goods_qna/write.html 000020934 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["categorylist"]){?>
		<tr>
			<th><p designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >분류</p></th>
			<td>
...
<?php }?>
		<tr>
			<th><p designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >작성자</p></th>
			<td>
...
<?php }?>
				<span class="<?php echo $TPL_VAR["hiddenlay"]?>"><input type="checkbox" name="hidden" id="hidden"  value="1" <?php echo $TPL_VAR["hiddenckeck"]?> /><label for="hidden" > <span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >비밀글</span></label></span>
...
<?php if(!$TPL_VAR["pw"]){?>
		<tr>
			<th><p designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >비밀번호</p></th>
			<td>
...
<?php }?>
		<tr>
			<th><p designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >답변받기</p></th>
			<td>
...
<?php if($TPL_VAR["manager"]["sms_reply_user_yn"]=='Y'){?>
					<li>
						...
						<label class="Dib"><input type="checkbox" name="board_sms" id="board_sms" value="1" <?php if(($TPL_VAR["seq"]&&$TPL_VAR["rsms"]=='Y')||(!$TPL_VAR["seq"]&&($TPL_VAR["tel1"]||$TPL_VAR["tel2"]))){?> checked="checked" <?php }?> /> <span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >SMS받기</span></label>
					</li>
<?php }?>
					<li>
						<input type="text" name="email" id="email" value="<?php echo $TPL_VAR["email"]?>" class="size_mail" title="이메일주소 입력" />
						<label class="Dib"><input type="checkbox" name="board_email" id="board_email" value="1"  <?php if(($TPL_VAR["seq"]&&$TPL_VAR["remail"]=='Y')||(!$TPL_VAR["seq"]&&$TPL_VAR["email"])){?> checked="checked" <?php }?>/> <span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >메일받기</span></label>
					</li>
				</ul>
			</td>
		</tr>
...
<?php }else{?>
		<tr>
			<th><p designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >문의상품</p></th>
			<td class="Pt0">
				<!-- 상품선택 & 선택된 상품 -->
				<div class="board_goods_select">
<?php if(!$TPL_VAR["seq"]){?>
					<div class="btn_area">
						<button type="button" id="issueGoodsButton" class="btn_resp size_b color2"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >상품 선택</span></button>
					</div>
<?php }?>
...
<?php if($TPL_displayGoods_1){foreach($TPL_VAR["displayGoods"] as $TPL_V1){?>
						<div class="goods_loop_area">
							<ul class="goods_area">
								<li class="img_area"><img src="<?php echo $TPL_V1["image"]?>" class="goodsThumbView goods_img" alt="" designImgSrcOri='ey5pbWFnZX0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s' designImgSrc='ey5pbWFnZX0=' designElement='image' ></li>
								<li class="info_area">
...
<?php }?>
		<tr>
			<th><p designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >제목</p></th>
			<td>
...
<?php }?>
	    <button type="button" class="data_save_btn btn_resp size_c color2"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >저장</span></button>
	    <button type="button" class="btn_resp size_c" onclick="<?php if($_GET["popup"]&&!$_GET["iframe"]){?>self.close();<?php }else{?>document.location.href='<?php echo $TPL_VAR["boardurl"]->lists?>';<?php }?>"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19xbmEvX2dvb2RzX3FuYS93cml0ZS5odG1s" >취소</span></button>
	</div>
