<?php /* Template_ 2.2.6 2020/12/08 10:20:38 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/product_bbs/gallery02/index.html 000014290 */  $this->include_("sslAction");
...
<?php if($TPL_V1["file_key_w"]&&$TPL_V1["uccdomain_thumbnail"]){?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["uccdomain_thumbnail"]?>" designImgSrcOri='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9wcm9kdWN0X2Jicy9nYWxsZXJ5MDIvaW5kZXguaHRtbA==' designImgSrc='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designElement='image' /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'http')){?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="http<?php echo str_replace('http','',$TPL_V1["filelist"]['realfile'])?>" designImgSrcOri='aHR0cHs9c3RyX3JlcGxhY2Uo' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9wcm9kdWN0X2Jicy9nYWxsZXJ5MDIvaW5kZXguaHRtbA==' designImgSrc='aHR0cHs9c3RyX3JlcGxhY2Uo' designElement='image' /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'/data/editor/')){?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif'" designImgSrcOri='ey5maWxlbGlzdFs=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9wcm9kdWN0X2Jicy9nYWxsZXJ5MDIvaW5kZXguaHRtbA==' designImgSrc='ey5maWxlbGlzdFs=' designElement='image' /></span>
<?php }else{?>
				<span class="board_view_wrap boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="#" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="/data/board/<?php echo $_GET["id"]?>/<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage.gif'" designImgSrcOri='L2RhdGEvYm9hcmQve19HRVQuaWR9L3suZmlsZWxpc3Rb' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9wcm9kdWN0X2Jicy9nYWxsZXJ5MDIvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvYm9hcmQve19HRVQuaWR9L3suZmlsZWxpc3Rb' designElement='image' /></span>
<?php }?>
			</li>
		</ul>
		<ul class="text_area">
