<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/_score.html 000009621 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 게시글/댓글 평가 @@
		...
		<table style="width:300px;margin:auto;border:0px dashed black;padding:5px;"> 
			...
			<tr  align="center">  
				<td>
					...
					<div><span class="icon_recommend1_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?>  icon_recommend1_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="recommend1"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_recommend1_src"]?>" class="icon_recommend1_img" designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kMV9zcmN9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9fc2NvcmUuaHRtbA==' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kMV9zcmN9' designElement='image' /></span></div>
				...
				<td>
					...
					<div><span class="icon_recommend4_<?php echo $TPL_VAR["seq"]?>_lay<?php echo $TPL_VAR["is_recommend"]?>  icon_recommend4_lay<?php echo $TPL_VAR["is_recommend"]?> hand"  board_recommend="recommend4"   board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" ><img src="<?php echo $TPL_VAR["managerview"]["icon_recommend4_src"]?>" class="icon_recommend4_img" designImgSrcOri='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kNF9zcmN9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9fc2NvcmUuaHRtbA==' designImgSrc='e21hbmFnZXJ2aWV3Lmljb25fcmVjb21tZW5kNF9zcmN9' designElement='image' /></span></div>
