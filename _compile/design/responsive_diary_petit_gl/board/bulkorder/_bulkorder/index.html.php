<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/bulkorder/_bulkorder/index.html 000010817 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["noticeloop"]||$TPL_VAR["loop"]){?>
	<div class="res_table">
		<ul class="thead">
			<li style="width:45px;"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >번호</span></li>
			<li style="width:80px;"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >상태</span></li>
			<li style="width:105px;"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >분류</span></li>
			<li><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >문의</span></li>
			<li style="width:120px;"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >문의자</span></li>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li style="width:100px;"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >문의일</span></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li style="width:45px;"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >조회</span></li><?php }?>
		</ul>
<?php if($TPL_VAR["noticeloop"]){?>
<?php if($TPL_noticeloop_1){foreach($TPL_VAR["noticeloop"] as $TPL_V1){?>
		<ul class="tbody notice">
			<li class="num"><span class="mtitle" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >공지</span> <?php echo $TPL_V1["number"]?></li>
			<li class="mo_hide"><span class="pointcolor" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >공지</span></li>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >조회:</span> <?php echo $TPL_V1["hit"]?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
<?php if($TPL_VAR["loop"]){?>
<?php if($TPL_loop_1){foreach($TPL_VAR["loop"] as $TPL_V1){?>
		<ul class="tbody <?php if($TPL_V1["display"]== 1){?>gray<?php }?> <?php if($TPL_V1["reply_state"]=='complete'){?>complete<?php }?> <?php if($TPL_V1["blank"]){?>reply<?php }?>">
			<li class="mo_hide"><span class="mtitle" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >번호:</span> <?php echo $TPL_V1["number"]?></li>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li><?php echo date('Y.m.d',strtotime($TPL_V1["date"]))?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[score]')&&$TPL_VAR["manager"]["auth_recommend_use"]=='Y'){?><li><span class="mtitle"><?php echo $TPL_VAR["manager"]["scoretitle"]?>:</span><?php echo $TPL_V1["recommendlay"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="motle2" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >조회:</span> <?php echo $TPL_V1["hit"]?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
	</div>
...
<ul class="bbs_bottom_wrap">
	<li class="right">
		<button type="button" name="boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"  <?php if($_GET["iframe"]){?>id="goods_boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"<?php }else{?>id="boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"<?php }?> board_id="<?php echo $TPL_VAR["boardid"]?>" fileperm_read="<?php echo $TPL_VAR["manager"]["fileperm_write"]?>" class="btn_resp size_b color2" /><?php echo $TPL_VAR["manager"]["name"]?> <span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9idWxrb3JkZXIvX2J1bGtvcmRlci9pbmRleC5odG1s" >쓰기</span></button>
	</li>
</ul>
