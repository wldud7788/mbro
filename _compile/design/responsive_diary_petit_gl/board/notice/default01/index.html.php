<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/notice/default01/index.html 000010611 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["noticeloop"]||$TPL_VAR["loop"]){?>
	<div class="res_table">
		<ul class="thead">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li style="width:48px;"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >번호</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?><li style="width:80px;"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >분류</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?><li><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >제목</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[writer]')){?><li class="Hide" style="width:100px;"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >작성자</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li style="width:100px;"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >등록일</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li style="width:45px;"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >조회</span></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="num"><span class="mtitle" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >공지</span> <?php echo $TPL_V1["number"]?></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >조회:</span> <?php echo $TPL_V1["hit"]?></li><?php }?>
...
<?php if($TPL_loop_1){foreach($TPL_VAR["loop"] as $TPL_V1){?>
		<ul class="tbody">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="mo_hide"><span class="mtitle" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >번호:</span> <?php echo $TPL_V1["number"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?><li><?php echo $TPL_V1["category"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?>
			<li class="subject">
				<span class="hand boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>"  viewtype="<?php echo $TPL_VAR["manager"]["viewtype"]?>"  pagetype="<?php echo $TPL_VAR["pagetype"]?>"  board_seq="<?php echo $TPL_V1["seq"]?>" board_id="<?php echo $_GET["id"]?>">
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[writer]')){?><li class="Hide"><?php echo $TPL_V1["name"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li><?php echo date('Y.m.d',strtotime($TPL_V1["date"]))?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL2luZGV4Lmh0bWw=" >조회:</span> <?php echo $TPL_V1["hit"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[score]')&&$TPL_VAR["manager"]["auth_recommend_use"]=='Y'){?><li><span class="mtitle"><?php echo $TPL_VAR["manager"]["scoretitle"]?>:</span> <?php echo $TPL_V1["recommendlay"]?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
