<?php /* Template_ 2.2.6 2021/12/03 16:33:31 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/notice/default01/view.html 000009512 */  $this->include_("sslAction","snslinkurl");
...
<!--다크비 이벤트 관련 css 주석 없어서 추가함 by 김혜진 2021.12.03-->
<style type="text/css">
    .text_center{text-align:center;}
    .blue_title{font-size:24px !important; color:blue !important; text-align:center;}
    .blue_title span{font-weight:bold;}
    .blue_title span:hover{text-decoration: underline;}
    .red_text{font-weight:bold; color:red; text-align:center;}

    .dkb_event_table{width:45%;}
    .dkb_event_table tr:nth-child(1) td p{font-weight:bold; font-size:18px;}
    .dkb_event_table tr>td {font-size:16px; text-align:center; padding:5px 0;}
...
<?php }?>
	...
	<table class="table_row_a Thc" data-responsive="yes" width="100%" cellpadding="0" cellspacing="0">
		...
		<tbody>
			<tr>
				<th><p designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL3ZpZXcuaHRtbA==" >분류</p></th>
				<td><?php if($TPL_VAR["datacategory"]){?>[<?php echo $TPL_VAR["datacategory"]?>]<?php }?> <?php echo $TPL_VAR["iconmobile"]?></td>
				<th><p designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL3ZpZXcuaHRtbA==" >작성자</p></th>
				<td><?php echo $TPL_VAR["name"]?></td>
			</tr>
			<tr>
				<th><p designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL3ZpZXcuaHRtbA==" >등록일</p></th>
				<td><?php echo $TPL_VAR["m_date"]?></td>
				<th><p designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL3ZpZXcuaHRtbA==" >조회수</p></th>
				<td><?php echo number_format($TPL_VAR["hit"])?></td>
			</tr>
<?php if($TPL_VAR["filelist"]){?>
			<tr>
				<th><p designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL3ZpZXcuaHRtbA==" >첨부파일</p></th>
				<td colspan="3">
					<ul>
...
<ul class="board_detail_btns">
	<li class="left"><button type="button" name="boardviewclose" class="btn_resp size_b color5"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ub3RpY2UvZGVmYXVsdDAxL3ZpZXcuaHRtbA==" >목록</span></button></li>
</ul>
