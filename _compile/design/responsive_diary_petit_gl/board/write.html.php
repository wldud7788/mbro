<?php /* Template_ 2.2.6 2021/04/13 15:13:15 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/write.html 000003559 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 게시판 Write 레이아웃 템플릿 @@
...
<?php if(!$_GET["iframe"]){?>
			<!-- 전체 메뉴 -->
			<a id="subAllButton" class="btn_sub_all" href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC93cml0ZS5odG1s" >MENU</span></a>
