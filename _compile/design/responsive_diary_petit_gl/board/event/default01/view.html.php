<?php /* Template_ 2.2.6 2021/05/31 10:34:25 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/event/default01/view.html 000010298 */  $this->include_("sslAction","snslinkurl");
...
<?php if($TPL_V1["is_image"]){?>
								<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');" ><img src="/data/skin/responsive_diary_petit_gl/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vLi4vLi4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9ldmVudC9kZWZhdWx0MDEvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9pY29uL2ljb25fem9vbS5naWY=' designElement='image' /></span>
<?php }?>
						</li>
<?php }}?>
					</ul>
