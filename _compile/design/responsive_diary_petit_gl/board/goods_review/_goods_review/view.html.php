<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/goods_review/_goods_review/view.html 000014610 */  $this->include_("sslAction","snslinkurl");
...
<?php if($TPL_VAR["datacategory"]){?>[<?php echo $TPL_VAR["datacategory"]?>]<?php }?> <?php echo $TPL_VAR["iconmobile"]?> <?php echo $TPL_VAR["subject"]?> <?php echo $TPL_VAR["iconnew"]?> <?php echo $TPL_VAR["iconhot"]?> <?php echo $TPL_VAR["iconhidden"]?>
	...
	<table class="table_row_a Thc" data-responsive="yes" width="100%" cellpadding="0" cellspacing="0">
		...
		<tbody>
			<tr>
				<th><p designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >작성자</p></th>
				<td><?php echo $TPL_VAR["name"]?></td>
				<th><p designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >등록일</p></th>
				<td><?php echo $TPL_VAR["r_date"]?></td>
			</tr>
			<tr>
				<th><p designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >조회수</p></th>
				<td><?php echo number_format($TPL_VAR["hit"])?></td>
<?php if($TPL_VAR["buyertitle"]){?>
				<th><p designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >구매여부</p></th>
				<td><?php echo $TPL_VAR["buyertitle"]?></td>
<?php }?>
			</tr>
			<tr>
				<th><p designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >평점</p></th>
				<td colspan="3">
...
<?php if($TPL_VAR["file_key_w"]&&$TPL_VAR["uccdomain_fileswf"]){?>
			<tr>
				<th><p designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >첨부파일</p></th>
				<td colspan="3">
...
<?php if($TPL_VAR["filelist"]){?>
			<tr>
				<th><p designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >첨부파일</p></th>
				<td colspan="3">
					<ul>
...
<?php if($TPL_V1["is_image"]){?>
								<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfileurl"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');"><img src="/data/skin/responsive_diary_petit_gl/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vLi4vLi4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9pY29uL2ljb25fem9vbS5naWY=' designElement='image' /></span>
<?php }?>
						</li>
<?php }}?>
					</ul>
...
<?php if($TPL_VAR["goodsview"]){?>
	<div class="goods_origin_info">
		<h4 class="title"><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >상품 정보</span></h4>
...
<ul class="board_detail_btns">
	<li class="left"><button type="button" name="boardviewclose" class="btn_resp size_b color5"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >목록</span></button></li>
	<li class="right">
<?php if($TPL_VAR["display"]== 0&&$TPL_VAR["managerview"]["isperm_moddel"]!="_mbno"){?>
		<button type="button" <?php if($_GET["iframe"]){?>name="goods_boad_modify_btn<?php echo $TPL_VAR["managerview"]["isperm_moddel"]?>"<?php }else{?>name="boad_modify_btn<?php echo $TPL_VAR["managerview"]["isperm_moddel"]?>"<?php }?> board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" class="btn_resp size_b"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >수정</span></button>
<?php }?>
<?php if((($TPL_VAR["display"]== 0||($TPL_VAR["display"]== 1&&$TPL_VAR["replyor"]== 0&&$TPL_VAR["comment"]== 0)))&&$TPL_VAR["managerview"]["isperm_moddel"]!="_mbno"){?> 
		<button type="button"  <?php if($_GET["iframe"]){?>name="goods_boad_delete_btn<?php echo $TPL_VAR["managerview"]["isperm_moddel"]?>"<?php }else{?>name="boad_delete_btn<?php echo $TPL_VAR["managerview"]["isperm_moddel"]?>"<?php }?>  board_seq="<?php echo $TPL_VAR["seq"]?>"  board_id="<?php echo $TPL_VAR["boardid"]?>"  class="btn_resp size_b"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >삭제</span></button>
<?php }?>
<?php if(!$_GET["iframe"]){?>
<?php if($TPL_VAR["display"]== 0&&$TPL_VAR["replylay"]=='Y'&&$TPL_VAR["managerview"]["isperm_write"]!="_no"){?>
			<button type="button"  name="boad_reply_btn" board_seq="<?php echo $TPL_VAR["seq"]?>"  board_id="<?php echo $TPL_VAR["boardid"]?>" class="btn_resp size_b"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >답변</span></button>
<?php }?>
<?php }?>
<?php if($TPL_VAR["managerview"]["isperm_write"]!="_no"){?>
		<button type="button" <?php if($_GET["iframe"]){?>id="goods_boad_write_btn<?php echo $TPL_VAR["managerview"]["isperm_write"]?>"<?php }else{?>id="boad_write_btn<?php echo $TPL_VAR["managerview"]["isperm_write"]?>"<?php }?> board_id="<?php echo $TPL_VAR["boardid"]?>" class="btn_resp size_b color2"><?php echo $TPL_VAR["manager"]["name"]?> <span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9nb29kc19yZXZpZXcvX2dvb2RzX3Jldmlldy92aWV3Lmh0bWw=" >쓰기</span></button>
<?php }?>
	</li>
</ul>
