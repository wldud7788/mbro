<?php /* Template_ 2.2.6 2020/10/15 17:39:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/board/_mobile_file.html 000003256 */ 
...
<tr>
	<th class="width_a"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9fbW9iaWxlX2ZpbGUuaHRtbA==" >첨부파일을</span></th>
	<td>
...
<?php if($TPL_VAR["manager"]["file_use"]=='Y'){?>
				<tr>
					<td>
						...
						<div class="pdt5">
							<button type="button" class="btnUploader btn_resp size_b"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9ib2FyZC9fbW9iaWxlX2ZpbGUuaHRtbA==" >+ 파일 추가</span></button>
						</div>
					</td>
				</tr>
<?php }?>
