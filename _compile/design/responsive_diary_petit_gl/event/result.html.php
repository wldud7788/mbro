<?php /* Template_ 2.2.6 2021/03/29 16:42:08 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/event/result.html 000002002 */ 
...
<?php if($TPL_V1["sign"]=='Y'){?>
	<div class="user_info_wrap free_no_user">
		...
		<div class="free_ok_btn">
			<a href="/event/movepage" hrefOri='L2V2ZW50L21vdmVwYWdl' >한달 이용권 사용하기</a>
		</div>
	</div>
<?php }?>
<?php if($TPL_V1["sign"]=='N'){?>
	<div class="user_info_wrap free_no_user">
		...
		<div class="free_ok_btn">
			<a href="/mypage" hrefOri='L215cGFnZQ==' >마이페이지</a>
		</div>
	</div>
<?php }?>
<?php }}?>
