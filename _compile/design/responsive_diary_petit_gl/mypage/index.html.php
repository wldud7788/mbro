<?php /* Template_ 2.2.6 2021/01/19 11:39:50 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/index.html 000020918 */  $this->include_("showMycartTop");
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<ul class="my_index_top mycs_fcont_margin">
			<li>
				...
				<ul class="my_msub1">
					...
					<li><a href="/mypage/myinfo" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" hrefOri='L215cGFnZS9teWluZm8=' >회원정보 수정</a></li>
				</ul>
			</li>
			<li>
				<ul class="my_msub2">
		...
		<div class="title_container2 Bbx Pb0 Mt80">
			...
			<a class="btn_thebogi" href="/mypage/order_catalog" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" hrefOri='L215cGFnZS9vcmRlcl9jYXRhbG9n' >전체조회</a>
		</div>
		<ul class="my_order_step">
			<li class="step1"><a href="../mypage/order_catalog?step_type=order" hrefOri='Li4vbXlwYWdlL29yZGVyX2NhdGFsb2c/c3RlcF90eXBlPW9yZGVy' ><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" >주문접수</span><?php if($TPL_VAR["counts"]['15']){?><span class="pushCount"><?php echo $TPL_VAR["counts"]['15']?></span><?php }?></a></li>
			<li class="step2"><a href="../mypage/order_catalog?step_type=deposit_only" hrefOri='Li4vbXlwYWdlL29yZGVyX2NhdGFsb2c/c3RlcF90eXBlPWRlcG9zaXRfb25seQ==' ><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" >결제확인</span><?php if($TPL_VAR["counts"]['25']){?><span class="pushCount"><?php echo $TPL_VAR["counts"]['25']?></span><?php }?></a></li>
			<li class="step3"><a href="../mypage/order_catalog?step_type=ready_only" hrefOri='Li4vbXlwYWdlL29yZGVyX2NhdGFsb2c/c3RlcF90eXBlPXJlYWR5X29ubHk=' ><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" >상품준비중</span><?php if(($TPL_VAR["counts"]['35']+$TPL_VAR["counts"]['40']+$TPL_VAR["counts"]['45'])){?><span class="pushCount"><?php echo ($TPL_VAR["counts"]['35']+$TPL_VAR["counts"]['40']+$TPL_VAR["counts"]['45'])?></span><?php }?></a></li>
			<li class="step4"><a href="../mypage/order_catalog?step_type=delivery_ing" hrefOri='Li4vbXlwYWdlL29yZGVyX2NhdGFsb2c/c3RlcF90eXBlPWRlbGl2ZXJ5X2luZw==' ><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" >배송중</span><?php if(($TPL_VAR["counts"]['50']+$TPL_VAR["counts"]['55']+$TPL_VAR["counts"]['60']+$TPL_VAR["counts"]['65']+$TPL_VAR["counts"]['70'])){?><span class="pushCount"><?php echo $TPL_VAR["counts"]['50']+$TPL_VAR["counts"]['55']+$TPL_VAR["counts"]['60']+$TPL_VAR["counts"]['65']+$TPL_VAR["counts"]['70']?></span><?php }?></a></li>
			<li class="step5"><a href="../mypage/order_catalog?step_type=delivery_complete" hrefOri='Li4vbXlwYWdlL29yZGVyX2NhdGFsb2c/c3RlcF90eXBlPWRlbGl2ZXJ5X2NvbXBsZXRl' ><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" >배송완료</span><?php if($TPL_VAR["counts"]['75']){?><span class="pushCount"><?php echo $TPL_VAR["counts"]['75']?></span><?php }?></a></li>
		</ul>
...
<?php if($TPL_orders_1){foreach($TPL_VAR["orders"] as $TPL_V1){?>
			<ul class="tbody">
				...
				<li class="sjb_top order_seq"><span class="motle" designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==" >주문번호 : </span><a href="/mypage/order_view?no=<?php echo $TPL_V1["order_seq"]?>" hrefOri='L215cGFnZS9vcmRlcl92aWV3P25vPXsub3JkZXJfc2VxfQ==' ><?php echo $TPL_V1["order_seq"]?></a></li>
				<li class="item_info">
...
<?php if(is_array($TPL_R3=$TPL_V2["options"])&&!empty($TPL_R3)){$TPL_I3=-1;foreach($TPL_R3 as $TPL_V3){$TPL_I3++;?>
					<ul class="oc_item_info_detail">
						<li class="img_link" <?php if($TPL_V2["goods_type"]!='gift'){?>style="cursor:pointer" title="상품 상세" onclick="location.href='../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>';"<?php }?>>
							<img src="<?php echo viewImg($TPL_V2["goods_seq"],'thumbCart')?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_diary_petit_gl/images/common/noimage_list.gif'" alt="" designImgSrcOri='ez12aWV3SW1nKC4uZ29vZHNfc2VxLCA=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='ez12aWV3SW1nKC4uZ29vZHNfc2VxLCA=' designElement='image' />
						</li>
						<li class="detail_spec">
<?php if($TPL_V2["eventEnd"]){?>
							<div class="oc_event_area">
								<span class="soloEventTd<?php echo $TPL_V3["item_option_seq"]?>">
									<img src="/data/skin/responsive_diary_petit_gl/images/common/icon_clock.gif" class="img_clock" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb2NrLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaWNvbl9jbG9jay5naWY=' designElement='image' > 남은시간
...
<?php if($TPL_V2["goods_type"]=='gift'){?><img src="/data/skin/responsive_diary_petit_gl/images/common/icon_gift.gif" alt="사은품" vspace=3 designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2dpZnQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaWNvbl9naWZ0LmdpZg==' designElement='image' /><?php }?>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/common/auth_img.png" class="icon1" alt="성인" height="17" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vYXV0aF9pbWcucG5n' designElement='image' />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/common/plane.png" class="icon1" alt="해외배송상품" height="16" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vcGxhbmUucG5n' designElement='image' />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/common/nocancellation.gif" class="icon1" alt="청약철회"  designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9ub2NhbmNlbGxhdGlvbi5naWY=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vbm9jYW5jZWxsYXRpb24uZ2lm' designElement='image' />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
								<img src="/data/skin/responsive_diary_petit_gl/images/common/taxfree.gif" class="icon1" alt="비과세" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi90YXhmcmVlLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vdGF4ZnJlZS5naWY=' designElement='image' />
<?php }?>
							</div>
<?php }?>
...
<?php if($TPL_V4["type"]=='file'){?>
										<a href="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" hrefOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' ><img src="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" class="input_img" title="크게 보기" designImgSrcOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvaW5kZXguaHRtbA==' designImgSrc='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designElement='image' /></a>
<?php }else{?>
