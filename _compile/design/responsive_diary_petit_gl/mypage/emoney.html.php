<?php /* Template_ 2.2.6 2021/05/31 13:33:43 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/emoney.html 000005053 */ 
...
<?php }?>
		...
		<!-- <a href="/coin/coin_notice?" style=" background-color: gray; color: white; padding: 15px 30px; border-radius: 15px; border: 1px solid gray; display: block; text-align: center; margin-top: 50px;" hrefOri='L2NvaW4vY29pbl9ub3RpY2U/' >코인 환전하러 가기</a> -->
		</div>
