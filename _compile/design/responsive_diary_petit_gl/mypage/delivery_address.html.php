<?php /* Template_ 2.2.6 2020/10/15 17:39:16 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl/mypage/delivery_address.html 000033638 */ 
					...
					<div class="tab_basic size1">
						<ul>
							<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?> class="on"<?php }?>>
								<a href="javascript:;" onclick="submitAddressBookFrm('tab','1')" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvZGVsaXZlcnlfYWRkcmVzcy5odG1s" >자주쓰는 배송지</span></a>
							</li>
							<li <?php if($_GET["tab"]=='2'){?> class="on"<?php }?>>
								<a href="javascript:;" onclick="submitAddressBookFrm('tab','2')" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvZGVsaXZlcnlfYWRkcmVzcy5odG1s" >최근 배송지</span></a>
							</li>
						</ul>
					</div>
...
<?php if($TPL_V1["default"]=='Y'){?><img src="/data/skin/responsive_diary_petit_gl/images/common/icon_default.gif" title="기본" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2RlZmF1bHQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbC9teXBhZ2UvZGVsaXZlcnlfYWRkcmVzcy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsL2ltYWdlcy9jb21tb24vaWNvbl9kZWZhdWx0LmdpZg==' designElement='image' /><?php }?>
