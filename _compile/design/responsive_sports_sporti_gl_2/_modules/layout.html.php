<?php /* Template_ 2.2.6 2022/09/06 16:41:42 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/_modules/layout.html 000012677 */ 
...
<?php if($TPL_V1["level"]=='2'){?>
									<li style="position: relative;">
										<a href="/goods/catalog?code=<?php echo $TPL_V1["category_code"]?>" class="submenu_title <?php echo $TPL_V1["id"]?>" hrefOri='L2dvb2RzL2NhdGFsb2c/Y29kZT17LmNhdGVnb3J5X2NvZGV9' ><?php echo $TPL_V1["title"]?></a>
...
<?php }else{?>
									<div class="subpage_subbox <?php echo $TPL_V1["parent_id"]?> <?php echo $TPL_V1["title"]?>" data-id="<?php echo $TPL_V1["parent_id"]?>"> <!-- 여기에 케이팝이 들어가야함-->
										<ul>
											<li><a href="/goods/catalog?code=<?php echo $TPL_V1["category_code"]?>" hrefOri='L2dvb2RzL2NhdGFsb2c/Y29kZT17LmNhdGVnb3J5X2NvZGV9' >&nbsp;&nbsp;&nbsp;&nbsp;ㄴ&nbsp;<?php echo $TPL_V1["title"]?></a></li>
										</ul>
									</div>
...
<?php }else{?>
								<div class="subpage_subbox brand" data-type="brand">
									<ul>
										<li>
											<a href="/goods/brand?code=<?php echo $TPL_V1["category_code"]?>" hrefOri='L2dvb2RzL2JyYW5kP2NvZGU9ey5jYXRlZ29yeV9jb2RlfQ==' >&nbsp;&nbsp;&nbsp;&nbsp;ㄴ&nbsp;<?php echo $TPL_V1["title"]?></a>
										</li>
									</ul>
								</div>
<?php }?>
...
<?php if($TPL_VAR["cata_chk"]){?>
							<li><a href="/board/?id=notice" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw="  textindex="16" hrefOri='L2JvYXJkLz9pZD1ub3RpY2U=' >공지사항</a></li>
							<li><a href="/board/?id=faq" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw="  textindex="17" hrefOri='L2JvYXJkLz9pZD1mYXE=' >자주묻는질문</a></li>
							<li><a href="/board/?id=goods_qna" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw="  textindex="18" hrefOri='L2JvYXJkLz9pZD1nb29kc19xbmE=' >상품문의</a></li>
							<li><a href="https://musicbroshop.com/mypage/myqna_catalog" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw="  textindex="19" hrefOri='aHR0cHM6Ly9tdXNpY2Jyb3Nob3AuY29tL215cGFnZS9teXFuYV9jYXRhbG9n' >1:1 문의</a></li>
							<li><a href="/board/?id=goods_review" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw="  textindex="20" hrefOri='L2JvYXJkLz9pZD1nb29kc19yZXZpZXc=' >상품후기</a></li>
							<li><a href="/board/?id=bulkorder" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw="  textindex="21" hrefOri='L2JvYXJkLz9pZD1idWxrb3JkZXI=' > 대량구매</a></li>
<?php }else{?>
<?php }?>
					</ul>
				</div>
...
<div id="payprocessing" class="pay_layer hide">
	<div style="margin:auto;"><img src="/data/skin/responsive_sports_sporti_gl_2/images/design/img_paying.gif" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9pbWdfcGF5aW5nLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvZGVzaWduL2ltZ19wYXlpbmcuZ2lm' designElement='image' /></div>
	<div style="margin:auto;padding-top:20px;"><img src="/data/skin/responsive_sports_sporti_gl_2/images/design/progress_bar.gif" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9wcm9ncmVzc19iYXIuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvX21vZHVsZXMvbGF5b3V0Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvZGVzaWduL3Byb2dyZXNzX2Jhci5naWY=' designElement='image' /></div>
</div>
