<?php /* Template_ 2.2.6 2022/09/06 16:41:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/goods/_select_options.html 000037574 */ 
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >상품옵션</span></th>
		</tr>
<?php }?>
<?php }?>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >입력옵션</span></th>
		</tr>
<?php }?>
...
<?php if($TPL_V1["input_value"]){?>
					<td><img src="/data/order/<?php echo $TPL_V1["input_value"]?>" id="prevImg" style="height:20px;" designImgSrcOri='L2RhdGEvb3JkZXIvey5pbnB1dF92YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='L2RhdGEvb3JkZXIvey5pbnB1dF92YWx1ZX0=' designElement='image' /></td>
<?php }else{?>
					<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" designImgSrcOri='YWJvdXQ6Ymxhbms7' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='YWJvdXQ6Ymxhbms7' designElement='image' /></td>
<?php }?>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >추가구성</span></th>
		</tr>
<?php }?>
...
<?php if((count($TPL_VAR["options"])> 0&&$TPL_VAR["options"][ 0]["option_title"])&&(($TPL_VAR["suboptions"]&&$TPL_VAR["goods"]["suboption_layout_group"]!='first')||($TPL_VAR["inputs"]&&$TPL_VAR["goods"]["inputoption_layout_position"]!='down'))){?>
		<tr>
			<td colspan="2" align="center" style="padding-top:10px; padding-bottom:10px;">
				<button type="button" class="viewOptionsApply btn_resp size_c color6" style="width:100%"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >위의 정보로 선택</span></button>
			</td>
		</tr>
<?php }?>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >추가구성</span></th>
		</tr>
<?php }?>
<?php if($TPL_suboptions_1){$TPL_I1=-1;foreach($TPL_VAR["suboptions"] as $TPL_V1){$TPL_I1++;?>
<?php if($TPL_V1[ 0]["sub_required"]=='y'){?>
...
<?php }?>
						...
						<ul class="num_price">
							...
							<li class="option_col_price">
								...
								<img src="/data/skin/responsive_sports_sporti_gl_2/images/common/icon_close_gray.png" class="removeOption" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb3NlX2dyYXkucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ljb25fY2xvc2VfZ3JheS5wbmc=' designElement='image' />
							</li>
						</ul>
					</td>
				</tr>
...
<?php if($TPL_V2["input_value"]){?>
									<td><img src="/data/order/<?php echo $TPL_V2["input_value"]?>" class="prevImg" style="height:20px;" designImgSrcOri='L2RhdGEvb3JkZXIvey4uaW5wdXRfdmFsdWV9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='L2RhdGEvb3JkZXIvey4uaW5wdXRfdmFsdWV9' designElement='image' /></td>
<?php }else{?>
									<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" designImgSrcOri='YWJvdXQ6Ymxhbms7' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='YWJvdXQ6Ymxhbms7' designElement='image' /></td>
<?php }?>
