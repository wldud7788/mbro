<?php /* Template_ 2.2.6 2022/09/06 16:41:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/goods/_search_form_light.html 000025407 */  $this->include_("assignBrandBestIcon","setTemplatePath","showCategoryRecommendDisplay","showBrandRecommendDisplay","showLocationRecommendDisplay");
...
<?php if($TPL_V1["best"]=='Y'&&$TPL_VAR["brand_best_icon"]){?>
							<img class="icon" src="<?php echo $TPL_VAR["brand_best_icon"]?>" alt="best" onerror="this.src='/data/icon/goods/error/noimage_list.gif';" designImgSrcOri='e2JyYW5kX2Jlc3RfaWNvbn0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvX3NlYXJjaF9mb3JtX2xpZ2h0Lmh0bWw=' designImgSrc='e2JyYW5kX2Jlc3RfaWNvbn0=' designElement='image' />
<?php }?>
						</label>
					</li>
<?php }?>
