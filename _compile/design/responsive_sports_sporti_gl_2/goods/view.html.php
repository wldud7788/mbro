<?php /* Template_ 2.2.6 2022/09/06 16:41:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/goods/view.html 000113260 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php if($TPL_VAR["wish_seq"]){?>
			$('#wishimg').css('background-image','url(/data/skin/responsive_sports_sporti_gl_2/images/design/ico_wish_on.png)');
		...
		$.ajax({
			...
			'success' : function(res){
				if($('#wishimg').attr('usewish') == 'n'){
					//$('#wishimg').attr('src','/data/skin/responsive_sports_sporti_gl_2/images/design/ico_wish_on.png');
					$('#wishimg').css('background-image','url(/data/skin/responsive_sports_sporti_gl_2/images/design/ico_wish_on.png)');
					$('#wishimg').attr('usewish','y');
					...
					//$('#wishimg').attr('src','/data/skin/responsive_sports_sporti_gl_2/images/design/ico_wish_off.png');
					$('#wishimg').css('background-image','url(/data/skin/responsive_sports_sporti_gl_2/images/design/ico_wish_off.png)');
...
<script type="text/javascript" src='/data/skin/responsive_sports_sporti_gl_2/common/minishop.js'></script>
...
<?php if($TPL_icons_1){foreach($TPL_VAR["icons"] as $TPL_V1){?>
			<img src="/data/icon/goods/<?php echo $TPL_V1["codecd"]?>.gif" alt="" designImgSrcOri='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designElement='image' >
<?php }}?>
		</span>
	</p>
...
<?php }?>
<?php }else{?>
							<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl_2/images/common/noimage_wide.gif'" title="<?php echo $TPL_V1["large"]["label"]?>" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="<?php echo $TPL_VAR["goods_view_image_alt"]?>"<?php }?> designImgSrcOri='ey52aWV3LmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='ey52aWV3LmltYWdlfQ==' designElement='image' />
<?php }?>
					</div>
<?php }?>
<?php }}?>
...
<?php if($TPL_V1["thumbView"]["image"]){?>
							<li><a href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><img src="<?php echo $TPL_V1["thumbView"]["image"]?>" width="<?php echo $TPL_VAR["goodsImageSize"]["thumbView"]["width"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl_2/images/common/noimage_list.gif'" <?php if($TPL_V1["thumbView"]["match_color"]){?> color="<?php echo $TPL_V1["thumbView"]["match_color"]?>"<?php }?> designImgSrcOri='ey50aHVtYlZpZXcuaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='ey50aHVtYlZpZXcuaW1hZ2V9' designElement='image' /></a></li>
<?php }?>
<?php }}?>
						</ul>
					</div>
...
<?php }?>
		...
		<input type="hidden" name="goodsViewVersion" value="2" />
			...
			<div class="sns_wish">
				<!-- SNS 공유 -->
				<a href="javascript:void(0)" id="btnSnsShare" class="btn_sns_share" title="SNS 공유" onclick="share_chg()" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >공유</span></a>
				<div id="snsListDetail" class="snsbox_area" style="display:none;">
					<?php echo snslinkurl('goods',$TPL_VAR["goods"]["goods_name"])?>

				</div>
				<!-- 찜 -->
				<a href="javascript:void(0)" id="wishimg" class="ico_wish" usewish="n" onclick="wish_chg();" title="찜하기(위시리스트에 추가)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >찜</span></a>
			</div>
...
<?php if($TPL_VAR["eventEnd"]){?>
				<li class="spec_solo_event">
					<ul class="list">
						<li class="buy_num"><strong class="num"><?php echo number_format($TPL_VAR["goods"]["event"]["event_order_ea"])?></strong><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >개 구매중</span></li>
						<li class="remain_time">
							<span class="title"></span>
							<div class="event_datetime_box">
								<span class="num2" id="soloday<?php echo $TPL_VAR["goods"]["goods_seq"]?>">00</span><span class="day" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >일</span>
...
<?php if($TPL_VAR["braodcastData"]["status"]=='live'){?>
						<img class="status" src="/data/skin/responsive_sports_sporti_gl_2/images/broadcast/i_live.png" alt="방송 중" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9pX2xpdmUucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvYnJvYWRjYXN0L2lfbGl2ZS5wbmc=' designElement='image' >
						<p class="notice_text"><?php echo $TPL_VAR["braodcastData"]["start_date"]?> 현재 방송 중</p>
						<a class="btn_resp no_border" href="/broadcast/player?no=<?php echo $TPL_VAR["braodcastData"]["bs_seq"]?>" target="_blank" hrefOri='L2Jyb2FkY2FzdC9wbGF5ZXI/bm89e2JyYW9kY2FzdERhdGEuYnNfc2VxfQ==' ><img src="/data/skin/responsive_sports_sporti_gl_2/images/broadcast/btn_live_go.png" alt="시청하기" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9idG5fbGl2ZV9nby5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvYnJvYWRjYXN0L2J0bl9saXZlX2dvLnBuZw==' designElement='image' ></a>
<?php }else{?>
						<img class="status" src="/data/skin/responsive_sports_sporti_gl_2/images/broadcast/reserve_live.png" alt="방송 예정 LIVE" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9yZXNlcnZlX2xpdmUucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvYnJvYWRjYXN0L3Jlc2VydmVfbGl2ZS5wbmc=' designElement='image' >
...
<?php if((array_sum($TPL_VAR["sales"]["sale_list"])-$TPL_VAR["sales"]["sale_list"]["basic"])> 0){?>
					<button type="button" class="btn_open_small btn_resp B" onclick="detail_contents_toggle(this,'priceDetail')"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >혜택보기</span></button>
...
<?php }?>
				...
				<li class="goods_spec_number hide">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상품번호</span></li>
...
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
				<li class="goods_spec_unsold">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상태</span></li>
						<li class="td sell_stop"><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >판매중지</span></li>
					</ul>
				</li>
<?php }?>
				<!-- ~~~~~ //판매중지 ~~~~~ -->
...
<?php if($TPL_VAR["sales"]["mtext_list"]['multi']){?>
				<li class="goods_spec_large_purchase">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >대량구매</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['multi']?>

						</li>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'multi')"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['member']){?>
				<li class="goods_spec_member_grade">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >회원등급</span></li>
						<li><?php echo $TPL_VAR["sales"]["mtext_list"]['member']?></li>
<?php if($TPL_VAR["goods"]["group_benifits"]){?>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'memberBenefitDetail')"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
<?php }?>
					</ul>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['coupon']){?>
				<li class="goods_spec_coupon">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >쿠폰</span></li>
						<li>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['code']){?>
				<li class="goods_spec_sales_code">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >할인코드</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['code']?>

						</li>
						<li class="btn_area1">
							<button type="button" id="codeSaleView" class="btn_resp no_border resStyle"><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
				</li>
<?php }?>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['like']&&$TPL_VAR["APP_USE"]=='f'&&$TPL_VAR["APP_LIKE_TYPE"]!='NO'){?>
				<li class="goods_spec_like">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >좋아요</span></li>
						<li>
...
<?php }?>
						...
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'fblikeDetail')"><span designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if(is_array($TPL_R1=$TPL_VAR["fblikesale"]["result"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
							<li>
								<p class="e_title" ><span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >좋아요 + </span><?php echo get_currency_price($TPL_V1["price1"], 2)?><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" > 이상 구매시</span></p>
								<div class="e_content">
...
<?php if($TPL_VAR["sales"]["mtext_list"]['mobile']){?>
				<li class="goods_spec_mobile">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >모바일</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['mobile']?>

						</li>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'mobileDetail')"><span designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if(is_array($TPL_R1=$TPL_VAR["mobilesale"]["result"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
							<li>
								<p class="e_title"><span designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >모바일 + </span><?php echo get_currency_price($TPL_V1["price1"], 2)?><span designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" > 이상 구매시</span></p>
								<div class="e_content">
<?php if(count($TPL_V1["result"])> 1){?>
										<ul class="basic_lr_style">
											<li>최대</li>
...
<?php }?>
				...
				<li class="goods_spec_halbu">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >무이자할부</span></li>
						<li><span class="gray_06" designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >우측 '자세히' 참조</span></li>
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'goodsInterest')"><span designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
					<div id="goodsInterest" class="Relative hide">
						<div class="layer_simple_basic px p_right">
							<table class="detail_option_table card" cellpadding="0" cellspacing="0">
								<tbody>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_bc.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfYmMuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19iYy5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_ct.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfY3QuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19jdC5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="29"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="30"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_hd.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaGQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19oZC5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="31"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="32"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_hn.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaG4uZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19obi5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="33"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="34"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_kb.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfa2IuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19rYi5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="35"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="36"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_lt.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfbHQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19sdC5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="37"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="38"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_sh.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc2guZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19zaC5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="39"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="40"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								<tr>
									<th><img src="/data/skin/responsive_sports_sporti_gl_2/images/common/interest/Interest_img_ss.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc3MuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19zcy5naWY=' designElement='image' ></th>
									<td><span designElement="text" textIndex="41"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >3~12개월</span></td>
									<td><span designElement="text" textIndex="42"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >5만원이상</span></td>
								</tr>
								</tbody>
							</table>
						</div>
...
<?php if($TPL_VAR["goods"]["referer_sale"]["referersale_seq"]){?>
				<li class="goods_spec_referersale_seq">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="43"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >유입경로</span></li>
						<li>
...
<?php }?>
				...
				<li class="goods_spec_saving_benefit">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="44"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >적립혜택</span></li>
						<li>
							<span designElement="text" textIndex="45"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >구매</span>
<?php if($TPL_VAR["goods"]["string_price_use"]){?>
...
<?php if(($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_photo"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_photo"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_review"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_review"]> 0||($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]))&&$TPL_VAR["isplusfreenot"]){?>
							&nbsp;<span class="gray_07">|</span>&nbsp; <span designElement="text" textIndex="46"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >후기</span> <span class="Dib gray_06" designElement="text" textIndex="47"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >우측 '자세히' 참조</span>
<?php }?>
						</li>
<?php if(($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_photo"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_photo"]> 0||$TPL_VAR["cfg_reserve"]["autoemoney_review"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_review"]> 0||($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]))&&$TPL_VAR["isplusfreenot"]){?>
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'reviewDetail')"><span designElement="text" textIndex="48"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
<?php }?>
					</ul>
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_review"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_review"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="49"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >일반 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_photo"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_photo"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="50"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >포토 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="51"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >동영상 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]){?>
							<li>
								<p class="e_title" designElement="text" textIndex="52"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >기타 상품후기</p>
								<div class="e_content">
...
<?php if(in_array($TPL_VAR["naver_mileage_yn"],array('y','t'))){?>
				<li class="goods_spec_naver_mileage">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="53"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >네이버 마일리지</span></li>
						<li>
...
<?php }else{?>
				<li class="goods_spec_shipping">
					<ul class="detail_spec_table">
						<li class="th">
							<span designElement="text" textIndex="54"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >배송</span>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_sports_sporti_gl_2/images/common/icon_inter_ship.png" class="icon_global" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2ludGVyX3NoaXAucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL2ljb25faW50ZXJfc2hpcC5wbmc=' designElement='image' />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<ul class="detail_spec_table sub">
								<li><span designElement="text" textIndex="55"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >해외구매대행 상품, 개인통관고유부호</span></li>
								<li class="btn_area1"><button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'customsDetail')"><span designElement="text" textIndex="56"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button></li>
							</ul>
<?php }?>
...
<?php }?>
									...
									<div id="shipping_detail_lay" class="resp_layer_pop hide">
										<h4 class="title"><span designElement="text" textIndex="57"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >배송비 안내</span></h4>
								...
								<li class="btn_area1">
									<button type="button" class="btn_resp no_border" id="shipping_detail_info_resp"><span designElement="text" textIndex="58"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
								</li>
							</ul>
<?php }?>
...
<?php if($TPL_V1["delivery_add_input"]){?>
										<div class="add">
											<span designElement="text" textIndex="59"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >추가배송비</span> <?php echo $TPL_V1["delivery_add_input"]?>

										</div>
<?php }?>
<?php if($TPL_V1["delivery_hop_input"]&&!$TPL_VAR["goods"]["reserve_ship_flag"]){?>
										<div class="hop">
											<span designElement="text" textIndex="60"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >희망배송일</span> <?php echo $TPL_V1["delivery_hop_input"]?>

											<button type="button" value="" class="btn_resp calendarBtn" grp_seq="<?php echo $TPL_V1["shipping_group_seq"]?>" set_seq="<?php echo $TPL_V1["shipping_set_seq"]?>" onclick="detail_contents_toggle(this,'deliverydateDetail');"><span designElement="text" textIndex="61"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >희망배송일</span></button>
...
<?php if($TPL_VAR["goods"]["reserve_ship_flag"]){?>
							<ul class="detail_spec_table sub">
								<li><span designElement="text" textIndex="62"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >예약판매 :</span> <?php echo $TPL_VAR["goods"]["reserve_ship_txt"]?></li>
							</ul>
<?php }?>
						</li>
					</ul>
					...
					<div id="deliverydateDetail" class="Relative hide">
						<div class="hopCalendarLayer layer_simple_basic"><span designElement="text" textIndex="63"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >달력</span></div>
					</div>

					<div id="customsDetail" class="detail_option_list hide">
						<ul>
							<li>
								<p class="e_title" designElement="text" textIndex="64"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >해외구매대행 상품이란?</p>
								<p class="e_content" designElement="text" textIndex="65"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >
									해외에서 수입하여 판매하는 상품으로 배송, 반품, 교환이 일반상품과 다를 수 있습니다. 또한 관세청 수입통관 신고 시 구매자의 개인통관고유부호가 필요하기 때문에 주문 시 구매자로부터 개인통관고유부호를 수집하게 됩니다.
								</p>
							</li>
							<li>
								<p class="e_title" designElement="text" textIndex="66"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >개인통관고유부호란?</p>
								<p class="e_content" designElement="text" textIndex="67"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >
									관세청에서는 개인정보 유출을 방지하기 위하여 개인물품 수입신고 시 주민등록번호를 대신 활용할 수 있는 개인통관고유부호 제도를 운영합니다. 개인통관고유부호는 <a href="https://p.customs.go.kr" class="Und" target="_blank" title="새창" designElement="text" textIndex="68"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" hrefOri='aHR0cHM6Ly9wLmN1c3RvbXMuZ28ua3I=' >관세청 사이트</a>에서 신청 즉시 부여되며, 계속 같은 번호로 사용이 가능합니다. 분실하면 관세청 사이트에서 조회 가능합니다. 부호 체계는 P로 시작하고 13자리입니다.
								</p>
							</li>
						</ul>
					</div>
					...
					<div id="eachDeliveryDetail" class="detail_option_list hide">
						<ul>
							<li>
								<p class="e_title" designElement="text" textIndex="69"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >포장최대단위</p>
								<div class="e_content">
									상품 <?php echo number_format($TPL_VAR["goods"]["limit_shipping_ea"])?>개
								</div>
							</li>
							<li>
								<p class="e_title" designElement="text" textIndex="70"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >포장단위별 배송비</p>
								<div class="e_content">
							...
							<li>
								<p class="e_title" designElement="text" textIndex="71"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >포장단위별 추가배송비</p>
								<div class="e_content">
...
<?php if($TPL_VAR["ship_summary"]["gl_shipping_yn"]=='Y'){?>
				<li class="goods_spec_international_shipping">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="72"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >해외배송</span> <img src="/data/skin/responsive_sports_sporti_gl_2/images/common/plane.png" height="15" alt="해외배송" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvY29tbW9uL3BsYW5lLnBuZw==' designElement='image' /></li>
						<li>
							<span class="gray_06" designElement="text" textIndex="73"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >우측 '자세히' 참조</span>
							<div class="hide">
								이 상품은 해외에서 국내로 배송되는 상품이므로 배송,반품,교환이 일반 상품과 다를 수 있습니다.
							</div>
						</li>
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'countryDetail')"><span designElement="text" textIndex="74"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if($TPL_ship_gl_list_1){foreach($TPL_VAR["ship_gl_list"] as $TPL_V1){?>
									<tr>
										<th scope="row" class="L">
											<img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_V1["gl_nation"]?>.png" height="20" alt="" designImgSrcOri='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designElement='image' >
...
<?php if($TPL_VAR["goods"]["sub_info_desc"]["subInfo"]){?>
				<li class="goods_spec_sub_info">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="75"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상품정보</span></li>
						<li><span class="gray_06" designElement="text" textIndex="76"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >우측 '자세히' 참조</span></li>
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="showCenterLayer('#infoDetail')"><span designElement="text" textIndex="77"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
					<div id="infoDetail" class="resp_layer_pop hide">
						<h4 class="title"><span designElement="text" textIndex="78"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상품 정보 제공 고시</span></h4>
						<div class="y_scroll_auto2">
...
<?php if($TPL_VAR["goods"]["review_count"]){?>
				<li class="goods_spec_customer_ev">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="79"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상품후기</span></li>
						<li>
							<?php echo number_format($TPL_VAR["goods"]["review_count"])?><span designElement="text" textIndex="80"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >명</span>&nbsp;
...
<?php if($TPL_VAR["goods"]["brand"]){?>
				<li class="goods_spec_brand">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="81"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >브랜드</span></li>
						<li>
...
<?php if($TPL_VAR["goods"]["cancel_type"]=='1'){?>
				<li class="goods_spec_cancel">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="82"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >청약철회</span></li>
						<li>
							<span designElement="text" textIndex="83"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >불가</span>
						</li>
					</ul>
				</li>
<?php }?>
...
<?php if($TPL_VAR["provider"]["provider_seq"]){?>
				<li class="goods_spec_provider">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="84"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >판매자</span></li>
						<li>
						...
						<li class="btn_area1">
							<button type="button" class="btn_resp no_border" onclick="showCenterLayer('#sellerInfo')"><span designElement="text" textIndex="85"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
					<div id="sellerInfo" class="resp_layer_pop hide">
						<h4 class="title"><span designElement="text" textIndex="86"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >판매자 정보</span></h4>
...
<?php if($TPL_VAR["config_basic"]["companyName"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="87"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상호명</p></li>
											<li class="td"><?php echo $TPL_VAR["config_basic"]["companyName"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["config_basic"]["ceo"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="88"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >대표자</p></li>
											<li class="td"><?php echo $TPL_VAR["config_basic"]["ceo"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["config_basic"]["businessLicense"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="89"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >사업자등록번호</p></li>
											<li class="td"><?php echo $TPL_VAR["config_basic"]["businessLicense"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["config_basic"]["mailsellingLicense"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="90"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >통신판매신고번호</p></li>
											<li class="td"><?php echo $TPL_VAR["config_basic"]["mailsellingLicense"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["config_basic"]["companyPhone"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="91"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >연락처</p></li>
											<li class="td"><?php echo $TPL_VAR["config_basic"]["companyPhone"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["config_basic"]["companyAddress"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="92"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >사업장 소재지</p></li>
...
<?php if($TPL_VAR["provider"]["info_name"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="93"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상호명</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_name"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_ceo"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="94"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >대표자</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_ceo"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_num"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="95"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >사업자등록번호</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_num"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_selling_license"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="96"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >통신판매신고번호</p></li>
											<li class="td"><?php echo $TPL_VAR["provider"]["info_selling_license"]?></li>
										</ul>
<?php }?>
<?php if($TPL_VAR["provider"]["info_phone"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="97"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >연락처</p></li>
...
<?php if($TPL_VAR["provider"]["info_address2"]){?>
										<ul>
											<li class="th size2"><p designElement="text" textIndex="98"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >사업장 소재지</p></li>
											<li class="td">
...
<?php }?>
			...
			<div id="goodsBuyOpenSection" class="goods_buy_open_sections">
				<a href="javascript:void(0);" id="btnSectionOpen" class="btn_section_open off" onclick="btn_close()" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >열기</a>
...
<?php }?>
							<li><button type="button" id="buy_btn" class="btn_resp size_c color2" onclick="btn_close()"><span designElement="text" textIndex="99"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >구매하기</span></button></li>
						</ul>
					</li>
...
<?php }else{?>
<?php }?>
							<p class="text_soldout NpayNo" designElement="text" textIndex="100"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >품절</p>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='purchasing'){?>
						<li><button type="button" style="width:100%;" class="btn_resp size_c NpayNo"><span designElement="text" textIndex="101"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >재고확보 중</span></button></li>
<?php }?>
<?php if(($TPL_VAR["goods"]["goods_status"]=='purchasing'&&serviceLimit('H_NFR'))||($TPL_VAR["goods"]["goods_status"]=='runout'&&$TPL_VAR["goods"]["restock_notify_use"])){?>
						<li><button type="button" style="width:100%;" class="restockOpenBtn btn_resp size_c color4 NpayNo"><span designElement="text" textIndex="102"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >재입고알림 신청</span></button></li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
						<li><button type="button" style="width:100%;" class="btn_resp size_c color3 NpayNo"><span designElement="text" textIndex="103"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >판매중지</span></button></li>
<?php }?>
<?php }?>

<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<li>
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="104"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_sports_sporti_gl_2/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvaWNvbi9pY29uX3RhbGsucG5n' designElement='image' />&nbsp; <span designElement="text" textIndex="105"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >톡톡하세요</span></button>
					</li>
<?php }?>
				</ul>
			</div>
			<!-- ~~~~~~~~~~~ 구매하기 열기 섹션( 모바일 전용 ) ~~~~~~~~~~~ -->
			<script>
				/* 20220419 새로운 스킨 적용시 해당 스크립트 꼭 필요! 밑의 onclick 까지 포함! by khj */
				function btn_open() {
					var selectClass = document.getElementById("goodsOptionBuySection").style;
				...
				function btn_close() {
					...
					selectClass.display='block';
				}
			</script>
			<!-- ~~~~~~~~~~~ 구매하기 ~~~~~~~~~~~ -->
			<div id="goodsOptionBuySection" class="goods_buy_sections">
				<a href="javascript:void(0);" id="btnSectionClose" class="btn_section_close btn_close" onclick="btn_open()" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >닫기</a>
...
<?php }?>
						<td class="total_goods_price">
							<span class="total_goods_tit" designElement="text" textIndex="106"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >총 상품금액</span>
...
<?php if($TPL_VAR["goods"]["goods_status"]=='normal'&&!$TPL_VAR["goods"]["string_price_use"]&&!$TPL_VAR["goods"]["string_button_use"]){?>
						<li>
							<ul class="basic_btn_area">
								<li><button type="button" name="addCart" id="addCart" class="btn_resp size_extra2 NpayNo"><span designElement="text" textIndex="107"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >장바구니</span></button></li>
<?php if($TPL_VAR["ship_summary"]["kr_direct_store_yn"]=='Y'||$TPL_VAR["ship_summary"]["gl_direct_store_yn"]=='Y'){?>
								<li>
									<button type="button" id="direct_store" class="btn_resp size_extra2 NpayNo"><span designElement="text" textIndex="108"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >매장픽업</span></button>
								</li>
<?php }?>
								<li><button type="button" id="buy" class="btn_resp size_extra2 color2 NpayNo"><span designElement="text" textIndex="109"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >구매하기</span></button></li>
							</ul>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='runout'){?>
...
<?php }else{?>
<?php }?>
							<p class="text_soldout NpayNo" designElement="text" textIndex="110"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >품절</p>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='purchasing'){?>
						<li>
							<button type="button" class="btn_resp size_c color3 Cd NpayNo"><span designElement="text" textIndex="111"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >재고확보 중</span></button>
						</li>
<?php }?>
<?php if(($TPL_VAR["goods"]["goods_status"]=='purchasing'&&serviceLimit('H_NFR'))||($TPL_VAR["goods"]["goods_status"]=='runout'&&$TPL_VAR["goods"]["restock_notify_use"])){?>
						<li>
							<button type="button" class="restockOpenBtn btn_resp size_c color4 NpayNo"><span designElement="text" textIndex="112"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >재입고알림 신청</span></button>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
						<li>
							<button type="button" class="btn_resp size_c color3 NpayNo"><span designElement="text" textIndex="113"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >판매중지</span></button>
						</li>
<?php }?>
					</ul>
<?php }?>
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<div class="goods_naver_talk_pc">
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="114"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_sports_sporti_gl_2/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvaWNvbi9pY29uX3RhbGsucG5n' designElement='image' />&nbsp; <span designElement="text" textIndex="115"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >톡톡하세요</span></button>
					</div>
<?php }?>
				</div>
			</div>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['event']){?>
				<li class="goods_spec_event" style="display:none"><!-- 하단 관련 이벤트와 중복이라 hide 처리함( sjg ) -->
					<ul class="detail_event_area" onclick="detail_contents_toggle(this,'eventDetail'); if( $('#eventDetail').is(':hidden') ) $(this).removeClass('up'); else $(this).addClass('up');">
						<li class="th"><span designElement="text" textIndex="116"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >이벤트</span></li>
						<li>
...
<?php if($TPL_VAR["goods"]["gift"]&&$TPL_VAR["goods"]["gift"]["benifits"]){?>
				<li class="goods_spec_gift">
					<ul class="detail_event_area" onclick="detail_contents_toggle(this,'giftInterest'); if( $('#giftInterest').is(':hidden') ) $(this).removeClass('up'); else $(this).addClass('up');">
						<li class="th"><span designElement="text" textIndex="117"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >사은품</span></li>
						<li>
	...
	<div id="goods_contents_quick" class="set_preload">
		...
		<div id="goods_tabs" class="goods_tabs">
			<div class="resp_area">
				<div class="goods_information_tabs">
					<a href="#goods_contents_quick" class="current" onclick="open_information_tab(this,'goods_description');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="118"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상세설명</span></a>
					...
					<a href="#goods_contents_quick" id="goodsQnaLoad" onclick="open_information_tab(this,'goods_qna');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span><span designElement="text" textIndex="120"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상품문의</span> <?php if($TPL_VAR["goods"]["qna_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["qna_count"])?></span><?php }?></span></a>
					<a href="#goods_contents_quick" onclick="open_information_tab(this,'exchange_guide');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="121"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >교환/반품/<span class="Dib">배송</span></span></a>
				</div>
			</div>
		</div>
		<script>
		...
		<div class="goods_information_contents goods_description">
			...
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29udGVudHM/bm89e2dvb2RzLmdvb2RzX3NlcX0mem9vbT0x' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
					<button type="button" class="btn_resp size_b" onclick="document.location.href='/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1';"><span designElement="text" textIndex="123"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >원본 보기</span></button>
				</li>
			</ul>
			<!-- <?php }?> -->

			<div class="goods_description_images goods_view_contents">
				<!-- 2022.06.15 황혜찬 느낌표 없앰 !preload > preload -->
<?php if(!$TPL_VAR["preload"]){?>
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29tbW9uX2NvbnRlbnRzP25vPXtnb29kcy5nb29kc19zZXF9Jnpvb209MQ==' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
					<button type="button" class="btn_resp size_b" onclick="document.location.href='/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1';"><span designElement="text" textIndex="125"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >원본 보기</span></button>
				</li>
			</ul>
<?php }?>
...
<?php if($TPL_VAR["event_banner"]){?>
		<h3 class="title_sub1"><span designElement="text" textIndex="126"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >관련 이벤트</span></h3>
...
<?php if($TPL_VAR["goodsRelationDisplayHTML"]){?>
		<h3 class="title_sub1"><span designElement="text" textIndex="127"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >관련상품</span></h3>
...
<?php if($TPL_VAR["goodsRelationSellerDisplayHTML"]){?>
		<h3 class="title_sub1"><span designElement="text" textIndex="128"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >판매자 인기상품</span></h3>
...
<div id="restockNotifyApply" class="resp_layer_pop hide">
	<h4 class="title"><span designElement="text" textIndex="129"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvZ29vZHMvdmlldy5odG1s" >재입고 알림</span></h4>
	<div class="y_scroll_auto">
