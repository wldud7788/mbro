<?php /* Template_ 2.2.6 2022/09/06 16:41:43 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/layout_header/standard.html 000032535 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #LAYOUT_HEADER @@
  ...
  <div class="resp_wrap">
    <div class="logo_wrap">
      ...
      <h1 class="logo_area">
        ...
        <a href='https://musicbroshop.com/' target='_self' style="max-width: 160px;" hrefOri='aHR0cHM6Ly9tdXNpY2Jyb3Nob3AuY29tLw==' ><img src="/data/skin/responsive_sports_sporti_gl_2/images/design_resp/white_logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbl9yZXNwL3doaXRlX2xvZ28ucG5n' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2xfMi9pbWFnZXMvZGVzaWduX3Jlc3Avd2hpdGVfbG9nby5wbmc=' designElement='image' ></a>
      </h1>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
        <li class="user_info">
          <a href="/mypage" hrefOri='L215cGFnZQ==' ><?php if($TPL_VAR["userInfo"]["user_name"]){?><span class="u_name"><?php echo $TPL_VAR["userInfo"]["user_name"]?></span><?php }else{?><span class="u_id"><?php echo $TPL_VAR["userInfo"]["userid"]?></span><?php }?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >님 환영합니다!</span></a>
        </li>
        <li class="user_logout"><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >LOGOUT</a><?php }else{?><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
        <li class="user_logout"><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a></li>
<?php }else{?>
        <li class="user_login"><a href="/member/login" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9sb2dpbg==' >LOGIN</a></li>
<!--         <li class="user_join">
...
<?php }?>
        <li><a href="/mypage" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L215cGFnZQ==' >MYPAGE</a></li>
        <li class="respCartArea"><a href="/order/cart" hrefOri='L29yZGVyL2NhcnQ=' ><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >CART</span><span class="cart_cnt1"><?php echo $TPL_VAR["push_count_cart"]?></span></a></li>
        <li><a href="/service/cs" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L3NlcnZpY2UvY3M=' >CS CENTER</a></li>
...
<?php }?>
  ...
  <!--          <li class="custom_nav_link">
              ...
              <a class="categoryDepthLink" designElement="text" href="#" hrefOri='Iw==' ><em>LIVE</em></a>
                        ...
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#" hrefOri='Iw==' ><em>TV</em></a>
            </li>
...
<!--             <li class="custom_nav_link">
                <a class="categoryDepthLink" designElement="text" href="https://www.musicbroshop.com/promotion/event_view?event=40&page=1&searchMode=event_view&per=40&sorting=ranking&filter_display=lattice" hrefOri='aHR0cHM6Ly93d3cubXVzaWNicm9zaG9wLmNvbS9wcm9tb3Rpb24vZXZlbnRfdmlldz9ldmVudD00MCZwYWdlPTEmc2VhcmNoTW9kZT1ldmVudF92aWV3JnBlcj00MCZzb3J0aW5nPXJhbmtpbmcmZmlsdGVyX2Rpc3BsYXk9bGF0dGljZQ==' ><em style="color: #F7C645;">LUXURY WEEK</em></a>
                        ...
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#" hrefOri='Iw==' ><em>SALE</em></a>
            </li>
                        <li class="custom_nav_link">
              <a class="categoryDepthLink" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="https://www.musicbroshop.com/promotion/event" hrefOri='aHR0cHM6Ly93d3cubXVzaWNicm9zaG9wLmNvbS9wcm9tb3Rpb24vZXZlbnQ=' ><em>기획전</em></a>
            </li>
            <!--<li class="custom_nav_link">
...
<!-- 상단영역 : 끝 -->
<script type="text/javascript" src="/data/skin/responsive_sports_sporti_gl_2/common/search_ver2_ready.js"></script><!-- 반응형 관련 프론트 js : 검색, 자동검색어 최근본상품 -->
<script type="text/javascript">
    /* 스크롤시 상단 메뉴바 고정시키기 */
    $(function() {
