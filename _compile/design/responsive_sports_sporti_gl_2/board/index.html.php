<?php /* Template_ 2.2.6 2022/09/06 16:41:30 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/board/index.html 000007065 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 게시판 List 레이아웃 템플릿 @@
...
<!-- 본문내용 시작 -->
<!-- <link type="text/css" rel="stylesheet" charset="utf-8" href="/data/skin/responsive_sports_sporti_gl_2/board/<?php echo $TPL_VAR["skindir"]?>/board.css" /> -->
...
<?php if(!$_GET["iframe"]){?>
			<!-- 전체 메뉴 -->
			<a id="subAllButton" class="btn_sub_all" href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvaW5kZXguaHRtbA==" >MENU</span></a>
...
<?php $this->print_("skin",$TPL_SCP,1);?>
	...
	<script type="text/javascript" src="/data/skin/responsive_sports_sporti_gl_2/common/cscenter_ui.js"></script><!-- 고객센터 ui 공통 -->
