<?php /* Template_ 2.2.6 2022/03/30 18:32:41 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl_2/board/notice/default01/index.html 000010655 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["noticeloop"]||$TPL_VAR["loop"]){?>
	<div class="res_table">
		<ul class="thead">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li style="width:48px;"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >번호</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?><li style="width:80px;"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >분류</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?><li><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >제목</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[writer]')){?><li class="Hide" style="width:100px;"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >작성자</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li style="width:100px;"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >등록일</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li style="width:45px;"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >조회</span></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="num"><span class="mtitle" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >공지</span> <?php echo $TPL_V1["number"]?></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >조회:</span> <?php echo $TPL_V1["hit"]?></li><?php }?>
...
<?php if($TPL_loop_1){foreach($TPL_VAR["loop"] as $TPL_V1){?>
		<ul class="tbody">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="mo_hide"><span class="mtitle" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >번호:</span> <?php echo $TPL_V1["number"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?><li><?php echo $TPL_V1["category"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?>
			<li class="subject">
				<span class="hand boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>"  viewtype="<?php echo $TPL_VAR["manager"]["viewtype"]?>"  pagetype="<?php echo $TPL_VAR["pagetype"]?>"  board_seq="<?php echo $TPL_V1["seq"]?>" board_id="<?php echo $_GET["id"]?>">
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[writer]')){?><li class="Hide"><?php echo $TPL_V1["name"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li><?php echo date('Y.m.d',strtotime($TPL_V1["date"]))?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsXzIvYm9hcmQvbm90aWNlL2RlZmF1bHQwMS9pbmRleC5odG1s" >조회:</span> <?php echo $TPL_V1["hit"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[score]')&&$TPL_VAR["manager"]["auth_recommend_use"]=='Y'){?><li><span class="mtitle"><?php echo $TPL_VAR["manager"]["scoretitle"]?>:</span> <?php echo $TPL_V1["recommendlay"]?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
