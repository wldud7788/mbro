<?php /* Template_ 2.2.6 2021/12/15 16:44:42 /www/music_brother_firstmall_kr/data/skin/responsive_multishop_trendy_gl/layout_header/standard.html 000025249 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showTopPromotion","showCategoryLightNavigation");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ #LAYOUT_HEADER @@
...
<div id="layout_header" class="layout_header">
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/main/index' target='_self' hrefOri='L21haW4vaW5kZXg=' ><img src="/data/skin/responsive_multishop_trendy_gl/images/design_resp/logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbl9yZXNwL2xvZ28ucG5n' designTplPath='cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX211bHRpc2hvcF90cmVuZHlfZ2wvaW1hZ2VzL2Rlc2lnbl9yZXNwL2xvZ28ucG5n' designElement='image' ></a>
			</h1>
...
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
				<li class="user_info">
					<a href="/mypage" hrefOri='L215cGFnZQ==' ><?php if($TPL_VAR["userInfo"]["user_name"]){?><span class="u_name"><?php echo $TPL_VAR["userInfo"]["user_name"]?></span><?php }else{?><span class="u_id"><?php echo $TPL_VAR["userInfo"]["userid"]?></span><?php }?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" >님.<br />진심 환영합니다!</span></a>
				</li>
				<li class="user_logout"><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >LOGOUT</a><?php }else{?><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li class="user_logout"><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a></li>
<?php }else{?>
				<li class="user_login"><a href="/member/login" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" hrefOri='L21lbWJlci9sb2dpbg==' >LOGIN</a></li>
				<li class="user_join">
					<a href="/member/agreement" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA==" hrefOri='L21lbWJlci9hZ3JlZW1lbnQ=' >JOIN</a>
...
<?php }?>
				<li class="respCartArea"><a href="/order/cart" hrefOri='L29yZGVyL2NhcnQ=' ><?php echo $TPL_VAR["push_count_cart"]?></a></li>
			</ul>
				...
				<div class="designCategoryNavigation">
					<ul class="respCategoryList">
						...
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/goods/new_arrivals" hrefOri='L2dvb2RzL25ld19hcnJpdmFscw==' ><em>NEW</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/goods/best" hrefOri='L2dvb2RzL2Jlc3Q=' ><em>BEST</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/goods/brand_main" hrefOri='L2dvb2RzL2JyYW5kX21haW4=' ><em>BRANDS</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/promotion/event" hrefOri='L3Byb21vdGlvbi9ldmVudA==' ><em>EVENT</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9tdWx0aXNob3BfdHJlbmR5X2dsL2xheW91dF9oZWFkZXIvc3RhbmRhcmQuaHRtbA=="  href="/board/?id=custom_bbs2" hrefOri='L2JvYXJkLz9pZD1jdXN0b21fYmJzMg==' ><em>STORY</em></a>
						</li>
					</ul>
				</div>
			</div>
