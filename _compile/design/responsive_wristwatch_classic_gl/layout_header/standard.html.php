<?php /* Template_ 2.2.6 2021/12/15 17:04:30 /www/music_brother_firstmall_kr/data/skin/responsive_wristwatch_classic_gl/layout_header/standard.html 000032460 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","setTemplatePath","showDesignBanner","showTopPromotion","showCategoryLightNavigation");
...
<?php }}?>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/main/index' hrefOri='L21haW4vaW5kZXg=' ><img src="/data/skin/responsive_wristwatch_classic_gl/images/design_resp/logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbl9yZXNwL2xvZ28ucG5n' designTplPath='cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3dyaXN0d2F0Y2hfY2xhc3NpY19nbC9pbWFnZXMvZGVzaWduX3Jlc3AvbG9nby5wbmc=' designElement='image' ></a>
			</h1>

            <!-- 상단 유틸메뉴 -->
            <ul class="util_wrap_menu2">
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>				
				<li><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >LOGOUT</a><?php }else{?><a href="/login_process/logout" target="actionFrame" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a></li>
<?php }else{?>
                <li><a href="/member/login" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9sb2dpbg==' >LOGIN</a></li>
				<li>
					<a href="/member/agreement" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9hZ3JlZW1lbnQ=' >JOIN</a>
...
<?php }?>
                <!-- <li><a href="/service/cs" designElement="text" hrefOri='L3NlcnZpY2UvY3M=' >CS CENTER</a></li> -->
                <li class="respCartArea"><a href="/order/cart" hrefOri='L29yZGVyL2NhcnQ=' ><em designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >CART</em><?php if($TPL_VAR["push_count_cart"]){?><span class="cart_cnt2"><?php echo $TPL_VAR["push_count_cart"]?></span><?php }?></a></li>
				<li class="respMypage"><a href="/mypage" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L215cGFnZQ==' ><em>MY SHOPPING</em></a></li>
			</ul>
				...
				<div class="designCategoryNavigation">
					<ul class="respCategoryList">
                        <li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/service/company" target="_self" hrefOri='L3NlcnZpY2UvY29tcGFueQ==' ><em>About Us</em></a>
						</li>					
						<li class="nav_category_all <?php if(preg_match('/goods\/catalog/',$_SERVER["REQUEST_URI"])){?>on<?php }?>">
							<!-- 전체 카테고리 버튼 class 네임 : 'categoryAllBtn', 전체 브랜드 : 'brandAllBtn', 전체 지역 : 'locationAllBtn' -->
							<!-- 전체 카테고리 로딩 파일위치 : [스킨폴더]/_modules/category/all_navigation.html -->
							<a class="categoryAllBtn" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#none" target="_self" hrefOri='I25vbmU=' ><em>Shop</em></a>
                        ...
                        <li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/goods/best" target="_self" hrefOri='L2dvb2RzL2Jlc3Q=' ><em>Best</em></a>
						</li>
                        <li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/goods/new_arrivals" target="_self" hrefOri='L2dvb2RzL25ld19hcnJpdmFscw==' ><em>New</em></a>
						</li>	
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/goods/brand_main" target="_self" hrefOri='L2dvb2RzL2JyYW5kX21haW4=' ><em>Brand</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/promotion/event" target="_self" hrefOri='L3Byb21vdGlvbi9ldmVudA==' ><em>Event</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/board/?id=custom_bbs2" target="_self" hrefOri='L2JvYXJkLz9pZD1jdXN0b21fYmJzMg==' ><em>Story</em></a>
						</li>
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/service/cs" target="_self" hrefOri='L3NlcnZpY2UvY3M=' ><em>CS Center</em></a>
						</li>
					</ul>
				</div>
			</div>
