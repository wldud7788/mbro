<?php /* Template_ 2.2.6 2020/12/30 16:37:14 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_2/layout_footer/standard.html 000018333 */  $this->include_("escrow_mark","confirmLicenseLink");
...
<?php }}?>
    ...
    <div class="footer_b">
        ...
        <div class="resp_wrap">
            <ul class="menu1">
                <li>
                    <span class="info_title" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >COMPANY</span> <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["companyName"]?></span> <span class="info_title" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" ></span><!-- <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["ceo"]?></span>-->
                    <span class="info_title" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >사업장 주소</span>
                ...
                <li>
                    <span class="info_title" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >대표번호/고객센터</span> <a href="tel:<?php echo $TPL_VAR["config_basic"]["companyPhone"]?>" class="pcolor" hrefOri='dGVsOntjb25maWdfYmFzaWMuY29tcGFueVBob25lfQ==' ><?php echo $TPL_VAR["config_basic"]["companyPhone"]?></a>
<?php if($TPL_VAR["config_basic"]["companyFax"]){?>
                    <span class="info_title" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >FAX</span> <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["companyFax"]?></span>
<?php }?>
                    <span class="info_title" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >통신판매업신고번호</span> <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["businessLicense"]?> <?php echo confirmLicenseLink("[사업자정보확인]")?></span> <span class="info_title" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >통신판매업신고번호</span>
                    <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["mailsellingLicense"]?></span>
                </li>
                <li>
                    <span class="info_title" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >대표이사</span> <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["member_info_manager"]?> (<a href="mailto:<?php echo $TPL_VAR["config_basic"]["companyEmail"]?>" hrefOri='bWFpbHRvOntjb25maWdfYmFzaWMuY29tcGFueUVtYWlsfQ==' ><?php echo $TPL_VAR["config_basic"]["companyEmail"]?></a>)</span>
                    <span class="info_title" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >HOSTING PROVIDER</span>
                    <span class="pcolor">(주)가비아씨엔에스</span>
                </li>
            </ul>
            <p class="copyright" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >COPYRIGHT (c) <span class="pcolor"><?php echo $TPL_VAR["config_basic"]["companyName"]?></span> ALL RIGHTS RESERVED.</p>
            <ul class="footer_info">
                <li><a href="https://mubrothers.com" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA=="  target="_blank" hrefOri='aHR0cHM6Ly9tdWJyb3RoZXJzLmNvbQ==' >공식홈페이지</a></li>
                <li><a href="/service/agreement" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA=="  target="_self" hrefOri='L3NlcnZpY2UvYWdyZWVtZW50' >이용약관</a></li>
                <li><a href="/service/privacy" designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA=="  target="_self" hrefOri='L3NlcnZpY2UvcHJpdmFjeQ==' ><strong>개인정보처리방침</strong></a></li>
                <li><a href="/service/guide" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA=="  target="_self" hrefOri='L3NlcnZpY2UvZ3VpZGU=' >이용안내</a></li>
                <li><a href="https://musicbroshop.com/page/index?tpl=etc%2Fparter_page.html" designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA=="  target="_self" hrefOri='aHR0cHM6Ly9tdXNpY2Jyb3Nob3AuY29tL3BhZ2UvaW5kZXg/dHBsPWV0YyUyRnBhcnRlcl9wYWdlLmh0bWw=' >입점문의</a></li>
            </ul>
        </div>

        <div class="ini_box">
            <div>
                <img class="ini_img" src='/data/skin/responsive_diary_petit_gl_2/images/escrow_74x74_color.png' border="0" alt="클릭하시면 이니시스 결제시스템의 유효성을 확인하실 수 있습니다." designImgSrcOri='Li4vaW1hZ2VzL2VzY3Jvd183NHg3NF9jb2xvci5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzIvaW1hZ2VzL2VzY3Jvd183NHg3NF9jb2xvci5wbmc=' designElement='image' >
...
<?php if($TPL_VAR["push_count_today_images"]){?><a href="javascript:;" class="ico_floating_recently" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==" >최근본</span><br /><img src="<?php echo $TPL_VAR["push_count_today_images"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl_2/images/common/noimage.gif'" designImgSrcOri='e3B1c2hfY291bnRfdG9kYXlfaW1hZ2VzfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8yL2xheW91dF9mb290ZXIvc3RhbmRhcmQuaHRtbA==' designImgSrc='e3B1c2hfY291bnRfdG9kYXlfaW1hZ2VzfQ==' designElement='image' /></a><?php }?>
<?php }?>
