<?php /* Template_ 2.2.6 2021/12/15 17:08:34 /www/music_brother_firstmall_kr/data/skin/responsive_accessories_classy_gl/layout_header/standard.html 000030255 */  $this->include_("showDesignLightPopup","showSearchRecent","dataGoodsTodayLight","showCategoryLightNavigation","showTopPromotion");
...
<?php }}?>
		...
		<div class="logo_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/main/index' hrefOri='L21haW4vaW5kZXg=' ><img src="/data/skin/responsive_accessories_classy_gl/images/design_resp/logo.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbl9yZXNwL2xvZ28ucG5n' designTplPath='cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2FjY2Vzc29yaWVzX2NsYXNzeV9nbC9pbWFnZXMvZGVzaWduX3Jlc3AvbG9nby5wbmc=' designElement='image' ></a>
			</h1>

			<ul class="util_wrap_menu">
				<li class="custom_nav_link"><a href="/goods/new_arrivals" class="categoryDepthLink" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2dvb2RzL25ld19hcnJpdmFscw==' ><em>NEW</em></a></li>
				<li class="custom_nav_link"><a href="/goods/best" class="categoryDepthLink" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2dvb2RzL2Jlc3Q=' ><em>BEST</em></a></li>
				<li class="custom_nav_link"><a href="/goods/brand_main" class="categoryDepthLink" designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2dvb2RzL2JyYW5kX21haW4=' ><em>BRAND</em></a></li>
				<li class="custom_nav_link"><a href="/promotion/event" class="categoryDepthLink" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L3Byb21vdGlvbi9ldmVudA==' ><em>EVENT</em></a></li>
				<li class="custom_nav_link"><a href="/board/?id=custom_bbs2" class="categoryDepthLink" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2JvYXJkLz9pZD1jdXN0b21fYmJzMg==' ><em>STORY</em></a></li>
			</ul>
            <ul class="util_wrap_menu2">
                <li class="hide"><a href="<?php echo $TPL_VAR["bookmark"]?>" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='e2Jvb2ttYXJrfQ==' >BOOKMARK</a></li>
<?php if($TPL_VAR["userInfo"]["member_seq"]){?>
				<li class="user_info"><?php if($TPL_VAR["userInfo"]["user_name"]){?><span class="u_name"><?php echo $TPL_VAR["userInfo"]["user_name"]?></span><?php }else{?><span class="u_id"><?php echo $TPL_VAR["userInfo"]["userid"]?></span><?php }?><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >님 반갑습니다.</span></li>
				<li><?php if($TPL_VAR["userInfo"]["snsfacebookcon"]&&$TPL_VAR["fbuser"]){?><a href="javascript:void(0);" onclick="FB.logout(function(response) {logout();});return false;" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >LOGOUT</a><?php }else{?><a href="/login_process/logout" target="actionFrame" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a><?php }?></li>
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L2xvZ2luX3Byb2Nlc3MvbG9nb3V0' >LOGOUT</a></li>
<?php }else{?>
				<li><a href="/member/login" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9sb2dpbg==' >LOGIN</a></li>
				<li>
					<a href="/member/agreement" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L21lbWJlci9hZ3JlZW1lbnQ=' >JOIN</a>
...
<?php }?>
				<li class="respCartArea"><a href="/order/cart" hrefOri='L29yZGVyL2NhcnQ=' ><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >CART</span> <?php if($TPL_VAR["push_count_cart"]){?><span>(<?php echo $TPL_VAR["push_count_cart"]?>)</span><?php }?></a></li>
                <!-- <li><a href="/mypage/order_catalog" designElement="text" hrefOri='L215cGFnZS9vcmRlcl9jYXRhbG9n' >ORDER</a></li> -->
                <li><a href="/mypage" designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L215cGFnZQ==' >MYPAGE</a></li>
				<li><a href="/service/cs" designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" hrefOri='L3NlcnZpY2UvY3M=' >CSCENTER</a></li>
			</ul>
				...
				<div class="designCategoryNavigation">
					<ul class="respCategoryList">
						<li class="nav_category_all <?php if(preg_match('/goods\/catalog/',$_SERVER["REQUEST_URI"])){?>on<?php }?>">
							...
							<a class="categoryAllBtn" designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9hY2Nlc3Nvcmllc19jbGFzc3lfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="#none" hrefOri='I25vbmU=' ><em>ALL</em></a>
						</li>
...
<script type="text/javascript" src="/data/skin/responsive_accessories_classy_gl/common/search_ver2_ready.js"></script><!-- 반응형 관련 프론트 js : 검색, 자동검색어 최근본상품 -->
<script type="text/javascript">
	/* 카테고리 메뉴 */
    $(function(){
