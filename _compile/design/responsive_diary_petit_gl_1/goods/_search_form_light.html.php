<?php /* Template_ 2.2.6 2021/01/08 12:01:42 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/goods/_search_form_light.html 000025343 */  $this->include_("assignBrandBestIcon","setTemplatePath","showCategoryRecommendDisplay","showBrandRecommendDisplay","showLocationRecommendDisplay");
...
<?php if($TPL_V1["best"]=='Y'&&$TPL_VAR["brand_best_icon"]){?>
							<img class="icon" src="<?php echo $TPL_VAR["brand_best_icon"]?>" alt="best" onerror="this.src='/data/icon/goods/error/noimage_list.gif';" designImgSrcOri='e2JyYW5kX2Jlc3RfaWNvbn0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2dvb2RzL19zZWFyY2hfZm9ybV9saWdodC5odG1s' designImgSrc='e2JyYW5kX2Jlc3RfaWNvbn0=' designElement='image' />
<?php }?>
						</label>
					</li>
<?php }?>
