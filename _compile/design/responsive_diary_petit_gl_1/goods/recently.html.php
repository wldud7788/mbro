<?php /* Template_ 2.2.6 2020/12/23 15:33:30 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/goods/recently.html 000007506 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2dvb2RzL3JlY2VudGx5Lmh0bWw=" >최근본 상품</span></h2>
		</div>
...
<?php if($TPL_record_1){foreach($TPL_VAR["record"] as $TPL_V1){?>
					<li>
						<div class="img_area">
							<a href="../goods/view?no=<?php echo $TPL_V1["goods_seq"]?>" hrefOri='Li4vZ29vZHMvdmlldz9ubz17Lmdvb2RzX3NlcX0=' >
								<img src="<?php echo $TPL_V1["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl_1/images/common/noimage_list.gif'" designImgSrcOri='ey5pbWFnZX0=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2dvb2RzL3JlY2VudGx5Lmh0bWw=' designImgSrc='ey5pbWFnZX0=' designElement='image' />
							</a>
						</div>
						<ul class="sub">
