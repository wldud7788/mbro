<?php /* Template_ 2.2.6 2021/07/12 11:06:53 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/member/login.html 000008140 */  $this->include_("sslAction");?>
<a href="http://musicbroshop.com/page/index?tpl=etc%2Fsignup_event.html" target="_self" hrefOri='aHR0cDovL211c2ljYnJvc2hvcC5jb20vcGFnZS9pbmRleD90cGw9ZXRjJTJGc2lnbnVwX2V2ZW50Lmh0bWw=' ><img src="/data/skin/responsive_diary_petit_gl_1/images/KakaoTalk_20210308_133858062.jpg" alt="" title="" designImgSrcOri='Li4vaW1hZ2VzL0tha2FvVGFsa18yMDIxMDMwOF8xMzM4NTgwNjIuanBn' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9sb2dpbi5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL0tha2FvVGFsa18yMDIxMDMwOF8xMzM4NTgwNjIuanBn' designElement='image' ></a>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 로그인 @@
...
<div class="resp_login_wrap">
	<div id="loginTab" class="tab_basic fullsize Pt20">
		...
		<ul>
			<li class="on"><a href="javascript:void(0)" data-tab="member" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9sb2dpbi5odG1s" >회원</span></a></li>
			<li <?php if($TPL_VAR["mode"]=='settle'){?>style="display:none"<?php }?>><a href="javascript:void(0)" data-tab="nonmember" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9sb2dpbi5odG1s" >비회원</span></a></li>
		</ul>
	</div>
</div>
...
<?php if($TPL_K1){?><li class="sns-login-button" snstype="<?php echo $TPL_K1?>"><div class="img"><img src="/data/skin/responsive_diary_petit_gl_1/images/design/sns_icon_<?php echo $TPL_K1?>.png" alt="<?php echo $TPL_K1?> 로그인" title="<?php echo $TPL_V1['nm']?> 로그인" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9zbnNfaWNvbl97PS5rZXlffS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9sb2dpbi5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL2Rlc2lnbi9zbnNfaWNvbl97PS5rZXlffS5wbmc=' designElement='image' /></div></li><?php }?>
<?php }}?>
			</ul>
<?php }?>
