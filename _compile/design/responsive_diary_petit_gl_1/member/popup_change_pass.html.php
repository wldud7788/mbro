<?php /* Template_ 2.2.6 2021/01/08 12:02:11 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/member/popup_change_pass.html 000005188 */ ?>
<style>
...
.keyboard_guide_img .keyboard_hangul {margin:20px auto 0 auto; width:290px; height:80px; background:url('/data/skin/responsive_diary_petit_gl_1/images/common/keyboard.gif') no-repeat; background-size:100% auto}
.keyboard_guide_img .keyboard_specialchars {margin:20px auto 0 auto; width:290px; height:60px; background:url('/data/skin/responsive_diary_petit_gl_1/images/common/keyboard.gif') no-repeat 0 -85px; background-size:100% auto; display:none;}
