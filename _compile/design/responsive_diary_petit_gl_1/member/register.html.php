<?php /* Template_ 2.2.6 2021/01/08 12:02:11 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/member/register.html 000006927 */  $this->include_("sslAction");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 회원가입 > 회원정보 입력 @@
...
<div class="title_container">
	<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9yZWdpc3Rlci5odG1s" >뮤직브로 통합 회원 가입</span></h2>
</div>
<div class="mypage_greeting Pb30">
	<span class="pilsu_icon"></span> <span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9yZWdpc3Rlci5odG1s" >항목은 <span class="pointcolor">필수 입력</span> 항목입니다.</span> <br><br>
	<span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9yZWdpc3Rlci5odG1s" >"회원가입 후 뮤직브로의 다양한 서비스를 이용해보세요~" </span>
	<div style="text-align: center;">
		<div style="width: 250px; display: inline-block;">
			<img src="/data/skin/responsive_diary_petit_gl_1/images/music_cha.jpg" alt="" style="width: 100%;" designImgSrcOri='Li4vaW1hZ2VzL211c2ljX2NoYS5qcGc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9yZWdpc3Rlci5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL211c2ljX2NoYS5qcGc=' designElement='image' >
		</div>
		<div style="width: 250px; display: inline-block;">
			<img src="/data/skin/responsive_diary_petit_gl_1/images/shop_cha.jpg" alt="" style="width: 100%;" designImgSrcOri='Li4vaW1hZ2VzL3Nob3BfY2hhLmpwZw==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9yZWdpc3Rlci5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL3Nob3BfY2hhLmpwZw==' designElement='image' >
		</div>
	</div>
</div>
...
<?php $this->print_("form_member",$TPL_SCP,1);?>
	...
	<div id="btn_register" class="btn_area_c">
		<button type="submit" class="btn_resp size_c color2 Wmax"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL21lbWJlci9yZWdpc3Rlci5odG1s" >입력 완료</span></button>
	</div>
	</form>
</div>
