<?php /* Template_ 2.2.6 2021/01/08 12:02:08 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/mypage/order_return.html 000024429 */ 
...
<div class="subpage_wrap" data-ezmark="undo">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><?php if($_GET["mode"]=='exchange'){?><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9vcmRlcl9yZXR1cm4uaHRtbA==" >교환</span><?php }else{?><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9vcmRlcl9yZXR1cm4uaHRtbA==" >반품</span><?php }?> <span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9vcmRlcl9yZXR1cm4uaHRtbA==" >신청</span></h2>
		</div>
...
<?php }?>
			...
			<p class="desc">
<?php if($_GET["mode"]=='exchange'){?>교환<?php }else{?>반품<?php }?>할 상품을 먼저 선택하고 수량을 입력하세요.<br />
<?php if($_GET["mode"]=='exchange'){?>
...
<?php if($TPL_I2== 0){?>
								<input type="hidden" name="pay_shiping_cost[]" shipping_seq="<?php echo $TPL_V2["shipping_seq"]?>" value="<?php if($TPL_V2["shiping_free_yn"]=='Y'||$_GET["mode"]=='exchange'){?><?php echo $TPL_V2["swap_shiping_cost"]?><?php }else{?><?php echo $TPL_V2["refund_shiping_cost"]?><?php }?>" />
<?php }?>
							</li>
							<li class="subject">
<?php if($TPL_V2["opt_type"]=='opt'){?>
								<ul class="board_goods_list">
									<li class="pic">
										<img src="<?php echo $TPL_V2["image"]?>" onerror="this.src='/data/skin/responsive_diary_petit_gl_1/images/common/noimage_list.gif'" alt="<?php echo $TPL_V2["goods_name"]?>" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9vcmRlcl9yZXR1cm4uaHRtbA==' designImgSrc='ey4uaW1hZ2V9' designElement='image' /></span>
									</li>
									<li class="info">
										<div class="title">
...
<?php }?>
<?php if($TPL_V2["goods_kind"]=='coupon'&&$_GET["mode"]!='exchange'){?>
...
<?php if($TPL_V3["title"]){?><span class="xtle v2"><?php echo $TPL_V3["title"]?></span><?php }?><?php if($TPL_V3["type"]=='file'){?><a href="../mypage_process/filedown?file=<?php echo $TPL_V3["value"]?>" target="actionFrame" class="gray_05" title="다운로드" hrefOri='Li4vbXlwYWdlX3Byb2Nlc3MvZmlsZWRvd24/ZmlsZT17Li4udmFsdWV9' ><?php echo $TPL_V3["value"]?></a><?php }else{?><?php echo $TPL_V3["value"]?><?php }?>
											</span>
<?php }?>
<?php }}?>
										</div>
...
<?php }?>
				...
				<span class="reason_ship_duty_area pointcolor2"><?php if($_GET["mode"]=='exchange'){?>교환<?php }else{?>반품<?php }?>배송비 :
...
<?php if($_GET["mode"]!='exchange'&&$TPL_VAR["orders"]["show_refund_method"]=='Y'){?>
...
<?php }?>
						...
						<span class="pointcolor2"><?php if($_GET["mode"]=='exchange'){?>교환<?php }else{?>반품<?php }?>배송비 : <span id="refund_ship_cost"><?php echo get_currency_price( 0, 2)?></span></span>
...
<?php }}?>
			...
			<div class="btn_area_c">
				...
				<a href="/mypage/order_catalog" class="btn_resp size_c" hrefOri='L215cGFnZS9vcmRlcl9jYXRhbG9n' >취소</a>
			</div>
		</form>
		</div>
