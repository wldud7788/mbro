<?php /* Template_ 2.2.6 2020/12/23 15:33:55 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/mypage/delivery_address.html 000033662 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9kZWxpdmVyeV9hZGRyZXNzLmh0bWw=" >주소록</span></h2>
		</div>
					...
					<div class="tab_basic size1">
						<ul>
							<li <?php if($_GET["tab"]=='1'||!$_GET["tab"]){?> class="on"<?php }?>>
								<a href="javascript:;" onclick="submitAddressBookFrm('tab','1')" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9kZWxpdmVyeV9hZGRyZXNzLmh0bWw=" >자주쓰는 배송지</span></a>
							</li>
							<li <?php if($_GET["tab"]=='2'){?> class="on"<?php }?>>
								<a href="javascript:;" onclick="submitAddressBookFrm('tab','2')" hrefOri='amF2YXNjcmlwdDo7' ><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9kZWxpdmVyeV9hZGRyZXNzLmh0bWw=" >최근 배송지</span></a>
							</li>
						</ul>
					</div>
...
<?php if($_GET["popup"]){?>
					...
					<a href="javascript:;" class="pop_close" onclick="self.close();" hrefOri='amF2YXNjcmlwdDo7' >창닫기</a>
<?php }?>
...
<?php if($TPL_V1["default"]=='Y'){?><img src="/data/skin/responsive_diary_petit_gl_1/images/common/icon_default.gif" title="기본" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2RlZmF1bHQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL215cGFnZS9kZWxpdmVyeV9hZGRyZXNzLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL2NvbW1vbi9pY29uX2RlZmF1bHQuZ2lm' designElement='image' /><?php }?>
...
<?php if($_GET["popup"]){?>
	...
	.address_reg .pop_close {padding-right:13px; background:url('/data/skin/responsive_diary_petit_gl_1/images/common/btn_close.gif') no-repeat right;}
