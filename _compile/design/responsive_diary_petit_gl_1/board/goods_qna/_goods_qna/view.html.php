<?php /* Template_ 2.2.6 2021/01/08 12:01:43 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/board/goods_qna/_goods_qna/view.html 000012820 */  $this->include_("sslAction","snslinkurl");
...
<?php }?>
	...
	<table class="table_row_a Thc" data-responsive="yes" width="100%" cellpadding="0" cellspacing="0">
		...
		<tbody>
			<tr>
				<th><p designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >분류</p></th>
				...
				<th><p designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >작성자</p></th>
				<td><?php echo $TPL_VAR["name"]?></td>
			</tr>
			<tr>
				<th><p designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >등록일</p></th>
				<td><?php echo $TPL_VAR["r_date"]?></td>
				<th><p designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >조회수</p></th>
				<td><?php echo number_format($TPL_VAR["hit"])?></td>
			</tr>
<?php if($TPL_VAR["filelist"]){?>
			<tr>
				<th><p designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >첨부파일</p></th>
				<td colspan="3">
					<ul>
...
<?php if($TPL_V1["is_image"]){?>
								<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');" ><img src="/data/skin/responsive_diary_petit_gl_1/board/goods_qna/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvYm9hcmQvZ29vZHNfcW5hL2ltYWdlcy9pY29uL2ljb25fem9vbS5naWY=' designElement='image' /></span>
<?php }?>
						</li>
<?php }}?>
					</ul>
...
<?php if($TPL_VAR["goodsview"]){?>
	<div class="goods_origin_info">
		<h4 class="title"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >상품 정보</span></h4>
...
<?php if($TPL_VAR["re_contents"]){?>
	<div class="board_manager_reply">
		<div class="writer">
			<span class="icon1" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >답변</span> <strong><?php echo $TPL_VAR["adminname"]?></strong> 
...
<ul class="board_detail_btns">
	<li class="left"><button type="button" name="boardviewclose" class="btn_resp size_b color5"><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >목록</span></button></li>
	<li class="right">
<?php if($TPL_VAR["display"]== 0&&$TPL_VAR["managerview"]["isperm_moddel"]!="_mbno"){?>
		<button type="button" name="goods_boad_modify_btn<?php echo $TPL_VAR["managerview"]["isperm_moddel"]?>" board_seq="<?php echo $TPL_VAR["seq"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" class="btn_resp size_b"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >수정</span></button>
<?php }?>
<?php if((($TPL_VAR["display"]== 0||($TPL_VAR["display"]== 1&&$TPL_VAR["replyor"]== 0&&$TPL_VAR["comment"]== 0)))&&$TPL_VAR["managerview"]["isperm_moddel"]!="_mbno"){?> 
		<button type="button"  name="goods_boad_delete_btn<?php echo $TPL_VAR["managerview"]["isperm_moddel"]?>"  board_seq="<?php echo $TPL_VAR["seq"]?>"  board_id="<?php echo $TPL_VAR["boardid"]?>"  class="btn_resp size_b"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >삭제</span></button>
<?php }?>
<?php if($TPL_VAR["display"]== 0&&$TPL_VAR["replylay"]=='Y'&&$TPL_VAR["managerview"]["isperm_write"]!="_no"){?> 
		<button type="button"  id="goods_boad_reply_btn" board_seq="<?php echo $TPL_VAR["seq"]?>"  board_id="<?php echo $TPL_VAR["boardid"]?>" class="btn_resp size_b"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >답변</button>
<?php }?>
<?php if($TPL_VAR["managerview"]["isperm_write"]!="_no"){?>
		<button type="button" id="goods_boad_write_btn<?php echo $TPL_VAR["managerview"]["isperm_write"]?>" board_id="<?php echo $TPL_VAR["boardid"]?>" class="btn_resp size_b color2"><?php echo $TPL_VAR["manager"]["name"]?> <span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2dvb2RzX3FuYS9fZ29vZHNfcW5hL3ZpZXcuaHRtbA==" >쓰기</span></button>
<?php }?>
	</li>
</ul>
<!-- //버튼 -->
