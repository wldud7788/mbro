<?php /* Template_ 2.2.6 2021/01/08 12:01:43 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/board/index.html 000007055 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 게시판 List 레이아웃 템플릿 @@
...
<!-- 본문내용 시작 -->
<!-- <link type="text/css" rel="stylesheet" charset="utf-8" href="/data/skin/responsive_diary_petit_gl_1/board/<?php echo $TPL_VAR["skindir"]?>/board.css" /> -->
...
<?php if(!$_GET["iframe"]){?>
			<!-- 전체 메뉴 -->
			<a id="subAllButton" class="btn_sub_all" href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL2JvYXJkL2luZGV4Lmh0bWw=" >MENU</span></a>
