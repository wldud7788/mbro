<?php /* Template_ 2.2.6 2021/11/29 12:39:55 /www/music_brother_firstmall_kr/data/skin/responsive_diary_petit_gl_1/order/settle.html 000088881 */  $this->include_("showNaverMileageButton","sslAction");
...
<form name="orderFrm" id="orderFrm" method="post" action="innopay_process" target="actionFrame">
	...
	<div class="subpage_wrap">
		<div class="subpage_container v3 Pb10">
			...
			<div class="title_container Pb0">
				<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >주문/결제</span></h2>
			</div>
		</div>
	</div>
	...
	<div id="orderPaymentLayout" class="subpage_wrap order_payment" data-ezmark="undo">
		<div class="subpage_container v2 Pt0 order_payment_left">
			<!-- 주문상품 :: START -->
			<h2 class="title_od1 Pt15"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >주문상품 정보</span></h2>
							...
							<div class="cart_goods_detail">
								...
								<div class="cgd_contents">
									<div class="block block1">
										<ul>
											<li class="img_area">
												<a href="../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>" hrefOri='Li4vZ29vZHMvdmlldz9ubz17Li5nb29kc19zZXF9' ><img src="<?php echo $TPL_V2["image"]?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_diary_petit_gl_1/images/common/noimage_list.gif'" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='ey4uaW1hZ2V9' designElement='image' /></a>
											</li>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
													<img src="/data/skin/responsive_diary_petit_gl_1/images/common/auth_img.png" alt="성인" class="icon1" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designElement='image' />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
													<img src="/data/skin/responsive_diary_petit_gl_1/images/common/plane.png" alt="해외배송상품" class="icon2" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designElement='image' />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
													<img src="/data/skin/responsive_diary_petit_gl_1/images/common/nocancellation.gif" alt="청약철회" class="icon3" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9ub2NhbmNlbGxhdGlvbi5naWY=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL2NvbW1vbi9ub2NhbmNlbGxhdGlvbi5naWY=' designElement='image' />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
													<img src="/data/skin/responsive_diary_petit_gl_1/images/common/taxfree.gif" alt="비과세" class="icon4" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi90YXhmcmVlLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX2RpYXJ5X3BldGl0X2dsXzEvaW1hZ2VzL2NvbW1vbi90YXhmcmVlLmdpZg==' designElement='image' />
<?php }?>
												</div>
<?php }?>
...
<?php if($TPL_V3["input_title"]){?><span class="xtle v2"><?php echo $TPL_V3["input_title"]?></span><?php }?>
														<a href="/mypage_process/filedown?file=<?php echo $TPL_V3["input_value"]?>" target="actionFrame" title="크게 보기" hrefOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLmlucHV0X3ZhbHVlfQ==' ><img src="/mypage_process/filedown?file=<?php echo $TPL_V3["input_value"]?>" class="inputed_img" designImgSrcOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLmlucHV0X3ZhbHVlfQ==' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLmlucHV0X3ZhbHVlfQ==' designElement='image' /></a>
<?php }else{?>
<?php if($TPL_V3["input_title"]){?><span class="xtle v2"><?php echo $TPL_V3["input_title"]?></span><?php }?>
...
<?php if(get_gift_image($TPL_V2,'list1')){?>
							<img class="img1" src="<?php echo get_gift_image($TPL_V2,'list1')?>" alt="" designImgSrcOri='ez1nZXRfZ2lmdF9pbWFnZSguLnZhbHVlXyw=' designTplPath='cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s' designImgSrc='ez1nZXRfZ2lmdF9pbWFnZSguLnZhbHVlXyw=' designElement='image' />
<?php }?>
...
<?php }?>
			...
			<div class="order_subsection v2">
				<!-- ++++++++++++++++++++ 주문자 :: START ++++++++++++++++++++ -->
				<h3 class="title3"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >주문자</span></h3>
...
<?php }?>
				...
				<!-- ++++++++++++++++++++ 배송지 :: START ++++++++++++++++++++ -->
				<h3 class="title3"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >배송지</span></h3>
...
<?php }?>
				...
				<!-- ++++++++++++++++++++ 배송지 :: END ++++++++++++++++++++ -->
				<!-- ++++++++++++++++++++ 할인입력 :: START ++++++++++++++++++++ -->
				<h3 class="title3"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >할인</span></h3>
				<ul class="list_01 v2">
...
<?php if(is_array($TPL_R2=$TPL_V1["goods"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
				<? if ( $TPL_V1["goods"][ 0]['goods_seq'] == '2122') { ?>
				 	<h3 class="title3"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" > 팬사인회 응모자 정보</span></h3>
					<li>
						<span class="od_sale_title">정보입력</span>
						<input type="text" style="width: 90%" placeholder="성함 / 생년월일 / 핸드폰번호(000-0000-0000)">
						<span class="international_nation">반드시 팬사인회 참가자 정보를 입력해주세요</span>
					</li>
				 <? } ?>
<?php }}?>
<?php }}?>
				...
				<div class="right_flying_wrap1">
					<div class="right_flying_wrap2">
						<div class="right_flying_wrap3">
							<!-- ++++++++++++++++++++ 결제 금액 :: START ++++++++++++++++++++ -->
							<h3 class="title3 Pt15"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >결제 금액</span></h3>
							<div class="order_price_total">
								<ul>
									<li class="th"><span class="gray_01 Fs17" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >상품금액</span></li>
									<li class="td"><?php echo get_currency_price($TPL_VAR["total"], 2,'','<span id="total_goods_price" class="v2 gray_01">_str_price_</span>')?></li>
								</ul>
								<ul>
									<li class="th">
										<span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >배송비</span>&nbsp;
										<button type="button" class="btn_resp size_a gray_05" onclick="showCenterLayer('#besongDetailList')"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >내역</span></button>
									</li>
									<li class="td">
								...
								<ul>
									<li class="th">
										<span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >할인금액</span>&nbsp;
										<button type="button" class="btn_resp size_a gray_05" onclick="showCenterLayer('#saleDetailList')"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >내역</span></button>
									</li>
...
<?php if($TPL_VAR["members"]){?>
								<ul>
									<li class="th"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >캐시 사용</span></li>
									<li class="td pointcolor3">
										<span>(-)</span>
...
<?php if($TPL_VAR["cfg_reserve"]["cash_use"]=='Y'){?>
								<ul>
									<li class="th"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >예치금 사용</span></li>
									<li class="td pointcolor3">
										(-)
...
<?php }?>
								<ul class="total">
									<li class="th"><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >최종 결제금액</span></li>
									<li class="td">
...
<?php if($TPL_VAR["members"]){?>
							<p class="od_sale_title2"><span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >예상적립 혜택</span></p>
...
<?php if(in_array($TPL_VAR["naver_mileage_yn"],array('y','t'))){?>
							<p class="od_sale_title2" designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >네이버마일리지</p>
...
<?php }?>
							...
							<!-- ++++++++++++++++++++ 결제 수단 :: START ++++++++++++++++++++ -->
							<h3 class="title3"><span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >결제 수단</span></h3>
...
<?php if($TPL_VAR["payment"]["payco"]){?>
								<li>
									...
									<p designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >페이코</p>
								</li>
<?php }?>
<?php if($TPL_VAR["payment"]["kakaopay"]){?>
								<li>
									...
									<p onclick="click_Kakaopay(this);" designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >카카오페이</p>
								</li>
<?php }?>
								<!-- 이노페이 테스트 관련-->
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="innopay" /></label>
									</div>
									<p designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >신용카드(이노페이 테스트)</p>
								</li>
								<!-- 이노페이 관련 -->
								<li>
									<div class="card">
									...
									<p designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >신용카드</p>
								</li>
								<li>
									<div class="account">
										<label><input type="radio" name="payment" value="BANK" /></label>
									</div>
									<p designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >계좌이체</p>
								</li>
								<li>
									<div class="virtual">
										<label><input type="radio" name="payment" value="VBANK" /></label>
									</div>
									<p designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >무통장입금(가상계좌)</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="EPAY" /></label>
									</div>
									<p designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >간편결제</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="CARS" /></label>
									</div>
									<p designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >ARSPAY Web LINK</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="CSMS" /></label>
									</div>
									<p designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >SMS카드결제 Web LINK(인증)</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="DSMS" /></label>
									</div>
									<p designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >SMS카드결제 Web LINK(수기)</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="DSMS" /></label>
									</div>
									<p designElement="text" textIndex="29"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >SMS카드결제 Web LINK(수기)</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="DSMS" /></label>
									</div>
									<p designElement="text" textIndex="30"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >SMS카드결제 Web LINK(수기)</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="CKEYIN" /></label>
									</div>
									<p designElement="text" textIndex="31"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >수기결제 WebLink</p>
								</li>
								<li>
									<div class="card">
										<label><input type="radio" name="payment" value="EBANK" /></label>
									</div>
									<p designElement="text" textIndex="32"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >계좌간편결제</p>
								</li>
<?php if($TPL_VAR["payment"]["bank"]){?>
								<li>
									...
									<p designElement="text" textIndex="33"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >무통장입금</p>
								</li>
<?php }?>
<?php if($TPL_VAR["payment"]["paypal"]){?>
								<li>
									...
									<p designElement="text" textIndex="34"  textTemplatePath="cmVzcG9uc2l2ZV9kaWFyeV9wZXRpdF9nbF8xL29yZGVyL3NldHRsZS5odG1s" >Paypal</p>
								</li>
<?php }?>
