<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/member/register_ok.html 000002881 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 회원가입 완료 @@
...
<?php if($TPL_VAR["userInfo"]){?>
		<li><a class="btn_resp size_c color2" href="../mypage/myinfo" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9yZWdpc3Rlcl9vay5odG1s" hrefOri='Li4vbXlwYWdlL215aW5mbw==' >회원정보수정</a></li>
<?php }else{?>
		<li><a class="btn_resp size_c color2" href="../member/login?return_url=<?php echo urlencode('../main/index')?>" hrefOri='Li4vbWVtYmVyL2xvZ2luP3JldHVybl91cmw9ez11cmxlbmNvZGUo' ><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9yZWdpc3Rlcl9vay5odG1s" >로그인</span></a></li>
<?php }?>
		<li><a class="btn_resp size_c color4" href="../main" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9yZWdpc3Rlcl9vay5odG1s" hrefOri='Li4vbWFpbg==' >쇼핑하러가기</a></li>
	</ul>
</div>
<?php }?>