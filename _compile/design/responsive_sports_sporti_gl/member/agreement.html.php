<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/member/agreement.html 000013657 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 회원가입 > 약관동의 @@
		...
		<div class="mem_agree_area">
			...
			<ul id="agreeList" class="agree_list3">
				<li class="agree_section">
					<a class="agree_view" href="javascript:void(0)" onclick="showCenterLayer('#agreementDeatilLayer')" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9hZ3JlZW1lbnQuaHRtbA==" >보기</span></a>
				...
				<li class="agree_section">
					<a class="agree_view" href="javascript:void(0)" onclick="showCenterLayer('#privacyDeatilLayer')" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9hZ3JlZW1lbnQuaHRtbA==" >보기</span></a>
...
<?php if($TPL_VAR["joinform_optionYN"]=='Y'){?>
				<li class="agree_section">
					<a class="agree_view" href="javascript:void(0)" onclick="showCenterLayer('#joinformDeatilLayer')" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9hZ3JlZW1lbnQuaHRtbA==" >보기</span></a>
...
<?php if($TPL_VAR["join_type"]=='member'&&($TPL_VAR["email_use"]=='Y'||$TPL_VAR["cellphone_use"]=='Y')){?>
				<li class="agree_section">
					<a class="agree_view" href="javascript:void(0)" onclick="showCenterLayer('#marketingDeatilLayer')" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9hZ3JlZW1lbnQuaHRtbA==" >보기</span></a>
...
<?php }elseif($TPL_VAR["join_type"]=='business'&&($TPL_VAR["bemail_use"]=='Y'||$TPL_VAR["bcellphone_use"]=='Y')){?>
				<li class="agree_section">
					<a class="agree_view" href="javascript:void(0)" onclick="showCenterLayer('#marketingDeatilLayer')" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL21lbWJlci9hZ3JlZW1lbnQuaHRtbA==" >보기</span></a>
