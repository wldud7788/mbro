<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/goods/view_common_contents.html 000004048 */  $this->include_("defaultScriptFunc");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 상품 상세 설명 - 공용정보 원본 보기 @@
...
<link rel="stylesheet" type="text/css" href="/data/skin/responsive_sports_sporti_gl/css/common.css" />
...
#goods_view_contents_title h2 { font-size:14px; font-weight:500; line-height:40px; padding-left:36px; color:#fff; background:url(/data/skin/responsive_sports_sporti_gl/images/design/hand_zoom.png) 0 50% no-repeat; background-size:24px; }
#goods_view_contents_title .close { position: absolute; right: 0px; top: 0px; background: url(/data/skin/responsive_sports_sporti_gl/images/design/btn_close.png) no-repeat center center; background-size: 39px 39px; width: 39px; height: 39px; box-sizing: border-box; overflow:hidden; text-indent:-999px; }
...
<div id="goods_view_contents_title">
	...
	<a href="javascript:void(0)" class="close" onclick="history.back();" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >닫기</a>
</div>

<!-- to top -->
<div id="goods_view_contents_top">
	<a href="#" hrefOri='Iw==' ><img src="/data/skin/responsive_sports_sporti_gl/images/design/btn_floating_top.png" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9idG5fZmxvYXRpbmdfdG9wLnBuZw==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL3ZpZXdfY29tbW9uX2NvbnRlbnRzLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2Rlc2lnbi9idG5fZmxvYXRpbmdfdG9wLnBuZw==' designElement='image' /></a>
</div>
