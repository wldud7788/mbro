<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/goods/brand_main.html 000008300 */  $this->include_("assignBrandMenuData","setTemplatePath","showDesignBanner");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 브랜드 메인 @@
...
<div class="search_nav">
	...
	<span class="navi_linemap on" designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==" >BRANDS</span>
</div>
...
<?php if(in_array('brand',$TPL_VAR["page_config"]["search_filter"])){?>
		<div class="resp_brand_search_form">
			<span class="search_title" designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==" >Search Brand</span>
			<input type="text" name="keyword" class="search_input" value="" />&nbsp;
			<button type="submit" class="btn_resp size_c"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==" >검색</span></button>
		</div>
<?php }?>
<?php if(in_array('kor',$TPL_VAR["page_config"]["search_filter"])||in_array('eng',$TPL_VAR["page_config"]["search_filter"])){?>
		<div class="resp_brand_search_btns">
			<ul>
				<li><a href="javascript:void(0)" class="alphabet_btn all on" data-target="all" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==" >ALL</span></a></li>
...
<?php if(is_array($TPL_R1=($TPL_VAR["ALL"]))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
		<ul class="brandwrap all brand<?php echo $TPL_V1["category_code"]?>" >
			<li>
				<a class="brand_list_block" <?php if($TPL_V1["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V1["category_code"]?>" hrefOri='L2dvb2RzL2JyYW5kP2NvZGU9ey5jYXRlZ29yeV9jb2RlfQ==' >
					<img src="<?php echo $TPL_V1["brand_image"]?>" alt="<?php echo $TPL_V1["prn_title"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif';" designImgSrcOri='ez0uYnJhbmRfaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==' designImgSrc='ez0uYnJhbmRfaW1hZ2V9' designElement='image' />
					<span class="name">
						<?php echo $TPL_V1["prn_title"]?>

<?php if($TPL_V1["best"]=='Y'&&$TPL_VAR["brand_best_icon"]){?>
						<img class="icon" src="<?php echo $TPL_VAR["brand_best_icon"]?>" alt="best" onerror="this.src='/data/icon/goods/error/noimage_list.gif';" designImgSrcOri='e2JyYW5kX2Jlc3RfaWNvbn0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==' designImgSrc='e2JyYW5kX2Jlc3RfaWNvbn0=' designElement='image' />
<?php }?>
					</span>
				</a>
			</li>
		...
		<ul class="brandwrap brand<?php echo $TPL_V2["category_code"]?> wrap<?php echo str_replace("/","",strtr(base64_encode(str_replace("/","",$TPL_K1)),"+=","-_"))?>" style="display: none">
			<li>
				<a class="brand_list_block" <?php if($TPL_V2["brand_image"]){?><?php }?> href="/goods/brand?code=<?php echo $TPL_V2["category_code"]?>" hrefOri='L2dvb2RzL2JyYW5kP2NvZGU9ey4uY2F0ZWdvcnlfY29kZX0=' >
					<img src="<?php echo $TPL_V2["brand_image"]?>" alt="<?php echo $TPL_V2["prn_title"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif';" designImgSrcOri='ez0uLmJyYW5kX2ltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2dvb2RzL2JyYW5kX21haW4uaHRtbA==' designImgSrc='ez0uLmJyYW5kX2ltYWdlfQ==' designElement='image' />
					<span class="name">
