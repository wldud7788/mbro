<?php /* Template_ 2.2.6 2021/12/15 16:50:22 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/goods_review/_goods_review/index.html 000021809 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["noticeloop"]||$TPL_VAR["loop"]){?>
	<div class="res_table">
		<ul class="thead">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li style="width:45px;"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >번호</span></li><?php }?>
			<li><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >후기</span></li>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[reviewinfo]')||strstr($TPL_VAR["manager"]["list_show"],'[emoney]')){?><li style="width:90px;"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >평가</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[writer]')){?><li style="width:94px;"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >작성자</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[order_seq]')){?><li style="width:94px;"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >구매여부</span></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li style="width:84px;"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >등록일</span></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li style="width:45px;"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >조회</span></li><?php }?>
		</ul>
<?php if($TPL_VAR["noticeloop"]){?>
<?php if($TPL_noticeloop_1){foreach($TPL_VAR["noticeloop"] as $TPL_V1){?>
		<ul class="tbody notice">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="num"><span class="mtitle" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >공지</span> <?php echo $TPL_V1["number"]?></li><?php }?>
			<li class="subject">
<?php if($TPL_V1["goodsInfo"]){?>
					<ul class="board_goods_list">
						<li class="pic">
<?php if($TPL_V1["file_key_w"]&&$TPL_V1["uccdomain_thumbnail"]){?>
							<img src="<?php echo $TPL_V1["uccdomain_thumbnail"]?>" alt="" designImgSrcOri='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=' designImgSrc='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designElement='image' />
<?php }else{?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >조회:</span> <?php echo number_format($TPL_V1["hit"])?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
<?php if($TPL_VAR["loop"]){?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="mo_hide"><span class="mtitle" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >번호:</span> <?php echo $TPL_V1["number"]?></li><?php }?>
			<li class="subject">
<?php if($TPL_V1["goodsInfo"]){?>
					<ul class="board_goods_list">
						<li class="pic">
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li><?php echo $TPL_V1["date"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[score]')&&$TPL_VAR["manager"]["auth_recommend_use"]=='Y'){?><li><span class="mtitle"><?php echo $TPL_VAR["manager"]["scoretitle"]?>:</span> <?php echo $TPL_V1["recommendlay"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >조회:</span> <?php echo number_format($TPL_V1["hit"])?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
	</div>
...
<ul class="bbs_bottom_wrap">
	<li class="right">
		<button type="button" name="boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>" <?php if($_GET["iframe"]){?>id="goods_boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"<?php }else{?>id="boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"<?php }?> board_id="<?php echo $TPL_VAR["boardid"]?>" fileperm_read="<?php echo $TPL_VAR["manager"]["fileperm_write"]?>" class="btn_resp size_b color2" /><?php echo $TPL_VAR["manager"]["name"]?> <span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL2dvb2RzX3Jldmlldy9fZ29vZHNfcmV2aWV3L2luZGV4Lmh0bWw=" >쓰기</span></button>
	</li>
</ul>
