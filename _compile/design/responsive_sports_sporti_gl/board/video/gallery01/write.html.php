<?php /* Template_ 2.2.6 2022/02/25 17:12:20 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/video/gallery01/write.html 000015393 */  $this->include_("sslAction");
...
<?php }?>
	...
	<div class="bbswrite_division">
		유튜브 동영상 url : <input type="text" id="youtube_url" name="youtube_url" style="width: 30%" value="<?php echo $TPL_VAR["video_url"]?>">
		<button type="button" onclick="check_url()">입력</button><br>
		동영상 미리 보기 : <br>
		<div id="player_autoload">
			<iframe id="youtube_preview" width="560" height="315" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</div>
