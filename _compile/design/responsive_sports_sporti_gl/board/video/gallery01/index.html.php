<?php /* Template_ 2.2.6 2022/03/11 14:18:01 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/video/gallery01/index.html 000016638 */  $this->include_("sslAction");
	...
	<ul class="bbs_top_wrap gallery">
		<li class="left">
			...
			<ul id="customGallerySort" class="custom_gallery_sort">
				<li class="sort_1 on"><a href="#type1" hrefOri='I3R5cGUx' >가로형</a></li>
				<li class="sort_2"><a href="#type2" hrefOri='I3R5cGUy' >새로형</a></li>
...
<?php if($TPL_V1["file_key_w"]&&$TPL_V1["uccdomain_thumbnail"]){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["uccdomain_thumbnail"]?>" designImgSrcOri='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL3ZpZGVvL2dhbGxlcnkwMS9pbmRleC5odG1s' designImgSrc='ey51Y2Nkb21haW5fdGh1bWJuYWlsfQ==' designElement='image' /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'http')){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="http<?php echo str_replace('http','',$TPL_V1["filelist"]['realfile'])?>" designImgSrcOri='aHR0cHs9c3RyX3JlcGxhY2Uo' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL3ZpZGVvL2dhbGxlcnkwMS9pbmRleC5odG1s' designImgSrc='aHR0cHs9c3RyX3JlcGxhY2Uo' designElement='image' /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'/data/editor/')){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif'" designImgSrcOri='ey5maWxlbGlzdFs=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL3ZpZGVvL2dhbGxlcnkwMS9pbmRleC5odG1s' designImgSrc='ey5maWxlbGlzdFs=' designElement='image' /></span>
<?php }else{?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="/data/board/<?php echo $_GET["id"]?>/<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage.gif'" designImgSrcOri='L2RhdGEvYm9hcmQve19HRVQuaWR9L3suZmlsZWxpc3Rb' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL3ZpZGVvL2dhbGxlcnkwMS9pbmRleC5odG1s' designImgSrc='L2RhdGEvYm9hcmQve19HRVQuaWR9L3suZmlsZWxpc3Rb' designElement='image' /></span>
<?php }?>
			</li>
		</ul>
		-->
		<ul class="custom_board_img_area">
			<li>
				<!-- 20220216 여기-->
				<span>
					<img id="video_img" class="image_thumb yutube_img" style="width: 500px; height: 300px; position: absolute;" src="https://img.youtube.com/vi/<?php echo $TPL_V1["video_url"]?>/maxresdefault.jpg" designImgSrcOri='aHR0cHM6Ly9pbWcueW91dHViZS5jb20vdmkvey52aWRlb191cmx9L21heHJlc2RlZmF1bHQuanBn' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL3ZpZGVvL2dhbGxlcnkwMS9pbmRleC5odG1s' designImgSrc='aHR0cHM6Ly9pbWcueW91dHViZS5jb20vdmkvey52aWRlb191cmx9L21heHJlc2RlZmF1bHQuanBn' designElement='image' />
					<iframe class="yutube_video" id="youtube_preview" width="500" height="300" style=" pointer-events: none;" src="https://www.youtube.com/embed/<?php echo $TPL_V1["video_url"]?>?autoplay=1&mute=1&controls=0&loop=1&playlist=<?php echo $TPL_V1["video_url"]?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</span>
			</li>
		</ul>
		<ul class="text_area">
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li class="c_hit">조회 <?php echo $TPL_V1["hit"]?></li><?php }?>
			<!-- ///////////// 동여상 내용 줄바꿈 부분 ///////////////// -->
			<li class="c_short_code" onclick="location.href='<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>';">
				<div class="board_detail_contents"><pre><?php echo $TPL_V1["contentcut"]?></pre></div>
			</li>
...
// <!--2022.02.16 미리보기 사진 변경-->
// $(document).ready(function () {
// 	self.setTimeout("none_img()",1500);

// });

// function none_img() {
// 	document.getElementById("video_img").style.opacity="0";
// 	document.getElementById("youtube_preview").style.opacity="1";
// }
$(function(){
	$('.yutube_video').fadeIn(1500);
	$('.yutube_img').fadeOut(3000);
});
