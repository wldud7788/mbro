<?php /* Template_ 2.2.6 2022/02/25 18:59:36 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/board/video/gallery01/view.html 000010658 */  $this->include_("sslAction","snslinkurl");
...
<?php if($TPL_V1["is_image"]){?>
				<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfile"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');" ><img src="/data/skin/responsive_sports_sporti_gl/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vLi4vLi4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL2JvYXJkL3ZpZGVvL2dhbGxlcnkwMS92aWV3Lmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designElement='image' /></span>
<?php }?>
		</li>
<?php }}?>
	</ul>
...
<?php }?>
	...
	<div id="player_autoload">
		<iframe id="youtube_preview" width="700" height="400" src="https://www.youtube.com/embed/<?php echo $TPL_VAR["video_url"]?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div>
