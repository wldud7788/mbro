<?php /* Template_ 2.2.6 2022/03/15 17:28:00 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/emoney.html 000005320 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="res_table" style="text-align: center">
			<img src="<?php echo $TPL_VAR["walletAdd"]?>" designImgSrcOri='eyB3YWxsZXRBZGQgfQ==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9lbW9uZXkuaHRtbA==' designImgSrc='eyB3YWxsZXRBZGQgfQ==' designElement='image' >
		</div>
		-->
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9lbW9uZXkuaHRtbA==" >캐시전환내역</span></h2>
		</div>
		<div class="mypage_greeting btm_padding">
...
<?php }?>
		...
		<!-- 타이틀 -->
		<div class="title_container">
			<h2><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9lbW9uZXkuaHRtbA==" >캐시 내역</span></h2>
		</div>
