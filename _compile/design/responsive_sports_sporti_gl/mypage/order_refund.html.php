<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/order_refund.html 000015007 */ 
...
<div class="subpage_wrap" data-ezmark="undo">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9yZWZ1bmQuaHRtbA==" >결제취소 / 환불신청</span></h2>
		</div>
...
<?php }}?>
			...
			<div id="refund_method_layer" <?php if(in_array($TPL_VAR["orders"]["payment"],array("card","kakaomoney","payco","cellphone"))){?>style="display: none"<?php }?>>
