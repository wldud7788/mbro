<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/mygdreview_view.html 000020113 */  $this->include_("sslAction","snslinkurl");
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9teWdkcmV2aWV3X3ZpZXcuaHRtbA==" >나의 상품 후기</span></h2>
		</div>
...
<?php if($TPL_V1["is_image"]){?>
										<span class="hand" imgsrc="<?php echo $TPL_V1["realfile"]?>" onclick="board_file_review('<?php echo $TPL_V1["realfileurl"]?>','<?php echo $TPL_V1["imagesize"][ 0]?>','<?php echo $TPL_V1["imagesize"][ 1]?>');" ><img src="/data/skin/responsive_sports_sporti_gl/images/icon/icon_zoom.gif" hspace="1" title="미리보기" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9teWdkcmV2aWV3X3ZpZXcuaHRtbA==' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2ljb24vaWNvbl96b29tLmdpZg==' designElement='image' /></span>
<?php }?>
								</li>
<?php }}?>
							</ul>
