<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/order_return.html 000024865 */ 
...
<?php if($TPL_V2["opt_type"]=='opt'){?>
								<ul class="board_goods_list">
									<li class="pic">
										<img src="<?php echo $TPL_V2["image"]?>" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_list.gif'" alt="<?php echo $TPL_V2["goods_name"]?>" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9yZXR1cm4uaHRtbA==' designImgSrc='ey4uaW1hZ2V9' designElement='image' /></span>
									</li>
									<li class="info">
										<div class="title">
