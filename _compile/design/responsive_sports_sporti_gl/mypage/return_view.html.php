<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/return_view.html 000016626 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9yZXR1cm5fdmlldy5odG1s" >반품/교환 상세</span></h2>
		</div>
			...
			<ul class="tbody">
				<li class="item_info">
					<ul class="oc_item_info_detail">
						<li class="img_link">
							<a href='/goods/view?no=<?php echo $TPL_V1["goods_seq"]?>' target='_blank' title="새창" hrefOri='L2dvb2RzL3ZpZXc/bm89ey5nb29kc19zZXF9' ><img src="<?php echo $TPL_V1["image"]?>" class="order_thumb" alt="<?php echo $TPL_V1["goods_name"]?>" designImgSrcOri='ey5pbWFnZX0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9yZXR1cm5fdmlldy5odG1s' designImgSrc='ey5pbWFnZX0=' designElement='image' /></a>
						</li>
						<li class="detail_spec">
<?php if($TPL_V1["goods_type"]=='gift'){?><img src="/data/skin/responsive_sports_sporti_gl/images/common/icon_gift.gif" alt="사은품" vspace=3 designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2dpZnQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9yZXR1cm5fdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi9pY29uX2dpZnQuZ2lm' designElement='image' /><?php }?>
...
<?php }?>
		...
		<div class="btn_area_b">
			<a href="/mypage/return_catalog" class="btn_resp size_c" hrefOri='L215cGFnZS9yZXR1cm5fY2F0YWxvZw==' >반품 목록</a>
		</div>
