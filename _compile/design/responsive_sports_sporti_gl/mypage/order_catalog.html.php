<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/mypage/order_catalog.html 000018944 */ 
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=" >주문/배송 내역</span></h2>
		</div>
...
<?php if(is_array($TPL_R3=$TPL_V2["options"])&&!empty($TPL_R3)){$TPL_I3=-1;foreach($TPL_R3 as $TPL_V3){$TPL_I3++;?>
					<ul class="oc_item_info_detail">
						<li class="img_link" <?php if($TPL_V2["goods_type"]!='gift'){?>style="cursor:pointer" title="상품 상세" onclick="location.href='../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>';"<?php }?>>
							<img src="<?php echo viewImg($TPL_V2["goods_seq"],'thumbCart')?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_sports_sporti_gl/images/common/noimage_list.gif'" alt="" designImgSrcOri='ez12aWV3SW1nKC4uZ29vZHNfc2VxLCA=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='ez12aWV3SW1nKC4uZ29vZHNfc2VxLCA=' designElement='image' />
						</li>
						<li class="detail_spec">
<?php if($TPL_V2["eventEnd"]){?>
							<div class="oc_event_area">
								<span class="soloEventTd<?php echo $TPL_V3["item_option_seq"]?>">
									<img src="/data/skin/responsive_sports_sporti_gl/images/common/icon_clock.gif" class="img_clock" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb2NrLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb2NrLmdpZg==' designElement='image' > 남은시간
...
<?php if($TPL_V2["goods_type"]=='gift'){?><img src="/data/skin/responsive_sports_sporti_gl/images/common/icon_gift.gif" alt="사은품" vspace=3 designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2dpZnQuZ2lm' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi9pY29uX2dpZnQuZ2lm' designElement='image' /><?php }?>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
								<img src="/data/skin/responsive_sports_sporti_gl/images/common/auth_img.png" class="icon1" alt="성인" height="17" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designElement='image' />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
								<img src="/data/skin/responsive_sports_sporti_gl/images/common/plane.png" class="icon1" alt="해외배송상품" height="16" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designElement='image' />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
								<img src="/data/skin/responsive_sports_sporti_gl/images/common/nocancellation.gif" class="icon1" alt="청약철회"  designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9ub2NhbmNlbGxhdGlvbi5naWY=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi9ub2NhbmNlbGxhdGlvbi5naWY=' designElement='image' />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
								<img src="/data/skin/responsive_sports_sporti_gl/images/common/taxfree.gif" class="icon1" alt="비과세" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi90YXhmcmVlLmdpZg==' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2NvbW1vbi90YXhmcmVlLmdpZg==' designElement='image' />
<?php }?>
							</div>
<?php }?>
...
<?php if($TPL_V4["type"]=='file'){?>
										<a href="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" hrefOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' ><img src="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" class="input_img" title="크게 보기" designImgSrcOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL215cGFnZS9vcmRlcl9jYXRhbG9nLmh0bWw=' designImgSrc='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designElement='image' /></a>
<?php }else{?>
