<?php /* Template_ 2.2.6 2021/12/15 16:50:24 /www/music_brother_firstmall_kr/data/skin/responsive_sports_sporti_gl/order/complete.html 000036177 */ 
...
<div class="subpage_wrap">
	<div class="subpage_container v3 Pb10">
		...
		<div class="title_container">
			<a class="btn_history back" href="javascript:history.back();" hrefOri='amF2YXNjcmlwdDpoaXN0b3J5LmJhY2soKTs=' ><img src="/data/skin/responsive_sports_sporti_gl/images/design/arw_prev.gif" alt="히스토리 뒤로" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9hcndfcHJldi5naWY=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2Rlc2lnbi9hcndfcHJldi5naWY=' designElement='image' /></a>
<?php if($TPL_VAR["orders"]["step"]== 99||$TPL_VAR["orders"]["step"]== 0){?>
			<h2 class="pointcolor imp"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >결제실패</span></h2>
<?php }else{?>
			<h2><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >주문완료</span></h2>
<?php }?>
			<a class="btn_history forward" href="javascript:history.forward();" hrefOri='amF2YXNjcmlwdDpoaXN0b3J5LmZvcndhcmQoKTs=' ><img src="/data/skin/responsive_sports_sporti_gl/images/design/arw_next.gif" alt="히스토리 앞으로" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9hcndfbmV4dC5naWY=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3Nwb3J0c19zcG9ydGlfZ2wvaW1hZ2VzL2Rlc2lnbi9hcndfbmV4dC5naWY=' designElement='image' /></a>
		</div>
...
<div class="subpage_wrap order_payment" data-ezmark="undo">
	<div class="subpage_container v2 Pt0 Pb40 order_payment_left2">
		<h2 class="title_od1 Pt15"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >주문상품</span></h2>
...
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?>
														<a href="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" target="actionFrame" title="다운로드" hrefOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' ><img src="/mypage_process/filedown?file=<?php echo $TPL_V4["value"]?>" class="inputed_img" alt="" designImgSrcOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=' designImgSrc='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLi52YWx1ZX0=' designElement='image' /></a>
<?php }else{?>
<?php if($TPL_V4["title"]){?><span class="xtle v2"><?php echo $TPL_V4["title"]?></span><?php }?>
...
<?php }?>
		...
		<div class="order_subsection v2">
			<h3 class="title3"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >주문자</span></h3>
			<ul class="list_01 v2">
				<li>
...
<?php }?>
			...
			<h3 class="title3"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >배송지</span></h3>
			<ul class="list_01 v2">
				<li>
...
<?php if($TPL_VAR["orders"]["clearance_unique_personal_code"]){?>
			<h3 class="title3"><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >해외구매대행상품</span></h3>
...
<?php }?>
	...
	<div class="subpage_container v2 Pt0 Pb40 order_payment_right2">
		<div class="order_subsection v2 ">
			<h3 class="title3 Pt15"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >결제 금액</span></h3>
			<div class="order_price_total">
				<ul>
					<li class="th"><strong><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >상품금액</span></strong></li>
					<li class="td"><?php echo get_currency_price($TPL_VAR["orders"]["tot_price"], 2)?></li>
				</ul>
				<ul>
					<li class="th">
						<span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >배송비</span>&nbsp;
...
<?php if($TPL_VAR["orders"]["total_sale_price"]> 0){?>
				<ul>
					<li class="th">
						<span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >할인금액</span>&nbsp;
...
<?php }?>
				<ul class="total">
					<li class="th"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >총 결제금액</span></li>
					<li class="td">
...
<?php }?>
			...
			<h3 class="title3"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >주문결제정보</span>&nbsp; <?php if($TPL_VAR["btn_tradeinfo"]){?><span class="btn_resp gray_06"><?php echo $TPL_VAR["btn_tradeinfo"]?></span><?php }?></h3>
...
<div class="Pb60 C">
	<a href="/mypage/order_view?no=<?php echo $TPL_VAR["orders"]["order_seq"]?>" class="btn_resp size_c color2" hrefOri='L215cGFnZS9vcmRlcl92aWV3P25vPXtvcmRlcnMub3JkZXJfc2VxfQ==' ><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >MY페이지 주문내역</span></a>
	<a href="/" class="btn_resp size_c color5" hrefOri='Lw==' ><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV9zcG9ydHNfc3BvcnRpX2dsL29yZGVyL2NvbXBsZXRlLmh0bWw=" >쇼핑 계속하기</span></a>
</div>
